...
//    _paTreeSpaceArray = NEW TreeSpace<3u>[_num_space];
...
//    const uint32_t index = morton_order_space_num + (POW2D[_top_space_level-shift_num]-1)/7;
...
//#endif
//    //要素を線形八分木空間に登録(所属させる)
//    TreeSpace<3u>* pTreeSpace = &(_paTreeSpaceArray[index]);
