...
GgafLinearQuadtreeForActor::GgafLinearQuadtreeForActor(GgafLinearQuadtree* prm_paTargetLinearQuadtree, void (GgafActor::*prm_pFunc)(GgafActor*)) : GgafObject() {
    _pTargetLinearQuadtree = prm_paTargetLinearQuadtree;
    _paTargetLinearOctant = _pTargetLinearQuadtree->_paLinearOctant;
    _num_space_minus_one = _pTargetLinearQuadtree->_num_space-1;
    _pFunc = prm_pFunc;
    _kind_groupA = 0;
    _kind_groupB = 0;
}

void GgafLinearQuadtreeForActor::executeAll(actorkind prm_groupA, actorkind prm_groupB) {
...
void GgafLinearQuadtreeForActor::execute(uint32_t prm_index) {
    ...
    const uint32_t lower_level_index = prm_index*4 + 1; //_papOctant[prm_index] 空間の子空間のモートン順序位置0番の配列要素番号
...
void GgafLinearQuadtreeForActor::executeRoundRobin(ActorStack* prm_pStackA, ActorStack* prm_pStackB) {
