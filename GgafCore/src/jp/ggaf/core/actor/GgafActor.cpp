...
void GgafActor::notifyFormationAboutDestroyed() {
    ...
    if (_pFormation) {
        ...
        throwGgafCriticalException("GgafDxGeometricActor::informDestroyedFollower() _pFormation Ç™ NULLÇ≈Ç∑ÅB"<<
                                   "ëŒâûÇ∑ÇÈ TreeFormation Ç…ÇÊÇÈ addSubLast() àΩÇ¢ÇÕ callUpUntil() Ç…ÇÊÇËÅAIFormationAbleÉAÉNÉ^Å[Ç™ê›íËÇ≥ÇÍÇƒÇ¢Ç‹ÇπÇÒÅBthis="<<this);
    }
#endif
