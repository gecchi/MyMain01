...
GgafException::GgafException(string prm_message) : GgafObject("GgafException") {
    ...
    MessageBox(NULL, message_dialog.c_str(), "不本意な事態", MB_OK|MB_ICONQUESTION|MB_SETFOREGROUND);
