 ...
 * とある意味合いで纏ったアクター達のツリー頂点に位置しするアクターです。<BR>
 * いわゆる『種別』を意味付ける役割を持ったアクターで、具体的なアクターではありません。<BR>
 * 団長配下の全てのアクターの『種別』は、団長の『種別』とする。という仕組みです。<BR>
 * 『種別』とは、当たり判定時の [自機の弾]と[敵本体] 等の [] の中身のような事を指します。（分類とすべきなのかもしれません）<BR>
