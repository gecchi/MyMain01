#ifndef GGAFCORE_GGAFCONFIG_H_
#define GGAFCORE_GGAFCONFIG_H_
...
#include "jp/ggaf/core/util/GgafRgb.h"
    ...
    #undef CONFIG
#endif
#define CONFIG GgafCore::GgafConfig
...
public:
    ...
    /** [r] 保持プロパティ */
    static GgafProperties _properties;
