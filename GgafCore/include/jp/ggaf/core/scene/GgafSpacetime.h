#ifndef GGAFCORE_GGAFSPACETIME_H_
#define GGAFCORE_GGAFSPACETIME_H_
 ...
 */
class GgafSpacetime : public GgafMainScene {
    friend class GgafGod;
    friend class GgafScene;

public:
    GgafSpacetime(const char* prm_name);
    ...
    virtual ~GgafSpacetime();
};

}
#endif /*GGAFCORE_GGAFSPACETIME_H_*/
