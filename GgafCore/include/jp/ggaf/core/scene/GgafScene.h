 ...
 * 機能として、シーンオブジェクト同士のポインタ接合し、ツリー階層構造を採る事ができます。このツリー構造はクラスの継承と関係ありません。<BR>
 ...
 * また、シーンクラスは管理者アクター(GgafLoadActor)を管理するクラスでもあります。
 * 管理者アクターとはシーン毎のアクターの大親分のようなもので、GgafLoadActor のコメントも参照して下さい。<BR>
 * 各シーンは、必ず１つの管理者アクター(GgafLoadActor)をメンバとして保持しています。<BR>
 *
 * <B>【用語補足】</B>
 * <TABLE border='1'>
 * <TR>
 * <TD>「シーン」</TD>
 * <TD>シーンクラスのインスタンス（オブジェクト）へのポインタを省略して、単にシーンと呼ぶことにします。</TD>
 * </TR><TR>
 * <TD>「自シーン」「自」</TD>
 * <TD>解説やコメント文のメソッドが実行されるシーン自身を指しています。</TD>
 * </TR><TR>
 * <TD>「サブシーン」「サブ」「子」</TD>
 * <TD>シーン同士のツリー階層構造上において、シーンに<B>直に</B>ぶら下がる１階層下のシーン達を指しています。<BR>
 * シーンクラスを継承したクラスという意味では無いこととします。</TD>
 * </TR><TR>
 * <TD>「シーン配下」「配下」</TD>
 * <TD>シーン同士のツリー階層構造上において、シーン<B>に</B>ぶら下がる全てのシーンを指しています。サブも含まれます。<BR>
 * シーンクラスを継承元クラスという意味では無いこととします。</TD></TD>
 * </TR><TR>
 * <TD>「親シーン」「親」</TD>
 ...
 * </TR><TR>
 * <TD>「自所属ツリー」</TD>
 * <TD>自シーンが含まれている部分ツリー(或いはツリー全体)すべてのツリー階層構造を指します。</TD>
 * </TR><TR>
 * <TD>「自ツリー」</TD>
