...
/**
 * シーンの基底クラス .
 * 本プログラムで言う『シーン（場面）』とは、主にアクターに指示するオブジェクトで<BR>
 * 各シーンは、必ず１つのアクターツリーをメンバとして保持しています。<BR>
 * 全てのシーンクラスは、本クラスを直接・間接継承しなければなりません。<BR>
 * また、シーン同士で、ツリー階層構造を採る事ができます。<BR>
 * シーンに実装されているメソッド郡のほとんどは、自分自身と自分配下のシーン（自ツリーシーン）全てに影響する仕様になっています。<BR>
 * ゲームをオブジェクト指向で表現するため、様々な『シーン（場面）』で『アクター(キャラ)』たちが活躍する、という事を念頭において設計してあります。<BR>
 * <B>【用語補足】</B>
 * <TABLE>
 * <TR>
 * <TD>「シーン」</TD>
 ...
 * </TR><TR>
 * <TD>「親シーン」「親」</TD>
 * <TD>シーン同士のツリー階層構造上において、シーン<B>が</B>直接或いは間接的にぶら下がっているシーン全てを指しています。</TD>
 * </TR><TR>
 * <TD>「他シーン」「他」</TD>
 * <TD>自シーン以外のシーン全てを指しています。</TD>
 * </TR><TR>
 * <TD>「ツリー」</TD>
 ...
 * </TR><TR>
 * <TD>「自ツリー」</TD>
 * <TD>自シーンを頂点とする、自シーン＋自シーン配下のツリー構造部分を指します。</TD>
 * </TR><TR>
 * <TD>「自ツリーシーン」</TD>
