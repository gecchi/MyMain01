...
void TrialAndErrScene::processBehavior() {
    ...
    if (getActiveFrame() == 100) {
        for (int id = 0; id < 17; id++) {
            ...
            pTest->locate(PX_C(100*id), PX_C(100*id), PX_C(100*id));
