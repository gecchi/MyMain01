...
void SmpActor2::onHit(const GgafCore::Checker* prm_pThisHitChecker, const GgafCore::Checker* prm_pOppHitChecker) {
    _TRACE_("SmpActor2::onHit!!!! ëäéËÅÅ"<<prm_pOppHitChecker->_pActor->getName()<<"");
}
