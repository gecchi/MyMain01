...
void SmpSprite::onHit(const GgafCore::Checker* prm_pThisHitChecker, const GgafCore::Checker* prm_pOppHitChecker) {
    _TRACE_("SmpSprite::onHit!!!! 相手＝"<<prm_pOppHitChecker->_pActor->getName()<<"");
}
