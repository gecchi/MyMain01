...
void SeActor3::onHit(const GgafCore::Checker* prm_pThisHitChecker, const GgafCore::Checker* prm_pOppHitChecker) {
    _TRACE_("SeActor3::onHit!!!! 相手＝"<<prm_pOppHitChecker->_pActor->getName()<<"");
}
