...
public:
     ...
     * </code>
     * @param prm_FirstPhase 先頭の進捗状態
     * @param prm_EndPhase 末尾の進捗状態
     * @param prm_FirstChildSceneName 先頭の進捗状態(prm_FirstPhase)に対応する子シーンの名称
     */
     ...
     * @param prm_FirstPhase 先頭の進捗状態
     * @param prm_EndPhase   末尾の進捗状態
     * @param prm_pFirstChildScene 先頭の進捗状態(prm_FirstPhase)に対応する子シーン
     */
