 ...
 * 先頭のチップの動きを processBehaviorHeadChip() に実装して下さい。LocusVehicle で移動します。<BR>
 * dispatch() したら、座標と LocusVehicle（向き速度）を設定して下さい。<BR>
 * 先頭のチップの場合のみ、座標と LocusVehicle（向き速度）の設定が適用され、
