 ...
 * <TR><TD>getKuroko()</TD><TD>黒衣。移動支援(※正面方角回転機能はZ軸回転のみ有効)</TD><TD>GgafDx::Kuroko</TD></TR>
...
public:
    DefaultBoardActor(const char* prm_name, const char* prm_model, GgafCore::Status* prm_pStat = nullptr);
