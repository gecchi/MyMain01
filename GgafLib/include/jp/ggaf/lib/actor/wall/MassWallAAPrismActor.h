 ...
 */
class MassWallAAPrismActor : public MassWallActor {
...
public:
    MassWallAAPrismActor(const char* prm_name, const char* prm_model, GgafCore::GgafStatus* prm_pStat=nullptr);

    static bool initStatic(MassWallAAPrismActor* prm_pMassWallAAPrismActor);
