 ...
 */
class FixedFontBoardActor : public GgafDxCore::GgafDxMassBoardActor , public IFixedFont<FixedFontBoardActor> {
...
public:
    FixedFontBoardActor(const char* prm_name, const char* prm_model, GgafCore::GgafStatus* prm_pStat = nullptr);
