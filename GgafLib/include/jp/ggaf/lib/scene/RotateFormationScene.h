...
private:
    ...
    public:
        /** 編隊アクター */
        GgafDx::Formation* _pFormationActor;
         ...
         * @return
         */
        FormationTblElem(GgafDx::Formation* prm_pFormationActor, frame prm_max_delay_offset = 0) {
...
public:
     ...
     * @return
     */
    virtual void addFormation(GgafDx::Formation* prm_pFormationActor, frame prm_max_delay_offset = 0);
