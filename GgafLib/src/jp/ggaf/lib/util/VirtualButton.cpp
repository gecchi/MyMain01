...
std::map<int, std::string> VirtualButton::_mapKeyName;
std::map<int, std::string> VirtualButton::_mapJoyName;
...
void VirtualButton::init() {
    ...
    _mapKeyName[0x01] = "DIK_ESCAPE";
    _mapKeyName[0x02] = "DIK_1";
    _mapKeyName[0x03] = "DIK_2";
    _mapKeyName[0x04] = "DIK_3";
    _mapKeyName[0x05] = "DIK_4";
    _mapKeyName[0x06] = "DIK_5";
    _mapKeyName[0x07] = "DIK_6";
    _mapKeyName[0x08] = "DIK_7";
    _mapKeyName[0x09] = "DIK_8";
    _mapKeyName[0x0A] = "DIK_9";
    _mapKeyName[0x0B] = "DIK_0";
    _mapKeyName[0x0C] = "DIK_MINUS";
    _mapKeyName[0x0D] = "DIK_EQUALS";
    _mapKeyName[0x0E] = "DIK_BACK";
    _mapKeyName[0x0F] = "DIK_TAB";
    _mapKeyName[0x10] = "DIK_Q";
    _mapKeyName[0x11] = "DIK_W";
    _mapKeyName[0x12] = "DIK_E";
    _mapKeyName[0x13] = "DIK_R";
    _mapKeyName[0x14] = "DIK_T";
    _mapKeyName[0x15] = "DIK_Y";
    _mapKeyName[0x16] = "DIK_U";
    _mapKeyName[0x17] = "DIK_I";
    _mapKeyName[0x18] = "DIK_O";
    _mapKeyName[0x19] = "DIK_P";
    _mapKeyName[0x1A] = "DIK_LBRACKET";
    _mapKeyName[0x1B] = "DIK_RBRACKET";
    _mapKeyName[0x1C] = "DIK_RETURN";
    _mapKeyName[0x1D] = "DIK_LCONTROL";
    _mapKeyName[0x1E] = "DIK_A";
    _mapKeyName[0x1F] = "DIK_S";
    _mapKeyName[0x20] = "DIK_D";
    _mapKeyName[0x21] = "DIK_F";
    _mapKeyName[0x22] = "DIK_G";
    _mapKeyName[0x23] = "DIK_H";
    _mapKeyName[0x24] = "DIK_J";
    _mapKeyName[0x25] = "DIK_K";
    _mapKeyName[0x26] = "DIK_L";
    _mapKeyName[0x27] = "DIK_SEMICOLON";
    _mapKeyName[0x28] = "DIK_APOSTROPHE";
    _mapKeyName[0x29] = "DIK_GRAVE";
    _mapKeyName[0x2A] = "DIK_LSHIFT";
    _mapKeyName[0x2B] = "DIK_BACKSLASH";
    _mapKeyName[0x2C] = "DIK_Z";
    _mapKeyName[0x2D] = "DIK_X";
    _mapKeyName[0x2E] = "DIK_C";
    _mapKeyName[0x2F] = "DIK_V";
    _mapKeyName[0x30] = "DIK_B";
    _mapKeyName[0x31] = "DIK_N";
    _mapKeyName[0x32] = "DIK_M";
    _mapKeyName[0x33] = "DIK_COMMA";
    _mapKeyName[0x34] = "DIK_PERIOD";
    _mapKeyName[0x35] = "DIK_SLASH";
    _mapKeyName[0x36] = "DIK_RSHIFT";
    _mapKeyName[0x37] = "DIK_MULTIPLY";
    _mapKeyName[0x38] = "DIK_LMENU";
    _mapKeyName[0x39] = "DIK_SPACE";
    _mapKeyName[0x3A] = "DIK_CAPITAL";
    _mapKeyName[0x3B] = "DIK_F1";
    _mapKeyName[0x3C] = "DIK_F2";
    _mapKeyName[0x3D] = "DIK_F3";
    _mapKeyName[0x3E] = "DIK_F4";
    _mapKeyName[0x3F] = "DIK_F5";
    _mapKeyName[0x40] = "DIK_F6";
    _mapKeyName[0x41] = "DIK_F7";
    _mapKeyName[0x42] = "DIK_F8";
    _mapKeyName[0x43] = "DIK_F9";
    _mapKeyName[0x44] = "DIK_F10";
    _mapKeyName[0x45] = "DIK_NUMLOCK";
    _mapKeyName[0x46] = "DIK_SCROLL";
    _mapKeyName[0x47] = "DIK_NUMPAD7";
    _mapKeyName[0x48] = "DIK_NUMPAD8";
    _mapKeyName[0x49] = "DIK_NUMPAD9";
    _mapKeyName[0x4A] = "DIK_SUBTRACT";
    _mapKeyName[0x4B] = "DIK_NUMPAD4";
    _mapKeyName[0x4C] = "DIK_NUMPAD5";
    _mapKeyName[0x4D] = "DIK_NUMPAD6";
    _mapKeyName[0x4E] = "DIK_ADD";
    _mapKeyName[0x4F] = "DIK_NUMPAD1";
    _mapKeyName[0x50] = "DIK_NUMPAD2";
    _mapKeyName[0x51] = "DIK_NUMPAD3";
    _mapKeyName[0x52] = "DIK_NUMPAD0";
    _mapKeyName[0x53] = "DIK_DECIMAL";
    _mapKeyName[0x56] = "DIK_OEM_102";
    _mapKeyName[0x57] = "DIK_F11";
    _mapKeyName[0x58] = "DIK_F12";
    _mapKeyName[0x64] = "DIK_F13";
    _mapKeyName[0x65] = "DIK_F14";
    _mapKeyName[0x66] = "DIK_F15";
    _mapKeyName[0x70] = "DIK_KANA";
    _mapKeyName[0x73] = "DIK_ABNT_C1";
    _mapKeyName[0x79] = "DIK_CONVERT";
    _mapKeyName[0x7B] = "DIK_NOCONVERT";
    _mapKeyName[0x7D] = "DIK_YEN";
    _mapKeyName[0x7E] = "DIK_ABNT_C2";
    _mapKeyName[0x8D] = "DIK_NUMPADEQUALS";
    _mapKeyName[0x90] = "DIK_PREVTRACK";
    _mapKeyName[0x91] = "DIK_AT";
    _mapKeyName[0x92] = "DIK_COLON";
    _mapKeyName[0x93] = "DIK_UNDERLINE";
    _mapKeyName[0x94] = "DIK_KANJI";
    _mapKeyName[0x95] = "DIK_STOP";
    _mapKeyName[0x96] = "DIK_AX";
    _mapKeyName[0x97] = "DIK_UNLABELED";
    _mapKeyName[0x99] = "DIK_NEXTTRACK";
    _mapKeyName[0x9C] = "DIK_NUMPADENTER";
    _mapKeyName[0x9D] = "DIK_RCONTROL";
    _mapKeyName[0xA0] = "DIK_MUTE";
    _mapKeyName[0xA1] = "DIK_CALCULATOR";
    _mapKeyName[0xA2] = "DIK_PLAYPAUSE";
    _mapKeyName[0xA4] = "DIK_MEDIASTOP";
    _mapKeyName[0xAE] = "DIK_VOLUMEDOWN";
    _mapKeyName[0xB0] = "DIK_VOLUMEUP";
    _mapKeyName[0xB2] = "DIK_WEBHOME";
    _mapKeyName[0xB3] = "DIK_NUMPADCOMMA";
    _mapKeyName[0xB5] = "DIK_DIVIDE";
    _mapKeyName[0xB7] = "DIK_SYSRQ";
    _mapKeyName[0xB8] = "DIK_RMENU";
    _mapKeyName[0xC5] = "DIK_PAUSE";
    _mapKeyName[0xC7] = "DIK_HOME";
    _mapKeyName[0xC8] = "DIK_UP";
    _mapKeyName[0xC9] = "DIK_PRIOR";
    _mapKeyName[0xCB] = "DIK_LEFT";
    _mapKeyName[0xCD] = "DIK_RIGHT";
    _mapKeyName[0xCF] = "DIK_END";
    _mapKeyName[0xD0] = "DIK_DOWN";
    _mapKeyName[0xD1] = "DIK_NEXT";
    _mapKeyName[0xD2] = "DIK_INSERT";
    _mapKeyName[0xD3] = "DIK_DELETE";
    _mapKeyName[0xDB] = "DIK_LWIN";
    _mapKeyName[0xDC] = "DIK_RWIN";
    _mapKeyName[0xDD] = "DIK_APPS";
    _mapKeyName[0xDE] = "DIK_POWER";
    _mapKeyName[0xDF] = "DIK_SLEEP";
    _mapKeyName[0xE3] = "DIK_WAKE";
    _mapKeyName[0xE5] = "DIK_WEBSEARCH";
    _mapKeyName[0xE6] = "DIK_WEBFAVORITES";
    _mapKeyName[0xE7] = "DIK_WEBREFRESH";
    _mapKeyName[0xE8] = "DIK_WEBSTOP";
    _mapKeyName[0xE9] = "DIK_WEBFORWARD";
    _mapKeyName[0xEA] = "DIK_WEBBACK";
    _mapKeyName[0xEB] = "DIK_MYCOMPUTER";
    _mapKeyName[0xEC] = "DIK_MAIL";
    _mapKeyName[0xED] = "DIK_MEDIASELECT";
    _mapKeyName[0x0E] = "DIK_BACKSPACE";
    _mapKeyName[0x37] = "DIK_NUMPADSTAR";
    _mapKeyName[0x38] = "DIK_LALT";
    _mapKeyName[0x3A] = "DIK_CAPSLOCK";
    _mapKeyName[0x4A] = "DIK_NUMPADMINUS";
    _mapKeyName[0x4E] = "DIK_NUMPADPLUS";
    _mapKeyName[0x53] = "DIK_NUMPADPERIOD";
    _mapKeyName[0xB5] = "DIK_NUMPADSLASH";
    _mapKeyName[0xB8] = "DIK_RALT";
    _mapKeyName[0xC8] = "DIK_UPARROW";
    _mapKeyName[0xC9] = "DIK_PGUP";
    _mapKeyName[0xCB] = "DIK_LEFTARROW";
    _mapKeyName[0xCD] = "DIK_RIGHTARROW";
    _mapKeyName[0xD0] = "DIK_DOWNARROW";
    _mapKeyName[0xD1] = "DIK_PGDN";

    _mapJoyName[0]  = "JOY_BUTTON_00";
    _mapJoyName[1]  = "JOY_BUTTON_01";
    _mapJoyName[2]  = "JOY_BUTTON_02";
    _mapJoyName[3]  = "JOY_BUTTON_03";
    _mapJoyName[4]  = "JOY_BUTTON_04";
    _mapJoyName[5]  = "JOY_BUTTON_05";
    _mapJoyName[6]  = "JOY_BUTTON_06";
    _mapJoyName[7]  = "JOY_BUTTON_07";
    _mapJoyName[8]  = "JOY_BUTTON_08";
    _mapJoyName[9]  = "JOY_BUTTON_09";
    _mapJoyName[10] = "JOY_BUTTON_10";
    _mapJoyName[11] = "JOY_BUTTON_11";
    _mapJoyName[12] = "JOY_BUTTON_12";
