...
SplineSequence* SteppedCoordSplineManufacture::createSplineSequence(GgafDxCore::GgafDxKurokoA* prm_pKurokoA) {
    return NEW SteppedCoordSplineSequence(this, prm_pKurokoA);
}
