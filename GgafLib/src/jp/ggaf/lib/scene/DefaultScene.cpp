...
DefaultScene::DefaultScene(const char* prm_name, GgafCore::SceneChief* prm_pSceneChief) :
        GgafDx::Scene(prm_name, prm_pSceneChief ? prm_pSceneChief : NEW DefaultSceneChief(this)) {
