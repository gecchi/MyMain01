#ifndef GGAFDXCORE_GGAFDXMESHEFFECT_H_
#define GGAFDXCORE_GGAFDXMESHEFFECT_H_
...
public:
     ...
     * @return
     */
    GgafDxMeshEffect(const char* prm_effect_name);
...
#endif /*GGAFDXCORE_GGAFDXMESHEFFECT_H_*/
