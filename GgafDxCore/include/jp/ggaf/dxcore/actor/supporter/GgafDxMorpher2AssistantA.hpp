#ifndef GGAFDXCORE_GGAFDXMORPHER2ASSISTANT_H_
#define GGAFDXCORE_GGAFDXMORPHER2ASSISTANT_H_
 ...
 */
template<class T>
class GgafDxMorpher2AssistantA : public GgafCore::GgafObject {

public:
    /** [r]師匠 */
    GgafDxMorpher2<T>* _pMaster;
    /** [r]重み加速器 */
...
public:
     ...
     */
    explicit GgafDxMorpher2AssistantA(GgafDxMorpher2<T>* prm_pMaster);
   ...
   /**
    ...
    virtual ~GgafDxMorpher2AssistantA();
};

template<class T>
GgafDxMorpher2AssistantA<T>::GgafDxMorpher2AssistantA(GgafDxMorpher2<T>* prm_pMaster) : GgafCore::GgafObject(),
...
template<class T>
void GgafDxMorpher2AssistantA<T>::behave() {
    for (int i = 1; i <= _target_num; i++) {
...
template<class T>
void GgafDxMorpher2AssistantA<T>::morphByDt(int prm_target_mesh_no,
                                        float prm_target_distance, int prm_target_frames,
                                        float prm_p1, float prm_p2, float prm_end_velo,
...
template<class T>
void GgafDxMorpher2AssistantA<T>::morphByVd(int prm_target_mesh_no,
                                        float prm_top_velo, float prm_target_distance,
                                        float prm_p1, float prm_p2, float prm_end_velo,
                                        bool prm_zero_acc_end_flg) {
    _pa_smthMph[prm_target_mesh_no]._t_value = 0;
...
template<class T>
GgafDxMorpher2AssistantA<T>::~GgafDxMorpher2AssistantA() {
