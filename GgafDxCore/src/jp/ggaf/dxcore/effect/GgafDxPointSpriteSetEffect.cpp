...
GgafDxPointSpriteSetEffect::GgafDxPointSpriteSetEffect(const char* prm_effect_name) : GgafDxEffect(prm_effect_name) {
    _obj_effect |= Obj_GgafDxPointSpriteSetEffect;
...
void GgafDxPointSpriteSetEffect::setParamPerFrame() {
    GgafDxCamera* const pCam = P_GOD->getSpacetime()->getCamera();
...
GgafDxPointSpriteSetEffect::~GgafDxPointSpriteSetEffect() {
}
