...
void GgafDxBoardActor::processDraw() {
    ...
    checkDxException(hr, D3D_OK, "GgafDxBoardActor::draw SetFloat(_h_transformed_x) に失敗しました。3");
    hr = pID3DXEffect->SetFloat(_pBoardEffect->_h_transformed_y, float(C_PX(_y)));
    checkDxException(hr, D3D_OK, "GgafDxBoardActor::draw SetFloat(_h_transformed_y) に失敗しました。3");
    ...
    checkDxException(hr, D3D_OK, "GgafDxBoardActor::draw SetFloat(_h_depth_z) に失敗しました。");
