...
void GgafDxUtil::convRzRyToVector(angle prm_ang_rz,
    ...
    if (0 <= prm_ang_rz && prm_ang_rz < D90ANG) {
        ...
        if (0 <= prm_ang_ry && prm_ang_ry < D90ANG) { //第五象限
            ...
            throwGgafCriticalException("getNormalizeVectorZY: なんかおかしいですぜ(1) prm_ang_rz="<<prm_ang_rz<<" prm_ang_ry="<<prm_ang_ry);
        }
        ...
        if (0 <= prm_ang_ry && prm_ang_ry < D90ANG) { //第二象限
            ...
            throwGgafCriticalException("getNormalizeVectorZY: なんかおかしいですぜ(2) prm_ang_rz="<<prm_ang_rz<<" prm_ang_ry="<<prm_ang_ry);
        }
        ...
        if (0 <= prm_ang_ry && prm_ang_ry < D90ANG) { //第三象限
            ...
            throwGgafCriticalException("getNormalizeVectorZY: なんかおかしいですぜ(3) prm_ang_rz="<<prm_ang_rz<<" prm_ang_ry="<<prm_ang_ry);
        }
        ...
        if (0 <= prm_ang_ry && prm_ang_ry < D90ANG) { //第八象限
            ...
            throwGgafCriticalException("getNormalizeVectorZY: なんかおかしいですぜ(4) prm_ang_rz="<<prm_ang_rz<<" prm_ang_ry="<<prm_ang_ry);
        }
    } else {
        throwGgafCriticalException("getNormalizeVectorZY: なんかおかしいですぜ(5) prm_ang_rz="<<prm_ang_rz<<" prm_ang_ry="<<prm_ang_ry);
    }
    uint32_t vx, vy, vz;
