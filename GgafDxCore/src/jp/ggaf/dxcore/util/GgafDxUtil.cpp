...
void GgafDxUtil::convRzRyToVector(angle prm_rz,
    ...
    if (0 <= prm_rz && prm_rz < D90ANG) {
        ...
        if (0 <= prm_ry && prm_ry < D90ANG) { //第五卦限
            ...
            ysign = 1;
            zsign = -1;
        } else if (D90ANG <= prm_ry && prm_ry < D180ANG) { //第六卦限
            ry_rev = (D180ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = 1;
            zsign = -1;
        } else if (D180ANG <= prm_ry && prm_ry < D270ANG) { //第二卦限
            ry_rev = (prm_ry - D180ANG) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = 1;
            zsign = 1;
        } else if (D270ANG <= prm_ry && prm_ry <= D360ANG) { //第一卦限
        ...
        if (0 <= prm_ry && prm_ry < D90ANG) { //第二卦限
            ...
            ysign = 1;
            zsign = 1;
        } else if (D90ANG <= prm_ry && prm_ry < D180ANG) { //第一卦限
            ry_rev = (D180ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = 1;
            ysign = 1;
            zsign = 1;
        } else if (D180ANG <= prm_ry && prm_ry < D270ANG) { //第五卦限
            ry_rev = (prm_ry - D180ANG) * (1.0 / SANG_RATE);
            xsign = 1;
            ysign = 1;
            zsign = -1;
        } else if (D270ANG <= prm_ry && prm_ry <= D360ANG) { //第六卦限
            ry_rev = (D360ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = 1;
            zsign = -1;
        ...
        if (0 <= prm_ry && prm_ry < D90ANG) { //第三卦限
            ...
            ysign = -1;
            zsign = 1;
        } else if (D90ANG <= prm_ry && prm_ry < D180ANG) { //第四卦限
            ry_rev = (D180ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = 1;
            ysign = -1;
            zsign = 1;
        } else if (D180ANG <= prm_ry && prm_ry < D270ANG) { //第八卦限
            ry_rev = (prm_ry - D180ANG) * (1.0 / SANG_RATE);
            xsign = 1;
            ysign = -1;
            zsign = -1;
        } else if (D270ANG <= prm_ry && prm_ry <= D360ANG) { //第七卦限
            ry_rev = (D360ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = -1;
            zsign = -1;
        ...
        if (0 <= prm_ry && prm_ry < D90ANG) { //第八卦限
            ...
            ysign = -1;
            zsign = -1;
        } else if (D90ANG <= prm_ry && prm_ry < D180ANG) { //第七卦限
            ry_rev = (D180ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = -1;
            zsign = -1;
        } else if (D180ANG <= prm_ry && prm_ry < D270ANG) { //第三卦限
            ry_rev = (prm_ry - D180ANG) * (1.0 / SANG_RATE);
            xsign = -1;
            ysign = -1;
            zsign = 1;
        } else if (D270ANG <= prm_ry && prm_ry <= D360ANG) { //第四卦限
            ry_rev = (D360ANG - prm_ry) * (1.0 / SANG_RATE);
            xsign = 1;
            ysign = -1;
            zsign = 1;
