...
pixcoord GgafDxProperties::GAME_BUFFER_WIDTH = 0;
pixcoord GgafDxProperties::GAME_BUFFER_HEIGHT = 0;
float GgafDxProperties::GAME_SPACE_DEPTH = 0;
pixcoord GgafDxProperties::RENDER_TARGET_BUFFER_WIDTH = 0;
pixcoord GgafDxProperties::RENDER_TARGET_BUFFER_HEIGHT = 0;

pixcoord GgafDxProperties::SINGLE_VIEW_WINDOW_WIDTH = 0;
pixcoord GgafDxProperties::SINGLE_VIEW_WINDOW_HEIGHT = 0;
pixcoord GgafDxProperties::DUAL_VIEW_WINDOW1_WIDTH = 0;
pixcoord GgafDxProperties::DUAL_VIEW_WINDOW1_HEIGHT = 0;
pixcoord GgafDxProperties::DUAL_VIEW_WINDOW2_WIDTH = 0;
pixcoord GgafDxProperties::DUAL_VIEW_WINDOW2_HEIGHT = 0;
pixcoord GgafDxProperties::SINGLE_VIEW_FULL_SCREEN_WIDTH = 0;
pixcoord GgafDxProperties::SINGLE_VIEW_FULL_SCREEN_HEIGHT = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN1_WIDTH = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN1_HEIGHT = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN2_WIDTH = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN2_HEIGHT = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN_WIDTH = 0;
pixcoord GgafDxProperties::DUAL_VIEW_FULL_SCREEN_HEIGHT = 0;
