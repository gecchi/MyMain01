...
void GgafDx9MorphMeshEffect::setParamPerFrame() {
    ...
    checkDxException(hr, D3D_OK, "GgafDx9MorphMeshEffect::setParamPerFrame SetMatrix(_h_matView) に失敗しました。");
    hr = _pID3DXEffect->SetValue(_h_posCam, P_CAM->_pVecCamFromPoint, sizeof(D3DXVECTOR3) );
    checkDxException(hr, D3D_OK, "GgafDx9MorphMeshEffect::setParamPerFrame SetValue(_h_posCam) に失敗しました。");
}
