...
#define Obj_GgafDx_Formation                 (0x80000000000ULL)  //0b 00000000 00000000 00001000 00000000 00000000 00000000 00000000 01000000
...
//POS_PRISM_YZ_NN
//＜意味＞
//BOXをYZ平面に垂直にスライスしてカット
//（※頂点を対角で結ぶ２パターンあるがのスライス方法がある）
//（※スライスしてカットすると、軸並行の直角三角形の角柱が２個出来上がるイメージ）
//このうち、YZ平面の -y , -z 方向にプリズムの直角三角形の直角があるプリズムとする。
//＜解説＞
...
//ZX ・・・ AABのZX平面に垂直にスライス
//[スライスの仕方]
// Nn(negative)は負方向、P(positive)は正方向、という意味を持たしている
