...
public:
     ...
     * @param prm_x 単位方向ベクトルX要素（長さ1 が 10000000) > 0
     * @param prm_y 単位方向ベクトルY要素（長さ1 が 10000000) > 0
     * @param prm_z 単位方向ベクトルZ要素（長さ1 が 10000000) > 0
     ...
     * @param out_x 単位方向ベクトルX要素（長さ1 が 10000000) > 0
     * @param out_y 単位方向ベクトルY要素（長さ1 が 10000000) > 0
     * @param out_z 単位方向ベクトルZ要素（長さ1 が 10000000) > 0
     */
