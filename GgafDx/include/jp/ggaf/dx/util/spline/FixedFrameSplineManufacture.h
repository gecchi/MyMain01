#ifndef GGAF_DX_FIXEDFRAMESPLINEMANUFACTURE_H_
#define GGAF_DX_FIXEDFRAMESPLINEMANUFACTURE_H_
...
public:
    ...
    SplineLeader* createGeoDriverLeader(GgafDx::GeoDriver* prm_pGeoDriver) override;

    virtual ~FixedFrameSplineManufacture();
};

}
#endif /*GGAF_DX_FIXEDFRAMESPLINEMANUFACTURE_H_*/
