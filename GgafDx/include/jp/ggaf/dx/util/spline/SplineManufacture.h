#ifndef GGAF_DX_SPLINEMANUFACTURE_H_
#define GGAF_DX_SPLINEMANUFACTURE_H_
 ...
 *
 * SplineManufacture  スプライン曲線の座標点セットの拡大縮小情報、またそれに伴うSplineVecDriverLeaderの実装クラスの情報を保持。
...
public:
     ...
     * @return
     */
    virtual SplineLeader* createVecDriverLeader(GgafDx::VecDriver* prm_pVecDriver);

    virtual SplineLeader* createGeoDriverLeader(GgafDx::GeoDriver* prm_pGeoDriver);

    virtual ~SplineManufacture();
};

}
#endif /*GGAF_DX_SPLINEMANUFACTURE_H_*/
