#ifndef GGAF_DX_FIXEDVELOCITYSPLINEVECDRIVERLEADER_H_
#define GGAF_DX_FIXEDVELOCITYSPLINEVECDRIVERLEADER_H_
 ...
 */
class FixedVelocitySplineVecDriverLeader : public SplineLeader {
...
public:
     ...
     */
    FixedVelocitySplineVecDriverLeader(SplineManufacture* prm_pManufacture, GgafDx::VecDriver* prm_pVecDriver_target);
    ...
    virtual ~FixedVelocitySplineVecDriverLeader();
};
