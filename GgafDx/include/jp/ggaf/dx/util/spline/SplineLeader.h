#ifndef GGAF_DX_SPLINELEADER_H_
#define GGAF_DX_SPLINELEADER_H_
...
//     * start()時の対象アクター力車の移動方向(callVecDriver()->_rz_mv, callVecDriver()->_ry_mv）
