#ifndef GGAF_DX_KUROKOFACEANGASSISTANT_H_
#define GGAF_DX_KUROKOFACEANGASSISTANT_H_
 ...
 */
class KurokoFaceAngAssistant : public GgafCore::Object {
    friend class Kuroko;
...
public:
     ...
     */
    explicit KurokoFaceAngAssistant(Kuroko* prm_pMaster);
    ...
    virtual ~KurokoFaceAngAssistant();
};

}
#endif /*GGAF_DX_KUROKOFACEANGASSISTANT_H_*/
