#ifndef GGAF_DX_LOCUSVEHICLEMVANGASSISTANT_H_
#define GGAF_DX_LOCUSVEHICLEMVANGASSISTANT_H_
 ...
 */
class LocusVehicleMvAngAssistant : public GgafCore::Object {
...
public:
     ...
     */
    explicit LocusVehicleMvAngAssistant(LocusVehicle* prm_pMaster);
    ...
    virtual ~LocusVehicleMvAngAssistant();
};

}
#endif /*GGAF_DX_LOCUSVEHICLEMVANGASSISTANT_H_*/
