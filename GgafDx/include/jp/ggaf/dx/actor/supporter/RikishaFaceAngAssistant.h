#ifndef GGAF_DX_RIKISHAFACEANGASSISTANT_H_
#define GGAF_DX_RIKISHAFACEANGASSISTANT_H_
...
/**
 * 力車の助手B .
 * 師匠(力車)の軸回転方角角速度の補佐を行います。
 * @version 1.00
 * @since 2013/12/05
 * @author Masatoshi Tsuge
 */
class RikishaFaceAngAssistant : public GgafCore::Object {
...
public:
     ...
     */
    explicit RikishaFaceAngAssistant(Rikisha* prm_pMaster);
    ...
    virtual ~RikishaFaceAngAssistant();
};

}
#endif /*GGAF_DX_RIKISHAFACEANGASSISTANT_H_*/
