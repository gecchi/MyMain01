#ifndef GGAF_DX_KUROKOMVANGASSISTANT_H_
#define GGAF_DX_KUROKOMVANGASSISTANT_H_
 ...
 */
class KurokoMvAngAssistant : public GgafCore::Object {
    friend class Kuroko;
...
public:
     ...
     */
    explicit KurokoMvAngAssistant(Kuroko* prm_pMaster);
    ...
    virtual ~KurokoMvAngAssistant();
};

}
#endif /*GGAF_DX_KUROKOMVANGASSISTANT_H_*/
