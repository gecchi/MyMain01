#ifndef GGAF_DX_RIKISHAMVANGASSISTANT_H_
 ...
 */
class RikishaMvAngAssistant : public GgafCore::Object {
...
public:
     ...
     */
    explicit RikishaMvAngAssistant(Rikisha* prm_pMaster);
    ...
    virtual ~RikishaMvAngAssistant();
};

}
#endif /*GGAF_DX_RIKISHAMVANGASSISTANT_H_*/
