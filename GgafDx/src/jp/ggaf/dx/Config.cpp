...
int Config::SCREEN_DISPLAY_NO[MAX_SCREENS] = {0, 1};
...
bool Config::SCREEN_ASPECT_RATIO_FIXED[MAX_SCREENS] = { false, false };
...
int Config::SCREEN_PRESENT_POSITION[MAX_SCREENS] = { 6, 4 };
