...
int Config::PRIMARY_SCREEN_DISPLAY_NO = 0;
int Config::SECONDARY_SCREEN_DISPLAY_NO = 1;

pixcoord Config::PRIMARY_SCREEN_RENDER_BUFFER_SOURCE_LEFT   = 0;
pixcoord Config::PRIMARY_SCREEN_RENDER_BUFFER_SOURCE_TOP    = 0;
pixcoord Config::PRIMARY_SCREEN_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH;
pixcoord Config::PRIMARY_SCREEN_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;

pixcoord Config::SECONDARY_SCREEN_RENDER_BUFFER_SOURCE_LEFT   = Config::RENDER_TARGET_BUFFER_WIDTH/2;
pixcoord Config::SECONDARY_SCREEN_RENDER_BUFFER_SOURCE_TOP    = 0;
pixcoord Config::SECONDARY_SCREEN_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH/2;
pixcoord Config::SECONDARY_SCREEN_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;

pixcoord Config::PRIMARY_SCREEN_WINDOW_WIDTH = 1600;
pixcoord Config::PRIMARY_SCREEN_WINDOW_HEIGHT = 450;
pixcoord Config::SECONDARY_SCREEN_WINDOW_WIDTH = 800;
pixcoord Config::SECONDARY_SCREEN_WINDOW_HEIGHT = 450;
//0の場合現在の解像度でフルスクリーン
pixcoord Config::PRIMARY_SCREEN_FULL_SCREEN_WIDTH = 0;
pixcoord Config::PRIMARY_SCREEN_FULL_SCREEN_HEIGHT = 0;
pixcoord Config::SECONDARY_SCREEN_FULL_SCREEN_WIDTH = 0;
pixcoord Config::SECONDARY_SCREEN_FULL_SCREEN_HEIGHT = 0;

pixcoord Config::PRIMARY_SCREEN_FULL_SCREEN_WIDTH_BK   = Config::PRIMARY_SCREEN_FULL_SCREEN_WIDTH;
pixcoord Config::PRIMARY_SCREEN_FULL_SCREEN_HEIGHT_BK  = Config::PRIMARY_SCREEN_FULL_SCREEN_HEIGHT;
pixcoord Config::SECONDARY_SCREEN_FULL_SCREEN_WIDTH_BK   = Config::SECONDARY_SCREEN_FULL_SCREEN_WIDTH;
pixcoord Config::SECONDARY_SCREEN_FULL_SCREEN_HEIGHT_BK  = Config::SECONDARY_SCREEN_FULL_SCREEN_HEIGHT;


bool Config::FIXED_SCREEN_ASPECT = false;

bool Config::SWAP_SCREEN = false;
int Config::PRIMARY_SCREEN_PRESENT_POSITION = 6;
int Config::SECONDARY_SCREEN_PRESENT_POSITION = 4;

double Config::PRIMARY_SCREEN_WIDTH_RATIO = 1.0;
double Config::PRIMARY_SCREEN_HEIGHT_RATIO = 1.0;
double Config::SECONDARY_SCREEN_WIDTH_RATIO = 1.0;
double Config::SECONDARY_SCREEN_HEIGHT_RATIO = 1.0;
...
void Config::loadProperties(std::string prm_properties_filename) {
    ...
    if (GgafCore::Config::_properties.isExistKey("FIXED_SCREEN_ASPECT")) {
        Config::FIXED_SCREEN_ASPECT = GgafCore::Config::_properties.getBool("FIXED_SCREEN_ASPECT");
    }
    ...
    _TRACE_("Config::DUAL_SCREEN=" << Config::DUAL_SCREEN);
    ...
    _TRACE_("Config::FIXED_SCREEN_ASPECT=" << Config::FIXED_SCREEN_ASPECT);
