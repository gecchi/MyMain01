...
pixcoord Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH;
pixcoord Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;

pixcoord Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   = Config::RENDER_TARGET_BUFFER_WIDTH/2;
pixcoord Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP    = 0;
pixcoord Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH/2;
pixcoord Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;

pixcoord Config::PRIMARY_VIEW_WINDOW_WIDTH = 1600;
pixcoord Config::PRIMARY_VIEW_WINDOW_HEIGHT = 450;
pixcoord Config::SECONDARY_VIEW_WINDOW_WIDTH = 800;
pixcoord Config::SECONDARY_VIEW_WINDOW_HEIGHT = 450;
//0の場合現在の解像度でフルスクリーン
pixcoord Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH = 0;
pixcoord Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT = 0;
pixcoord Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH = 0;
pixcoord Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT = 0;

pixcoord Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH_BK   = Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH;
pixcoord Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT_BK  = Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT;
pixcoord Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH_BK   = Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH;
pixcoord Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT_BK  = Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT;


bool Config::FIXED_VIEW_ASPECT = false;

bool Config::SWAP_VIEW = false;
int Config::PRIMARY_VIEW_PRESENT_POSITION = 6;
int Config::SECONDARY_VIEW_PRESENT_POSITION = 4;
...
void Config::loadProperties(std::string prm_properties_filename) {
    ...
    if (Config::DUAL_VIEW) {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   = 0;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP    = 0;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH/2;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;

        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   = Config::RENDER_TARGET_BUFFER_WIDTH/2;
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP    = 0;
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH/2;
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;
    } else {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   = 0;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP    = 0;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  = Config::RENDER_TARGET_BUFFER_WIDTH;
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = Config::RENDER_TARGET_BUFFER_HEIGHT;
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT")) {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT");
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP")) {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP");
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH")) {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH");
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT")) {
        Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT")) {
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP")) {
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH")) {
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT")) {
        Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT");
    }

    Config::PRIMARY_VIEW_WINDOW_WIDTH = PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH;
    Config::PRIMARY_VIEW_WINDOW_HEIGHT = PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT;
    Config::SECONDARY_VIEW_WINDOW_WIDTH = SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH;
    Config::SECONDARY_VIEW_WINDOW_HEIGHT = SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT;
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_WINDOW_WIDTH")) {
        Config::PRIMARY_VIEW_WINDOW_WIDTH = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_WINDOW_WIDTH");
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_WINDOW_HEIGHT")) {
        Config::PRIMARY_VIEW_WINDOW_HEIGHT = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_WINDOW_HEIGHT");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_WINDOW_WIDTH")) {
        Config::SECONDARY_VIEW_WINDOW_WIDTH = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_WINDOW_WIDTH");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_WINDOW_HEIGHT")) {
        Config::SECONDARY_VIEW_WINDOW_HEIGHT = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_WINDOW_HEIGHT");
    }


    Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH = PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH;
    Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT = PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT;
    Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH = SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH;
    Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT = SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT;
    ...
    Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH_BK   = Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH;
    Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT_BK  = Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT;
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_FULL_SCREEN_WIDTH")) {
        Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_FULL_SCREEN_WIDTH");
        Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH_BK   = Config::PRIMARY_VIEW_FULL_SCREEN_WIDTH;
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_FULL_SCREEN_HEIGHT")) {
        Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_FULL_SCREEN_HEIGHT");
        Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT_BK  = Config::PRIMARY_VIEW_FULL_SCREEN_HEIGHT;
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_FULL_SCREEN_WIDTH")) {
        Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_FULL_SCREEN_WIDTH");
        Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH_BK   = Config::SECONDARY_VIEW_FULL_SCREEN_WIDTH;
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_FULL_SCREEN_HEIGHT")) {
        Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_FULL_SCREEN_HEIGHT");
        Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT_BK  = Config::SECONDARY_VIEW_FULL_SCREEN_HEIGHT;
    }

    if (GgafCore::Config::_properties.isExistKey("FIXED_VIEW_ASPECT")) {
        Config::FIXED_VIEW_ASPECT = GgafCore::Config::_properties.getBool("FIXED_VIEW_ASPECT");
    }
    if (GgafCore::Config::_properties.isExistKey("SWAP_VIEW")) {
        Config::SWAP_VIEW = GgafCore::Config::_properties.getBool("SWAP_VIEW");
    }

    if (Config::DUAL_VIEW) {
        Config::PRIMARY_VIEW_PRESENT_POSITION = 6;
        Config::SECONDARY_VIEW_PRESENT_POSITION = 4;
    } else {
        Config::PRIMARY_VIEW_PRESENT_POSITION = 5;
    }
    if (GgafCore::Config::_properties.isExistKey("PRIMARY_VIEW_PRESENT_POSITION")) {
        Config::PRIMARY_VIEW_PRESENT_POSITION = GgafCore::Config::_properties.getInt("PRIMARY_VIEW_PRESENT_POSITION");
    }
    if (GgafCore::Config::_properties.isExistKey("SECONDARY_VIEW_PRESENT_POSITION")) {
        Config::SECONDARY_VIEW_PRESENT_POSITION = GgafCore::Config::_properties.getInt("SECONDARY_VIEW_PRESENT_POSITION");
    }
    ...
    _TRACE_("Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT=" << Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   );
    _TRACE_("Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP=" << Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_TOP    );
    _TRACE_("Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH=" << Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  );
    _TRACE_("Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT=" << Config::PRIMARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT );
    _TRACE_("Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT=" << Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_LEFT   );
    _TRACE_("Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP=" << Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_TOP    );
    _TRACE_("Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH=" << Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_WIDTH  );
    _TRACE_("Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT=" << Config::SECONDARY_VIEW_RENDER_BUFFER_SOURCE_HEIGHT );

    _TRACE_("Config::PRIMARY_VIEW_WINDOW_WIDTH=" << Config::PRIMARY_VIEW_WINDOW_WIDTH);
    _TRACE_("Config::PRIMARY_VIEW_WINDOW_HEIGHT=" << Config::PRIMARY_VIEW_WINDOW_HEIGHT);
