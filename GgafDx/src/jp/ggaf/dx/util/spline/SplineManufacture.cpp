...
SplineLeader* SplineManufacture::createVecDriverLeader(GgafDx::VecDriver* prm_pVecDriver) {
    throwCriticalException("SplineManufacture::createVecDriverLeader() 下位でオーバーライドして実装が必要です。");
    return nullptr;
}

SplineLeader* SplineManufacture::createGeoDriverLeader(GgafDx::GeoDriver* prm_pGeoDriver) {
    throwCriticalException("SplineManufacture::createGeoDriverLeader() 下位でオーバーライドして実装が必要です。");
    return nullptr;
}
