...
SplineLeader* FixedVelocitySplineManufacture::createVecDriverLeader(GgafDx::VecDriver* prm_pVecDriver) {
    return NEW FixedVelocitySplineVecDriverLeader(this, prm_pVecDriver);
}
