...
SplineLeader* FixedFrameSplineManufacture::createVecDriverLeader(GgafDx::VecDriver* prm_pVecDriver) {
    return NEW FixedFrameSplineVecDriverLeader(this, prm_pVecDriver);
}
SplineLeader* FixedFrameSplineManufacture::createGeoDriverLeader(GgafDx::GeoDriver* prm_pGeoDriver) {
    return NEW FixedFrameSplineGeoDriverLeader(this, prm_pGeoDriver);
}
