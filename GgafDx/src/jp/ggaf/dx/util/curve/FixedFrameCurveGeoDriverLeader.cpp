...
FixedFrameCurveGeoDriverLeader::FixedFrameCurveGeoDriverLeader(
                                       CurveManufacture* prm_pManufacture,
                                       GgafDx::GeoDriver* prm_pGeoDriver_target) :
        DriverLeader(prm_pManufacture, prm_pGeoDriver_target->_pActor) {
...
void FixedFrameCurveGeoDriverLeader::restart() {
...
void FixedFrameCurveGeoDriverLeader::behave() {
    if (_is_leading) {
