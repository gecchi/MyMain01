...
//		throwGgafCriticalException("[GgafDx9Sound::createSe] Error! GgafDx9Soundは初期化してません。init()を実行してください。");
//	}
...
//	if (_pIDirectSound8 == NULL) {
//		throwGgafCriticalException("[GgafDx9Sound::createBgm] Error! GgafDx9Soundは初期化してません。init()を実行してください。");
//	}
