...
GgafDx9WorldBoundEffect::GgafDx9WorldBoundEffect(char* prm_effect_name) : GgafDx9MorphMeshEffect(prm_effect_name) {
    //_h_pos_camera = _pID3DXEffect->GetParameterByName( NULL, "pos_camera" );
}

//void GgafDx9WorldBoundEffect::setParamPerFrame() {
...
GgafDx9WorldBoundEffect::~GgafDx9WorldBoundEffect() {
}
