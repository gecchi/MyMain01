...
int* GgafDx9Properties::GAME_BUFFER_WIDTH = NULL;
int* GgafDx9Properties::GAME_BUFFER_HEIGHT = NULL;
...
void GgafDx9Properties::load(string prm_ini_filename) {
    ...
    GAME_BUFFER_WIDTH = getInt("GAME_BUFFER_WIDTH");
    GAME_BUFFER_HEIGHT = getInt("GAME_BUFFER_HEIGHT");
    ...
    _TRACE_("GGAFDX9_PROPERTY(GAME_BUFFER_WIDTH)="<<GGAFDX9_PROPERTY(GAME_BUFFER_WIDTH));
    _TRACE_("GGAFDX9_PROPERTY(GAME_SPACE_DEPTH)="<<GGAFDX9_PROPERTY(GAME_SPACE_DEPTH));
    _TRACE_("GGAFDX9_PROPERTY(GAME_BUFFER_HEIGHT)="<<GGAFDX9_PROPERTY(GAME_BUFFER_HEIGHT));
...
void GgafDx9Properties::clean() {
    ...
    DELETE_IMPOSSIBLE_NULL(GAME_BUFFER_WIDTH);
    DELETE_IMPOSSIBLE_NULL(GAME_BUFFER_HEIGHT);
