...
void GgafDx9Properties::load(string prm_ini_filename) {
    ...
    GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_WIDTH   = getInt("DUAL_VIEW_FULL_SCREEN1_WIDTH");
    GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_HEIGHT  = getInt("DUAL_VIEW_FULL_SCREEN1_HEIGHT");
    GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_WIDTH   = getInt("DUAL_VIEW_FULL_SCREEN2_WIDTH");
    GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_HEIGHT  = getInt("DUAL_VIEW_FULL_SCREEN2_HEIGHT");
    ...
    _TRACE_("GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_WIDTH="<<GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_WIDTH);
    _TRACE_("GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_HEIGHT="<<GgafDx9Properties::DUAL_VIEW_FULL_SCREEN1_HEIGHT);
    _TRACE_("GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_WIDTH="<<GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_WIDTH);
    _TRACE_("GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_HEIGHT="<<GgafDx9Properties::DUAL_VIEW_FULL_SCREEN2_HEIGHT);
