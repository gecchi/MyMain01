...
GgafDx9WorldBoundModel::GgafDx9WorldBoundModel(char* prm_model_name) : GgafDx9MorphMeshModel(prm_model_name) {
    TRACE3("GgafDx9WorldBoundModel::GgafDx9WorldBoundModel(" << _model_name << ")");
}


HRESULT GgafDx9WorldBoundModel::draw(GgafDx9DrawableActor* prm_pActor_Target, int prm_draw_set_num) {
    TRACE4("GgafDx9WorldBoundModel::draw("<<prm_pActor_Target->getName()<<") this="<<getName());
    ...
    if (GgafDx9ModelManager::_pModelLastDraw != this) {
        ...
        checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() SetFloat(_h_tex_blink_power) に失敗しました。");
        hr = pID3DXEffect->SetFloat(pWorldBoundEffect->_h_tex_blink_threshold, _blink_threshold);
        checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() SetFloat(_h_tex_blink_threshold) に失敗しました。");
//        hr = pID3DXEffect->SetFloat(pWorldBoundEffect->_h_specular, _specular);
//        checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() SetFloat(_h_specular) に失敗しました。");
//        hr = pID3DXEffect->SetFloat(pWorldBoundEffect->_h_specular_power, _specular_power);
//        checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() SetFloat(_h_specular_power) に失敗しました。");
    }
...
//        }
        ...
        if ((GgafDx9EffectManager::_pEffect_Active != pWorldBoundEffect || GgafDx9DrawableActor::_hash_technique_last_draw != prm_pActor_Target->_hash_technique) &&
            ...
            if (GgafDx9EffectManager::_pEffect_Active) {
               TRACE4("EndPass("<<GgafDx9EffectManager::_pEffect_Active->_pID3DXEffect<<"): /_pEffect_Active="<<GgafDx9EffectManager::_pEffect_Active->_effect_name<<"("<<GgafDx9EffectManager::_pEffect_Active<<")");
                ...
                checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() EndPass() に失敗しました。"<<GgafDx9EffectManager::_pEffect_Active->_pID3DXEffect<<"): /_pEffect_Active="<<GgafDx9EffectManager::_pEffect_Active->_effect_name<<"("<<GgafDx9EffectManager::_pEffect_Active<<")");
                hr = GgafDx9EffectManager::_pEffect_Active->_pID3DXEffect->End();
                checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() End() に失敗しました。");
            ...
            checkDxException(hr, S_OK, "GgafDx9WorldBoundModel::draw() SetTechnique("<<pTargetActor->_technique<<") に失敗しました。");
            ...
            checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() Begin() に失敗しました。");
            ...
            checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw() BeginPass("<<_morph_target_num<<") に失敗しました。");
            ...
            checkDxException(hr, D3D_OK, "GgafDx9WorldBoundModel::draw()CommitChanges() に失敗しました。");
        }
    ...
    GgafDx9EffectManager::_pEffect_Active = pWorldBoundEffect;
...
GgafDx9WorldBoundModel::~GgafDx9WorldBoundModel() {
}
