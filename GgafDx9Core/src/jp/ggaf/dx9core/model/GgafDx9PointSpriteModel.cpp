...
HRESULT GgafDx9PointSpriteModel::draw(GgafDx9DrawableActor* prm_pActor_Target) {
    ...
    if (GgafDx9ModelManager::_pModelLastDraw != this) {
        ...
        checkDxException(hr, D3D_OK, "GgafDx9PointSpriteActor::draw() SetFloat(_hPowerBlink) に失敗しました。");
        hr = pID3DXEffect->SetFloat(pPointSpriteEffect->_hBlinkThreshold, _fBlinkThreshold);
        checkDxException(hr, D3D_OK, "GgafDx9PointSpriteActor::draw() SetFloat(_hBlinkThreshold) に失敗しました。");
...
GgafDx9PointSpriteModel::~GgafDx9PointSpriteModel() {
    TRACE3("GgafDx9PointSpriteModel::~GgafDx9PointSpriteModel() " << _model_name << " start");
    release();
}
