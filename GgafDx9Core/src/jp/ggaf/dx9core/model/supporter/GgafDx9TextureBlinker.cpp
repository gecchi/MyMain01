...
void GgafDx9TextureBlinker::loopLiner(frame prm_beat_target_frames, float prm_beat_num) {
...
void GgafDx9TextureBlinker::beat(frame prm_beat_target_frames, frame prm_attack_frames, frame prm_rest_frames, float prm_beat_num) {
