//angXY -> angRz ÇÕäpìx0ÅãÇÃà íu(ï˚å¸ÉxÉNÉgÉã(x,y,z)=(1,0,0))ÅAê≥ÇÃâÒì]ï˚å¸Ç™àÍívÇ∑ÇÈÇÃÇ≈ÇÌÇ©ÇËÇ‚Ç∑Ç¢Ç≈Ç∑Ç™ÅA
//
//Ç¬Ç‹ÇË rotXY = angXY or angRz
//ÅuÇﬂÇ‡Åv
//angXZ -> angRy ÇÃì«Ç›ë÷Ç¶ÇÕê≥ÇÃâÒì]ï˚å¸Ç™ angXZ Ç∆ angRy Ç≈ãtÇ…Ç»Ç¡ÇƒÇµÇ‹Ç¢Ç‹Ç∑ÅB
//angZX -> angRy ÇÃèÍçáÇÕê≥ÇÃâÒì]ï˚å¸ÇÕàÍívÇµÇ‹Ç∑Ç™ÅAäpìx0ÅãÇÃà íuÇ™(x,y,z)=(1,0,0) Ç≈ÇÕÇ»Ç≠Ç»Ç¡ÇƒÇµÇ‹Ç§ÇΩÇﬂÅAÉLÉÉÉâÇÃé≤âÒì]Ç…ÇÕå¸Ç´Ç‹ÇπÇÒ
//
//ÇªÇ±Ç≈
//rotXZ = angXZ or angRy_rev
//ÇÃÇÊÇ§Ç… "rev" Åuãté¸ÇËÇ≈Ç∑ÇÊÅvÇ∆èëÇ≠ÇÊÇ§Ç…ÇµÇΩÅB
...
void GgafDx9Util::init() {
    ...
    int d_index_slant = 0;
    //åXÇ´ 0.0 Å` 1.0 ÇÃ äpìxÇãÅÇﬂîzóÒÇ…é˚ÇﬂÇÈÅBé˚ÇﬂÇÈäpìxÇÕ100î{ÇÃêÆêîÅB
    //óvëfî‘çÜÇÕÅAåXÇ´*10000
    ...
    // SLANT2ANG[0]      = 0
    // SLANT2ANG[1(.7)]Å` = 1000Å`
    // SLANT2ANG[3(.4)]Å` = 2000Å`
    // SLANT2ANG[5(.2)]  = 3000Å`
    // SLANT2ANG[6(.9)]  = 4000Å`
    // SLANT2ANG[8(.7)]  = 5000Å` Ç∆Ç¢Ç¡ÇΩãÔçáÇ…Ç»ÇÈÇÊÇ§Ç…í≤êÆ
    ...
    //ang=4500   slant=1 vx,vy=0.707107,0.707107         <--Ç±ÇÃÇ†ÇΩÇËÇ‹Ç≈ãÅÇﬂÇÈ
    ...
    for (int ang = 0; ang <= 4500; ang++) {
        ...
        for (int i = index_slant_prev+1, d = 1; i <= index_slant; i++, d++) {
            if (i > 10000) {
                _TRACE_("ÅÉåxçêÅÑëzíËîÕàÕà»è„ÇÃåXÇ´îzóÒINDEXÇê›íËÅBÉÅÉÇÉäÇ™îjâÛÇ≥ÇÍÇ‹Ç∑ÅBSLANT2ANG["<<i<<"]<="<<(ang*10));
            }
            //ìôï™Ç∑ÇÈÅiÇ±Ç±Ç™ÉAÉoÉEÉgÇÃÇ‡Ç∆Åj
    ...
    for (int i = index_slant_prev+1, d = 1; i <= 10000; i++, d++) {
        if (i > 10000) {
            _TRACE_("ÅÉåxçêÅÑëzíËîÕàÕà»è„ÇÃåXÇ´îzóÒINDEXÇê›íËÅBÉÅÉÇÉäÇ™îjâÛÇ≥ÇÍÇ‹Ç∑ÅBSLANT2ANG["<<i<<"]<="<<(45000));
        }
        SLANT2ANG[i] = (angle)( (4500-1) + (1.0*d)/(1.0*d_index_slant) );
    }

    //<PROJ_ANG2ROT_ANG> Åi2009/10/20 åoà‹ÅEÅEÅEë¨Ç≠Ç∑ÇÈÇΩÇﬂÇ»ÇÁâΩÇ≈Ç‡Ç‚Ç¡ÇƒÇ›ÇÊÇ§Åj
    //Ç†ÇÈï˚å¸ÉxÉNÉgÉãÇ©ÇÁÅAXYïΩñ ÅAZYïΩñ Ç…ìäâeÇµÇΩéûÇ…Ç≈Ç´ÇÈé≤Ç∆ÇÃäpÅiÇªÇÍÇºÇÍXYéÀâeäpÅAZYéÀâeäpÇ∆åƒÇ‘Ç±Ç∆Ç∆Ç∑ÇÈÅjÇ∆ÅA
    //ÇªÇÃï˚å¸ÉxÉNÉgÉãÇÃíPà ÉxÉNÉgÉãÇ™éwÇ∑íPà ãÖÇÃà‹ìxÇ∆åoìxÅiZé≤âÒì]äpÅAYé≤âÒì]äpÅjÇïRÇ¬ÇØÇÈÇ±Ç∆Çñ⁄ìIÇ∆Ç∑ÇÈÅB
    //Ç¬Ç‹ÇËÅAXYéÀâeäpÅAZYéÀâeäp Å® Zé≤âÒì]äpÅAYé≤âÒì]äp ÇÃì«Ç›ë÷Ç¶ÇçÇë¨Ç…çsÇ¢ÇΩÇ¢
    //XYéÀâeäp90ìxï™ * ZYéÀâeäp90ìxï™ ÇîzóÒóvëfÅAílÇZé≤âÒì]äpÅAYé≤âÒì]äpÇílÇ∆Ç∑ÇÈîzóÒÇç\ízÅB
...
void GgafDx9Util::getRzRyAngle(int vx,
    ...
    if (vx >= 0 && vy >= 0 && vz >= 0) { //ëÊàÍè€å¿
        ...
        _TRACE_("Ç®Ç©ÇµÇ¢Ç≈Ç∑Ç∫getRzRyAngle_new");
    }
}
...
void GgafDx9Util::getRzRyAngle(float nvx, float nvy, float nvz, angle& out_angFaceZ, angle& out_angFaceY) {
...
//åªç›ñ¢égópÅBÇÊÇËçÇë¨Ç»getRzRyAngleÇégópÇµÇƒÇ¢ÇÈÅB
...
void GgafDx9Util::getNormalizeVectorZY(angle prm_angFaceZ,
    ...
    if (0 <= prm_angFaceZ && prm_angFaceZ < ANGLE90) {
        ...
        if (0 <= prm_angFaceY && prm_angFaceY < ANGLE90) { //ëÊå‹è€å¿
            rY_rev = prm_angFaceY / ANGLE_RATE;
            Xsign = 1;
            Ysign = 1;
            Zsign = -1;
        } else if (ANGLE90 <= prm_angFaceY && prm_angFaceY < ANGLE180) { //ëÊòZè€å¿
            rY_rev = (ANGLE180 - prm_angFaceY) / ANGLE_RATE;
            Xsign = -1;
            Ysign = 1;
            Zsign = -1;
        } else if (ANGLE180 <= prm_angFaceY && prm_angFaceY < ANGLE270) { //ëÊìÒè€å¿
            rY_rev = (prm_angFaceY - ANGLE180) / ANGLE_RATE;
            Xsign = -1;
            Ysign = 1;
            Zsign = 1;
        } else if (ANGLE270 <= prm_angFaceY && prm_angFaceY <= ANGLE360) { //ëÊàÍè€å¿
        ...
        if (0 <= prm_angFaceY && prm_angFaceY < ANGLE90) { //ëÊìÒè€å¿
            rY_rev = prm_angFaceY / ANGLE_RATE;
            Xsign = -1;
            Ysign = 1;
            Zsign = 1;
        } else if (ANGLE90 <= prm_angFaceY && prm_angFaceY < ANGLE180) { //ëÊàÍè€å¿
            rY_rev = (ANGLE180 - prm_angFaceY) / ANGLE_RATE;
            Xsign = 1;
            Ysign = 1;
            Zsign = 1;
        } else if (ANGLE180 <= prm_angFaceY && prm_angFaceY < ANGLE270) { //ëÊå‹è€å¿
            rY_rev = (prm_angFaceY - ANGLE180) / ANGLE_RATE;
            Xsign = 1;
            Ysign = 1;
            Zsign = -1;
        } else if (ANGLE270 <= prm_angFaceY && prm_angFaceY <= ANGLE360) { //ëÊòZè€å¿
            rY_rev = (ANGLE360 - prm_angFaceY) / ANGLE_RATE;
            Xsign = -1;
            Ysign = 1;
            Zsign = -1;
        ...
        if (0 <= prm_angFaceY && prm_angFaceY < ANGLE90) { //ëÊéOè€å¿
            rY_rev = prm_angFaceY / ANGLE_RATE;
            Xsign = -1;
            Ysign = -1;
            Zsign = 1;
        } else if (ANGLE90 <= prm_angFaceY && prm_angFaceY < ANGLE180) { //ëÊélè€å¿
            rY_rev = (ANGLE180 - prm_angFaceY) / ANGLE_RATE;
            Xsign = 1;
            Ysign = -1;
            Zsign = 1;
        } else if (ANGLE180 <= prm_angFaceY && prm_angFaceY < ANGLE270) { //ëÊî™è€å¿
            rY_rev = (prm_angFaceY - ANGLE180) / ANGLE_RATE;
            Xsign = 1;
            Ysign = -1;
            Zsign = -1;
        } else if (ANGLE270 <= prm_angFaceY && prm_angFaceY <= ANGLE360) { //ëÊéµè€å¿
            rY_rev = (ANGLE360 - prm_angFaceY) / ANGLE_RATE;
            Xsign = -1;
            Ysign = -1;
            Zsign = -1;
        ...
        if (0 <= prm_angFaceY && prm_angFaceY < ANGLE90) { //ëÊî™è€å¿
            rY_rev = prm_angFaceY / ANGLE_RATE;
            Xsign = 1;
            Ysign = -1;
            Zsign = -1;
        } else if (ANGLE90 <= prm_angFaceY && prm_angFaceY < ANGLE180) { //ëÊéµè€å¿
            rY_rev = (ANGLE180 - prm_angFaceY) / ANGLE_RATE;
            Xsign = -1;
            Ysign = -1;
            Zsign = -1;
        } else if (ANGLE180 <= prm_angFaceY && prm_angFaceY < ANGLE270) { //ëÊéOè€å¿
            rY_rev = (prm_angFaceY - ANGLE180) / ANGLE_RATE;
            Xsign = -1;
            Ysign = -1;
            Zsign = 1;
        } else if (ANGLE270 <= prm_angFaceY && prm_angFaceY <= ANGLE360) { //ëÊélè€å¿
            rY_rev = (ANGLE360 - prm_angFaceY) / ANGLE_RATE;
            Xsign = 1;
            Ysign = -1;
            Zsign = 1;
        ...
        _TRACE_("getNormalizeVectorZY: Ç»ÇÒÇ©Ç®Ç©ÇµÇ¢Ç≈Ç∑Ç∫ prm_angFaceZ="<<prm_angFaceZ<<" prm_angFaceY="<<prm_angFaceY);
    }
...
void GgafDx9Util::calcWorldMatrix_RxRzRxScMv(GgafDx9GeometricActor* prm_pActor, D3DXMATRIX& out_matWorld) {
    ...
    //Å¶Yé≤âÒì]Ç™Ç†ÇËÇ‹ÇπÇÒÅBRYÇÕÇQâÒñ⁄ÇÃXé≤âÒì]Ç∆Ç»ÇÈ
