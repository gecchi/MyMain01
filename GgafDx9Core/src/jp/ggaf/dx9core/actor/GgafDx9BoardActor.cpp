...
//    mightDx9Exception(hr, S_OK, "GgafDx9BoardActor::processDrawMain SetTechnique("<<_technique<<") に失敗しました。");
...
//    mightDx9Exception(hr, D3D_OK, "GgafDx9BoardActor::processDrawMain Begin() に失敗しました。");
//    for (UINT pass = 0; pass < numPass; pass++) {
//        hr = pID3DXEffect->BeginPass(pass);
//        mightDx9Exception(hr, D3D_OK, "GgafDx9BoardActor::processDrawMain BeginPass(0) に失敗しました。");
        _pBoardModel->draw(this);
//        hr = pID3DXEffect->EndPass();
//        mightDx9Exception(hr, D3D_OK, "GgafDx9BoardActor::processDrawMain EndPass() に失敗しました。");
//    }
//    hr = pID3DXEffect->End();
//    mightDx9Exception(hr, D3D_OK, "GgafDx9BoardActor::processDrawMain End() に失敗しました。");
}
