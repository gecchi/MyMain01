...
GgafDx9BoxActor::GgafDx9BoxActor(const char* prm_name,
                                   ...
                                   GgafDx9MeshActor(prm_name,
                                                    ...
                                                    prm_pChecker) {
    //_obj_class |= Obj_GgafDx9BoxActor;
    _class_name = "GgafDx9BoxActor";
}

//void GgafDx9BoxActor::processDraw() {
//    GgafDx9GeometricActor::setWorldTransformScRzMxyz(this);
//    _pD3DXMeshModel->draw(this);
//}

void GgafDx9BoxActor::drawBox(int prm_x1, int prm_y1, int prm_z1, int prm_x2, int prm_y2, int prm_z2) {
...
GgafDx9BoxActor::~GgafDx9BoxActor() {
}
