...
void GgafDx9SpriteMeshActor::setRotationUV(int prm_tex_col_num, float prm_tex_width, float prm_tex_height)  {
    if (prm_tex_col_num < 0) {
        throwGgafCriticalException("GgafDx9SpriteMeshActor::setRotationUV prm_tex_col_numは0以上の整数で設定して下さい。");
    }
