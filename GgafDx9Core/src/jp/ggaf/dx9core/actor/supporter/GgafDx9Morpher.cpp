...
void GgafDx9Morpher::loopLiner(int prm_target_mesh, frame prm_loop_spend_frame, float prm_loop_num) {
...
void GgafDx9Morpher::loopTriangleWave(int prm_target_mesh, frame prm_loop_spend_frame, frame prm_attack_frame, frame prm_rest_frame, float prm_loop_num) {
