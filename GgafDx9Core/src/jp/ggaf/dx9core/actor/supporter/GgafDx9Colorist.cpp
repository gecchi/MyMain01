...
void GgafDx9Colorist::intoTargetColorAcceStep(int prm_target_color, int prm_velo_color, int prm_acce_color) {
    for (int c = 0; c < 4; c++) {
...
void GgafDx9Colorist::intoTargetColorLinerStep(int prm_target_color, int prm_velo_color) {
    for (int c = 0; c < 3; c++) {
...
void GgafDx9Colorist::loopLiner(frame prm_beat_target_frames, float prm_beat_num) {
    for (int c = 0; c < 4; c++) {
...
void GgafDx9Colorist::beat(frame prm_beat_target_frames, frame prm_attack_frames, frame prm_rest_frames, float prm_beat_num) {
    for (int c = 0; c < 4; c++) {
...
void GgafDx9Colorist::stopImmediately() {
    for (int c = 0; c < 4; c++) {
        stopImmediately(c);
    }
}

void GgafDx9Colorist::stopImmediately(int prm_c) {
    _method[prm_c] = NOCOLOR;
}


GgafDx9Colorist::~GgafDx9Colorist() {
}
