...
//    mightDx9Exception(hr, S_OK, "GgafDx9DynaD3DXMeshActor::processDrawMain() SetTechnique("<<_technique<<") に失敗しました。");
...
//    mightDx9Exception(hr, D3D_OK, "GgafDx9DynaD3DXMeshActor::processDrawMain() Begin() に失敗しました。");
//    for (UINT pass = 0; pass < numPass; pass++) {
//        hr = pID3DXEffect->BeginPass(pass);
//        mightDx9Exception(hr, D3D_OK, "GgafDx9DynaD3DXMeshActor::processDrawMain() BeginPass("<<pass<<") に失敗しました。");
        _pD3DXMeshModel->draw(this);
//        hr = pID3DXEffect->EndPass();
//        mightDx9Exception(hr, D3D_OK, "GgafDx9DynaD3DXMeshActor::processDrawMain() EndPass() に失敗しました。");
//    }
//    hr = pID3DXEffect->End();
//    mightDx9Exception(hr, D3D_OK, "GgafDx9DynaD3DXMeshActor::processDrawMain() End() に失敗しました。");
}
