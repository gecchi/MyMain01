...
void GgafDx9UntransformedActor::processDrawPrior() {
    ...
    if (_is_active_flg && _can_live_flg && isOffScreen() == false) {
        if (getAlpha() < 1.0) {
            ...
            //_Z Ç™ ÉJÉÅÉâà íu Å` ÉJÉÅÉâ + 1000*MAX_DRAW_DEPTH_LEVEL ÇÃä‘Ç≈Ç†ÇÍÇŒ MAX_DRAW_DEPTH_LEVELÇ≈
            //íiäKÉåÉìÉ_ÉäÉìÉOÇÇ∑ÇÈÇ±Ç∆Ç∆Ç∑ÇÈÅB
            //ëeÇ≥ÇÕ 1000ÅBÅ©Ç±ÇÃîÕàÕÇÃZÇÕìØàÍê[ìxÇ∆Ç»ÇÈÅB
            //TODO: ÉJÉÅÉâÇ™ìÆÇ´Zç¿ïWÇ≈ê[ìxÇ™åàÇ‹ÇÁÇ»Ç¢èÍçáîgèÛÇ∑ÇÈÅBê≥ÇµÇ≠ÇÕÉJÉÅÉâç¿ïWÇ©ÇÁÇÃãóó£Ç≈É\Å[ÉgÇ∑Ç◊Ç´ÅBÅEÅEÅEÇªÇÃì‡Ç‚ÇÎÇ§ÅB
