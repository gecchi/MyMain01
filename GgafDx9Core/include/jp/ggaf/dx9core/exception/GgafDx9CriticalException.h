 ...
 */
#ifdef OREDEBUG
#define potentialGgafDx9CriticalException(HR, OKVAL, X) {if (HR != OKVAL) {std::stringstream ss; ss <<__FILE__<<"("<<__LINE__<<") : " << X; throw GgafDx9CriticalException(ss.str(),HR); } }
#else
#define potentialGgafDx9CriticalException(HR, OKVAL, X)
#endif
