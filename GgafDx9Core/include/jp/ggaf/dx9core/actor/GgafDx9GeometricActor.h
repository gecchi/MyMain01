...
public:
    ...
    //　例えば、_X = 5000 は、画面では5pxの位置、DirectX座標では0.5になる（ように設計）。
    ...
    //　全部整数で計算してやろう、というのが発端。昔は良く使っていた手法（DEFINT A-Z とか）で、効果は確かにあった。
    //　しかし、現在では float や double でもかなり速いので、本当に良かったのかどうか微妙。
    //【_RX, _RY, _RZ の単位について】
