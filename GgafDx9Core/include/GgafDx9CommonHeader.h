...
enum GgafDx9ScaleMethod {
    ...
    TARGET_SCALE_SIN,          //!< 未実装
    BEAT_SCALE_SIN,            //!< 未実装
    TARGET_SCALE_ACCELERATION,
    BEAT_SCALE_PARABOLA,       //!< 未実装
    TARGET_SCALE_PARABOLA_REV, //!< 未実装
    BEAT_SCALE_PARABOLA_REV    //!< 未実装
};
...
enum GgafDx9MorphMethod {
    ...
    TARGET_MORPH_SIN,          //!< 未実装
    LOOP_MORPH_SIN,            //!< 未実装
    TARGET_MORPH_ACCELERATION,
    LOOP_MORPH_PARABOLA,       //!< 未実装
    TARGET_MORPH_PARABOLA_REV, //!< 未実装
    LOOP_MORPH_PARABOLA_REV    //!< 未実装
};
...
enum GgafDx9BlinkerMethod {
    ...
    TARGET_BLINK_SIN,          //!< 未実装
    BEAT_BLINK_SIN,            //!< 未実装
    TARGET_BLINK_ACCELERATION,
    BEAT_BLINK_PARABOLA,       //!< 未実装
    TARGET_BLINK_PARABOLA_REV, //!< 未実装
    BEAT_BLINK_PARABOLA_REV    //!< 未実装
};
