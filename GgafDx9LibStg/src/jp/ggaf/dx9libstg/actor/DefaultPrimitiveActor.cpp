...
DefaultPrimitiveActor::DefaultPrimitiveActor(const char* prm_name, const char* prm_model) :
    GgafDx9PrimitiveActor(prm_name, prm_model, NEW GgafDx9GeometryMover(this), NEW StgChecker(this))
{
