...
//    _pos_prism = pos_prism;
    ...
    } else if (_pos_prism & PRISM_YZ) {
        _a = 1.0*(_z2 - _z1) / (_y2 - _y1);
        _b = (_y1*_z2 - _y2*_z1) / (_y1 - _y2);

    } else if (_pos_prism & PRISM_ZX) {
