...
//イベント用 UINT32 数値宣言
AVAILABLE_EVENT(EVENT_GOD_WILL_DIE);

AVAILABLE_EVENT(EVENT_PREPARE_NEXT_STAGE);
AVAILABLE_EVENT(EVENT_JUST_GAME_OVER);
AVAILABLE_EVENT(EVENT_STG01_01_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG01_02_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG01_03_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG01_CLIMAX_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STAGE01CONTROLLER_WAS_END);
AVAILABLE_EVENT(EVENT_STG02_01_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG02_02_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG02_03_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STG02_CLIMAX_WAS_BROKEN);
AVAILABLE_EVENT(EVENT_STAGE02CONTROLLER_WAS_END);
AVAILABLE_EVENT(EVENT_MY_SHIP_WAS_DESTROYED_BEGIN);
AVAILABLE_EVENT(EVENT_MY_SHIP_WAS_DESTROYED_FINISH);
AVAILABLE_EVENT(EVENT_ALL_MY_SHIP_WAS_DESTROYED);
AVAILABLE_EVENT(EVENT_GAME_OVER_FINISH);

AVAILABLE_EVENT(EVENT_PREGAMETITLESCENE_FINISH);
AVAILABLE_EVENT(EVENT_GAMETITLESCENE_FINISH);
AVAILABLE_EVENT(EVENT_GAMEDEMOSCENE_FINISH);
