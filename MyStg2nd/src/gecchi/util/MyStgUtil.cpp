...
// gen02 start
	void MyStgUtil::resetMyStraightLaserChip001Status(GgafStatus* p) {
		...
		p->set(STAT_AddRankPoint_Reduction, 0.00000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
	...
	void MyStgUtil::resetMyShipStatus(GgafStatus* p) {
		p->set(STAT_DEFAULT_ACTOR_KIND, KIND_MY_BODY);  //éÌï (ÉfÉtÉHÉãÉg)
		p->set(STAT_AddScorePoint, 0 );  //â¡éZìæì_
		p->set(STAT_AddRankPoint_Reduction, 0.00000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
		p->set(STAT_Stamina, 100 );  //ëÃóÕ
	...
	void MyStgUtil::resetEnemyCeresStatus(GgafStatus* p) {
		p->set(STAT_DEFAULT_ACTOR_KIND, KIND_ENEMY_BODY);  //éÌï (ÉfÉtÉHÉãÉg)
		p->set(STAT_AddScorePoint, 100 );  //â¡éZìæì_
		p->set(STAT_AddRankPoint_Reduction, 0.10000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
		p->set(STAT_Stamina, 100 );  //ëÃóÕ
		p->set(STAT_Attack, 100 );  //çUåÇóÕ
		p->set(STAT_DefaultDefenceRate, 1.00000 );  //äÓèÄñhå‰ó¶
	...
	void MyStgUtil::resetEnemyCeresShot001Status(GgafStatus* p) {
		p->set(STAT_DEFAULT_ACTOR_KIND, KIND_ENEMY_SHOT_GU);  //éÌï (ÉfÉtÉHÉãÉg)
		p->set(STAT_AddScorePoint, 1 );  //â¡éZìæì_
		p->set(STAT_AddRankPoint_Reduction, 0.00000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
		p->set(STAT_Stamina, 100 );  //ëÃóÕ
		p->set(STAT_Attack, 100 );  //çUåÇóÕ
	...
	void MyStgUtil::resetEnemyAstraeaStatus(GgafStatus* p) {
		...
		p->set(STAT_AddRankPoint_Reduction, 0.20000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
		p->set(STAT_Stamina, 100 );  //ëÃóÕ
		p->set(STAT_Attack, 100 );  //çUåÇóÕ
		p->set(STAT_DefaultDefenceRate, 1.00000 );  //äÓèÄñhå‰ó¶
	...
	void MyStgUtil::resetEnemyVestaStatus(GgafStatus* p) {
		p->set(STAT_DEFAULT_ACTOR_KIND, KIND_ENEMY_BODY);  //éÌï (ÉfÉtÉHÉãÉg)
		p->set(STAT_AddScorePoint, 1000 );  //â¡éZìæì_
		p->set(STAT_AddRankPoint_Reduction, 0.50000 );  //â¡éZÉâÉìÉN
		p->set(STAT_AddRankPoint, 0.90000 );  //â¡éZÉâÉìÉNå∏è≠ó¶
		p->set(STAT_Stamina, 100 );  //ëÃóÕ
		p->set(STAT_Attack, 100 );  //çUåÇóÕ
		p->set(STAT_DefaultDefenceRate, 1.00000 );  //äÓèÄñhå‰ó¶
