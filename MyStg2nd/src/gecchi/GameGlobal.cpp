...
void GameGlobal::init() {
    if (_isInit == false) {
        ...
        _lim_MyShip_top     = GGAFDX9_PROPERTY(GAME_SCREEN_HEIGHT)*LEN_UNIT / 2;
        _lim_MyShip_bottom  = -(GGAFDX9_PROPERTY(GAME_SCREEN_HEIGHT)*LEN_UNIT / 2);
        ...
        _lim_MyShip_zleft   = GGAFDX9_PROPERTY(GAME_SCREEN_WIDTH)*LEN_UNIT / 2;
        _lim_MyShip_zright  = -(GGAFDX9_PROPERTY(GAME_SCREEN_WIDTH)*LEN_UNIT / 2);
