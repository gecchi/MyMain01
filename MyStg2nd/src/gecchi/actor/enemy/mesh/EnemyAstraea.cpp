...
EnemyAstraea::EnemyAstraea(const char* prm_name, RotationActor* prm_pRotEnemyMeshShots001) :
    DefaultMeshEnemyActor(prm_name, "X/Astraea") {
    _class_name = "EnemyAstraea";
...
//		//_TRACE_("Astraea:"<<getName()<<" (_X,_Y,_Z)=("<<_X<<","<<_Y<<","<<_Z<<")");
//
...
//	}
//
//	//_TRACE_("Astraea("<<_X<<","<<_Y<<","<<_Z<<")"<<_incZ <<"/"<<(_pGeoMover->_veloVzMove));
//}
