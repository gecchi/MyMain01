...
//    }
//    //Ç´ÇØÇÒ	GgafFactory::_pGarbageBox->_pGarbageRootActor->addSubLast(_pDispatcher_EnemyCeresShots001); //âºèäëÆ
//    addSubLast(_pDispatcher_EnemyCeresShots001); //âºèäëÆ
//
...
EnemyCeres::EnemyCeres(const char* prm_name, ActorDispatcher* prm_pDispatcher_EnemyCeresShots001) :
    ...
    if (prm_pDispatcher_EnemyCeresShots001 == NULL) {
        ...
        //Ç´ÇØÇÒ   GgafFactory::_pGarbageBox->_pGarbageRootActor->addSubLast(_pDispatcher_EnemyCeresShots001); //âºèäëÆ
        accept(KIND_ENEMY_SHOT_GU, _pDispatcher_EnemyCeresShots001); //âºèäëÆ
        _createActorDispatcher = true;
    } else {
