...
//	_angRXAcce_MNZ = 100;
	...
	_iMvBtmVelo_MT = -1*_iMoveSpeed;		//TURBOˆÚ“®’†‚ÌˆÚ“®‘¬“x‚ÌÅ’á‘¬“x
	_iMvVelo_BeginMT = _iMoveSpeed*3;	//TURBOˆÚ“®ŠJŽnŽž‚ÌˆÚ“®‘¬“x‚Ì‰‘¬“x
	_iMvAcce_MT = -100;					//TURBOˆÚ“®’†‚ÌˆÚ“®‘¬“x‚Ì‰Á‘¬“x

	_iMvAcce_EOD_MT = 100;			//TURBO’†‚É‹t•ûŒü‚É“ü—Í‚³‚ê‚éŽ–‚É‚æ‚èŒ¸‘¬‚·‚é‘¬“x

	_angRZVelo_BeginMYT = 13000;	//ã–”‚Í‰º‚ÖTURBOˆÚ“®ŠJŽnŽž‚ÌZŽ²‰ñ“]Šp‘¬“x‚Ì‰‘¬“x
	_angRZAcce_MYT = -200;			//ã–”‚Í‰º‚ÖTURBOˆÚ“®’†‚ÌZŽ²‰ñ“]Šp‘¬“x‚ÌŠp‰Á‘¬“x
	_angRZBtmVelo_MYT = 3000;		//ã–”‚Í‰º‚ÖTURBOˆÚ“®’†‚ÌZŽ²‰ñ“]Šp‘¬“x‚ÌÅ’á‘¬“x

	_angRZTopVelo_MNY = 2000;		//ã–”‚Í‰º‚Ö’ÊíˆÚ“®ŽžAŽ©“®“I‚ÉAngle0‚É–ß‚ë‚¤‚Æ‚·‚éZŽ²‰ñ“]Šp‘¬“x‚ÌãŒÀŠp‘¬“x
	_angRZAcce_MNY = 100;			//ã–”‚Í‰º‚Ö’ÊíˆÚ“®ŽžAŽ©“®“I‚ÉAngle0‚É–ß‚ë‚¤‚Æ‚·‚éŽž‚ÌZŽ²‰ñ“]Šp‰Á‘¬“x(³•‰‹¤’Ê)

	_angRXVelo_BeginMZT = 15000;	//‰œ–”‚ÍŽè‘O‚ÖTURBOˆÚ“®ŠJŽnŽž‚ÌXŽ²‰ñ“]Šp‘¬“x‚Ì‰‘¬“x
	_angRXAcce_MZT = -300;			//‰œ–”‚ÍŽè‘O‚ÖTURBOˆÚ“®’†‚ÌXŽ²‰ñ“]Šp‘¬“x‚ÌŠp‰Á‘¬“x
	_angRXBtmVelo_MZT = 5000;		//‰œ–”‚ÍŽè‘O‚ÖTURBOˆÚ“®’†‚ÌXŽ²‰ñ“]Šp‘¬“x‚ÌÅ’á‘¬“x

	_angRXTopVelo_MNZ = 2000; 		//‰œ–”‚ÍŽè‘OˆÈŠO‚Ì’ÊíˆÚ“®ŽžAŽ©“®“I‚ÉAngle0‚É–ß‚ë‚¤‚Æ‚·‚éXŽ²‰ñ“]Šp‘¬“x‚ÌãŒÀŠp‘¬“x
	_angRXAcce_MNZ = 100;			//‰œ–”‚ÍŽè‘OˆÈŠO‚Ì’ÊíˆÚ“®ŽžAŽ©“®“I‚ÉAngle0‚É–ß‚ë‚¤‚Æ‚·‚éŽž‚ÌXŽ²‰ñ“]Šp‰Á‘¬“x(³•‰‹¤’Ê)

	_angRXTopVelo_MZ = 4000;		//‰œ–”‚ÍŽè‘O‚ÖˆÚ“®’†‚ÌXŽ²‰ñ“]Šp‘¬“x‚ÌãŒÀŠp‘¬“x
	_angRXAcce_MZ = 200;			//‰œ–”‚ÍŽè‘O‚Ö’ÊíˆÚ“®’†‚ÌXŽ²‰ñ“]Šp‘¬“x‚ÌŠp‰Á‘¬“x
	_angRXStop_MZ = 80000;			//‰œ–”‚ÍŽè‘O‚Ö’ÊíZˆÚ“®’†‚ÌXŽ²‰ñ“]Šp‚Ì’âŽ~Šp“x
	_angRXVelo_BeginMZ = 500;		//‰œ–”‚ÍŽè‘O‚Ö’ÊíˆÚ“®ŠJŽnŽž‚ÌXŽ²‰ñ“]Šp‘¬“x‚Ì‰‘¬“x
	...
	_dwFrameTurboMove = 0;			//ƒ^[ƒ{Œo‰ßƒtƒŒ[ƒ€
...
void MyShip::initialize() {
	...
	for(int i = 0; i < numV; i++){
	  ...
	  //D3DFVF_XYZ‚Íæ“ª‚É‚ ‚é‚Ì‚ÅAƒIƒtƒZƒbƒg‚Í‚O
	  pV = (D3DVECTOR*)( pVertexSrc + (FVFSize * i) + 0 );
	  _TRACE_("’¸“_"<<(i+1)<<":("<<(pV->x)<<","<<(pV->y)<<","<<(pV->z)<<")");

//	  //ŽŸ‚ÉUV‚ª‚ ‚é‚Ì‚ÅAD3DFVF_XYZ‚ÌƒTƒCƒY•ª‚¾‚¯i‚ß‚½ˆÊ’u‚©‚çŽæ‚èo‚·
//	  uv = *(D3DXVECTOR2*)( pVtx + (FVFSize * i) + sizeof(D3DXVECTOR3) );
//
//	  `v0‚ª’¸“_À•W,uv‚ª‚»‚Ì’¸“_‚ÌƒeƒNƒXƒ`ƒƒ[À•W`
...
void MyShip::processBehavior() {
	...
	_tmpY = _Y;
	_tmpZ = _Z;
	_dwFrameTurboMove++; // ƒ^[ƒ{Œo‰ßƒtƒŒ[ƒ€
	_dwFrameNomalMove++; // ’ÊíˆÚ“®Œo‰ßƒtƒŒ[ƒ€
	//‰œŽè‘OˆÚ“®‰‚ß‚ÌTURBO‚©”Û‚©
