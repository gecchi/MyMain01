...
void MyDummyOption::initialize() {
    ...
    //‚Æ‚à‚©‚­‚±‚±‚Å‚¿‚á‚ñ‚ÆXŽ²‰ñ“]iRxj‚ð‚·‚é‚µ‚©‚È‚¢B
    //getNormalizeVectorXY ‚Æ‚©ì‚é‚µ‚©‚È‚¢‚©I
...
//    _pGeoMover->setRzMoveAngleVelocity(GgafDx9Util::COS[_angPosRotX/ANGLE_RATE]*_angvelo);//æ”¼Œa‚q‘¬“x‚u^Šp‘¬“xƒÖ
//    _pGeoMover->setRyMoveAngleVelocity(GgafDx9Util::SIN[_angPosRotX/ANGLE_RATE]*_angvelo);//æ”¼Œa‚q‘¬“x‚u^Šp‘¬“xƒÖ
...
//    }
    ...
    _pGeoMover->setRzMoveAngleVelocity(GgafDx9Util::COS[Rz/ANGLE_RATE]*_angvelo);//æ”¼Œa‚q‘¬“x‚u^Šp‘¬“xƒÖ
    _pGeoMover->setRyMoveAngleVelocity(GgafDx9Util::SIN[Ry/ANGLE_RATE]*_angvelo);//æ”¼Œa‚q‘¬“x‚u^Šp‘¬“xƒÖ
