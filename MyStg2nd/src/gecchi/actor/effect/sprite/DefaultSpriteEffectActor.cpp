...
DefaultSpriteEffectActor::DefaultSpriteEffectActor(const char* prm_name, const char* prm_model, const char* prm_technique) :
    DefaultSpriteActor(prm_name, prm_model, prm_technique) {
