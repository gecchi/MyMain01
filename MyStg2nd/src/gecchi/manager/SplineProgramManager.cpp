...
SplineProgramManager::SplineProgramManager(const char* prm_manager_name) :
    GgafResourceManager<GgafDx9Core::GgafDx9SplineProgram> (prm_manager_name) {
}

GgafDx9SplineProgram* SplineProgramManager::processCreateResource(char* prm_idstr, void* prm_p) {
    ...
    if (ifs.fail()) {
        throwGgafCriticalException("SplineProgramManager::processCreateResource "<<prm_idstr<<" が開けません");
    }
...
GgafResourceConnection<GgafDx9Core::GgafDx9SplineProgram>* SplineProgramManager::processCreateConnection(char* prm_idstr, GgafDx9SplineProgram* prm_pResource) {
    TRACE3(" SplineProgramManager::processCreateConnection "<<prm_idstr<<" を生成開始。");
    SplineProgramConnection* pConnection = NEW SplineProgramConnection(prm_idstr, prm_pResource);
    TRACE3(" SplineProgramManager::processCreateConnection "<<prm_idstr<<" を生成終了。");
    return pConnection;
}
