...
//MyShip::_lim_top     = CFG_PROPERTY(GAME_BUFFER_HEIGHT)*5*LEN_UNIT / 2;      //上下は画面高さの大体５画面分
//MyShip::_lim_bottom  = -(CFG_PROPERTY(GAME_BUFFER_HEIGHT)*5*LEN_UNIT / 2);
//MyShip::_lim_front   = CFG_PROPERTY(GAME_BUFFER_WIDTH)*4*LEN_UNIT / 2 ;    //前後は画面幅の大体４画面分
