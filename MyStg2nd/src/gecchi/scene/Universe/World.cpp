...
void World::initialize() {
    ...
    _pStringBoard01->update(Pix2App(CFG_PROPERTY(GAME_BUFFER_WIDTH)/2), Pix2App(CFG_PROPERTY(GAME_BUFFER_HEIGHT)/2),
...
//    _pStringBoard01->_pFader->beat(60,10,20,20,-1);
    ...
    _pFont16_Wait->update(Pix2App(CFG_PROPERTY(GAME_BUFFER_WIDTH)), 0, "*", ALIGN_RIGHT, VALIGN_TOP);
