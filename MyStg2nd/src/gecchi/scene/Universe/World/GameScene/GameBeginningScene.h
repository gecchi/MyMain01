...
#define GAMEBEGINNINGSCENE_PROG_INIT   1
#define GAMEBEGINNINGSCENE_PROG_SELECT_MODE  2
#define GAMEBEGINNINGSCENE_PROG_DECIDE 3
#define GAMEBEGINNINGSCENE_PROG_FINISH 4
