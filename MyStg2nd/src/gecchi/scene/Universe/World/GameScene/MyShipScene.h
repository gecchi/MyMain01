...
#define MYSHIPSCENE_SCENE_PROG_APPEARANCE_NOMAL   3
#define MYSHIPSCENE_SCENE_PROG_PLAY   4
#define MYSHIPSCENE_SCENE_PROG_DESTROY   5
#define MYSHIPSCENE_SCENE_PROG_END    6
