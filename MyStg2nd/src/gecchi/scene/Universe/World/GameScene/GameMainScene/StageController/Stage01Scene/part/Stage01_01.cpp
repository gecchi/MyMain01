...
void Stage01_01::processBehavior() {
	...
	if (getActivePartFrame() == _paFrame_NextEvent[_iCnt_Event]) {
		...
		_iCnt_Event = (_iCnt_Event < 163-1 ? _iCnt_Event+1 : _iCnt_Event);
	}
    // gen02 end
