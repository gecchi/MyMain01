...
void Stage01MainScene::processBehavior() {
	...
	if (getPartFrame() == _paFrame_NextEvent[_iCnt_Event]) {
		...
		_iCnt_Event = (_iCnt_Event < 1601-1 ? _iCnt_Event+1 : _iCnt_Event);
	}
    // gen02 end
