...
Stage01MainScene::Stage01MainScene(const char* prm_name) : DefaultScene(prm_name) {
	...
	orderActorWithDpToFactory(11377500, EnemyCeres, "Ceres_55", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113771500, EnemyCeres, "Ceres_56", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113772500, EnemyCeres, "Ceres_57", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11387530, EnemyCeres, "Ceres_58", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113871530, EnemyCeres, "Ceres_59", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113872530, EnemyCeres, "Ceres_60", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11397560, EnemyCeres, "Ceres_61", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113971560, EnemyCeres, "Ceres_62", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(113972560, EnemyCeres, "Ceres_63", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11407590, EnemyCeres, "Ceres_64", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114071590, EnemyCeres, "Ceres_65", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114072590, EnemyCeres, "Ceres_66", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11417620, EnemyCeres, "Ceres_67", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114171620, EnemyCeres, "Ceres_68", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114172620, EnemyCeres, "Ceres_69", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11427650, EnemyCeres, "Ceres_70", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114271650, EnemyCeres, "Ceres_71", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(114272650, EnemyCeres, "Ceres_72", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
    // gen01 end
}
	...
	if (_frame_of_life == _paFrame_NextEvent[_iCnt_Event]) {
		switch (_frame_of_life) {
			...
			case 10:
				...
				orderActorToFactory(110573010, EnemyVesta, "Vesta_73");
				break;
			case 70:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105770));
				orderActorToFactory(110573070, EnemyVesta, "Vesta_74");
				break;
			case 100:
				{
			...
			case 130:
				...
				orderActorToFactory(110573130, EnemyVesta, "Vesta_75");
				break;
			case 190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057190));
				orderActorToFactory(110573190, EnemyVesta, "Vesta_76");
				break;
			case 250:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057250));
				orderActorToFactory(110573250, EnemyVesta, "Vesta_77");
				break;
			case 310:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057310));
				orderActorToFactory(110573310, EnemyVesta, "Vesta_78");
				break;
			case 370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057370));
				orderActorToFactory(110573370, EnemyVesta, "Vesta_79");
				break;
			case 400:
				orderActorToFactory(111773400, EnemyAstraea, "Astraea_80");
				break;
			case 430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057430));
				orderActorToFactory(110573430, EnemyVesta, "Vesta_81");
				break;
			case 490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057490));
				orderActorToFactory(110573490, EnemyVesta, "Vesta_82");
				break;
			case 500:
				orderActorToFactory(111673500, EnemyAstraea, "Astraea_83");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11377500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113773500, EnemyCeres, "Ceres_84", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11387530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113873530, EnemyCeres, "Ceres_85", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057550));
				orderActorToFactory(110573550, EnemyVesta, "Vesta_86");
				break;
			case 560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11397560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113973560, EnemyCeres, "Ceres_87", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11407590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114073590, EnemyCeres, "Ceres_88", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057610));
				orderActorToFactory(110573610, EnemyVesta, "Vesta_89");
				break;
			case 620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11417620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114173620, EnemyCeres, "Ceres_90", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(11427650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114273650, EnemyCeres, "Ceres_91", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057670));
				orderActorToFactory(110573670, EnemyVesta, "Vesta_92");
				break;
			case 730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057730));
				orderActorToFactory(110573730, EnemyVesta, "Vesta_93");
				break;
			case 790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057790));
				orderActorToFactory(110573790, EnemyVesta, "Vesta_94");
				break;
			case 850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057850));
				orderActorToFactory(110573850, EnemyVesta, "Vesta_95");
				break;
			case 900:
				orderActorToFactory(110973900, EnemyAstraea, "Astraea_96");
				break;
			case 910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057910));
				orderActorToFactory(110573910, EnemyVesta, "Vesta_97");
				break;
			case 970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(11057970));
				orderActorToFactory(110573970, EnemyVesta, "Vesta_98");
				break;
			case 1030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571030));
				orderActorToFactory(110574030, EnemyVesta, "Vesta_99");
				break;
			case 1090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571090));
				orderActorToFactory(110574090, EnemyVesta, "Vesta_100");
				break;
			case 1150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571150));
				orderActorToFactory(110574150, EnemyVesta, "Vesta_101");
				break;
			case 1210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571210));
				orderActorToFactory(110574210, EnemyVesta, "Vesta_102");
				break;
			case 1270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571270));
				orderActorToFactory(110574270, EnemyVesta, "Vesta_103");
				break;
			case 1330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571330));
				orderActorToFactory(110574330, EnemyVesta, "Vesta_104");
				break;
			case 1390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571390));
				orderActorToFactory(110574390, EnemyVesta, "Vesta_105");
				break;
			case 1400:
				orderActorToFactory(111774400, EnemyAstraea, "Astraea_106");
				break;
			case 1450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571450));
				orderActorToFactory(110574450, EnemyVesta, "Vesta_107");
				break;
			case 1500:
				{
				...
				orderActorToFactory(111674500, EnemyAstraea, "Astraea_108");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113771500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113774500, EnemyCeres, "Ceres_109", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571510));
				orderActorToFactory(110574510, EnemyVesta, "Vesta_110");
				break;
			case 1530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113871530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113874530, EnemyCeres, "Ceres_111", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113971560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113974560, EnemyCeres, "Ceres_112", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571570));
				orderActorToFactory(110574570, EnemyVesta, "Vesta_113");
				break;
			case 1590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114071590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114074590, EnemyCeres, "Ceres_114", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114171620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114174620, EnemyCeres, "Ceres_115", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571630));
				orderActorToFactory(110574630, EnemyVesta, "Vesta_116");
				break;
			case 1650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114271650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114274650, EnemyCeres, "Ceres_117", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571690));
				orderActorToFactory(110574690, EnemyVesta, "Vesta_118");
				break;
			case 1750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571750));
				orderActorToFactory(110574750, EnemyVesta, "Vesta_119");
				break;
			case 1800:
				orderActorToFactory(111074800, EnemyAstraea, "Astraea_120");
				break;
			case 1810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571810));
				orderActorToFactory(110574810, EnemyVesta, "Vesta_121");
				break;
			case 1870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110571870));
				orderActorToFactory(110574870, EnemyVesta, "Vesta_122");
				break;
			case 1900:
				orderActorToFactory(110974900, EnemyAstraea, "Astraea_123");
				break;
			case 1930:
			...
			case 2050:
				...
				break;
			case 2100:
				orderActorToFactory(110775100, EnemyAstraea, "Astraea_127");
				break;
			case 2110:
			...
			case 2170:
				...
				orderActorToFactory(110575170, EnemyVesta, "Vesta_129");
				break;
			case 2230:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572230));
				orderActorToFactory(110575230, EnemyVesta, "Vesta_130");
				break;
			case 2290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572290));
				orderActorToFactory(110575290, EnemyVesta, "Vesta_131");
				break;
			case 2300:
				orderActorToFactory(111875300, EnemyAstraea, "Astraea_132");
				break;
			case 2350:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572350));
				orderActorToFactory(110575350, EnemyVesta, "Vesta_133");
				break;
			case 2400:
				orderActorToFactory(111775400, EnemyAstraea, "Astraea_134");
				break;
			case 2410:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572410));
				orderActorToFactory(110575410, EnemyVesta, "Vesta_135");
				break;
			case 2470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572470));
				orderActorToFactory(110575470, EnemyVesta, "Vesta_136");
				break;
			case 2500:
				{
				...
				orderActorToFactory(111675500, EnemyAstraea, "Astraea_137");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113772500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113775500, EnemyCeres, "Ceres_138", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2530:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572530));
				orderActorToFactory(110575530, EnemyVesta, "Vesta_139");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113872530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113875530, EnemyCeres, "Ceres_140", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113972560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113975560, EnemyCeres, "Ceres_141", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2590:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572590));
				orderActorToFactory(110575590, EnemyVesta, "Vesta_142");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114072590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114075590, EnemyCeres, "Ceres_143", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114172620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114175620, EnemyCeres, "Ceres_144", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2650:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572650));
				orderActorToFactory(110575650, EnemyVesta, "Vesta_145");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114272650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114275650, EnemyCeres, "Ceres_146", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 2710:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572710));
				orderActorToFactory(110575710, EnemyVesta, "Vesta_147");
				break;
			case 2770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572770));
				orderActorToFactory(110575770, EnemyVesta, "Vesta_148");
				break;
			case 2800:
				orderActorToFactory(111075800, EnemyAstraea, "Astraea_149");
				break;
			case 2830:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572830));
				orderActorToFactory(110575830, EnemyVesta, "Vesta_150");
				break;
			case 2890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110572890));
				orderActorToFactory(110575890, EnemyVesta, "Vesta_151");
				break;
			case 2900:
				{
			...
			case 3250:
				...
				break;
			case 3300:
				orderActorToFactory(111876300, EnemyAstraea, "Astraea_159");
				break;
			case 3310:
			...
			case 3400:
				...
				orderActorToFactory(111776400, EnemyAstraea, "Astraea_162");
				break;
			case 3430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573430));
				orderActorToFactory(110576430, EnemyVesta, "Vesta_163");
				break;
			case 3490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573490));
				orderActorToFactory(110576490, EnemyVesta, "Vesta_164");
				break;
			case 3500:
				{
				...
				orderActorToFactory(111676500, EnemyAstraea, "Astraea_165");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113773500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113776500, EnemyCeres, "Ceres_166", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113873530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113876530, EnemyCeres, "Ceres_167", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573550));
				orderActorToFactory(110576550, EnemyVesta, "Vesta_168");
				break;
			case 3560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113973560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113976560, EnemyCeres, "Ceres_169", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114073590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114076590, EnemyCeres, "Ceres_170", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573610));
				orderActorToFactory(110576610, EnemyVesta, "Vesta_171");
				break;
			case 3620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114173620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114176620, EnemyCeres, "Ceres_172", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114273650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114276650, EnemyCeres, "Ceres_173", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573670));
				orderActorToFactory(110576670, EnemyVesta, "Vesta_174");
				break;
			case 3700:
				orderActorToFactory(111176700, EnemyAstraea, "Astraea_175");
				break;
			case 3730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573730));
				orderActorToFactory(110576730, EnemyVesta, "Vesta_176");
				break;
			case 3790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573790));
				orderActorToFactory(110576790, EnemyVesta, "Vesta_177");
				break;
			case 3800:
				orderActorToFactory(111076800, EnemyAstraea, "Astraea_178");
				break;
			case 3850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573850));
				orderActorToFactory(110576850, EnemyVesta, "Vesta_179");
				break;
			case 3900:
				{
				...
				orderActorToFactory(110976900, EnemyAstraea, "Astraea_180");
				break;
			case 3910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573910));
				orderActorToFactory(110576910, EnemyVesta, "Vesta_181");
				break;
			case 3970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110573970));
				orderActorToFactory(110576970, EnemyVesta, "Vesta_182");
				break;
			case 4030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574030));
				orderActorToFactory(110577030, EnemyVesta, "Vesta_183");
				break;
			case 4090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574090));
				orderActorToFactory(110577090, EnemyVesta, "Vesta_184");
				break;
			case 4150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574150));
				orderActorToFactory(110577150, EnemyVesta, "Vesta_185");
				break;
			case 4200:
				orderActorToFactory(111977200, EnemyAstraea, "Astraea_186");
				break;
			case 4210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574210));
				orderActorToFactory(110577210, EnemyVesta, "Vesta_187");
				break;
			case 4270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574270));
				orderActorToFactory(110577270, EnemyVesta, "Vesta_188");
				break;
			case 4300:
				orderActorToFactory(111877300, EnemyAstraea, "Astraea_189");
				break;
			case 4330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574330));
				orderActorToFactory(110577330, EnemyVesta, "Vesta_190");
				break;
			case 4390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574390));
				orderActorToFactory(110577390, EnemyVesta, "Vesta_191");
				break;
			case 4400:
				{
				...
				orderActorToFactory(111777400, EnemyAstraea, "Astraea_192");
				break;
			case 4450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574450));
				orderActorToFactory(110577450, EnemyVesta, "Vesta_193");
				break;
			case 4500:
				{
				...
				orderActorToFactory(111677500, EnemyAstraea, "Astraea_194");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113774500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113777500, EnemyCeres, "Ceres_195", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574510));
				orderActorToFactory(110577510, EnemyVesta, "Vesta_196");
				break;
			case 4530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113874530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113877530, EnemyCeres, "Ceres_197", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113974560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113977560, EnemyCeres, "Ceres_198", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574570));
				orderActorToFactory(110577570, EnemyVesta, "Vesta_199");
				break;
			case 4590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114074590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114077590, EnemyCeres, "Ceres_200", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114174620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114177620, EnemyCeres, "Ceres_201", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574630));
				orderActorToFactory(110577630, EnemyVesta, "Vesta_202");
				break;
			case 4650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114274650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114277650, EnemyCeres, "Ceres_203", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 4690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574690));
				orderActorToFactory(110577690, EnemyVesta, "Vesta_204");
				break;
			case 4700:
				orderActorToFactory(111177700, EnemyAstraea, "Astraea_205");
				break;
			case 4750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574750));
				orderActorToFactory(110577750, EnemyVesta, "Vesta_206");
				break;
			case 4800:
				{
				...
				orderActorToFactory(111077800, EnemyAstraea, "Astraea_207");
				break;
			case 4810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574810));
				orderActorToFactory(110577810, EnemyVesta, "Vesta_208");
				break;
			case 4870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574870));
				orderActorToFactory(110577870, EnemyVesta, "Vesta_209");
				break;
			case 4900:
				{
				...
				orderActorToFactory(110977900, EnemyAstraea, "Astraea_210");
				break;
			case 4930:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574930));
				orderActorToFactory(110577930, EnemyVesta, "Vesta_211");
				break;
			case 4990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110574990));
				orderActorToFactory(110577990, EnemyVesta, "Vesta_212");
				break;
			case 5050:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575050));
				orderActorToFactory(110578050, EnemyVesta, "Vesta_213");
				break;
			case 5100:
				{
			...
			case 5110:
				...
				orderActorToFactory(110578110, EnemyVesta, "Vesta_214");
				break;
			case 5170:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575170));
				orderActorToFactory(110578170, EnemyVesta, "Vesta_215");
				break;
			case 5200:
				orderActorToFactory(111978200, EnemyAstraea, "Astraea_216");
				break;
			case 5230:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575230));
				orderActorToFactory(110578230, EnemyVesta, "Vesta_217");
				break;
			case 5290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575290));
				orderActorToFactory(110578290, EnemyVesta, "Vesta_218");
				break;
			case 5300:
				{
				...
				orderActorToFactory(111878300, EnemyAstraea, "Astraea_219");
				break;
			case 5350:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575350));
				orderActorToFactory(110578350, EnemyVesta, "Vesta_220");
				break;
			case 5400:
				{
				...
				orderActorToFactory(111778400, EnemyAstraea, "Astraea_221");
				break;
			case 5410:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575410));
				orderActorToFactory(110578410, EnemyVesta, "Vesta_222");
				break;
			case 5470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575470));
				orderActorToFactory(110578470, EnemyVesta, "Vesta_223");
				break;
			case 5500:
				{
				...
				orderActorToFactory(111678500, EnemyAstraea, "Astraea_224");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113775500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113778500, EnemyCeres, "Ceres_225", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5530:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575530));
				orderActorToFactory(110578530, EnemyVesta, "Vesta_226");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113875530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113878530, EnemyCeres, "Ceres_227", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113975560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113978560, EnemyCeres, "Ceres_228", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5590:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575590));
				orderActorToFactory(110578590, EnemyVesta, "Vesta_229");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114075590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114078590, EnemyCeres, "Ceres_230", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5600:
				orderActorToFactory(111278600, EnemyAstraea, "Astraea_231");
				break;
			case 5620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114175620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114178620, EnemyCeres, "Ceres_232", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5650:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575650));
				orderActorToFactory(110578650, EnemyVesta, "Vesta_233");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114275650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114278650, EnemyCeres, "Ceres_234", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5700:
				orderActorToFactory(111178700, EnemyAstraea, "Astraea_235");
				break;
			case 5710:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575710));
				orderActorToFactory(110578710, EnemyVesta, "Vesta_236");
				break;
			case 5770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575770));
				orderActorToFactory(110578770, EnemyVesta, "Vesta_237");
				break;
			case 5800:
				{
				...
				orderActorToFactory(111078800, EnemyAstraea, "Astraea_238");
				break;
			case 5830:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575830));
				orderActorToFactory(110578830, EnemyVesta, "Vesta_239");
				break;
			case 5890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575890));
				orderActorToFactory(110578890, EnemyVesta, "Vesta_240");
				break;
			case 5900:
				{
				...
				orderActorToFactory(110978900, EnemyAstraea, "Astraea_241");
				break;
			case 5950:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110575950));
				orderActorToFactory(110578950, EnemyVesta, "Vesta_242");
				break;
			case 6010:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576010));
				orderActorToFactory(110579010, EnemyVesta, "Vesta_243");
				break;
			case 6070:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576070));
				orderActorToFactory(110579070, EnemyVesta, "Vesta_244");
				break;
			case 6100:
				orderActorToFactory(112079100, EnemyAstraea, "Astraea_245");
				break;
			case 6130:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576130));
				orderActorToFactory(110579130, EnemyVesta, "Vesta_246");
				break;
			case 6190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576190));
				orderActorToFactory(110579190, EnemyVesta, "Vesta_247");
				break;
			case 6200:
				orderActorToFactory(111979200, EnemyAstraea, "Astraea_248");
				break;
			case 6250:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576250));
				orderActorToFactory(110579250, EnemyVesta, "Vesta_249");
				break;
			case 6300:
				{
				...
				orderActorToFactory(111879300, EnemyAstraea, "Astraea_250");
				break;
			case 6310:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576310));
				orderActorToFactory(110579310, EnemyVesta, "Vesta_251");
				break;
			case 6370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576370));
				orderActorToFactory(110579370, EnemyVesta, "Vesta_252");
				break;
			case 6400:
				{
				...
				orderActorToFactory(111779400, EnemyAstraea, "Astraea_253");
				break;
			case 6430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576430));
				orderActorToFactory(110579430, EnemyVesta, "Vesta_254");
				break;
			case 6490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576490));
				orderActorToFactory(110579490, EnemyVesta, "Vesta_255");
				break;
			case 6500:
				{
				...
				orderActorToFactory(111679500, EnemyAstraea, "Astraea_256");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113776500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113779500, EnemyCeres, "Ceres_257", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113876530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113879530, EnemyCeres, "Ceres_258", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576550));
				orderActorToFactory(110579550, EnemyVesta, "Vesta_259");
				break;
			case 6560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113976560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(113979560, EnemyCeres, "Ceres_260", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114076590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114079590, EnemyCeres, "Ceres_261", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6600:
				orderActorToFactory(111279600, EnemyAstraea, "Astraea_262");
				break;
			case 6610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576610));
				orderActorToFactory(110579610, EnemyVesta, "Vesta_263");
				break;
			case 6620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114176620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114179620, EnemyCeres, "Ceres_264", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114276650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(114279650, EnemyCeres, "Ceres_265", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576670));
				orderActorToFactory(110579670, EnemyVesta, "Vesta_266");
				break;
			case 6700:
				{
				...
				orderActorToFactory(111179700, EnemyAstraea, "Astraea_267");
				break;
			case 6730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576730));
				orderActorToFactory(110579730, EnemyVesta, "Vesta_268");
				break;
			case 6790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576790));
				orderActorToFactory(110579790, EnemyVesta, "Vesta_269");
				break;
			case 6800:
				{
				...
				orderActorToFactory(111079800, EnemyAstraea, "Astraea_270");
				break;
			case 6850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576850));
				orderActorToFactory(110579850, EnemyVesta, "Vesta_271");
				break;
			case 6900:
				{
				...
				orderActorToFactory(110979900, EnemyAstraea, "Astraea_272");
				break;
			case 6910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576910));
				orderActorToFactory(110579910, EnemyVesta, "Vesta_273");
				break;
			case 6970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110576970));
				orderActorToFactory(110579970, EnemyVesta, "Vesta_274");
				break;
			case 7030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577030));
				orderActorToFactory(1105710030, EnemyVesta, "Vesta_275");
				break;
			case 7090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577090));
				orderActorToFactory(1105710090, EnemyVesta, "Vesta_276");
				break;
			case 7100:
				orderActorToFactory(1107710100, EnemyAstraea, "Astraea_277");
				orderActorToFactory(1120710100, EnemyAstraea, "Astraea_278");
				break;
			case 7150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577150));
				orderActorToFactory(1105710150, EnemyVesta, "Vesta_279");
				break;
			case 7200:
				{
				...
				orderActorToFactory(1119710200, EnemyAstraea, "Astraea_280");
				break;
			case 7210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577210));
				orderActorToFactory(1105710210, EnemyVesta, "Vesta_281");
				break;
			case 7270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577270));
				orderActorToFactory(1105710270, EnemyVesta, "Vesta_282");
				break;
			case 7300:
				{
				...
				orderActorToFactory(1118710300, EnemyAstraea, "Astraea_283");
				break;
			case 7330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577330));
				orderActorToFactory(1105710330, EnemyVesta, "Vesta_284");
				break;
			case 7390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577390));
				orderActorToFactory(1105710390, EnemyVesta, "Vesta_285");
				break;
			case 7400:
				{
				...
				orderActorToFactory(1117710400, EnemyAstraea, "Astraea_286");
				break;
			case 7450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577450));
				orderActorToFactory(1105710450, EnemyVesta, "Vesta_287");
				break;
			case 7500:
				orderActorToFactory(1113710500, EnemyAstraea, "Astraea_288");
				{
				...
				orderActorToFactory(1116710500, EnemyAstraea, "Astraea_289");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113777500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137710500, EnemyCeres, "Ceres_290", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577510));
				orderActorToFactory(1105710510, EnemyVesta, "Vesta_291");
				break;
			case 7530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113877530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138710530, EnemyCeres, "Ceres_292", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113977560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139710560, EnemyCeres, "Ceres_293", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577570));
				orderActorToFactory(1105710570, EnemyVesta, "Vesta_294");
				break;
			case 7590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114077590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140710590, EnemyCeres, "Ceres_295", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7600:
				orderActorToFactory(1112710600, EnemyAstraea, "Astraea_296");
				break;
			case 7620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114177620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141710620, EnemyCeres, "Ceres_297", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577630));
				orderActorToFactory(1105710630, EnemyVesta, "Vesta_298");
				break;
			case 7650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114277650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142710650, EnemyCeres, "Ceres_299", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 7690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577690));
				orderActorToFactory(1105710690, EnemyVesta, "Vesta_300");
				break;
			case 7700:
				{
				...
				orderActorToFactory(1111710700, EnemyAstraea, "Astraea_301");
				break;
			case 7750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577750));
				orderActorToFactory(1105710750, EnemyVesta, "Vesta_302");
				break;
			case 7800:
				{
				...
				orderActorToFactory(1110710800, EnemyAstraea, "Astraea_303");
				break;
			case 7810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577810));
				orderActorToFactory(1105710810, EnemyVesta, "Vesta_304");
				break;
			case 7870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577870));
				orderActorToFactory(1105710870, EnemyVesta, "Vesta_305");
				break;
			case 7900:
				{
				...
				orderActorToFactory(1109710900, EnemyAstraea, "Astraea_306");
				break;
			case 7930:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577930));
				orderActorToFactory(1105710930, EnemyVesta, "Vesta_307");
				break;
			case 7990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110577990));
				orderActorToFactory(1105710990, EnemyVesta, "Vesta_308");
				break;
			case 8000:
				orderActorToFactory(1121711000, EnemyAstraea, "Astraea_309");
				break;
			case 8050:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578050));
				orderActorToFactory(1105711050, EnemyVesta, "Vesta_310");
				break;
			case 8100:
				orderActorToFactory(1120711100, EnemyAstraea, "Astraea_311");
				break;
			case 8110:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578110));
				orderActorToFactory(1105711110, EnemyVesta, "Vesta_312");
				break;
			case 8170:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578170));
				orderActorToFactory(1105711170, EnemyVesta, "Vesta_313");
				break;
			case 8200:
				{
				...
				orderActorToFactory(1119711200, EnemyAstraea, "Astraea_314");
				break;
			case 8230:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578230));
				orderActorToFactory(1105711230, EnemyVesta, "Vesta_315");
				break;
			case 8290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578290));
				orderActorToFactory(1105711290, EnemyVesta, "Vesta_316");
				break;
			case 8300:
				{
				...
				orderActorToFactory(1118711300, EnemyAstraea, "Astraea_317");
				break;
			case 8350:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578350));
				orderActorToFactory(1105711350, EnemyVesta, "Vesta_318");
				break;
			case 8400:
				{
				...
				orderActorToFactory(1117711400, EnemyAstraea, "Astraea_319");
				break;
			case 8410:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578410));
				orderActorToFactory(1105711410, EnemyVesta, "Vesta_320");
				break;
			case 8470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578470));
				orderActorToFactory(1105711470, EnemyVesta, "Vesta_321");
				break;
			case 8500:
				orderActorToFactory(1113711500, EnemyAstraea, "Astraea_322");
				{
				...
				orderActorToFactory(1116711500, EnemyAstraea, "Astraea_323");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113778500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137711500, EnemyCeres, "Ceres_324", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8530:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578530));
				orderActorToFactory(1105711530, EnemyVesta, "Vesta_325");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113878530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138711530, EnemyCeres, "Ceres_326", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113978560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139711560, EnemyCeres, "Ceres_327", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8590:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578590));
				orderActorToFactory(1105711590, EnemyVesta, "Vesta_328");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114078590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140711590, EnemyCeres, "Ceres_329", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8600:
				{
				...
				orderActorToFactory(1112711600, EnemyAstraea, "Astraea_330");
				break;
			case 8620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114178620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141711620, EnemyCeres, "Ceres_331", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8650:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578650));
				orderActorToFactory(1105711650, EnemyVesta, "Vesta_332");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114278650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142711650, EnemyCeres, "Ceres_333", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 8700:
				{
				...
				orderActorToFactory(1111711700, EnemyAstraea, "Astraea_334");
				break;
			case 8710:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578710));
				orderActorToFactory(1105711710, EnemyVesta, "Vesta_335");
				break;
			case 8770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578770));
				orderActorToFactory(1105711770, EnemyVesta, "Vesta_336");
				break;
			case 8800:
				{
				...
				orderActorToFactory(1110711800, EnemyAstraea, "Astraea_337");
				break;
			case 8830:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578830));
				orderActorToFactory(1105711830, EnemyVesta, "Vesta_338");
				break;
			case 8890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578890));
				orderActorToFactory(1105711890, EnemyVesta, "Vesta_339");
				break;
			case 8900:
				{
				...
				orderActorToFactory(1109711900, EnemyAstraea, "Astraea_340");
				break;
			case 8950:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110578950));
				orderActorToFactory(1105711950, EnemyVesta, "Vesta_341");
				break;
			case 9000:
				orderActorToFactory(1121712000, EnemyAstraea, "Astraea_342");
				break;
			case 9010:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579010));
				orderActorToFactory(1105712010, EnemyVesta, "Vesta_343");
				break;
			case 9070:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579070));
				orderActorToFactory(1105712070, EnemyVesta, "Vesta_344");
				break;
			case 9100:
				{
				...
				orderActorToFactory(1120712100, EnemyAstraea, "Astraea_345");
				break;
			case 9130:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579130));
				orderActorToFactory(1105712130, EnemyVesta, "Vesta_346");
				break;
			case 9190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579190));
				orderActorToFactory(1105712190, EnemyVesta, "Vesta_347");
				break;
			case 9200:
				{
				...
				orderActorToFactory(1119712200, EnemyAstraea, "Astraea_348");
				break;
			case 9250:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579250));
				orderActorToFactory(1105712250, EnemyVesta, "Vesta_349");
				break;
			case 9300:
				{
				...
				orderActorToFactory(1118712300, EnemyAstraea, "Astraea_350");
				break;
			case 9310:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579310));
				orderActorToFactory(1105712310, EnemyVesta, "Vesta_351");
				break;
			case 9370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579370));
				orderActorToFactory(1105712370, EnemyVesta, "Vesta_352");
				break;
			case 9400:
				orderActorToFactory(1114712400, EnemyAstraea, "Astraea_353");
				{
				...
				orderActorToFactory(1117712400, EnemyAstraea, "Astraea_354");
				break;
			case 9430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579430));
				orderActorToFactory(1105712430, EnemyVesta, "Vesta_355");
				break;
			case 9490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579490));
				orderActorToFactory(1105712490, EnemyVesta, "Vesta_356");
				break;
			case 9500:
				orderActorToFactory(1113712500, EnemyAstraea, "Astraea_357");
				{
				...
				orderActorToFactory(1116712500, EnemyAstraea, "Astraea_358");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113779500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137712500, EnemyCeres, "Ceres_359", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113879530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138712530, EnemyCeres, "Ceres_360", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579550));
				orderActorToFactory(1105712550, EnemyVesta, "Vesta_361");
				break;
			case 9560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(113979560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139712560, EnemyCeres, "Ceres_362", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114079590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140712590, EnemyCeres, "Ceres_363", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9600:
				{
				...
				orderActorToFactory(1112712600, EnemyAstraea, "Astraea_364");
				break;
			case 9610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579610));
				orderActorToFactory(1105712610, EnemyVesta, "Vesta_365");
				break;
			case 9620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114179620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141712620, EnemyCeres, "Ceres_366", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(114279650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142712650, EnemyCeres, "Ceres_367", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579670));
				orderActorToFactory(1105712670, EnemyVesta, "Vesta_368");
				break;
			case 9700:
				{
				...
				orderActorToFactory(1111712700, EnemyAstraea, "Astraea_369");
				break;
			case 9730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579730));
				orderActorToFactory(1105712730, EnemyVesta, "Vesta_370");
				break;
			case 9790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579790));
				orderActorToFactory(1105712790, EnemyVesta, "Vesta_371");
				break;
			case 9800:
				{
				...
				orderActorToFactory(1110712800, EnemyAstraea, "Astraea_372");
				break;
			case 9850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579850));
				orderActorToFactory(1105712850, EnemyVesta, "Vesta_373");
				break;
			case 9900:
				{
				...
				orderActorToFactory(1109712900, EnemyAstraea, "Astraea_374");
				break;
			case 9910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579910));
				orderActorToFactory(1105712910, EnemyVesta, "Vesta_375");
				break;
			case 9970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(110579970));
				orderActorToFactory(1105712970, EnemyVesta, "Vesta_376");
				break;
			case 10000:
				orderActorToFactory(1121713000, EnemyAstraea, "Astraea_377");
				break;
			case 10030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710030));
				orderActorToFactory(1105713030, EnemyVesta, "Vesta_378");
				break;
			case 10090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710090));
				orderActorToFactory(1105713090, EnemyVesta, "Vesta_379");
				break;
			case 10100:
				{
				...
				orderActorToFactory(1120713100, EnemyAstraea, "Astraea_380");
				break;
			case 10150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710150));
				orderActorToFactory(1105713150, EnemyVesta, "Vesta_381");
				break;
			case 10200:
				{
				...
				orderActorToFactory(1119713200, EnemyAstraea, "Astraea_382");
				break;
			case 10210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710210));
				orderActorToFactory(1105713210, EnemyVesta, "Vesta_383");
				break;
			case 10270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710270));
				orderActorToFactory(1105713270, EnemyVesta, "Vesta_384");
				break;
			case 10300:
				{
				...
				orderActorToFactory(1118713300, EnemyAstraea, "Astraea_385");
				break;
			case 10330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710330));
				orderActorToFactory(1105713330, EnemyVesta, "Vesta_386");
				break;
			case 10390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710390));
				orderActorToFactory(1105713390, EnemyVesta, "Vesta_387");
				break;
			case 10400:
				orderActorToFactory(1114713400, EnemyAstraea, "Astraea_388");
				{
				...
				orderActorToFactory(1117713400, EnemyAstraea, "Astraea_389");
				break;
			case 10450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710450));
				orderActorToFactory(1105713450, EnemyVesta, "Vesta_390");
				break;
			case 10500:
				{
				...
				orderActorToFactory(1113713500, EnemyAstraea, "Astraea_391");
				{
				...
				orderActorToFactory(1116713500, EnemyAstraea, "Astraea_392");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137710500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137713500, EnemyCeres, "Ceres_393", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710510));
				orderActorToFactory(1105713510, EnemyVesta, "Vesta_394");
				break;
			case 10530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138710530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138713530, EnemyCeres, "Ceres_395", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139710560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139713560, EnemyCeres, "Ceres_396", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710570));
				orderActorToFactory(1105713570, EnemyVesta, "Vesta_397");
				break;
			case 10590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140710590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140713590, EnemyCeres, "Ceres_398", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10600:
				{
				...
				orderActorToFactory(1112713600, EnemyAstraea, "Astraea_399");
				break;
			case 10620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141710620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141713620, EnemyCeres, "Ceres_400", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710630));
				orderActorToFactory(1105713630, EnemyVesta, "Vesta_401");
				break;
			case 10650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142710650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142713650, EnemyCeres, "Ceres_402", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 10690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710690));
				orderActorToFactory(1105713690, EnemyVesta, "Vesta_403");
				break;
			case 10700:
				{
				...
				orderActorToFactory(1111713700, EnemyAstraea, "Astraea_404");
				break;
			case 10750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710750));
				orderActorToFactory(1105713750, EnemyVesta, "Vesta_405");
				break;
			case 10800:
				{
				...
				orderActorToFactory(1110713800, EnemyAstraea, "Astraea_406");
				break;
			case 10810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710810));
				orderActorToFactory(1105713810, EnemyVesta, "Vesta_407");
				break;
			case 10870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710870));
				orderActorToFactory(1105713870, EnemyVesta, "Vesta_408");
				break;
			case 10900:
				{
				...
				orderActorToFactory(1109713900, EnemyAstraea, "Astraea_409");
				break;
			case 10930:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710930));
				orderActorToFactory(1105713930, EnemyVesta, "Vesta_410");
				break;
			case 10990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105710990));
				orderActorToFactory(1105713990, EnemyVesta, "Vesta_411");
				break;
			case 11000:
				{
				...
				orderActorToFactory(1121714000, EnemyAstraea, "Astraea_412");
				break;
			case 11050:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711050));
				orderActorToFactory(1105714050, EnemyVesta, "Vesta_413");
				break;
			case 11100:
				{
				...
				orderActorToFactory(1120714100, EnemyAstraea, "Astraea_414");
				break;
			case 11110:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711110));
				orderActorToFactory(1105714110, EnemyVesta, "Vesta_415");
				break;
			case 11170:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711170));
				orderActorToFactory(1105714170, EnemyVesta, "Vesta_416");
				break;
			case 11200:
				{
				...
				orderActorToFactory(1119714200, EnemyAstraea, "Astraea_417");
				break;
			case 11230:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711230));
				orderActorToFactory(1105714230, EnemyVesta, "Vesta_418");
				break;
			case 11290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711290));
				orderActorToFactory(1105714290, EnemyVesta, "Vesta_419");
				break;
			case 11300:
				{
				...
				orderActorToFactory(1118714300, EnemyAstraea, "Astraea_420");
				break;
			case 11350:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711350));
				orderActorToFactory(1105714350, EnemyVesta, "Vesta_421");
				break;
			case 11400:
				orderActorToFactory(1114714400, EnemyAstraea, "Astraea_422");
				{
				...
				orderActorToFactory(1117714400, EnemyAstraea, "Astraea_423");
				break;
			case 11410:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711410));
				orderActorToFactory(1105714410, EnemyVesta, "Vesta_424");
				break;
			case 11470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711470));
				orderActorToFactory(1105714470, EnemyVesta, "Vesta_425");
				break;
			case 11500:
				{
				...
				orderActorToFactory(1113714500, EnemyAstraea, "Astraea_426");
				{
				...
				orderActorToFactory(1116714500, EnemyAstraea, "Astraea_427");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137711500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137714500, EnemyCeres, "Ceres_428", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11530:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711530));
				orderActorToFactory(1105714530, EnemyVesta, "Vesta_429");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138711530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138714530, EnemyCeres, "Ceres_430", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139711560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139714560, EnemyCeres, "Ceres_431", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11590:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711590));
				orderActorToFactory(1105714590, EnemyVesta, "Vesta_432");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140711590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140714590, EnemyCeres, "Ceres_433", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11600:
				{
				...
				orderActorToFactory(1112714600, EnemyAstraea, "Astraea_434");
				break;
			case 11620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141711620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141714620, EnemyCeres, "Ceres_435", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11650:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711650));
				orderActorToFactory(1105714650, EnemyVesta, "Vesta_436");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142711650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142714650, EnemyCeres, "Ceres_437", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 11700:
				{
				...
				orderActorToFactory(1111714700, EnemyAstraea, "Astraea_438");
				break;
			case 11710:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711710));
				orderActorToFactory(1105714710, EnemyVesta, "Vesta_439");
				break;
			case 11770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711770));
				orderActorToFactory(1105714770, EnemyVesta, "Vesta_440");
				break;
			case 11800:
				{
				...
				orderActorToFactory(1110714800, EnemyAstraea, "Astraea_441");
				break;
			case 11830:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711830));
				orderActorToFactory(1105714830, EnemyVesta, "Vesta_442");
				break;
			case 11890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711890));
				orderActorToFactory(1105714890, EnemyVesta, "Vesta_443");
				break;
			case 11900:
				{
				...
				orderActorToFactory(1109714900, EnemyAstraea, "Astraea_444");
				break;
			case 11950:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105711950));
				orderActorToFactory(1105714950, EnemyVesta, "Vesta_445");
				break;
			case 12000:
				{
				...
				orderActorToFactory(1121715000, EnemyAstraea, "Astraea_446");
				break;
			case 12010:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712010));
				orderActorToFactory(1105715010, EnemyVesta, "Vesta_447");
				break;
			case 12070:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712070));
				orderActorToFactory(1105715070, EnemyVesta, "Vesta_448");
				break;
			case 12100:
				orderActorToFactory(1107715100, EnemyAstraea, "Astraea_449");
				{
				...
				orderActorToFactory(1120715100, EnemyAstraea, "Astraea_450");
				break;
			case 12130:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712130));
				orderActorToFactory(1105715130, EnemyVesta, "Vesta_451");
				break;
			case 12190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712190));
				orderActorToFactory(1105715190, EnemyVesta, "Vesta_452");
				break;
			case 12200:
				{
				...
				orderActorToFactory(1119715200, EnemyAstraea, "Astraea_453");
				break;
			case 12250:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712250));
				orderActorToFactory(1105715250, EnemyVesta, "Vesta_454");
				break;
			case 12300:
				{
				...
				orderActorToFactory(1118715300, EnemyAstraea, "Astraea_455");
				break;
			case 12310:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712310));
				orderActorToFactory(1105715310, EnemyVesta, "Vesta_456");
				break;
			case 12370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712370));
				orderActorToFactory(1105715370, EnemyVesta, "Vesta_457");
				break;
			case 12400:
				{
				...
				orderActorToFactory(1114715400, EnemyAstraea, "Astraea_458");
				{
				...
				orderActorToFactory(1117715400, EnemyAstraea, "Astraea_459");
				break;
			case 12430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712430));
				orderActorToFactory(1105715430, EnemyVesta, "Vesta_460");
				break;
			case 12490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712490));
				orderActorToFactory(1105715490, EnemyVesta, "Vesta_461");
				break;
			case 12500:
				{
				...
				orderActorToFactory(1113715500, EnemyAstraea, "Astraea_462");
				{
				...
				orderActorToFactory(1116715500, EnemyAstraea, "Astraea_463");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137712500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137715500, EnemyCeres, "Ceres_464", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138712530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138715530, EnemyCeres, "Ceres_465", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712550));
				orderActorToFactory(1105715550, EnemyVesta, "Vesta_466");
				break;
			case 12560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139712560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139715560, EnemyCeres, "Ceres_467", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140712590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140715590, EnemyCeres, "Ceres_468", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12600:
				{
				...
				orderActorToFactory(1112715600, EnemyAstraea, "Astraea_469");
				break;
			case 12610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712610));
				orderActorToFactory(1105715610, EnemyVesta, "Vesta_470");
				break;
			case 12620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141712620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141715620, EnemyCeres, "Ceres_471", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142712650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142715650, EnemyCeres, "Ceres_472", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712670));
				orderActorToFactory(1105715670, EnemyVesta, "Vesta_473");
				break;
			case 12700:
				{
				...
				orderActorToFactory(1111715700, EnemyAstraea, "Astraea_474");
				break;
			case 12730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712730));
				orderActorToFactory(1105715730, EnemyVesta, "Vesta_475");
				break;
			case 12790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712790));
				orderActorToFactory(1105715790, EnemyVesta, "Vesta_476");
				break;
			case 12800:
				{
				...
				orderActorToFactory(1110715800, EnemyAstraea, "Astraea_477");
				break;
			case 12850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712850));
				orderActorToFactory(1105715850, EnemyVesta, "Vesta_478");
				break;
			case 12900:
				{
				...
				orderActorToFactory(1109715900, EnemyAstraea, "Astraea_479");
				break;
			case 12910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712910));
				orderActorToFactory(1105715910, EnemyVesta, "Vesta_480");
				break;
			case 12970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105712970));
				orderActorToFactory(1105715970, EnemyVesta, "Vesta_481");
				break;
			case 13000:
				{
				...
				orderActorToFactory(1121716000, EnemyAstraea, "Astraea_482");
				break;
			case 13030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713030));
				orderActorToFactory(1105716030, EnemyVesta, "Vesta_483");
				break;
			case 13090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713090));
				orderActorToFactory(1105716090, EnemyVesta, "Vesta_484");
				break;
			case 13100:
				{
				...
				orderActorToFactory(1120716100, EnemyAstraea, "Astraea_485");
				break;
			case 13150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713150));
				orderActorToFactory(1105716150, EnemyVesta, "Vesta_486");
				break;
			case 13200:
				{
				...
				orderActorToFactory(1119716200, EnemyAstraea, "Astraea_487");
				break;
			case 13210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713210));
				orderActorToFactory(1105716210, EnemyVesta, "Vesta_488");
				break;
			case 13270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713270));
				orderActorToFactory(1105716270, EnemyVesta, "Vesta_489");
				break;
			case 13300:
				{
				...
				orderActorToFactory(1118716300, EnemyAstraea, "Astraea_490");
				break;
			case 13330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713330));
				orderActorToFactory(1105716330, EnemyVesta, "Vesta_491");
				break;
			case 13390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713390));
				orderActorToFactory(1105716390, EnemyVesta, "Vesta_492");
				break;
			case 13400:
				{
				...
				orderActorToFactory(1114716400, EnemyAstraea, "Astraea_493");
				{
				...
				orderActorToFactory(1117716400, EnemyAstraea, "Astraea_494");
				break;
			case 13450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713450));
				orderActorToFactory(1105716450, EnemyVesta, "Vesta_495");
				break;
			case 13500:
				{
				...
				orderActorToFactory(1113716500, EnemyAstraea, "Astraea_496");
				{
				...
				orderActorToFactory(1116716500, EnemyAstraea, "Astraea_497");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137713500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137716500, EnemyCeres, "Ceres_498", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713510));
				orderActorToFactory(1105716510, EnemyVesta, "Vesta_499");
				break;
			case 13530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138713530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138716530, EnemyCeres, "Ceres_500", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139713560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139716560, EnemyCeres, "Ceres_501", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713570));
				orderActorToFactory(1105716570, EnemyVesta, "Vesta_502");
				break;
			case 13590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140713590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140716590, EnemyCeres, "Ceres_503", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13600:
				{
				...
				orderActorToFactory(1112716600, EnemyAstraea, "Astraea_504");
				break;
			case 13620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141713620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141716620, EnemyCeres, "Ceres_505", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713630));
				orderActorToFactory(1105716630, EnemyVesta, "Vesta_506");
				break;
			case 13650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142713650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142716650, EnemyCeres, "Ceres_507", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713690));
				orderActorToFactory(1105716690, EnemyVesta, "Vesta_508");
				break;
			case 13700:
				{
				...
				orderActorToFactory(1111716700, EnemyAstraea, "Astraea_509");
				break;
			case 13750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713750));
				orderActorToFactory(1105716750, EnemyVesta, "Vesta_510");
				break;
			case 13800:
				{
				...
				orderActorToFactory(1110716800, EnemyAstraea, "Astraea_511");
				break;
			case 13810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713810));
				orderActorToFactory(1105716810, EnemyVesta, "Vesta_512");
				break;
			case 13870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713870));
				orderActorToFactory(1105716870, EnemyVesta, "Vesta_513");
				break;
			case 13900:
				{
				...
				orderActorToFactory(1109716900, EnemyAstraea, "Astraea_514");
				break;
			case 13930:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713930));
				orderActorToFactory(1105716930, EnemyVesta, "Vesta_515");
				break;
			case 13990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105713990));
				orderActorToFactory(1105716990, EnemyVesta, "Vesta_516");
				break;
			case 14000:
				{
				...
				orderActorToFactory(1121717000, EnemyAstraea, "Astraea_517");
				break;
			case 14050:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714050));
				orderActorToFactory(1105717050, EnemyVesta, "Vesta_518");
				break;
			case 14100:
				{
				...
				orderActorToFactory(1120717100, EnemyAstraea, "Astraea_519");
				break;
			case 14110:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714110));
				orderActorToFactory(1105717110, EnemyVesta, "Vesta_520");
				break;
			case 14170:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714170));
				orderActorToFactory(1105717170, EnemyVesta, "Vesta_521");
				break;
			case 14200:
				{
				...
				orderActorToFactory(1119717200, EnemyAstraea, "Astraea_522");
				break;
			case 14230:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714230));
				orderActorToFactory(1105717230, EnemyVesta, "Vesta_523");
				break;
			case 14290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714290));
				orderActorToFactory(1105717290, EnemyVesta, "Vesta_524");
				break;
			case 14300:
				{
				...
				orderActorToFactory(1118717300, EnemyAstraea, "Astraea_525");
				break;
			case 14350:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714350));
				orderActorToFactory(1105717350, EnemyVesta, "Vesta_526");
				break;
			case 14400:
				{
				...
				orderActorToFactory(1114717400, EnemyAstraea, "Astraea_527");
				{
				...
				orderActorToFactory(1117717400, EnemyAstraea, "Astraea_528");
				break;
			case 14410:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714410));
				orderActorToFactory(1105717410, EnemyVesta, "Vesta_529");
				break;
			case 14470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714470));
				orderActorToFactory(1105717470, EnemyVesta, "Vesta_530");
				break;
			case 14500:
				{
				...
				orderActorToFactory(1113717500, EnemyAstraea, "Astraea_531");
				{
				...
				orderActorToFactory(1116717500, EnemyAstraea, "Astraea_532");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137714500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137717500, EnemyCeres, "Ceres_533", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14530:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714530));
				orderActorToFactory(1105717530, EnemyVesta, "Vesta_534");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138714530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138717530, EnemyCeres, "Ceres_535", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139714560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139717560, EnemyCeres, "Ceres_536", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14590:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714590));
				orderActorToFactory(1105717590, EnemyVesta, "Vesta_537");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140714590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140717590, EnemyCeres, "Ceres_538", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14600:
				{
				...
				orderActorToFactory(1112717600, EnemyAstraea, "Astraea_539");
				break;
			case 14620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141714620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141717620, EnemyCeres, "Ceres_540", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14650:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714650));
				orderActorToFactory(1105717650, EnemyVesta, "Vesta_541");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142714650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142717650, EnemyCeres, "Ceres_542", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 14700:
				{
				...
				orderActorToFactory(1111717700, EnemyAstraea, "Astraea_543");
				break;
			case 14710:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714710));
				orderActorToFactory(1105717710, EnemyVesta, "Vesta_544");
				break;
			case 14770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714770));
				orderActorToFactory(1105717770, EnemyVesta, "Vesta_545");
				break;
			case 14800:
				{
				...
				orderActorToFactory(1110717800, EnemyAstraea, "Astraea_546");
				break;
			case 14830:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714830));
				orderActorToFactory(1105717830, EnemyVesta, "Vesta_547");
				break;
			case 14890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714890));
				orderActorToFactory(1105717890, EnemyVesta, "Vesta_548");
				break;
			case 14900:
				{
				...
				orderActorToFactory(1109717900, EnemyAstraea, "Astraea_549");
				break;
			case 14950:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105714950));
				orderActorToFactory(1105717950, EnemyVesta, "Vesta_550");
				break;
			case 15000:
				{
				...
				orderActorToFactory(1121718000, EnemyAstraea, "Astraea_551");
				break;
			case 15010:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715010));
				orderActorToFactory(1105718010, EnemyVesta, "Vesta_552");
				break;
			case 15070:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715070));
				orderActorToFactory(1105718070, EnemyVesta, "Vesta_553");
				break;
			case 15100:
				{
				...
				orderActorToFactory(1120718100, EnemyAstraea, "Astraea_554");
				break;
			case 15130:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715130));
				orderActorToFactory(1105718130, EnemyVesta, "Vesta_555");
				break;
			case 15190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715190));
				orderActorToFactory(1105718190, EnemyVesta, "Vesta_556");
				break;
			case 15200:
				{
				...
				orderActorToFactory(1119718200, EnemyAstraea, "Astraea_557");
				break;
			case 15250:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715250));
				orderActorToFactory(1105718250, EnemyVesta, "Vesta_558");
				break;
			case 15300:
				{
				...
				orderActorToFactory(1118718300, EnemyAstraea, "Astraea_559");
				break;
			case 15310:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715310));
				orderActorToFactory(1105718310, EnemyVesta, "Vesta_560");
				break;
			case 15370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715370));
				orderActorToFactory(1105718370, EnemyVesta, "Vesta_561");
				break;
			case 15400:
				{
				...
				orderActorToFactory(1114718400, EnemyAstraea, "Astraea_562");
				{
				...
				orderActorToFactory(1117718400, EnemyAstraea, "Astraea_563");
				break;
			case 15430:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715430));
				orderActorToFactory(1105718430, EnemyVesta, "Vesta_564");
				break;
			case 15490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715490));
				orderActorToFactory(1105718490, EnemyVesta, "Vesta_565");
				break;
			case 15500:
				{
				...
				orderActorToFactory(1113718500, EnemyAstraea, "Astraea_566");
				{
				...
				orderActorToFactory(1116718500, EnemyAstraea, "Astraea_567");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137715500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137718500, EnemyCeres, "Ceres_568", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138715530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138718530, EnemyCeres, "Ceres_569", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15550:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715550));
				orderActorToFactory(1105718550, EnemyVesta, "Vesta_570");
				break;
			case 15560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139715560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139718560, EnemyCeres, "Ceres_571", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140715590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140718590, EnemyCeres, "Ceres_572", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15600:
				{
				...
				orderActorToFactory(1112718600, EnemyAstraea, "Astraea_573");
				break;
			case 15610:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715610));
				orderActorToFactory(1105718610, EnemyVesta, "Vesta_574");
				break;
			case 15620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141715620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141718620, EnemyCeres, "Ceres_575", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142715650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142718650, EnemyCeres, "Ceres_576", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15670:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715670));
				orderActorToFactory(1105718670, EnemyVesta, "Vesta_577");
				break;
			case 15700:
				{
				...
				orderActorToFactory(1111718700, EnemyAstraea, "Astraea_578");
				break;
			case 15730:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715730));
				orderActorToFactory(1105718730, EnemyVesta, "Vesta_579");
				break;
			case 15790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715790));
				orderActorToFactory(1105718790, EnemyVesta, "Vesta_580");
				break;
			case 15800:
				{
				...
				orderActorToFactory(1110718800, EnemyAstraea, "Astraea_581");
				break;
			case 15850:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715850));
				orderActorToFactory(1105718850, EnemyVesta, "Vesta_582");
				break;
			case 15900:
				{
				...
				orderActorToFactory(1109718900, EnemyAstraea, "Astraea_583");
				break;
			case 15910:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715910));
				orderActorToFactory(1105718910, EnemyVesta, "Vesta_584");
				break;
			case 15970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105715970));
				orderActorToFactory(1105718970, EnemyVesta, "Vesta_585");
				break;
			case 16000:
				{
				...
				orderActorToFactory(1121719000, EnemyAstraea, "Astraea_586");
				break;
			case 16030:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716030));
				orderActorToFactory(1105719030, EnemyVesta, "Vesta_587");
				break;
			case 16090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716090));
				orderActorToFactory(1105719090, EnemyVesta, "Vesta_588");
				break;
			case 16100:
				{
				...
				orderActorToFactory(1120719100, EnemyAstraea, "Astraea_589");
				break;
			case 16150:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716150));
				orderActorToFactory(1105719150, EnemyVesta, "Vesta_590");
				break;
			case 16200:
				{
				...
				orderActorToFactory(1119719200, EnemyAstraea, "Astraea_591");
				break;
			case 16210:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716210));
				orderActorToFactory(1105719210, EnemyVesta, "Vesta_592");
				break;
			case 16270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716270));
				orderActorToFactory(1105719270, EnemyVesta, "Vesta_593");
				break;
			case 16300:
				{
				...
				orderActorToFactory(1118719300, EnemyAstraea, "Astraea_594");
				break;
			case 16330:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716330));
				orderActorToFactory(1105719330, EnemyVesta, "Vesta_595");
				break;
			case 16390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716390));
				orderActorToFactory(1105719390, EnemyVesta, "Vesta_596");
				break;
			case 16400:
				{
				...
				orderActorToFactory(1114719400, EnemyAstraea, "Astraea_597");
				{
				...
				orderActorToFactory(1117719400, EnemyAstraea, "Astraea_598");
				break;
			case 16450:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716450));
				orderActorToFactory(1105719450, EnemyVesta, "Vesta_599");
				break;
			case 16500:
				{
				...
				orderActorToFactory(1113719500, EnemyAstraea, "Astraea_600");
				{
				...
				orderActorToFactory(1116719500, EnemyAstraea, "Astraea_601");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137716500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1137719500, EnemyCeres, "Ceres_602", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16510:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716510));
				orderActorToFactory(1105719510, EnemyVesta, "Vesta_603");
				break;
			case 16530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138716530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1138719530, EnemyCeres, "Ceres_604", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139716560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1139719560, EnemyCeres, "Ceres_605", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16570:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716570));
				orderActorToFactory(1105719570, EnemyVesta, "Vesta_606");
				break;
			case 16590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140716590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1140719590, EnemyCeres, "Ceres_607", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16600:
				{
				...
				orderActorToFactory(1112719600, EnemyAstraea, "Astraea_608");
				break;
			case 16620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141716620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1141719620, EnemyCeres, "Ceres_609", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16630:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716630));
				orderActorToFactory(1105719630, EnemyVesta, "Vesta_610");
				break;
			case 16650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142716650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
				}
				orderActorWithDpToFactory(1142719650, EnemyCeres, "Ceres_611", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 16690:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716690));
				orderActorToFactory(1105719690, EnemyVesta, "Vesta_612");
				break;
			case 16700:
				{
				...
				orderActorToFactory(1111719700, EnemyAstraea, "Astraea_613");
				break;
			case 16750:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716750));
				orderActorToFactory(1105719750, EnemyVesta, "Vesta_614");
				break;
			case 16800:
				{
				...
				orderActorToFactory(1110719800, EnemyAstraea, "Astraea_615");
				break;
			case 16810:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716810));
				orderActorToFactory(1105719810, EnemyVesta, "Vesta_616");
				break;
			case 16870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716870));
				orderActorToFactory(1105719870, EnemyVesta, "Vesta_617");
				break;
			case 16900:
				{
				...
				orderActorToFactory(1109719900, EnemyAstraea, "Astraea_618");
				break;
			case 16930:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716930));
				orderActorToFactory(1105719930, EnemyVesta, "Vesta_619");
				break;
			case 16990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105716990));
				orderActorToFactory(1105719990, EnemyVesta, "Vesta_620");
				break;
			case 17000:
				{
				...
				orderActorToFactory(1121720000, EnemyAstraea, "Astraea_621");
				break;
			case 17050:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717050));
				orderActorToFactory(1105720050, EnemyVesta, "Vesta_622");
				break;
			case 17100:
				{
			...
			case 17110:
				...
				orderActorToFactory(1105720110, EnemyVesta, "Vesta_623");
				break;
			case 17170:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717170));
				orderActorToFactory(1105720170, EnemyVesta, "Vesta_624");
				break;
			case 17200:
				{
			...
			case 17230:
				...
				orderActorToFactory(1105720230, EnemyVesta, "Vesta_625");
				break;
			case 17290:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717290));
				orderActorToFactory(1105720290, EnemyVesta, "Vesta_626");
				break;
			case 17300:
				{
			...
			case 17350:
				...
				orderActorToFactory(1105720350, EnemyVesta, "Vesta_627");
				break;
			case 17400:
				{
			...
			case 17410:
				...
				orderActorToFactory(1105720410, EnemyVesta, "Vesta_628");
				break;
			case 17470:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717470));
				orderActorToFactory(1105720470, EnemyVesta, "Vesta_629");
				break;
			case 17500:
				{
				...
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137717500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17530:
				...
				orderActorToFactory(1105720530, EnemyVesta, "Vesta_630");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138717530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139717560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17590:
				...
				orderActorToFactory(1105720590, EnemyVesta, "Vesta_631");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140717590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141717620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17650:
				...
				orderActorToFactory(1105720650, EnemyVesta, "Vesta_632");
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142717650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 17710:
				...
				orderActorToFactory(1105720710, EnemyVesta, "Vesta_633");
				break;
			case 17770:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717770));
				orderActorToFactory(1105720770, EnemyVesta, "Vesta_634");
				break;
			case 17800:
				{
			...
			case 17830:
				...
				orderActorToFactory(1105720830, EnemyVesta, "Vesta_635");
				break;
			case 17890:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105717890));
				orderActorToFactory(1105720890, EnemyVesta, "Vesta_636");
				break;
			case 17900:
				{
			...
			case 17950:
				...
				orderActorToFactory(1105720950, EnemyVesta, "Vesta_637");
				break;
			case 18000:
				{
			...
			case 18010:
				...
				orderActorToFactory(1105721010, EnemyVesta, "Vesta_638");
				break;
			case 18070:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718070));
				orderActorToFactory(1105721070, EnemyVesta, "Vesta_639");
				break;
			case 18100:
				{
			...
			case 18130:
				...
				orderActorToFactory(1105721130, EnemyVesta, "Vesta_640");
				break;
			case 18190:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718190));
				orderActorToFactory(1105721190, EnemyVesta, "Vesta_641");
				break;
			case 18200:
				{
			...
			case 18250:
				...
				orderActorToFactory(1105721250, EnemyVesta, "Vesta_642");
				break;
			case 18300:
				{
			...
			case 18310:
				...
				orderActorToFactory(1105721310, EnemyVesta, "Vesta_643");
				break;
			case 18370:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718370));
				orderActorToFactory(1105721370, EnemyVesta, "Vesta_644");
				break;
			case 18400:
				{
			...
			case 18430:
				...
				orderActorToFactory(1105721430, EnemyVesta, "Vesta_645");
				break;
			case 18490:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718490));
				orderActorToFactory(1105721490, EnemyVesta, "Vesta_646");
				break;
			case 18500:
				{
				...
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137718500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138718530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18550:
				...
				orderActorToFactory(1105721550, EnemyVesta, "Vesta_647");
				break;
			case 18560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139718560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140718590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18610:
				...
				orderActorToFactory(1105721610, EnemyVesta, "Vesta_648");
				break;
			case 18620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141718620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142718650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 18670:
				...
				orderActorToFactory(1105721670, EnemyVesta, "Vesta_649");
				break;
			case 18700:
				{
			...
			case 18730:
				...
				orderActorToFactory(1105721730, EnemyVesta, "Vesta_650");
				break;
			case 18790:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718790));
				orderActorToFactory(1105721790, EnemyVesta, "Vesta_651");
				break;
			case 18800:
				{
			...
			case 18850:
				...
				orderActorToFactory(1105721850, EnemyVesta, "Vesta_652");
				break;
			case 18900:
				{
			...
			case 18910:
				...
				orderActorToFactory(1105721910, EnemyVesta, "Vesta_653");
				break;
			case 18970:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105718970));
				orderActorToFactory(1105721970, EnemyVesta, "Vesta_654");
				break;
			case 19000:
				{
			...
			case 19030:
				...
				orderActorToFactory(1105722030, EnemyVesta, "Vesta_655");
				break;
			case 19090:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105719090));
				orderActorToFactory(1105722090, EnemyVesta, "Vesta_656");
				break;
			case 19100:
				{
			...
			case 19150:
				...
				orderActorToFactory(1105722150, EnemyVesta, "Vesta_657");
				break;
			case 19200:
				{
			...
			case 19210:
				...
				orderActorToFactory(1105722210, EnemyVesta, "Vesta_658");
				break;
			case 19270:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105719270));
				orderActorToFactory(1105722270, EnemyVesta, "Vesta_659");
				break;
			case 19300:
				{
			...
			case 19330:
				...
				orderActorToFactory(1105722330, EnemyVesta, "Vesta_660");
				break;
			case 19390:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105719390));
				orderActorToFactory(1105722390, EnemyVesta, "Vesta_661");
				break;
			case 19400:
				{
			...
			case 19450:
				...
				orderActorToFactory(1105722450, EnemyVesta, "Vesta_662");
				break;
			case 19500:
				{
				...
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1137719500);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19510:
				...
				orderActorToFactory(1105722510, EnemyVesta, "Vesta_663");
				break;
			case 19530:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1138719530);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19560:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1139719560);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19570:
				...
				orderActorToFactory(1105722570, EnemyVesta, "Vesta_664");
				break;
			case 19590:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1140719590);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19620:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1141719620);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19630:
				...
				orderActorToFactory(1105722630, EnemyVesta, "Vesta_665");
				break;
			case 19650:
				{
				EnemyCeres* pActor = (EnemyCeres*)obtainActorFromFactory(1142719650);
				getLordActor()->accept(KIND_ENEMY_BODY,  pActor);
				pActor->_Z = -1500000;
				pActor->_Y_turn = -250000;
				pActor->_veloBegin = 8000;
			...
			case 19690:
				...
				orderActorToFactory(1105722690, EnemyVesta, "Vesta_666");
				break;
			case 19700:
				{
			...
			case 19750:
				...
				orderActorToFactory(1105722750, EnemyVesta, "Vesta_667");
				break;
			case 19800:
				{
			...
			case 19810:
				...
				orderActorToFactory(1105722810, EnemyVesta, "Vesta_668");
				break;
			case 19870:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105719870));
				orderActorToFactory(1105722870, EnemyVesta, "Vesta_669");
				break;
			case 19900:
				{
			...
			case 19930:
				...
				orderActorToFactory(1105722930, EnemyVesta, "Vesta_670");
				break;
			case 19990:
				getLordActor()->accept(KIND_ENEMY_BODY, obtainActorFromFactory(1105719990));
				orderActorToFactory(1105722990, EnemyVesta, "Vesta_671");
				break;
			case 20000:
				{
