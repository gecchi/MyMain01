...
Stage01MainScene::Stage01MainScene(const char* prm_name) : DefaultScene(prm_name) {
	...
	orderActorToFactory(113571000, FormationJuno001, "F002_Juno_43");
    // gen01 end
}
	...
	if (getPartFrame() == _paFrame_NextEvent[_iCnt_Event]) {
		switch (getPartFrame()) {
			...
			case 1000:
				...
				{
				FormationJuno001* pFormationActor = (FormationJuno001*)obtainActorFromFactory(113571000);
				getLordActor()->addSubGroup(pFormationActor);
				}
				break;
			case 1010:
			...
			case 17000:
				...
				orderActorToFactory(1136720000, FormationJuno001, "F002_Juno_301");
				break;
			case 17010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717010));
				orderActorToFactory(1105720010, EnemyMetis, "Metis_302");
				break;
			case 17110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717110));
				orderActorToFactory(1105720110, EnemyMetis, "Metis_303");
				break;
			case 17200:
				{
			...
			case 17210:
				...
				orderActorToFactory(1105720210, EnemyMetis, "Metis_304");
				break;
			case 17310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717310));
				orderActorToFactory(1105720310, EnemyMetis, "Metis_305");
				break;
			case 17400:
				{
			...
			case 17410:
				...
				orderActorToFactory(1105720410, EnemyMetis, "Metis_306");
				break;
			case 17510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717510));
				orderActorToFactory(1105720510, EnemyMetis, "Metis_307");
				break;
			case 17610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717610));
				orderActorToFactory(1105720610, EnemyMetis, "Metis_308");
				break;
			case 17710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717710));
				orderActorToFactory(1105720710, EnemyMetis, "Metis_309");
				break;
			case 17810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717810));
				orderActorToFactory(1105720810, EnemyMetis, "Metis_310");
				break;
			case 17900:
				{
			...
			case 17910:
				...
				orderActorToFactory(1105720910, EnemyMetis, "Metis_311");
				break;
			case 18010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718010));
				orderActorToFactory(1105721010, EnemyMetis, "Metis_312");
				{
			...
			case 18110:
				...
				orderActorToFactory(1105721110, EnemyMetis, "Metis_313");
				break;
			case 18210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718210));
				orderActorToFactory(1105721210, EnemyMetis, "Metis_314");
				break;
			case 18310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718310));
				orderActorToFactory(1105721310, EnemyMetis, "Metis_315");
				break;
			case 18400:
				{
			...
			case 18410:
				...
				orderActorToFactory(1105721410, EnemyMetis, "Metis_316");
				break;
			case 18500:
				{
			...
			case 18510:
				...
				orderActorToFactory(1105721510, EnemyMetis, "Metis_317");
				break;
			case 18530:
				{
			...
			case 18610:
				...
				orderActorToFactory(1105721610, EnemyMetis, "Metis_318");
				break;
			case 18620:
				{
			...
			case 18710:
				...
				orderActorToFactory(1105721710, EnemyMetis, "Metis_319");
				break;
			case 18810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718810));
				orderActorToFactory(1105721810, EnemyMetis, "Metis_320");
				break;
			case 18910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718910));
				orderActorToFactory(1105721910, EnemyMetis, "Metis_321");
				break;
			case 19000:
				{
			...
			case 19010:
				...
				orderActorToFactory(1105722010, EnemyMetis, "Metis_322");
				break;
			case 19100:
				{
			...
			case 19110:
				...
				orderActorToFactory(1105722110, EnemyMetis, "Metis_323");
				break;
			case 19210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719210));
				orderActorToFactory(1105722210, EnemyMetis, "Metis_324");
				break;
			case 19310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719310));
				orderActorToFactory(1105722310, EnemyMetis, "Metis_325");
				break;
			case 19410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719410));
				orderActorToFactory(1105722410, EnemyMetis, "Metis_326");
				break;
			case 19510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719510));
				orderActorToFactory(1105722510, EnemyMetis, "Metis_327");
				break;
			case 19610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719610));
				orderActorToFactory(1105722610, EnemyMetis, "Metis_328");
				break;
			case 19710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719710));
				orderActorToFactory(1105722710, EnemyMetis, "Metis_329");
				break;
			case 19800:
				{
			...
			case 19810:
				...
				orderActorToFactory(1105722810, EnemyMetis, "Metis_330");
				break;
			case 19910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719910));
				orderActorToFactory(1105722910, EnemyMetis, "Metis_331");
				break;
			case 20000:
				{
