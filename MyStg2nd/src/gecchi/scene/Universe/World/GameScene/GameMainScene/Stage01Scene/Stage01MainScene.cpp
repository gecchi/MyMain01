...
Stage01MainScene::Stage01MainScene(const char* prm_name) : DefaultScene(prm_name) {
	...
	orderActorToFactory(110972900, EnemyAstraea, "Astraea_151");
	orderActorToFactory(111671500, EnemyAstraea, "Astraea_152");
	orderActorToFactory(1124710, FormationIris001, "F001_Iris_153");
	orderActorToFactory(112472010, FormationIris001, "F001_Iris_154");
	orderActorToFactory(112571000, FormationIris002, "F002_Iris_155");
	orderActorToFactory(112573000, FormationIris002, "F002_Iris_156");
	orderActorWithDpToFactory(11277500, EnemyCeres, "Ceres_157", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11287530, EnemyCeres, "Ceres_158", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11297560, EnemyCeres, "Ceres_159", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11307590, EnemyCeres, "Ceres_160", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11317620, EnemyCeres, "Ceres_161", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
	orderActorWithDpToFactory(11327650, EnemyCeres, "Ceres_162", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
    // gen01 end
}
...
void Stage01MainScene::processBehavior() {
	...
	if (getPartFrame() == _paFrame_NextEvent[_iCnt_Event]) {
		switch (getPartFrame()) {
			...
			case 10:
				...
				orderActorToFactory(110573010, EnemyMetis, "Metis_163");
				{
			...
			case 510:
				...
				orderActorToFactory(110573510, EnemyMetis, "Metis_189");
				break;
			case 530:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057530));
				orderActorToFactory(110573530, EnemyMetis, "Metis_190");
				{
			...
			case 550:
				...
				orderActorToFactory(110573550, EnemyMetis, "Metis_191");
				break;
			case 560:
				{
			...
			case 570:
				...
				orderActorToFactory(110573570, EnemyMetis, "Metis_192");
				break;
			case 590:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057590));
				orderActorToFactory(110573590, EnemyMetis, "Metis_193");
				{
			...
			case 610:
				...
				orderActorToFactory(110573610, EnemyMetis, "Metis_194");
				break;
			case 620:
				{
			...
			case 630:
				...
				orderActorToFactory(110573630, EnemyMetis, "Metis_195");
				break;
			case 650:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057650));
				orderActorToFactory(110573650, EnemyMetis, "Metis_196");
				{
			...
			case 1500:
				...
				orderActorWithDpToFactory(112774500, EnemyCeres, "Ceres_240", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571510));
				orderActorToFactory(110574510, EnemyMetis, "Metis_241");
				break;
			case 1530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571530));
				orderActorToFactory(110574530, EnemyMetis, "Metis_242");
				orderActorWithDpToFactory(112874530, EnemyCeres, "Ceres_243", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1550:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571550));
				orderActorToFactory(110574550, EnemyMetis, "Metis_244");
				break;
			case 1560:
				orderActorWithDpToFactory(112974560, EnemyCeres, "Ceres_245", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1570:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571570));
				orderActorToFactory(110574570, EnemyMetis, "Metis_246");
				break;
			case 1590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571590));
				orderActorToFactory(110574590, EnemyMetis, "Metis_247");
				orderActorWithDpToFactory(113074590, EnemyCeres, "Ceres_248", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571610));
				orderActorToFactory(110574610, EnemyMetis, "Metis_249");
				break;
			case 1620:
				orderActorWithDpToFactory(113174620, EnemyCeres, "Ceres_250", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1630:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571630));
				orderActorToFactory(110574630, EnemyMetis, "Metis_251");
				break;
			case 1650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571650));
				orderActorToFactory(110574650, EnemyMetis, "Metis_252");
				orderActorWithDpToFactory(113274650, EnemyCeres, "Ceres_253", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 1670:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571670));
				orderActorToFactory(110574670, EnemyMetis, "Metis_254");
				break;
			case 1690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571690));
				orderActorToFactory(110574690, EnemyMetis, "Metis_255");
				break;
			case 1710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571710));
				orderActorToFactory(110574710, EnemyMetis, "Metis_256");
				break;
			case 1730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571730));
				orderActorToFactory(110574730, EnemyMetis, "Metis_257");
				break;
			case 1750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571750));
				orderActorToFactory(110574750, EnemyMetis, "Metis_258");
				break;
			case 1770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571770));
				orderActorToFactory(110574770, EnemyMetis, "Metis_259");
				break;
			case 1790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571790));
				orderActorToFactory(110574790, EnemyMetis, "Metis_260");
				break;
			case 1800:
				orderActorToFactory(111074800, EnemyAstraea, "Astraea_261");
				break;
			case 1810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571810));
				orderActorToFactory(110574810, EnemyMetis, "Metis_262");
				break;
			case 1830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571830));
				orderActorToFactory(110574830, EnemyMetis, "Metis_263");
				break;
			case 1850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571850));
				orderActorToFactory(110574850, EnemyMetis, "Metis_264");
				break;
			case 1870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571870));
				orderActorToFactory(110574870, EnemyMetis, "Metis_265");
				break;
			case 1890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571890));
				orderActorToFactory(110574890, EnemyMetis, "Metis_266");
				break;
			case 1910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571910));
				orderActorToFactory(110574910, EnemyMetis, "Metis_267");
				break;
			case 1930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571930));
				orderActorToFactory(110574930, EnemyMetis, "Metis_268");
				break;
			case 1950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571950));
				orderActorToFactory(110574950, EnemyMetis, "Metis_269");
				break;
			case 1970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571970));
				orderActorToFactory(110574970, EnemyMetis, "Metis_270");
				break;
			case 1990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571990));
				orderActorToFactory(110574990, EnemyMetis, "Metis_271");
				break;
			case 2000:
				orderActorToFactory(112575000, FormationIris002, "F002_Iris_272");
				break;
			case 2010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572010));
				orderActorToFactory(110575010, EnemyMetis, "Metis_273");
				{
			...
			case 2910:
				...
				orderActorToFactory(110575910, EnemyMetis, "Metis_319");
				break;
			case 2930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572930));
				orderActorToFactory(110575930, EnemyMetis, "Metis_320");
				break;
			case 2950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572950));
				orderActorToFactory(110575950, EnemyMetis, "Metis_321");
				break;
			case 2970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572970));
				orderActorToFactory(110575970, EnemyMetis, "Metis_322");
				break;
			case 2990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572990));
				orderActorToFactory(110575990, EnemyMetis, "Metis_323");
				break;
			case 3000:
				{
			...
			case 3410:
				...
				orderActorToFactory(110576410, EnemyMetis, "Metis_345");
				break;
			case 3430:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573430));
				orderActorToFactory(110576430, EnemyMetis, "Metis_346");
				break;
			case 3450:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573450));
				orderActorToFactory(110576450, EnemyMetis, "Metis_347");
				break;
			case 3470:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573470));
				orderActorToFactory(110576470, EnemyMetis, "Metis_348");
				break;
			case 3490:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573490));
				orderActorToFactory(110576490, EnemyMetis, "Metis_349");
				break;
			case 3500:
				orderActorToFactory(111676500, EnemyAstraea, "Astraea_350");
				break;
			case 3510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573510));
				orderActorToFactory(110576510, EnemyMetis, "Metis_351");
				break;
			case 3530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573530));
				orderActorToFactory(110576530, EnemyMetis, "Metis_352");
				break;
			case 3550:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573550));
				orderActorToFactory(110576550, EnemyMetis, "Metis_353");
				break;
			case 3570:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573570));
				orderActorToFactory(110576570, EnemyMetis, "Metis_354");
				break;
			case 3590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573590));
				orderActorToFactory(110576590, EnemyMetis, "Metis_355");
				break;
			case 3610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573610));
				orderActorToFactory(110576610, EnemyMetis, "Metis_356");
				break;
			case 3630:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573630));
				orderActorToFactory(110576630, EnemyMetis, "Metis_357");
				break;
			case 3650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573650));
				orderActorToFactory(110576650, EnemyMetis, "Metis_358");
				break;
			case 3670:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573670));
				orderActorToFactory(110576670, EnemyMetis, "Metis_359");
				break;
			case 3690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573690));
				orderActorToFactory(110576690, EnemyMetis, "Metis_360");
				break;
			case 3700:
				orderActorToFactory(111176700, EnemyAstraea, "Astraea_361");
				break;
			case 3710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573710));
				orderActorToFactory(110576710, EnemyMetis, "Metis_362");
				break;
			case 3730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573730));
				orderActorToFactory(110576730, EnemyMetis, "Metis_363");
				break;
			case 3750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573750));
				orderActorToFactory(110576750, EnemyMetis, "Metis_364");
				break;
			case 3770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573770));
				orderActorToFactory(110576770, EnemyMetis, "Metis_365");
				break;
			case 3790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573790));
				orderActorToFactory(110576790, EnemyMetis, "Metis_366");
				break;
			case 3810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573810));
				orderActorToFactory(110576810, EnemyMetis, "Metis_367");
				break;
			case 3830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573830));
				orderActorToFactory(110576830, EnemyMetis, "Metis_368");
				break;
			case 3850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573850));
				orderActorToFactory(110576850, EnemyMetis, "Metis_369");
				break;
			case 3870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573870));
				orderActorToFactory(110576870, EnemyMetis, "Metis_370");
				break;
			case 3890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573890));
				orderActorToFactory(110576890, EnemyMetis, "Metis_371");
				break;
			case 3910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573910));
				orderActorToFactory(110576910, EnemyMetis, "Metis_372");
				break;
			case 3930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573930));
				orderActorToFactory(110576930, EnemyMetis, "Metis_373");
				break;
			case 3950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573950));
				orderActorToFactory(110576950, EnemyMetis, "Metis_374");
				break;
			case 3970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573970));
				orderActorToFactory(110576970, EnemyMetis, "Metis_375");
				break;
			case 3990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573990));
				orderActorToFactory(110576990, EnemyMetis, "Metis_376");
				break;
			case 4000:
				orderActorToFactory(112577000, FormationIris002, "F002_Iris_377");
				break;
			case 4010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574010));
				orderActorToFactory(110577010, EnemyMetis, "Metis_378");
				{
			...
			case 4510:
				...
				orderActorToFactory(110577510, EnemyMetis, "Metis_404");
				break;
			case 4530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574530));
				orderActorToFactory(110577530, EnemyMetis, "Metis_405");
				{
			...
			case 4550:
				...
				orderActorToFactory(110577550, EnemyMetis, "Metis_406");
				break;
			case 4560:
				{
			...
			case 4570:
				...
				orderActorToFactory(110577570, EnemyMetis, "Metis_407");
				break;
			case 4590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574590));
				orderActorToFactory(110577590, EnemyMetis, "Metis_408");
				{
			...
			case 4610:
				...
				orderActorToFactory(110577610, EnemyMetis, "Metis_409");
				break;
			case 4620:
				{
			...
			case 4630:
				...
				orderActorToFactory(110577630, EnemyMetis, "Metis_410");
				break;
			case 4650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574650));
				orderActorToFactory(110577650, EnemyMetis, "Metis_411");
				{
			...
			case 4670:
				...
				orderActorToFactory(110577670, EnemyMetis, "Metis_412");
				break;
			case 4690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574690));
				orderActorToFactory(110577690, EnemyMetis, "Metis_413");
				break;
			case 4710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574710));
				orderActorToFactory(110577710, EnemyMetis, "Metis_414");
				break;
			case 4730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574730));
				orderActorToFactory(110577730, EnemyMetis, "Metis_415");
				break;
			case 4750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574750));
				orderActorToFactory(110577750, EnemyMetis, "Metis_416");
				break;
			case 4770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574770));
				orderActorToFactory(110577770, EnemyMetis, "Metis_417");
				break;
			case 4790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574790));
				orderActorToFactory(110577790, EnemyMetis, "Metis_418");
				break;
			case 4800:
				{
			...
			case 4810:
				...
				orderActorToFactory(110577810, EnemyMetis, "Metis_419");
				break;
			case 4830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574830));
				orderActorToFactory(110577830, EnemyMetis, "Metis_420");
				break;
			case 4850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574850));
				orderActorToFactory(110577850, EnemyMetis, "Metis_421");
				break;
			case 4870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574870));
				orderActorToFactory(110577870, EnemyMetis, "Metis_422");
				break;
			case 4890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574890));
				orderActorToFactory(110577890, EnemyMetis, "Metis_423");
				break;
			case 4900:
				orderActorToFactory(110977900, EnemyAstraea, "Astraea_424");
				break;
			case 4910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574910));
				orderActorToFactory(110577910, EnemyMetis, "Metis_425");
				break;
			case 4930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574930));
				orderActorToFactory(110577930, EnemyMetis, "Metis_426");
				break;
			case 4950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574950));
				orderActorToFactory(110577950, EnemyMetis, "Metis_427");
				break;
			case 4970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574970));
				orderActorToFactory(110577970, EnemyMetis, "Metis_428");
				break;
			case 4990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574990));
				orderActorToFactory(110577990, EnemyMetis, "Metis_429");
				break;
			case 5000:
				{
			...
			case 5010:
				...
				orderActorToFactory(110578010, EnemyMetis, "Metis_430");
				orderActorToFactory(112478010, FormationIris001, "F001_Iris_431");
				break;
			case 5030:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575030));
				orderActorToFactory(110578030, EnemyMetis, "Metis_432");
				break;
			case 5050:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575050));
				orderActorToFactory(110578050, EnemyMetis, "Metis_433");
				break;
			case 5070:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575070));
				orderActorToFactory(110578070, EnemyMetis, "Metis_434");
				break;
			case 5090:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575090));
				orderActorToFactory(110578090, EnemyMetis, "Metis_435");
				break;
			case 5110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575110));
				orderActorToFactory(110578110, EnemyMetis, "Metis_436");
				break;
			case 5130:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575130));
				orderActorToFactory(110578130, EnemyMetis, "Metis_437");
				break;
			case 5150:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575150));
				orderActorToFactory(110578150, EnemyMetis, "Metis_438");
				break;
			case 5170:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575170));
				orderActorToFactory(110578170, EnemyMetis, "Metis_439");
				break;
			case 5190:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575190));
				orderActorToFactory(110578190, EnemyMetis, "Metis_440");
				break;
			case 5210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575210));
				orderActorToFactory(110578210, EnemyMetis, "Metis_441");
				break;
			case 5230:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575230));
				orderActorToFactory(110578230, EnemyMetis, "Metis_442");
				break;
			case 5250:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575250));
				orderActorToFactory(110578250, EnemyMetis, "Metis_443");
				break;
			case 5270:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575270));
				orderActorToFactory(110578270, EnemyMetis, "Metis_444");
				break;
			case 5290:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575290));
				orderActorToFactory(110578290, EnemyMetis, "Metis_445");
				break;
			case 5300:
				{
			...
			case 5310:
				...
				orderActorToFactory(110578310, EnemyMetis, "Metis_446");
				break;
			case 5330:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575330));
				orderActorToFactory(110578330, EnemyMetis, "Metis_447");
				break;
			case 5350:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575350));
				orderActorToFactory(110578350, EnemyMetis, "Metis_448");
				break;
			case 5370:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575370));
				orderActorToFactory(110578370, EnemyMetis, "Metis_449");
				break;
			case 5390:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575390));
				orderActorToFactory(110578390, EnemyMetis, "Metis_450");
				break;
			case 5400:
				orderActorToFactory(111778400, EnemyAstraea, "Astraea_451");
				break;
			case 5410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575410));
				orderActorToFactory(110578410, EnemyMetis, "Metis_452");
				break;
			case 5430:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575430));
				orderActorToFactory(110578430, EnemyMetis, "Metis_453");
				break;
			case 5450:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575450));
				orderActorToFactory(110578450, EnemyMetis, "Metis_454");
				break;
			case 5470:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575470));
				orderActorToFactory(110578470, EnemyMetis, "Metis_455");
				break;
			case 5490:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575490));
				orderActorToFactory(110578490, EnemyMetis, "Metis_456");
				break;
			case 5500:
				orderActorWithDpToFactory(112778500, EnemyCeres, "Ceres_457", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575510));
				orderActorToFactory(110578510, EnemyMetis, "Metis_458");
				break;
			case 5530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575530));
				orderActorToFactory(110578530, EnemyMetis, "Metis_459");
				orderActorWithDpToFactory(112878530, EnemyCeres, "Ceres_460", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5550:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575550));
				orderActorToFactory(110578550, EnemyMetis, "Metis_461");
				break;
			case 5560:
				orderActorWithDpToFactory(112978560, EnemyCeres, "Ceres_462", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5570:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575570));
				orderActorToFactory(110578570, EnemyMetis, "Metis_463");
				break;
			case 5590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575590));
				orderActorToFactory(110578590, EnemyMetis, "Metis_464");
				orderActorWithDpToFactory(113078590, EnemyCeres, "Ceres_465", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5600:
				orderActorToFactory(111278600, EnemyAstraea, "Astraea_466");
				break;
			case 5610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575610));
				orderActorToFactory(110578610, EnemyMetis, "Metis_467");
				break;
			case 5620:
				orderActorWithDpToFactory(113178620, EnemyCeres, "Ceres_468", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5630:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575630));
				orderActorToFactory(110578630, EnemyMetis, "Metis_469");
				break;
			case 5650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575650));
				orderActorToFactory(110578650, EnemyMetis, "Metis_470");
				orderActorWithDpToFactory(113278650, EnemyCeres, "Ceres_471", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 5670:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575670));
				orderActorToFactory(110578670, EnemyMetis, "Metis_472");
				break;
			case 5690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575690));
				orderActorToFactory(110578690, EnemyMetis, "Metis_473");
				break;
			case 5710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575710));
				orderActorToFactory(110578710, EnemyMetis, "Metis_474");
				break;
			case 5730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575730));
				orderActorToFactory(110578730, EnemyMetis, "Metis_475");
				break;
			case 5750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575750));
				orderActorToFactory(110578750, EnemyMetis, "Metis_476");
				break;
			case 5770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575770));
				orderActorToFactory(110578770, EnemyMetis, "Metis_477");
				break;
			case 5790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575790));
				orderActorToFactory(110578790, EnemyMetis, "Metis_478");
				break;
			case 5810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575810));
				orderActorToFactory(110578810, EnemyMetis, "Metis_479");
				break;
			case 5830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575830));
				orderActorToFactory(110578830, EnemyMetis, "Metis_480");
				break;
			case 5850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575850));
				orderActorToFactory(110578850, EnemyMetis, "Metis_481");
				break;
			case 5870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575870));
				orderActorToFactory(110578870, EnemyMetis, "Metis_482");
				break;
			case 5890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575890));
				orderActorToFactory(110578890, EnemyMetis, "Metis_483");
				break;
			case 5910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575910));
				orderActorToFactory(110578910, EnemyMetis, "Metis_484");
				break;
			case 5930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575930));
				orderActorToFactory(110578930, EnemyMetis, "Metis_485");
				break;
			case 5950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575950));
				orderActorToFactory(110578950, EnemyMetis, "Metis_486");
				break;
			case 5970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575970));
				orderActorToFactory(110578970, EnemyMetis, "Metis_487");
				break;
			case 5990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575990));
				orderActorToFactory(110578990, EnemyMetis, "Metis_488");
				break;
			case 6000:
				orderActorToFactory(112579000, FormationIris002, "F002_Iris_489");
				break;
			case 6010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576010));
				orderActorToFactory(110579010, EnemyMetis, "Metis_490");
				{
			...
			case 6710:
				...
				orderActorToFactory(110579710, EnemyMetis, "Metis_526");
				break;
			case 6730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576730));
				orderActorToFactory(110579730, EnemyMetis, "Metis_527");
				break;
			case 6750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576750));
				orderActorToFactory(110579750, EnemyMetis, "Metis_528");
				break;
			case 6770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576770));
				orderActorToFactory(110579770, EnemyMetis, "Metis_529");
				break;
			case 6790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576790));
				orderActorToFactory(110579790, EnemyMetis, "Metis_530");
				break;
			case 6800:
				orderActorToFactory(111079800, EnemyAstraea, "Astraea_531");
				break;
			case 6810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576810));
				orderActorToFactory(110579810, EnemyMetis, "Metis_532");
				break;
			case 6830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576830));
				orderActorToFactory(110579830, EnemyMetis, "Metis_533");
				break;
			case 6850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576850));
				orderActorToFactory(110579850, EnemyMetis, "Metis_534");
				break;
			case 6870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576870));
				orderActorToFactory(110579870, EnemyMetis, "Metis_535");
				break;
			case 6890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576890));
				orderActorToFactory(110579890, EnemyMetis, "Metis_536");
				break;
			case 6910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576910));
				orderActorToFactory(110579910, EnemyMetis, "Metis_537");
				break;
			case 6930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576930));
				orderActorToFactory(110579930, EnemyMetis, "Metis_538");
				break;
			case 6950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576950));
				orderActorToFactory(110579950, EnemyMetis, "Metis_539");
				break;
			case 6970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576970));
				orderActorToFactory(110579970, EnemyMetis, "Metis_540");
				break;
			case 6990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576990));
				orderActorToFactory(110579990, EnemyMetis, "Metis_541");
				break;
			case 7000:
				{
			...
			case 7010:
				...
				orderActorToFactory(1105710010, EnemyMetis, "Metis_542");
				orderActorToFactory(1124710010, FormationIris001, "F001_Iris_543");
				break;
			case 7030:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577030));
				orderActorToFactory(1105710030, EnemyMetis, "Metis_544");
				break;
			case 7050:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577050));
				orderActorToFactory(1105710050, EnemyMetis, "Metis_545");
				break;
			case 7070:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577070));
				orderActorToFactory(1105710070, EnemyMetis, "Metis_546");
				break;
			case 7090:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577090));
				orderActorToFactory(1105710090, EnemyMetis, "Metis_547");
				break;
			case 7110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577110));
				orderActorToFactory(1105710110, EnemyMetis, "Metis_548");
				break;
			case 7130:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577130));
				orderActorToFactory(1105710130, EnemyMetis, "Metis_549");
				break;
			case 7150:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577150));
				orderActorToFactory(1105710150, EnemyMetis, "Metis_550");
				break;
			case 7170:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577170));
				orderActorToFactory(1105710170, EnemyMetis, "Metis_551");
				break;
			case 7190:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577190));
				orderActorToFactory(1105710190, EnemyMetis, "Metis_552");
				break;
			case 7200:
				{
			...
			case 7910:
				...
				orderActorToFactory(1105710910, EnemyMetis, "Metis_590");
				break;
			case 7930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577930));
				orderActorToFactory(1105710930, EnemyMetis, "Metis_591");
				break;
			case 7950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577950));
				orderActorToFactory(1105710950, EnemyMetis, "Metis_592");
				break;
			case 7970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577970));
				orderActorToFactory(1105710970, EnemyMetis, "Metis_593");
				break;
			case 7990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577990));
				orderActorToFactory(1105710990, EnemyMetis, "Metis_594");
				break;
			case 8000:
				orderActorToFactory(1121711000, EnemyAstraea, "Astraea_595");
				orderActorToFactory(1125711000, FormationIris002, "F002_Iris_596");
				break;
			case 8010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578010));
				orderActorToFactory(1105711010, EnemyMetis, "Metis_597");
				{
			...
			case 8410:
				...
				orderActorToFactory(1105711410, EnemyMetis, "Metis_617");
				break;
			case 8430:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578430));
				orderActorToFactory(1105711430, EnemyMetis, "Metis_618");
				break;
			case 8450:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578450));
				orderActorToFactory(1105711450, EnemyMetis, "Metis_619");
				break;
			case 8470:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578470));
				orderActorToFactory(1105711470, EnemyMetis, "Metis_620");
				break;
			case 8490:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578490));
				orderActorToFactory(1105711490, EnemyMetis, "Metis_621");
				break;
			case 8500:
				orderActorToFactory(1116711500, EnemyAstraea, "Astraea_622");
				{
			...
			case 8510:
				...
				orderActorToFactory(1105711510, EnemyMetis, "Metis_623");
				break;
			case 8530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578530));
				orderActorToFactory(1105711530, EnemyMetis, "Metis_624");
				{
			...
			case 8550:
				...
				orderActorToFactory(1105711550, EnemyMetis, "Metis_625");
				break;
			case 8560:
				{
			...
			case 8570:
				...
				orderActorToFactory(1105711570, EnemyMetis, "Metis_626");
				break;
			case 8590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578590));
				orderActorToFactory(1105711590, EnemyMetis, "Metis_627");
				{
			...
			case 8610:
				...
				orderActorToFactory(1105711610, EnemyMetis, "Metis_628");
				break;
			case 8620:
				{
			...
			case 8630:
				...
				orderActorToFactory(1105711630, EnemyMetis, "Metis_629");
				break;
			case 8650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578650));
				orderActorToFactory(1105711650, EnemyMetis, "Metis_630");
				{
			...
			case 8670:
				...
				orderActorToFactory(1105711670, EnemyMetis, "Metis_631");
				break;
			case 8690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578690));
				orderActorToFactory(1105711690, EnemyMetis, "Metis_632");
				break;
			case 8700:
				orderActorToFactory(1111711700, EnemyAstraea, "Astraea_633");
				break;
			case 8710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578710));
				orderActorToFactory(1105711710, EnemyMetis, "Metis_634");
				break;
			case 8730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578730));
				orderActorToFactory(1105711730, EnemyMetis, "Metis_635");
				break;
			case 8750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578750));
				orderActorToFactory(1105711750, EnemyMetis, "Metis_636");
				break;
			case 8770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578770));
				orderActorToFactory(1105711770, EnemyMetis, "Metis_637");
				break;
			case 8790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578790));
				orderActorToFactory(1105711790, EnemyMetis, "Metis_638");
				break;
			case 8810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578810));
				orderActorToFactory(1105711810, EnemyMetis, "Metis_639");
				break;
			case 8830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578830));
				orderActorToFactory(1105711830, EnemyMetis, "Metis_640");
				break;
			case 8850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578850));
				orderActorToFactory(1105711850, EnemyMetis, "Metis_641");
				break;
			case 8870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578870));
				orderActorToFactory(1105711870, EnemyMetis, "Metis_642");
				break;
			case 8890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578890));
				orderActorToFactory(1105711890, EnemyMetis, "Metis_643");
				break;
			case 8910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578910));
				orderActorToFactory(1105711910, EnemyMetis, "Metis_644");
				break;
			case 8930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578930));
				orderActorToFactory(1105711930, EnemyMetis, "Metis_645");
				break;
			case 8950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578950));
				orderActorToFactory(1105711950, EnemyMetis, "Metis_646");
				break;
			case 8970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578970));
				orderActorToFactory(1105711970, EnemyMetis, "Metis_647");
				break;
			case 8990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578990));
				orderActorToFactory(1105711990, EnemyMetis, "Metis_648");
				break;
			case 9000:
				{
			...
			case 9010:
				...
				orderActorToFactory(1105712010, EnemyMetis, "Metis_649");
				orderActorToFactory(1124712010, FormationIris001, "F001_Iris_650");
				break;
			case 9030:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579030));
				orderActorToFactory(1105712030, EnemyMetis, "Metis_651");
				break;
			case 9050:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579050));
				orderActorToFactory(1105712050, EnemyMetis, "Metis_652");
				break;
			case 9070:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579070));
				orderActorToFactory(1105712070, EnemyMetis, "Metis_653");
				break;
			case 9090:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579090));
				orderActorToFactory(1105712090, EnemyMetis, "Metis_654");
				break;
			case 9100:
				{
			...
			case 9110:
				...
				orderActorToFactory(1105712110, EnemyMetis, "Metis_655");
				break;
			case 9130:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579130));
				orderActorToFactory(1105712130, EnemyMetis, "Metis_656");
				break;
			case 9150:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579150));
				orderActorToFactory(1105712150, EnemyMetis, "Metis_657");
				break;
			case 9170:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579170));
				orderActorToFactory(1105712170, EnemyMetis, "Metis_658");
				break;
			case 9190:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579190));
				orderActorToFactory(1105712190, EnemyMetis, "Metis_659");
				break;
			case 9200:
				orderActorToFactory(1119712200, EnemyAstraea, "Astraea_660");
				break;
			case 9210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579210));
				orderActorToFactory(1105712210, EnemyMetis, "Metis_661");
				break;
			case 9230:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579230));
				orderActorToFactory(1105712230, EnemyMetis, "Metis_662");
				break;
			case 9250:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579250));
				orderActorToFactory(1105712250, EnemyMetis, "Metis_663");
				break;
			case 9270:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579270));
				orderActorToFactory(1105712270, EnemyMetis, "Metis_664");
				break;
			case 9290:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579290));
				orderActorToFactory(1105712290, EnemyMetis, "Metis_665");
				break;
			case 9310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579310));
				orderActorToFactory(1105712310, EnemyMetis, "Metis_666");
				break;
			case 9330:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579330));
				orderActorToFactory(1105712330, EnemyMetis, "Metis_667");
				break;
			case 9350:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579350));
				orderActorToFactory(1105712350, EnemyMetis, "Metis_668");
				break;
			case 9370:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579370));
				orderActorToFactory(1105712370, EnemyMetis, "Metis_669");
				break;
			case 9390:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579390));
				orderActorToFactory(1105712390, EnemyMetis, "Metis_670");
				break;
			case 9400:
				orderActorToFactory(1114712400, EnemyAstraea, "Astraea_671");
				break;
			case 9410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579410));
				orderActorToFactory(1105712410, EnemyMetis, "Metis_672");
				break;
			case 9430:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579430));
				orderActorToFactory(1105712430, EnemyMetis, "Metis_673");
				break;
			case 9450:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579450));
				orderActorToFactory(1105712450, EnemyMetis, "Metis_674");
				break;
			case 9470:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579470));
				orderActorToFactory(1105712470, EnemyMetis, "Metis_675");
				break;
			case 9490:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579490));
				orderActorToFactory(1105712490, EnemyMetis, "Metis_676");
				break;
			case 9500:
				orderActorWithDpToFactory(1127712500, EnemyCeres, "Ceres_677", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579510));
				orderActorToFactory(1105712510, EnemyMetis, "Metis_678");
				break;
			case 9530:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579530));
				orderActorToFactory(1105712530, EnemyMetis, "Metis_679");
				orderActorWithDpToFactory(1128712530, EnemyCeres, "Ceres_680", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9550:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579550));
				orderActorToFactory(1105712550, EnemyMetis, "Metis_681");
				break;
			case 9560:
				orderActorWithDpToFactory(1129712560, EnemyCeres, "Ceres_682", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9570:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579570));
				orderActorToFactory(1105712570, EnemyMetis, "Metis_683");
				break;
			case 9590:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579590));
				orderActorToFactory(1105712590, EnemyMetis, "Metis_684");
				orderActorWithDpToFactory(1130712590, EnemyCeres, "Ceres_685", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579610));
				orderActorToFactory(1105712610, EnemyMetis, "Metis_686");
				break;
			case 9620:
				orderActorWithDpToFactory(1131712620, EnemyCeres, "Ceres_687", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9630:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579630));
				orderActorToFactory(1105712630, EnemyMetis, "Metis_688");
				break;
			case 9650:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579650));
				orderActorToFactory(1105712650, EnemyMetis, "Metis_689");
				orderActorWithDpToFactory(1132712650, EnemyCeres, "Ceres_690", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9670:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579670));
				orderActorToFactory(1105712670, EnemyMetis, "Metis_691");
				break;
			case 9690:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579690));
				orderActorToFactory(1105712690, EnemyMetis, "Metis_692");
				break;
			case 9710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579710));
				orderActorToFactory(1105712710, EnemyMetis, "Metis_693");
				break;
			case 9730:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579730));
				orderActorToFactory(1105712730, EnemyMetis, "Metis_694");
				break;
			case 9750:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579750));
				orderActorToFactory(1105712750, EnemyMetis, "Metis_695");
				break;
			case 9770:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579770));
				orderActorToFactory(1105712770, EnemyMetis, "Metis_696");
				break;
			case 9790:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579790));
				orderActorToFactory(1105712790, EnemyMetis, "Metis_697");
				break;
			case 9800:
				{
			...
			case 9810:
				...
				orderActorToFactory(1105712810, EnemyMetis, "Metis_698");
				break;
			case 9830:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579830));
				orderActorToFactory(1105712830, EnemyMetis, "Metis_699");
				break;
			case 9850:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579850));
				orderActorToFactory(1105712850, EnemyMetis, "Metis_700");
				break;
			case 9870:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579870));
				orderActorToFactory(1105712870, EnemyMetis, "Metis_701");
				break;
			case 9890:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579890));
				orderActorToFactory(1105712890, EnemyMetis, "Metis_702");
				break;
			case 9900:
				orderActorToFactory(1109712900, EnemyAstraea, "Astraea_703");
				break;
			case 9910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579910));
				orderActorToFactory(1105712910, EnemyMetis, "Metis_704");
				break;
			case 9930:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579930));
				orderActorToFactory(1105712930, EnemyMetis, "Metis_705");
				break;
			case 9950:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579950));
				orderActorToFactory(1105712950, EnemyMetis, "Metis_706");
				break;
			case 9970:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579970));
				orderActorToFactory(1105712970, EnemyMetis, "Metis_707");
				break;
			case 9990:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579990));
				orderActorToFactory(1105712990, EnemyMetis, "Metis_708");
				break;
			case 10000:
				orderActorToFactory(1125713000, FormationIris002, "F002_Iris_709");
				break;
			case 10010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710010));
				orderActorToFactory(1105713010, EnemyMetis, "Metis_710");
				{
			...
			case 10310:
				...
				orderActorToFactory(1105713310, EnemyMetis, "Metis_725");
				break;
			case 10330:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710330));
				orderActorToFactory(1105713330, EnemyMetis, "Metis_726");
				break;
			case 10350:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710350));
				orderActorToFactory(1105713350, EnemyMetis, "Metis_727");
				break;
			case 10370:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710370));
				orderActorToFactory(1105713370, EnemyMetis, "Metis_728");
				break;
			case 10390:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710390));
				orderActorToFactory(1105713390, EnemyMetis, "Metis_729");
				break;
			case 10400:
				orderActorToFactory(1117713400, EnemyAstraea, "Astraea_730");
				break;
			case 10410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710410));
				orderActorToFactory(1105713410, EnemyMetis, "Metis_731");
				break;
			case 10430:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710430));
				orderActorToFactory(1105713430, EnemyMetis, "Metis_732");
				break;
			case 10450:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710450));
				orderActorToFactory(1105713450, EnemyMetis, "Metis_733");
				break;
			case 10470:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710470));
				orderActorToFactory(1105713470, EnemyMetis, "Metis_734");
				break;
			case 10490:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710490));
				orderActorToFactory(1105713490, EnemyMetis, "Metis_735");
				break;
			case 10500:
				{
			...
			case 11710:
				...
				orderActorToFactory(1105714710, EnemyMetis, "Metis_799");
				break;
			case 11730:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711730));
				orderActorToFactory(1105714730, EnemyMetis, "Metis_800");
				break;
			case 11750:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711750));
				orderActorToFactory(1105714750, EnemyMetis, "Metis_801");
				break;
			case 11770:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711770));
				orderActorToFactory(1105714770, EnemyMetis, "Metis_802");
				break;
			case 11790:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711790));
				orderActorToFactory(1105714790, EnemyMetis, "Metis_803");
				break;
			case 11800:
				orderActorToFactory(1110714800, EnemyAstraea, "Astraea_804");
				break;
			case 11810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711810));
				orderActorToFactory(1105714810, EnemyMetis, "Metis_805");
				break;
			case 11830:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711830));
				orderActorToFactory(1105714830, EnemyMetis, "Metis_806");
				break;
			case 11850:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711850));
				orderActorToFactory(1105714850, EnemyMetis, "Metis_807");
				break;
			case 11870:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711870));
				orderActorToFactory(1105714870, EnemyMetis, "Metis_808");
				break;
			case 11890:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711890));
				orderActorToFactory(1105714890, EnemyMetis, "Metis_809");
				break;
			case 11910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711910));
				orderActorToFactory(1105714910, EnemyMetis, "Metis_810");
				break;
			case 11930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711930));
				orderActorToFactory(1105714930, EnemyMetis, "Metis_811");
				break;
			case 11950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711950));
				orderActorToFactory(1105714950, EnemyMetis, "Metis_812");
				break;
			case 11970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711970));
				orderActorToFactory(1105714970, EnemyMetis, "Metis_813");
				break;
			case 11990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711990));
				orderActorToFactory(1105714990, EnemyMetis, "Metis_814");
				break;
			case 12000:
				orderActorToFactory(1125715000, FormationIris002, "F002_Iris_815");
				break;
			case 12010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712010));
				orderActorToFactory(1105715010, EnemyMetis, "Metis_816");
				{
			...
			case 12210:
				...
				orderActorToFactory(1105715210, EnemyMetis, "Metis_826");
				break;
			case 12230:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712230));
				orderActorToFactory(1105715230, EnemyMetis, "Metis_827");
				break;
			case 12250:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712250));
				orderActorToFactory(1105715250, EnemyMetis, "Metis_828");
				break;
			case 12270:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712270));
				orderActorToFactory(1105715270, EnemyMetis, "Metis_829");
				break;
			case 12290:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712290));
				orderActorToFactory(1105715290, EnemyMetis, "Metis_830");
				break;
			case 12300:
				orderActorToFactory(1118715300, EnemyAstraea, "Astraea_831");
				break;
			case 12310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712310));
				orderActorToFactory(1105715310, EnemyMetis, "Metis_832");
				break;
			case 12330:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712330));
				orderActorToFactory(1105715330, EnemyMetis, "Metis_833");
				break;
			case 12350:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712350));
				orderActorToFactory(1105715350, EnemyMetis, "Metis_834");
				break;
			case 12370:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712370));
				orderActorToFactory(1105715370, EnemyMetis, "Metis_835");
				break;
			case 12390:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712390));
				orderActorToFactory(1105715390, EnemyMetis, "Metis_836");
				break;
			case 12400:
				{
			...
			case 12410:
				...
				orderActorToFactory(1105715410, EnemyMetis, "Metis_837");
				break;
			case 12430:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712430));
				orderActorToFactory(1105715430, EnemyMetis, "Metis_838");
				break;
			case 12450:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712450));
				orderActorToFactory(1105715450, EnemyMetis, "Metis_839");
				break;
			case 12470:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712470));
				orderActorToFactory(1105715470, EnemyMetis, "Metis_840");
				break;
			case 12490:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712490));
				orderActorToFactory(1105715490, EnemyMetis, "Metis_841");
				break;
			case 12500:
				orderActorToFactory(1113715500, EnemyAstraea, "Astraea_842");
				{
			...
			case 12510:
				...
				orderActorToFactory(1105715510, EnemyMetis, "Metis_843");
				break;
			case 12530:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712530));
				orderActorToFactory(1105715530, EnemyMetis, "Metis_844");
				{
			...
			case 12550:
				...
				orderActorToFactory(1105715550, EnemyMetis, "Metis_845");
				break;
			case 12560:
				{
			...
			case 12570:
				...
				orderActorToFactory(1105715570, EnemyMetis, "Metis_846");
				break;
			case 12590:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712590));
				orderActorToFactory(1105715590, EnemyMetis, "Metis_847");
				{
			...
			case 12610:
				...
				orderActorToFactory(1105715610, EnemyMetis, "Metis_848");
				break;
			case 12620:
				{
			...
			case 12630:
				...
				orderActorToFactory(1105715630, EnemyMetis, "Metis_849");
				break;
			case 12650:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712650));
				orderActorToFactory(1105715650, EnemyMetis, "Metis_850");
				{
			...
			case 12910:
				...
				orderActorToFactory(1105715910, EnemyMetis, "Metis_863");
				break;
			case 12930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712930));
				orderActorToFactory(1105715930, EnemyMetis, "Metis_864");
				break;
			case 12950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712950));
				orderActorToFactory(1105715950, EnemyMetis, "Metis_865");
				break;
			case 12970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712970));
				orderActorToFactory(1105715970, EnemyMetis, "Metis_866");
				break;
			case 12990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712990));
				orderActorToFactory(1105715990, EnemyMetis, "Metis_867");
				break;
			case 13000:
				orderActorToFactory(1121716000, EnemyAstraea, "Astraea_868");
				{
			...
			case 13410:
				...
				orderActorToFactory(1105716410, EnemyMetis, "Metis_890");
				break;
			case 13430:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713430));
				orderActorToFactory(1105716430, EnemyMetis, "Metis_891");
				break;
			case 13450:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713450));
				orderActorToFactory(1105716450, EnemyMetis, "Metis_892");
				break;
			case 13470:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713470));
				orderActorToFactory(1105716470, EnemyMetis, "Metis_893");
				break;
			case 13490:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713490));
				orderActorToFactory(1105716490, EnemyMetis, "Metis_894");
				break;
			case 13500:
				orderActorToFactory(1116716500, EnemyAstraea, "Astraea_895");
				orderActorWithDpToFactory(1127716500, EnemyCeres, "Ceres_896", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713510));
				orderActorToFactory(1105716510, EnemyMetis, "Metis_897");
				break;
			case 13530:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713530));
				orderActorToFactory(1105716530, EnemyMetis, "Metis_898");
				orderActorWithDpToFactory(1128716530, EnemyCeres, "Ceres_899", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13550:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713550));
				orderActorToFactory(1105716550, EnemyMetis, "Metis_900");
				break;
			case 13560:
				orderActorWithDpToFactory(1129716560, EnemyCeres, "Ceres_901", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13570:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713570));
				orderActorToFactory(1105716570, EnemyMetis, "Metis_902");
				break;
			case 13590:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713590));
				orderActorToFactory(1105716590, EnemyMetis, "Metis_903");
				orderActorWithDpToFactory(1130716590, EnemyCeres, "Ceres_904", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13600:
				{
			...
			case 13610:
				...
				orderActorToFactory(1105716610, EnemyMetis, "Metis_905");
				break;
			case 13620:
				orderActorWithDpToFactory(1131716620, EnemyCeres, "Ceres_906", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13630:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713630));
				orderActorToFactory(1105716630, EnemyMetis, "Metis_907");
				break;
			case 13650:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713650));
				orderActorToFactory(1105716650, EnemyMetis, "Metis_908");
				orderActorWithDpToFactory(1132716650, EnemyCeres, "Ceres_909", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 13670:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713670));
				orderActorToFactory(1105716670, EnemyMetis, "Metis_910");
				break;
			case 13690:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713690));
				orderActorToFactory(1105716690, EnemyMetis, "Metis_911");
				break;
			case 13700:
				orderActorToFactory(1111716700, EnemyAstraea, "Astraea_912");
				break;
			case 13710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713710));
				orderActorToFactory(1105716710, EnemyMetis, "Metis_913");
				break;
			case 13730:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713730));
				orderActorToFactory(1105716730, EnemyMetis, "Metis_914");
				break;
			case 13750:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713750));
				orderActorToFactory(1105716750, EnemyMetis, "Metis_915");
				break;
			case 13770:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713770));
				orderActorToFactory(1105716770, EnemyMetis, "Metis_916");
				break;
			case 13790:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713790));
				orderActorToFactory(1105716790, EnemyMetis, "Metis_917");
				break;
			case 13810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713810));
				orderActorToFactory(1105716810, EnemyMetis, "Metis_918");
				break;
			case 13830:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713830));
				orderActorToFactory(1105716830, EnemyMetis, "Metis_919");
				break;
			case 13850:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713850));
				orderActorToFactory(1105716850, EnemyMetis, "Metis_920");
				break;
			case 13870:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713870));
				orderActorToFactory(1105716870, EnemyMetis, "Metis_921");
				break;
			case 13890:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713890));
				orderActorToFactory(1105716890, EnemyMetis, "Metis_922");
				break;
			case 13910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713910));
				orderActorToFactory(1105716910, EnemyMetis, "Metis_923");
				break;
			case 13930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713930));
				orderActorToFactory(1105716930, EnemyMetis, "Metis_924");
				break;
			case 13950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713950));
				orderActorToFactory(1105716950, EnemyMetis, "Metis_925");
				break;
			case 13970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713970));
				orderActorToFactory(1105716970, EnemyMetis, "Metis_926");
				break;
			case 13990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713990));
				orderActorToFactory(1105716990, EnemyMetis, "Metis_927");
				break;
			case 14000:
				orderActorToFactory(1125717000, FormationIris002, "F002_Iris_928");
				break;
			case 14010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714010));
				orderActorToFactory(1105717010, EnemyMetis, "Metis_929");
				{
			...
			case 14030:
				...
				orderActorToFactory(1105717030, EnemyMetis, "Metis_930");
				break;
			case 14050:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714050));
				orderActorToFactory(1105717050, EnemyMetis, "Metis_931");
				break;
			case 14070:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714070));
				orderActorToFactory(1105717070, EnemyMetis, "Metis_932");
				break;
			case 14090:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714090));
				orderActorToFactory(1105717090, EnemyMetis, "Metis_933");
				break;
			case 14100:
				{
			...
			case 14810:
				...
				orderActorToFactory(1105717810, EnemyMetis, "Metis_971");
				break;
			case 14830:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714830));
				orderActorToFactory(1105717830, EnemyMetis, "Metis_972");
				break;
			case 14850:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714850));
				orderActorToFactory(1105717850, EnemyMetis, "Metis_973");
				break;
			case 14870:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714870));
				orderActorToFactory(1105717870, EnemyMetis, "Metis_974");
				break;
			case 14890:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714890));
				orderActorToFactory(1105717890, EnemyMetis, "Metis_975");
				break;
			case 14900:
				orderActorToFactory(1109717900, EnemyAstraea, "Astraea_976");
				break;
			case 14910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714910));
				orderActorToFactory(1105717910, EnemyMetis, "Metis_977");
				break;
			case 14930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714930));
				orderActorToFactory(1105717930, EnemyMetis, "Metis_978");
				break;
			case 14950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714950));
				orderActorToFactory(1105717950, EnemyMetis, "Metis_979");
				break;
			case 14970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714970));
				orderActorToFactory(1105717970, EnemyMetis, "Metis_980");
				break;
			case 14990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714990));
				orderActorToFactory(1105717990, EnemyMetis, "Metis_981");
				break;
			case 15000:
				{
			...
			case 15010:
				...
				orderActorToFactory(1105718010, EnemyMetis, "Metis_982");
				orderActorToFactory(1124718010, FormationIris001, "F001_Iris_983");
				break;
			case 15030:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715030));
				orderActorToFactory(1105718030, EnemyMetis, "Metis_984");
				break;
			case 15050:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715050));
				orderActorToFactory(1105718050, EnemyMetis, "Metis_985");
				break;
			case 15070:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715070));
				orderActorToFactory(1105718070, EnemyMetis, "Metis_986");
				break;
			case 15090:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715090));
				orderActorToFactory(1105718090, EnemyMetis, "Metis_987");
				break;
			case 15110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715110));
				orderActorToFactory(1105718110, EnemyMetis, "Metis_988");
				break;
			case 15130:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715130));
				orderActorToFactory(1105718130, EnemyMetis, "Metis_989");
				break;
			case 15150:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715150));
				orderActorToFactory(1105718150, EnemyMetis, "Metis_990");
				break;
			case 15170:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715170));
				orderActorToFactory(1105718170, EnemyMetis, "Metis_991");
				break;
			case 15190:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715190));
				orderActorToFactory(1105718190, EnemyMetis, "Metis_992");
				break;
			case 15210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715210));
				orderActorToFactory(1105718210, EnemyMetis, "Metis_993");
				break;
			case 15230:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715230));
				orderActorToFactory(1105718230, EnemyMetis, "Metis_994");
				break;
			case 15250:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715250));
				orderActorToFactory(1105718250, EnemyMetis, "Metis_995");
				break;
			case 15270:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715270));
				orderActorToFactory(1105718270, EnemyMetis, "Metis_996");
				break;
			case 15290:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715290));
				orderActorToFactory(1105718290, EnemyMetis, "Metis_997");
				break;
			case 15300:
				{
			...
			case 15310:
				...
				orderActorToFactory(1105718310, EnemyMetis, "Metis_998");
				break;
			case 15330:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715330));
				orderActorToFactory(1105718330, EnemyMetis, "Metis_999");
				break;
			case 15350:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715350));
				orderActorToFactory(1105718350, EnemyMetis, "Metis_1000");
				break;
			case 15370:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715370));
				orderActorToFactory(1105718370, EnemyMetis, "Metis_1001");
				break;
			case 15390:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715390));
				orderActorToFactory(1105718390, EnemyMetis, "Metis_1002");
				break;
			case 15400:
				orderActorToFactory(1117718400, EnemyAstraea, "Astraea_1003");
				break;
			case 15410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715410));
				orderActorToFactory(1105718410, EnemyMetis, "Metis_1004");
				break;
			case 15430:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715430));
				orderActorToFactory(1105718430, EnemyMetis, "Metis_1005");
				break;
			case 15450:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715450));
				orderActorToFactory(1105718450, EnemyMetis, "Metis_1006");
				break;
			case 15470:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715470));
				orderActorToFactory(1105718470, EnemyMetis, "Metis_1007");
				break;
			case 15490:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715490));
				orderActorToFactory(1105718490, EnemyMetis, "Metis_1008");
				break;
			case 15500:
				{
			...
			case 16000:
				...
				orderActorToFactory(1125719000, FormationIris002, "F002_Iris_1035");
				break;
			case 16010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716010));
				orderActorToFactory(1105719010, EnemyMetis, "Metis_1036");
				{
			...
			case 16510:
				...
				orderActorToFactory(1105719510, EnemyMetis, "Metis_1062");
				break;
			case 16530:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716530));
				orderActorToFactory(1105719530, EnemyMetis, "Metis_1063");
				{
			...
			case 16550:
				...
				orderActorToFactory(1105719550, EnemyMetis, "Metis_1064");
				break;
			case 16560:
				{
			...
			case 16570:
				...
				orderActorToFactory(1105719570, EnemyMetis, "Metis_1065");
				break;
			case 16590:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716590));
				orderActorToFactory(1105719590, EnemyMetis, "Metis_1066");
				{
			...
			case 16610:
				...
				orderActorToFactory(1105719610, EnemyMetis, "Metis_1067");
				break;
			case 16620:
				{
			...
			case 16630:
				...
				orderActorToFactory(1105719630, EnemyMetis, "Metis_1068");
				break;
			case 16650:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716650));
				orderActorToFactory(1105719650, EnemyMetis, "Metis_1069");
				{
			...
			case 16670:
				...
				orderActorToFactory(1105719670, EnemyMetis, "Metis_1070");
				break;
			case 16690:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716690));
				orderActorToFactory(1105719690, EnemyMetis, "Metis_1071");
				break;
			case 16700:
				{
			...
			case 16710:
				...
				orderActorToFactory(1105719710, EnemyMetis, "Metis_1072");
				break;
			case 16730:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716730));
				orderActorToFactory(1105719730, EnemyMetis, "Metis_1073");
				break;
			case 16750:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716750));
				orderActorToFactory(1105719750, EnemyMetis, "Metis_1074");
				break;
			case 16770:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716770));
				orderActorToFactory(1105719770, EnemyMetis, "Metis_1075");
				break;
			case 16790:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716790));
				orderActorToFactory(1105719790, EnemyMetis, "Metis_1076");
				break;
			case 16800:
				orderActorToFactory(1110719800, EnemyAstraea, "Astraea_1077");
				break;
			case 16810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716810));
				orderActorToFactory(1105719810, EnemyMetis, "Metis_1078");
				break;
			case 16830:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716830));
				orderActorToFactory(1105719830, EnemyMetis, "Metis_1079");
				break;
			case 16850:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716850));
				orderActorToFactory(1105719850, EnemyMetis, "Metis_1080");
				break;
			case 16870:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716870));
				orderActorToFactory(1105719870, EnemyMetis, "Metis_1081");
				break;
			case 16890:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716890));
				orderActorToFactory(1105719890, EnemyMetis, "Metis_1082");
				break;
			case 16910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716910));
				orderActorToFactory(1105719910, EnemyMetis, "Metis_1083");
				break;
			case 16930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716930));
				orderActorToFactory(1105719930, EnemyMetis, "Metis_1084");
				break;
			case 16950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716950));
				orderActorToFactory(1105719950, EnemyMetis, "Metis_1085");
				break;
			case 16970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716970));
				orderActorToFactory(1105719970, EnemyMetis, "Metis_1086");
				break;
			case 16990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716990));
				orderActorToFactory(1105719990, EnemyMetis, "Metis_1087");
				break;
			case 17000:
				{
			...
			case 17910:
				...
				orderActorToFactory(1105720910, EnemyMetis, "Metis_1133");
				break;
			case 17930:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717930));
				orderActorToFactory(1105720930, EnemyMetis, "Metis_1134");
				break;
			case 17950:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717950));
				orderActorToFactory(1105720950, EnemyMetis, "Metis_1135");
				break;
			case 17970:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717970));
				orderActorToFactory(1105720970, EnemyMetis, "Metis_1136");
				break;
			case 17990:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717990));
				orderActorToFactory(1105720990, EnemyMetis, "Metis_1137");
				break;
			case 18010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718010));
				orderActorToFactory(1105721010, EnemyMetis, "Metis_1138");
				{
			...
			case 19010:
				...
				orderActorToFactory(1105722010, EnemyMetis, "Metis_1188");
				break;
			case 19030:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719030));
				orderActorToFactory(1105722030, EnemyMetis, "Metis_1189");
				break;
			case 19050:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719050));
				orderActorToFactory(1105722050, EnemyMetis, "Metis_1190");
				break;
			case 19070:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719070));
				orderActorToFactory(1105722070, EnemyMetis, "Metis_1191");
				break;
			case 19090:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719090));
				orderActorToFactory(1105722090, EnemyMetis, "Metis_1192");
				break;
			case 19100:
				{
		...
		_iCnt_Event = (_iCnt_Event < 1709-1 ? _iCnt_Event+1 : _iCnt_Event);
	}
    // gen02 end
    ...
    if (getBehaveingFrame() == 2) {
        ...
        // 共通シーンを配下に移動
        addSubLast(GameGlobal::_pSceneCommon->becomeIndependent());
