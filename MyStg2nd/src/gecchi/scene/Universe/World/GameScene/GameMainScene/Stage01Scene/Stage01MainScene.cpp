...
Stage01MainScene::Stage01MainScene(const char* prm_name) : DefaultScene(prm_name) {
	...
	_paFrame_NextEvent = new DWORD[446];
	for (int i = 0; i < 446; i++) {
	...
	if (getPartFrame() == _paFrame_NextEvent[_iCnt_Event]) {
		switch (getPartFrame()) {
			...
			case 10:
				...
				orderActorToFactory(110573010, EnemyMetis, "Metis_44");
				{
			...
			case 110:
				...
				orderActorToFactory(110573110, EnemyMetis, "Metis_45");
				break;
			case 210:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057210));
				orderActorToFactory(110573210, EnemyMetis, "Metis_46");
				break;
			case 310:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057310));
				orderActorToFactory(110573310, EnemyMetis, "Metis_47");
				break;
			case 400:
				orderActorToFactory(111773400, EnemyAstraea, "Astraea_48");
				break;
			case 410:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057410));
				orderActorToFactory(110573410, EnemyMetis, "Metis_49");
				break;
			case 500:
				{
				...
				orderActorWithDpToFactory(112773500, EnemyCeres, "Ceres_50", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 510:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057510));
				orderActorToFactory(110573510, EnemyMetis, "Metis_51");
				break;
			case 530:
				{
				...
				orderActorWithDpToFactory(112873530, EnemyCeres, "Ceres_52", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 560:
				{
				...
				orderActorWithDpToFactory(112973560, EnemyCeres, "Ceres_53", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 590:
				{
				...
				orderActorWithDpToFactory(113073590, EnemyCeres, "Ceres_54", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 610:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057610));
				orderActorToFactory(110573610, EnemyMetis, "Metis_55");
				break;
			case 620:
				{
				...
				orderActorWithDpToFactory(113173620, EnemyCeres, "Ceres_56", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 650:
				{
				...
				orderActorWithDpToFactory(113273650, EnemyCeres, "Ceres_57", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 710:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057710));
				orderActorToFactory(110573710, EnemyMetis, "Metis_58");
				break;
			case 810:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057810));
				orderActorToFactory(110573810, EnemyMetis, "Metis_59");
				break;
			case 910:
				getLordActor()->addSubGroup(obtainActorFromFactory(11057910));
				orderActorToFactory(110573910, EnemyMetis, "Metis_60");
				break;
			case 1000:
				{
			...
			case 1010:
				...
				orderActorToFactory(110574010, EnemyMetis, "Metis_61");
				orderActorToFactory(112474010, FormationIris001, "F001_Iris_62");
				break;
			case 1110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571110));
				orderActorToFactory(110574110, EnemyMetis, "Metis_63");
				break;
			case 1210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571210));
				orderActorToFactory(110574210, EnemyMetis, "Metis_64");
				break;
			case 1310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571310));
				orderActorToFactory(110574310, EnemyMetis, "Metis_65");
				break;
			case 1410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571410));
				orderActorToFactory(110574410, EnemyMetis, "Metis_66");
				break;
			case 1500:
				{
			...
			case 1510:
				...
				orderActorToFactory(110574510, EnemyMetis, "Metis_67");
				break;
			case 1610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571610));
				orderActorToFactory(110574610, EnemyMetis, "Metis_68");
				break;
			case 1710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571710));
				orderActorToFactory(110574710, EnemyMetis, "Metis_69");
				break;
			case 1800:
				orderActorToFactory(111074800, EnemyAstraea, "Astraea_70");
				break;
			case 1810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571810));
				orderActorToFactory(110574810, EnemyMetis, "Metis_71");
				break;
			case 1910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110571910));
				orderActorToFactory(110574910, EnemyMetis, "Metis_72");
				break;
			case 2000:
				orderActorToFactory(112575000, FormationIris002, "F002_Iris_73");
				break;
			case 2010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572010));
				orderActorToFactory(110575010, EnemyMetis, "Metis_74");
				{
			...
			case 2110:
				...
				orderActorToFactory(110575110, EnemyMetis, "Metis_75");
				break;
			case 2210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572210));
				orderActorToFactory(110575210, EnemyMetis, "Metis_76");
				break;
			case 2300:
				orderActorToFactory(111875300, EnemyAstraea, "Astraea_77");
				break;
			case 2310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572310));
				orderActorToFactory(110575310, EnemyMetis, "Metis_78");
				break;
			case 2410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572410));
				orderActorToFactory(110575410, EnemyMetis, "Metis_79");
				break;
			case 2510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572510));
				orderActorToFactory(110575510, EnemyMetis, "Metis_80");
				break;
			case 2610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572610));
				orderActorToFactory(110575610, EnemyMetis, "Metis_81");
				break;
			case 2710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572710));
				orderActorToFactory(110575710, EnemyMetis, "Metis_82");
				break;
			case 2810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110572810));
				orderActorToFactory(110575810, EnemyMetis, "Metis_83");
				break;
			case 2900:
				{
			...
			case 2910:
				...
				orderActorToFactory(110575910, EnemyMetis, "Metis_84");
				break;
			case 3000:
				{
			...
			case 3010:
				...
				orderActorToFactory(110576010, EnemyMetis, "Metis_85");
				orderActorToFactory(112476010, FormationIris001, "F001_Iris_86");
				break;
			case 3110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573110));
				orderActorToFactory(110576110, EnemyMetis, "Metis_87");
				break;
			case 3210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573210));
				orderActorToFactory(110576210, EnemyMetis, "Metis_88");
				break;
			case 3310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573310));
				orderActorToFactory(110576310, EnemyMetis, "Metis_89");
				break;
			case 3400:
				{
			...
			case 3410:
				...
				orderActorToFactory(110576410, EnemyMetis, "Metis_90");
				break;
			case 3500:
				orderActorToFactory(111676500, EnemyAstraea, "Astraea_91");
				{
				...
				orderActorWithDpToFactory(112776500, EnemyCeres, "Ceres_92", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573510));
				orderActorToFactory(110576510, EnemyMetis, "Metis_93");
				break;
			case 3530:
				{
				...
				orderActorWithDpToFactory(112876530, EnemyCeres, "Ceres_94", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3560:
				{
				...
				orderActorWithDpToFactory(112976560, EnemyCeres, "Ceres_95", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3590:
				{
				...
				orderActorWithDpToFactory(113076590, EnemyCeres, "Ceres_96", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573610));
				orderActorToFactory(110576610, EnemyMetis, "Metis_97");
				break;
			case 3620:
				{
				...
				orderActorWithDpToFactory(113176620, EnemyCeres, "Ceres_98", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3650:
				{
				...
				orderActorWithDpToFactory(113276650, EnemyCeres, "Ceres_99", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 3700:
				orderActorToFactory(111176700, EnemyAstraea, "Astraea_100");
				break;
			case 3710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573710));
				orderActorToFactory(110576710, EnemyMetis, "Metis_101");
				break;
			case 3810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573810));
				orderActorToFactory(110576810, EnemyMetis, "Metis_102");
				break;
			case 3910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110573910));
				orderActorToFactory(110576910, EnemyMetis, "Metis_103");
				break;
			case 4000:
				orderActorToFactory(112577000, FormationIris002, "F002_Iris_104");
				break;
			case 4010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574010));
				orderActorToFactory(110577010, EnemyMetis, "Metis_105");
				{
			...
			case 4110:
				...
				orderActorToFactory(110577110, EnemyMetis, "Metis_106");
				break;
			case 4200:
				orderActorToFactory(111977200, EnemyAstraea, "Astraea_107");
				break;
			case 4210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574210));
				orderActorToFactory(110577210, EnemyMetis, "Metis_108");
				break;
			case 4310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574310));
				orderActorToFactory(110577310, EnemyMetis, "Metis_109");
				break;
			case 4410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574410));
				orderActorToFactory(110577410, EnemyMetis, "Metis_110");
				break;
			case 4510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574510));
				orderActorToFactory(110577510, EnemyMetis, "Metis_111");
				break;
			case 4610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574610));
				orderActorToFactory(110577610, EnemyMetis, "Metis_112");
				break;
			case 4710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574710));
				orderActorToFactory(110577710, EnemyMetis, "Metis_113");
				break;
			case 4800:
				{
			...
			case 4810:
				...
				orderActorToFactory(110577810, EnemyMetis, "Metis_114");
				break;
			case 4900:
				orderActorToFactory(110977900, EnemyAstraea, "Astraea_115");
				break;
			case 4910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110574910));
				orderActorToFactory(110577910, EnemyMetis, "Metis_116");
				break;
			case 5000:
				{
			...
			case 5010:
				...
				orderActorToFactory(110578010, EnemyMetis, "Metis_117");
				orderActorToFactory(112478010, FormationIris001, "F001_Iris_118");
				break;
			case 5110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575110));
				orderActorToFactory(110578110, EnemyMetis, "Metis_119");
				break;
			case 5210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575210));
				orderActorToFactory(110578210, EnemyMetis, "Metis_120");
				break;
			case 5300:
				{
			...
			case 5310:
				...
				orderActorToFactory(110578310, EnemyMetis, "Metis_121");
				break;
			case 5400:
				orderActorToFactory(111778400, EnemyAstraea, "Astraea_122");
				break;
			case 5410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575410));
				orderActorToFactory(110578410, EnemyMetis, "Metis_123");
				break;
			case 5510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575510));
				orderActorToFactory(110578510, EnemyMetis, "Metis_124");
				break;
			case 5600:
				orderActorToFactory(111278600, EnemyAstraea, "Astraea_125");
				break;
			case 5610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575610));
				orderActorToFactory(110578610, EnemyMetis, "Metis_126");
				break;
			case 5710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575710));
				orderActorToFactory(110578710, EnemyMetis, "Metis_127");
				break;
			case 5810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575810));
				orderActorToFactory(110578810, EnemyMetis, "Metis_128");
				break;
			case 5910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110575910));
				orderActorToFactory(110578910, EnemyMetis, "Metis_129");
				break;
			case 6000:
				orderActorToFactory(112579000, FormationIris002, "F002_Iris_130");
				break;
			case 6010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576010));
				orderActorToFactory(110579010, EnemyMetis, "Metis_131");
				{
				...
				break;
			case 6100:
				orderActorToFactory(112079100, EnemyAstraea, "Astraea_132");
				break;
			case 6110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576110));
				orderActorToFactory(110579110, EnemyMetis, "Metis_133");
				break;
			case 6210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576210));
				orderActorToFactory(110579210, EnemyMetis, "Metis_134");
				break;
			case 6310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576310));
				orderActorToFactory(110579310, EnemyMetis, "Metis_135");
				break;
			case 6410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576410));
				orderActorToFactory(110579410, EnemyMetis, "Metis_136");
				break;
			case 6500:
				{
				...
				orderActorWithDpToFactory(112779500, EnemyCeres, "Ceres_137", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576510));
				orderActorToFactory(110579510, EnemyMetis, "Metis_138");
				break;
			case 6530:
				{
				...
				orderActorWithDpToFactory(112879530, EnemyCeres, "Ceres_139", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6560:
				{
				...
				orderActorWithDpToFactory(112979560, EnemyCeres, "Ceres_140", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6590:
				{
				...
				orderActorWithDpToFactory(113079590, EnemyCeres, "Ceres_141", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576610));
				orderActorToFactory(110579610, EnemyMetis, "Metis_142");
				break;
			case 6620:
				{
				...
				orderActorWithDpToFactory(113179620, EnemyCeres, "Ceres_143", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6650:
				{
				...
				orderActorWithDpToFactory(113279650, EnemyCeres, "Ceres_144", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 6700:
				{
			...
			case 6710:
				...
				orderActorToFactory(110579710, EnemyMetis, "Metis_145");
				break;
			case 6800:
				orderActorToFactory(111079800, EnemyAstraea, "Astraea_146");
				break;
			case 6810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576810));
				orderActorToFactory(110579810, EnemyMetis, "Metis_147");
				break;
			case 6910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110576910));
				orderActorToFactory(110579910, EnemyMetis, "Metis_148");
				break;
			case 7000:
				{
			...
			case 7010:
				...
				orderActorToFactory(1105710010, EnemyMetis, "Metis_149");
				orderActorToFactory(1124710010, FormationIris001, "F001_Iris_150");
				break;
			case 7110:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577110));
				orderActorToFactory(1105710110, EnemyMetis, "Metis_151");
				break;
			case 7200:
				{
			...
			case 7210:
				...
				orderActorToFactory(1105710210, EnemyMetis, "Metis_152");
				break;
			case 7300:
				orderActorToFactory(1118710300, EnemyAstraea, "Astraea_153");
				break;
			case 7310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577310));
				orderActorToFactory(1105710310, EnemyMetis, "Metis_154");
				break;
			case 7410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577410));
				orderActorToFactory(1105710410, EnemyMetis, "Metis_155");
				break;
			case 7500:
				orderActorToFactory(1113710500, EnemyAstraea, "Astraea_156");
				break;
			case 7510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577510));
				orderActorToFactory(1105710510, EnemyMetis, "Metis_157");
				break;
			case 7610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577610));
				orderActorToFactory(1105710610, EnemyMetis, "Metis_158");
				break;
			case 7710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577710));
				orderActorToFactory(1105710710, EnemyMetis, "Metis_159");
				break;
			case 7810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110577810));
				orderActorToFactory(1105710810, EnemyMetis, "Metis_160");
				break;
			case 7900:
				{
			...
			case 7910:
				...
				orderActorToFactory(1105710910, EnemyMetis, "Metis_161");
				break;
			case 8000:
				orderActorToFactory(1121711000, EnemyAstraea, "Astraea_162");
				orderActorToFactory(1125711000, FormationIris002, "F002_Iris_163");
				break;
			case 8010:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578010));
				orderActorToFactory(1105711010, EnemyMetis, "Metis_164");
				{
			...
			case 8110:
				...
				orderActorToFactory(1105711110, EnemyMetis, "Metis_165");
				break;
			case 8210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578210));
				orderActorToFactory(1105711210, EnemyMetis, "Metis_166");
				break;
			case 8310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578310));
				orderActorToFactory(1105711310, EnemyMetis, "Metis_167");
				break;
			case 8400:
				{
			...
			case 8410:
				...
				orderActorToFactory(1105711410, EnemyMetis, "Metis_168");
				break;
			case 8500:
				orderActorToFactory(1116711500, EnemyAstraea, "Astraea_169");
				break;
			case 8510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578510));
				orderActorToFactory(1105711510, EnemyMetis, "Metis_170");
				break;
			case 8600:
				{
			...
			case 8610:
				...
				orderActorToFactory(1105711610, EnemyMetis, "Metis_171");
				break;
			case 8700:
				orderActorToFactory(1111711700, EnemyAstraea, "Astraea_172");
				break;
			case 8710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578710));
				orderActorToFactory(1105711710, EnemyMetis, "Metis_173");
				break;
			case 8810:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578810));
				orderActorToFactory(1105711810, EnemyMetis, "Metis_174");
				break;
			case 8910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110578910));
				orderActorToFactory(1105711910, EnemyMetis, "Metis_175");
				break;
			case 9000:
				{
			...
			case 9010:
				...
				orderActorToFactory(1105712010, EnemyMetis, "Metis_176");
				orderActorToFactory(1124712010, FormationIris001, "F001_Iris_177");
				break;
			case 9100:
				{
			...
			case 9110:
				...
				orderActorToFactory(1105712110, EnemyMetis, "Metis_178");
				break;
			case 9200:
				orderActorToFactory(1119712200, EnemyAstraea, "Astraea_179");
				break;
			case 9210:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579210));
				orderActorToFactory(1105712210, EnemyMetis, "Metis_180");
				break;
			case 9310:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579310));
				orderActorToFactory(1105712310, EnemyMetis, "Metis_181");
				break;
			case 9400:
				orderActorToFactory(1114712400, EnemyAstraea, "Astraea_182");
				break;
			case 9410:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579410));
				orderActorToFactory(1105712410, EnemyMetis, "Metis_183");
				break;
			case 9500:
				{
				...
				orderActorWithDpToFactory(1127712500, EnemyCeres, "Ceres_184", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9510:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579510));
				orderActorToFactory(1105712510, EnemyMetis, "Metis_185");
				break;
			case 9530:
				{
				...
				orderActorWithDpToFactory(1128712530, EnemyCeres, "Ceres_186", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9560:
				{
				...
				orderActorWithDpToFactory(1129712560, EnemyCeres, "Ceres_187", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9590:
				{
				...
				orderActorWithDpToFactory(1130712590, EnemyCeres, "Ceres_188", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9610:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579610));
				orderActorToFactory(1105712610, EnemyMetis, "Metis_189");
				break;
			case 9620:
				{
				...
				orderActorWithDpToFactory(1131712620, EnemyCeres, "Ceres_190", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9650:
				{
				...
				orderActorWithDpToFactory(1132712650, EnemyCeres, "Ceres_191", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 9710:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579710));
				orderActorToFactory(1105712710, EnemyMetis, "Metis_192");
				break;
			case 9800:
				{
			...
			case 9810:
				...
				orderActorToFactory(1105712810, EnemyMetis, "Metis_193");
				break;
			case 9900:
				orderActorToFactory(1109712900, EnemyAstraea, "Astraea_194");
				break;
			case 9910:
				getLordActor()->addSubGroup(obtainActorFromFactory(110579910));
				orderActorToFactory(1105712910, EnemyMetis, "Metis_195");
				break;
			case 10000:
				orderActorToFactory(1125713000, FormationIris002, "F002_Iris_196");
				break;
			case 10010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710010));
				orderActorToFactory(1105713010, EnemyMetis, "Metis_197");
				{
			...
			case 10110:
				...
				orderActorToFactory(1105713110, EnemyMetis, "Metis_198");
				break;
			case 10210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710210));
				orderActorToFactory(1105713210, EnemyMetis, "Metis_199");
				break;
			case 10300:
				{
			...
			case 10310:
				...
				orderActorToFactory(1105713310, EnemyMetis, "Metis_200");
				break;
			case 10400:
				orderActorToFactory(1117713400, EnemyAstraea, "Astraea_201");
				break;
			case 10410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710410));
				orderActorToFactory(1105713410, EnemyMetis, "Metis_202");
				break;
			case 10500:
				{
			...
			case 10510:
				...
				orderActorToFactory(1105713510, EnemyMetis, "Metis_203");
				break;
			case 10600:
				orderActorToFactory(1112713600, EnemyAstraea, "Astraea_204");
				break;
			case 10610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710610));
				orderActorToFactory(1105713610, EnemyMetis, "Metis_205");
				break;
			case 10710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710710));
				orderActorToFactory(1105713710, EnemyMetis, "Metis_206");
				break;
			case 10810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710810));
				orderActorToFactory(1105713810, EnemyMetis, "Metis_207");
				break;
			case 10910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105710910));
				orderActorToFactory(1105713910, EnemyMetis, "Metis_208");
				break;
			case 11000:
				{
			...
			case 11010:
				...
				orderActorToFactory(1105714010, EnemyMetis, "Metis_209");
				orderActorToFactory(1124714010, FormationIris001, "F001_Iris_210");
				break;
			case 11100:
				orderActorToFactory(1120714100, EnemyAstraea, "Astraea_211");
				break;
			case 11110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711110));
				orderActorToFactory(1105714110, EnemyMetis, "Metis_212");
				break;
			case 11210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711210));
				orderActorToFactory(1105714210, EnemyMetis, "Metis_213");
				break;
			case 11310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711310));
				orderActorToFactory(1105714310, EnemyMetis, "Metis_214");
				break;
			case 11410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711410));
				orderActorToFactory(1105714410, EnemyMetis, "Metis_215");
				break;
			case 11500:
				{
			...
			case 11510:
				...
				orderActorToFactory(1105714510, EnemyMetis, "Metis_216");
				break;
			case 11610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711610));
				orderActorToFactory(1105714610, EnemyMetis, "Metis_217");
				break;
			case 11700:
				{
			...
			case 11710:
				...
				orderActorToFactory(1105714710, EnemyMetis, "Metis_218");
				break;
			case 11800:
				orderActorToFactory(1110714800, EnemyAstraea, "Astraea_219");
				break;
			case 11810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711810));
				orderActorToFactory(1105714810, EnemyMetis, "Metis_220");
				break;
			case 11910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105711910));
				orderActorToFactory(1105714910, EnemyMetis, "Metis_221");
				break;
			case 12000:
				orderActorToFactory(1125715000, FormationIris002, "F002_Iris_222");
				break;
			case 12010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712010));
				orderActorToFactory(1105715010, EnemyMetis, "Metis_223");
				{
			...
			case 12110:
				...
				orderActorToFactory(1105715110, EnemyMetis, "Metis_224");
				break;
			case 12200:
				{
			...
			case 12210:
				...
				orderActorToFactory(1105715210, EnemyMetis, "Metis_225");
				break;
			case 12300:
				orderActorToFactory(1118715300, EnemyAstraea, "Astraea_226");
				break;
			case 12310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712310));
				orderActorToFactory(1105715310, EnemyMetis, "Metis_227");
				break;
			case 12400:
				{
			...
			case 12410:
				...
				orderActorToFactory(1105715410, EnemyMetis, "Metis_228");
				break;
			case 12500:
				orderActorToFactory(1113715500, EnemyAstraea, "Astraea_229");
				{
				...
				orderActorWithDpToFactory(1127715500, EnemyCeres, "Ceres_230", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712510));
				orderActorToFactory(1105715510, EnemyMetis, "Metis_231");
				break;
			case 12530:
				{
				...
				orderActorWithDpToFactory(1128715530, EnemyCeres, "Ceres_232", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12560:
				{
				...
				orderActorWithDpToFactory(1129715560, EnemyCeres, "Ceres_233", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12590:
				{
				...
				orderActorWithDpToFactory(1130715590, EnemyCeres, "Ceres_234", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712610));
				orderActorToFactory(1105715610, EnemyMetis, "Metis_235");
				break;
			case 12620:
				{
				...
				orderActorWithDpToFactory(1131715620, EnemyCeres, "Ceres_236", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12650:
				{
				...
				orderActorWithDpToFactory(1132715650, EnemyCeres, "Ceres_237", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 12710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712710));
				orderActorToFactory(1105715710, EnemyMetis, "Metis_238");
				break;
			case 12810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105712810));
				orderActorToFactory(1105715810, EnemyMetis, "Metis_239");
				break;
			case 12900:
				{
			...
			case 12910:
				...
				orderActorToFactory(1105715910, EnemyMetis, "Metis_240");
				break;
			case 13000:
				orderActorToFactory(1121716000, EnemyAstraea, "Astraea_241");
				{
			...
			case 13010:
				...
				orderActorToFactory(1105716010, EnemyMetis, "Metis_242");
				orderActorToFactory(1124716010, FormationIris001, "F001_Iris_243");
				break;
			case 13110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713110));
				orderActorToFactory(1105716110, EnemyMetis, "Metis_244");
				break;
			case 13210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713210));
				orderActorToFactory(1105716210, EnemyMetis, "Metis_245");
				break;
			case 13310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713310));
				orderActorToFactory(1105716310, EnemyMetis, "Metis_246");
				break;
			case 13400:
				{
			...
			case 13410:
				...
				orderActorToFactory(1105716410, EnemyMetis, "Metis_247");
				break;
			case 13500:
				orderActorToFactory(1116716500, EnemyAstraea, "Astraea_248");
				break;
			case 13510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713510));
				orderActorToFactory(1105716510, EnemyMetis, "Metis_249");
				break;
			case 13600:
				{
			...
			case 13610:
				...
				orderActorToFactory(1105716610, EnemyMetis, "Metis_250");
				break;
			case 13700:
				orderActorToFactory(1111716700, EnemyAstraea, "Astraea_251");
				break;
			case 13710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713710));
				orderActorToFactory(1105716710, EnemyMetis, "Metis_252");
				break;
			case 13810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713810));
				orderActorToFactory(1105716810, EnemyMetis, "Metis_253");
				break;
			case 13910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105713910));
				orderActorToFactory(1105716910, EnemyMetis, "Metis_254");
				break;
			case 14000:
				orderActorToFactory(1125717000, FormationIris002, "F002_Iris_255");
				break;
			case 14010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714010));
				orderActorToFactory(1105717010, EnemyMetis, "Metis_256");
				{
			...
			case 14110:
				...
				orderActorToFactory(1105717110, EnemyMetis, "Metis_257");
				break;
			case 14200:
				orderActorToFactory(1119717200, EnemyAstraea, "Astraea_258");
				break;
			case 14210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714210));
				orderActorToFactory(1105717210, EnemyMetis, "Metis_259");
				break;
			case 14310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714310));
				orderActorToFactory(1105717310, EnemyMetis, "Metis_260");
				break;
			case 14400:
				orderActorToFactory(1114717400, EnemyAstraea, "Astraea_261");
				break;
			case 14410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714410));
				orderActorToFactory(1105717410, EnemyMetis, "Metis_262");
				break;
			case 14510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714510));
				orderActorToFactory(1105717510, EnemyMetis, "Metis_263");
				break;
			case 14610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714610));
				orderActorToFactory(1105717610, EnemyMetis, "Metis_264");
				break;
			case 14710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714710));
				orderActorToFactory(1105717710, EnemyMetis, "Metis_265");
				break;
			case 14800:
				{
			...
			case 14810:
				...
				orderActorToFactory(1105717810, EnemyMetis, "Metis_266");
				break;
			case 14900:
				orderActorToFactory(1109717900, EnemyAstraea, "Astraea_267");
				break;
			case 14910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105714910));
				orderActorToFactory(1105717910, EnemyMetis, "Metis_268");
				break;
			case 15000:
				{
			...
			case 15010:
				...
				orderActorToFactory(1105718010, EnemyMetis, "Metis_269");
				orderActorToFactory(1124718010, FormationIris001, "F001_Iris_270");
				break;
			case 15110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715110));
				orderActorToFactory(1105718110, EnemyMetis, "Metis_271");
				break;
			case 15210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715210));
				orderActorToFactory(1105718210, EnemyMetis, "Metis_272");
				break;
			case 15300:
				{
			...
			case 15310:
				...
				orderActorToFactory(1105718310, EnemyMetis, "Metis_273");
				break;
			case 15400:
				orderActorToFactory(1117718400, EnemyAstraea, "Astraea_274");
				break;
			case 15410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715410));
				orderActorToFactory(1105718410, EnemyMetis, "Metis_275");
				break;
			case 15500:
				{
				...
				orderActorWithDpToFactory(1127718500, EnemyCeres, "Ceres_276", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715510));
				orderActorToFactory(1105718510, EnemyMetis, "Metis_277");
				break;
			case 15530:
				{
				...
				orderActorWithDpToFactory(1128718530, EnemyCeres, "Ceres_278", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15560:
				{
				...
				orderActorWithDpToFactory(1129718560, EnemyCeres, "Ceres_279", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15590:
				{
				...
				orderActorWithDpToFactory(1130718590, EnemyCeres, "Ceres_280", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15600:
				orderActorToFactory(1112718600, EnemyAstraea, "Astraea_281");
				break;
			case 15610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715610));
				orderActorToFactory(1105718610, EnemyMetis, "Metis_282");
				break;
			case 15620:
				{
				...
				orderActorWithDpToFactory(1131718620, EnemyCeres, "Ceres_283", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15650:
				{
				...
				orderActorWithDpToFactory(1132718650, EnemyCeres, "Ceres_284", GameGlobal::_pSceneCommon->_pDispatcher_EnemyShots001);
				break;
			case 15710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715710));
				orderActorToFactory(1105718710, EnemyMetis, "Metis_285");
				break;
			case 15810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715810));
				orderActorToFactory(1105718810, EnemyMetis, "Metis_286");
				break;
			case 15910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105715910));
				orderActorToFactory(1105718910, EnemyMetis, "Metis_287");
				break;
			case 16000:
				{
				...
				orderActorToFactory(1125719000, FormationIris002, "F002_Iris_288");
				break;
			case 16010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716010));
				orderActorToFactory(1105719010, EnemyMetis, "Metis_289");
				{
				...
				break;
			case 16100:
				orderActorToFactory(1120719100, EnemyAstraea, "Astraea_290");
				break;
			case 16110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716110));
				orderActorToFactory(1105719110, EnemyMetis, "Metis_291");
				break;
			case 16210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716210));
				orderActorToFactory(1105719210, EnemyMetis, "Metis_292");
				break;
			case 16310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716310));
				orderActorToFactory(1105719310, EnemyMetis, "Metis_293");
				break;
			case 16410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716410));
				orderActorToFactory(1105719410, EnemyMetis, "Metis_294");
				break;
			case 16500:
				{
			...
			case 16510:
				...
				orderActorToFactory(1105719510, EnemyMetis, "Metis_295");
				break;
			case 16610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716610));
				orderActorToFactory(1105719610, EnemyMetis, "Metis_296");
				break;
			case 16700:
				{
			...
			case 16710:
				...
				orderActorToFactory(1105719710, EnemyMetis, "Metis_297");
				break;
			case 16800:
				orderActorToFactory(1110719800, EnemyAstraea, "Astraea_298");
				break;
			case 16810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716810));
				orderActorToFactory(1105719810, EnemyMetis, "Metis_299");
				break;
			case 16910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105716910));
				orderActorToFactory(1105719910, EnemyMetis, "Metis_300");
				break;
			case 17000:
				{
			...
			case 17010:
				...
				orderActorToFactory(1105720010, EnemyMetis, "Metis_301");
				break;
			case 17110:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717110));
				orderActorToFactory(1105720110, EnemyMetis, "Metis_302");
				break;
			case 17200:
				{
			...
			case 17210:
				...
				orderActorToFactory(1105720210, EnemyMetis, "Metis_303");
				break;
			case 17310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717310));
				orderActorToFactory(1105720310, EnemyMetis, "Metis_304");
				break;
			case 17400:
				{
			...
			case 17410:
				...
				orderActorToFactory(1105720410, EnemyMetis, "Metis_305");
				break;
			case 17510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717510));
				orderActorToFactory(1105720510, EnemyMetis, "Metis_306");
				break;
			case 17610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717610));
				orderActorToFactory(1105720610, EnemyMetis, "Metis_307");
				break;
			case 17710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717710));
				orderActorToFactory(1105720710, EnemyMetis, "Metis_308");
				break;
			case 17810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105717810));
				orderActorToFactory(1105720810, EnemyMetis, "Metis_309");
				break;
			case 17900:
				{
			...
			case 17910:
				...
				orderActorToFactory(1105720910, EnemyMetis, "Metis_310");
				break;
			case 18010:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718010));
				orderActorToFactory(1105721010, EnemyMetis, "Metis_311");
				{
			...
			case 18110:
				...
				orderActorToFactory(1105721110, EnemyMetis, "Metis_312");
				break;
			case 18210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718210));
				orderActorToFactory(1105721210, EnemyMetis, "Metis_313");
				break;
			case 18310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718310));
				orderActorToFactory(1105721310, EnemyMetis, "Metis_314");
				break;
			case 18400:
				{
			...
			case 18410:
				...
				orderActorToFactory(1105721410, EnemyMetis, "Metis_315");
				break;
			case 18500:
				{
			...
			case 18510:
				...
				orderActorToFactory(1105721510, EnemyMetis, "Metis_316");
				break;
			case 18530:
				{
			...
			case 18610:
				...
				orderActorToFactory(1105721610, EnemyMetis, "Metis_317");
				break;
			case 18620:
				{
			...
			case 18710:
				...
				orderActorToFactory(1105721710, EnemyMetis, "Metis_318");
				break;
			case 18810:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718810));
				orderActorToFactory(1105721810, EnemyMetis, "Metis_319");
				break;
			case 18910:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105718910));
				orderActorToFactory(1105721910, EnemyMetis, "Metis_320");
				break;
			case 19000:
				{
			...
			case 19010:
				...
				orderActorToFactory(1105722010, EnemyMetis, "Metis_321");
				break;
			case 19100:
				{
			...
			case 19110:
				...
				orderActorToFactory(1105722110, EnemyMetis, "Metis_322");
				break;
			case 19210:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719210));
				orderActorToFactory(1105722210, EnemyMetis, "Metis_323");
				break;
			case 19310:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719310));
				orderActorToFactory(1105722310, EnemyMetis, "Metis_324");
				break;
			case 19410:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719410));
				orderActorToFactory(1105722410, EnemyMetis, "Metis_325");
				break;
			case 19510:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719510));
				orderActorToFactory(1105722510, EnemyMetis, "Metis_326");
				break;
			case 19610:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719610));
				orderActorToFactory(1105722610, EnemyMetis, "Metis_327");
				break;
			case 19710:
				getLordActor()->addSubGroup(obtainActorFromFactory(1105719710));
				orderActorToFactory(1105722710, EnemyMetis, "Metis_328");
				break;
			case 19800:
				{
		...
		_iCnt_Event = (_iCnt_Event < 446-1 ? _iCnt_Event+1 : _iCnt_Event);
	}
    // gen02 end
