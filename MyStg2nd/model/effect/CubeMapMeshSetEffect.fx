...
//	out_vs.uv = prm_uv;
	...
	out_vs.col = (g_colLightAmbient + (g_colLightDiffuse*power)) * colorMaterialDiffuse * float4(2.0, 2.0, 2.0, 1.0); //全体的に明るくする;
	//αフォグ
...
technique CubeMapMeshSetTechnique
{
	pass P0 {
		...
		VertexShader = compile vs_3_0  GgafDx9VS_CubeMapMeshSet();
		PixelShader  = compile ps_3_0  GgafDx9PS_CubeMapMeshSet();
	}
}
