...
private:
	 ...
	 * 所属シーンを設定する。 .
	 */
	void setScenePlatform(GgafActor* prm_pScene_Platform);
...
public:
	...
	/**
	 * 所属しているシーンを取得。 .
	 * @return	GgafActor*	所属しているシーン
	 */
	virtual GgafActor* getPlatformScene();
	 ...
	 */
	virtual void dump(char* prm_parent);
