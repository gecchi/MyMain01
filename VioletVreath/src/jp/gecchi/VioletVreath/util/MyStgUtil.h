...
public:
     ...
     */
    static EffectBlink* activateEntryEffectOf(GgafDxCore::GgafDxGeometricActor* prm_pActor);
     ...
     */
    static EffectBlink* activateLeaveEffectOf(GgafDxCore::GgafDxGeometricActor* prm_pActor);
     ...
     * @return 編隊全滅時エフェクト
     */
    static GgafDxCore::GgafDxFigureActor* performFormationDestroyAll(GgafDxCore::GgafDxFigureActor* prm_pActor_last_destroyed);
