        ...
        for (int i = 0; i < prm_way_num; i++) {
            ...
            if (pActor_shot) {
                ...
                pActor_shot->setPosition(prm_x + paGeo[i].x,
                                      prm_y + paGeo[i].y,
                                      prm_z + paGeo[i].z);
                pActor_shot->callRikisha()->setRzRyMvAng(paGeo[i].rz, paGeo[i].ry);
                pActor_shot->callRikisha()->setMvVelo(now_velo);
                pActor_shot->callRikisha()->setMvAcce(now_acce);
//                pActor_shot->_rz = Rz;
//                pActor_shot->_ry = Ry;
    ...
    switch (prm_pActor->getStatus()->get(STAT_ExplosionEffectKind)) {
        ...
        case EF_EXPLOSION001: {
            ...
            if (pE) {
                ...
                pE->callRikisha()->takeoverMvFrom(prm_pActor->callRikisha());
            }
            break;
        }
...
GgafDx::FigureActor* MyStgUtil::activateFormationDestroyedEffectOf(GgafDx::GeometricActor* prm_pActor) {
    ...
    switch (prm_pActor->getStatus()->get(STAT_FormationDestroyedEffectKind)) {
        ...
        case EF_EXPLO_AND_BONUS001: {
            ...
            pLabel->callRikisha()->takeoverMvFrom(prm_pActor->callRikisha());
            ...
            pTurbo002->callRikisha()->takeoverMvFrom(prm_pActor->callRikisha());
            break;
        }
//            case 2: {
