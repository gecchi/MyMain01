...
std::string Properties::MY_KEY_VIEW_UP = "";
std::string Properties::MY_KEY_VIEW_DOWN = "";
std::string Properties::MY_KEY_VIEW_LEFT = "";
std::string Properties::MY_KEY_VIEW_RIGHT = "";
...
std::string Properties::MY_JOY_VIEW_UP = "";
std::string Properties::MY_JOY_VIEW_DOWN = "";
std::string Properties::MY_JOY_VIEW_LEFT = "";
std::string Properties::MY_JOY_VIEW_RIGHT = "";
...
//    Properties::MY_KEY_VIEW       = getStr("MY_KEY_VIEW");
    ...
    Properties::MY_KEY_VIEW_UP    = getStr("MY_KEY_VIEW_UP");
    Properties::MY_KEY_VIEW_DOWN  = getStr("MY_KEY_VIEW_DOWN");
    Properties::MY_KEY_VIEW_LEFT  = getStr("MY_KEY_VIEW_LEFT");
    Properties::MY_KEY_VIEW_RIGHT = getStr("MY_KEY_VIEW_RIGHT");
...
//    Properties::MY_JOY_VIEW       = getStr("MY_JOY_VIEW");
    ...
    Properties::MY_JOY_VIEW_UP    = getStr("MY_JOY_VIEW_UP");
    Properties::MY_JOY_VIEW_DOWN  = getStr("MY_JOY_VIEW_DOWN");
    Properties::MY_JOY_VIEW_LEFT  = getStr("MY_JOY_VIEW_LEFT");
    Properties::MY_JOY_VIEW_RIGHT = getStr("MY_JOY_VIEW_RIGHT");
...
//    _TRACE_("Properties::MY_KEY_VIEW="    << Properties::MY_KEY_VIEW);
    ...
    _TRACE_("Properties::MY_KEY_VIEW_UP="   << Properties::MY_KEY_VIEW_UP);
    _TRACE_("Properties::MY_KEY_VIEW_DOWN=" << Properties::MY_KEY_VIEW_DOWN);
    _TRACE_("Properties::MY_KEY_VIEW_LEFT=" << Properties::MY_KEY_VIEW_LEFT);
    _TRACE_("Properties::MY_KEY_VIEW_RIGHT="<< Properties::MY_KEY_VIEW_RIGHT);
...
//    _TRACE_("Properties::MY_JOY_VIEW="    << Properties::MY_JOY_VIEW);
    ...
    _TRACE_("Properties::MY_JOY_UP="        << Properties::MY_JOY_UP);
    _TRACE_("Properties::MY_JOY_DOWN="      << Properties::MY_JOY_DOWN);
    _TRACE_("Properties::MY_JOY_LEFT="      << Properties::MY_JOY_LEFT);
    _TRACE_("Properties::MY_JOY_RIGHT="     << Properties::MY_JOY_RIGHT);
    _TRACE_("Properties::MY_JOY_VIEW_UP="   << Properties::MY_JOY_VIEW_UP);
    _TRACE_("Properties::MY_JOY_VIEW_DOWN=" << Properties::MY_JOY_VIEW_DOWN);
    _TRACE_("Properties::MY_JOY_VIEW_LEFT=" << Properties::MY_JOY_VIEW_LEFT);
    _TRACE_("Properties::MY_JOY_VIEW_RIGHT="<< Properties::MY_JOY_VIEW_RIGHT);
    _TRACE_("Properties::MY_JOY_UI_UP="     << Properties::MY_JOY_UI_UP);
    _TRACE_("Properties::MY_JOY_UI_DOWN="   << Properties::MY_JOY_UI_DOWN);
    _TRACE_("Properties::MY_JOY_UI_LEFT="   << Properties::MY_JOY_UI_LEFT);
