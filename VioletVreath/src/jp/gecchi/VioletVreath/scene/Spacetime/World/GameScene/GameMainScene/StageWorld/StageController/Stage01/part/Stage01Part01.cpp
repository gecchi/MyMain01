	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 1900: {
				...
				requestActor(20000017, VarietyRatislavia001);
				requestActor(20000019, FormationAppho001a);
				break;
			}
			case 2400: {
				requestActor(20000015, FormationUnomia001b);
				requestActor(20000018, VarietyRatislavia002);
			...
			case 7900: {
				requestActor(20000025, FormationAppho001a);
				break;
			}
			case 8000: {
			...
			case 8400: {
				requestActor(20000033, FormationAppho001b);
				break;
			}
			case 8500: {
			...
			case 8900: {
				requestActor(20000026, FormationAppho001a);
				break;
			}
			case 9000: {
			...
			case 9400: {
				requestActor(20000034, FormationAppho001b);
				break;
			}
			case 9500: {
