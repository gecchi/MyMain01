	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 5000: {
				...
				getSceneChief()->appendChild(pF);
				getSceneChief()->appendChild(receiveActor(30001026));
				break;
			}
			case 5020: {
			...
			case 6000: {
				getSceneChief()->appendChild(receiveActor(30001027));
				break;
			}
			case 6010: {
			...
			case 7000: {
				...
				getSceneChief()->appendChild(receiveActor(30001028));
				break;
			}
			case 7030: {
			...
			case 8000: {
				getSceneChief()->appendChild(receiveActor(30001029));
				break;
			}
			case 8020: {
