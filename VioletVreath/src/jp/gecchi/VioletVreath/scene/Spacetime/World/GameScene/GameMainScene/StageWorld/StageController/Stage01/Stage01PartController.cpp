...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10001666, EnemyDrastea, "EnemyDrastea-19");
	orderActorToFactory(10001667, EnemyDrastea, "EnemyDrastea-20");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 10: {
				orderActorToFactory(10000019, EnemyEtis, "EnemyEtis-21");
				break;
			}
			case 20: {
				orderActorToFactory(10000001, EnemyOebiusController002, "EnemyOebiusController002-22");
				break;
			}
			case 40: {
			...
			case 70: {
				orderActorToFactory(10000021, EnemyEtis, "EnemyEtis-24");
				break;
			}
			case 100: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000002);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000022, EnemyEtis, "EnemyEtis-25");
				orderActorToFactory(10001668, EnemyDrastea, "EnemyDrastea-26");
				break;
			}
			case 130: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000003);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000023, EnemyEtis, "EnemyEtis-27");
				break;
			}
			case 160: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000004);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000024, EnemyEtis, "EnemyEtis-28");
				break;
			}
			case 190: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000005);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000025, EnemyEtis, "EnemyEtis-29");
				break;
			}
			case 200: {
				orderActorToFactory(10001669, EnemyDrastea, "EnemyDrastea-30");
				break;
			}
			case 220: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000006);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000026, EnemyEtis, "EnemyEtis-31");
				break;
			}
			case 250: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000007);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000027, EnemyEtis, "EnemyEtis-32");
				break;
			}
			case 280: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000008);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000028, EnemyEtis, "EnemyEtis-33");
				break;
			}
			case 300: {
				orderActorToFactory(10001670, EnemyDrastea, "EnemyDrastea-34");
				break;
			}
			case 310: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000009);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000029, EnemyEtis, "EnemyEtis-35");
				break;
			}
			case 340: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000010);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000030, EnemyEtis, "EnemyEtis-36");
				break;
			}
			case 370: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000011);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000031, EnemyEtis, "EnemyEtis-37");
				break;
			}
			case 400: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000012);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000032, EnemyEtis, "EnemyEtis-38");
				orderActorToFactory(10001671, EnemyDrastea, "EnemyDrastea-39");
				break;
			}
			case 430: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000013);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000033, EnemyEtis, "EnemyEtis-40");
				break;
			}
			case 460: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000014);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000034, EnemyEtis, "EnemyEtis-41");
				break;
			}
			case 490: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000015);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000035, EnemyEtis, "EnemyEtis-42");
				break;
			}
			case 500: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001666);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001672, EnemyDrastea, "EnemyDrastea-43");
				break;
			}
			case 520: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000016);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000036, EnemyEtis, "EnemyEtis-44");
				break;
			}
			case 550: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000017);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000037, EnemyEtis, "EnemyEtis-45");
				break;
			}
			case 580: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000018);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000038, EnemyEtis, "EnemyEtis-46");
				break;
			}
			case 600: {
				...
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001673, EnemyDrastea, "EnemyDrastea-47");
				break;
			}
			case 610: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000019);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000039, EnemyEtis, "EnemyEtis-48");
				break;
			}
			case 620: {
			...
			case 4480: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000168, EnemyEtis, "EnemyEtis-215");
				break;
			}
			case 4500: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001706);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001712, EnemyDrastea, "EnemyDrastea-216");
				break;
			}
			case 4510: {
			...
			case 4570: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000171, EnemyEtis, "EnemyEtis-219");
				break;
			}
			case 4600: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000152);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000172, EnemyEtis, "EnemyEtis-220");
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001707);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001713, EnemyDrastea, "EnemyDrastea-221");
				break;
			}
			case 4630: {
			...
			case 4690: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000175, EnemyEtis, "EnemyEtis-224");
				break;
			}
			case 4700: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001708);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001714, EnemyDrastea, "EnemyDrastea-225");
				break;
			}
			case 4720: {
			...
			case 4780: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000178, EnemyEtis, "EnemyEtis-228");
				break;
			}
			case 4800: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001709);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001715, EnemyDrastea, "EnemyDrastea-229");
				break;
			}
			case 4810: {
			...
			case 4870: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000181, EnemyEtis, "EnemyEtis-232");
				break;
			}
			case 4900: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000162);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000182, EnemyEtis, "EnemyEtis-233");
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001710);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001716, EnemyDrastea, "EnemyDrastea-234");
				break;
			}
			case 4930: {
			...
			case 4990: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000185, EnemyEtis, "EnemyEtis-237");
				break;
			}
			case 5000: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001711);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001717, EnemyDrastea, "EnemyDrastea-238");
				break;
			}
			case 5020: {
			...
			case 5080: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000188, EnemyEtis, "EnemyEtis-241");
				break;
			}
			case 5100: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001712);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001718, EnemyDrastea, "EnemyDrastea-242");
				break;
			}
			case 5110: {
			...
			case 5170: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000191, EnemyEtis, "EnemyEtis-245");
				break;
			}
			case 5200: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000172);
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000192, EnemyEtis, "EnemyEtis-246");
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001713);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001719, EnemyDrastea, "EnemyDrastea-247");
				break;
			}
			case 5230: {
			...
			case 5290: {
				...
				bringDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000195, EnemyEtis, "EnemyEtis-250");
				break;
			}
			case 5300: {
				EnemyDrastea* p = (EnemyDrastea*)obtainActorFromFactory(10001714);
				bringDirector()->addSubGroup(p);
				orderActorToFactory(10001720, EnemyDrastea, "EnemyDrastea-251");
				break;
			}
			case 5320: {
