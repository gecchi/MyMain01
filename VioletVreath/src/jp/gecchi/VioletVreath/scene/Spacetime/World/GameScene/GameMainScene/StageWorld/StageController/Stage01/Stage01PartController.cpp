...
void Stage01PartController::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 10: {
				orderActorToFactory(10000023, EnemyEtis, "EnemyEtis-19");
				break;
			}
			case 20: {
				orderActorToFactory(10000005, EnemyOebiusController002, "EnemyOebiusController002-20");
				break;
			}
			case 40: {
				orderActorToFactory(10000024, EnemyEtis, "EnemyEtis-21");
				break;
			}
			case 70: {
				orderActorToFactory(10000025, EnemyEtis, "EnemyEtis-22");
				break;
			}
			case 100: {
				orderSceneToFactory(10000000, Stage01_01, "Stage01_01-23");
			...
			case 39100: {
				orderSceneToFactory(10000003, Stage01_Climax, "Stage01_Climax-1003");
				break;
			}
			case 40000: {
		...
		_cnt_event = (_cnt_event < 1008-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
