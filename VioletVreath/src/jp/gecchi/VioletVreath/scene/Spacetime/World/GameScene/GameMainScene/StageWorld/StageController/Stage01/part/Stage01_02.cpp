    ...
    if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
        switch (getBehaveingFrame()) {
            ...
            case 7000: {
                ...
                bringSceneMediator()->addSubGroup(p6);
                break;
            }
            case 7030: {
            ...
            case 8000: {
                ...
                bringSceneMediator()->addSubGroup(p7);
                break;
            }
            case 8020: {
            ...
            case 9000: {
                ...
                bringSceneMediator()->addSubGroup(p8);
                break;
            }
            case 9010: {
            ...
            case 9500: {
                ...
                bringSceneMediator()->addSubGroup(p10);
                break;
            }
            case 9520: {
            ...
            case 10000: {
                ...
                bringSceneMediator()->addSubGroup(p11);
                break;
            }
            case 10030: {
