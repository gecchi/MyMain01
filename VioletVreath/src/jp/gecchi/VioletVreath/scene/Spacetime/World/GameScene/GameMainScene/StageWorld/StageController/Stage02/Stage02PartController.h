...
DECLARE_HASHVAL(EVENT_STG02_01_WAS_BROKEN);
DECLARE_HASHVAL(EVENT_STG02_02_WAS_BROKEN);
DECLARE_HASHVAL(EVENT_STG02_03_WAS_BROKEN);
DECLARE_HASHVAL(EVENT_STG02_CLIMAX_WAS_BROKEN);
