...
StageDebugPartController::StageDebugPartController(const char* prm_name) : StagePartController(prm_name) {
    ...
    // gen01 start
	frame f[] = {1,5,100,105,205,305,405,500,505,605,705,805,905,1005,1105,1205,1305,1405,1505,1605,1705,1805,1900,1905,2005,2105,2205,2305,2405,2500,2505,2605,2705,2805,2905,3005,3105,3200,3205,3305,3405,3505,3605,3705,3805,3900,3905,4005,4100,4105,4205,4305,4405,4500,4505,4605,4705,4805,4905,5005,5105,5205,5305,5405,5505,5605,5705,5805,5900,5905,6005,6105,6205,6305,6405,6500,6505,6605,6705,6805,6905,7005,7105,7200,7205,7305,7405,7505,7605,7705,7805,7900,7905,8005,8100,8105,8205,8305,8405,8500,8505,8605,8705,8805,8905,9005,9105,9205,9305,9405,9505,9605,9705,9805,9900,9905,10005,10105,10205,10305,10405,10500,10505,10605,10705,10805,10905,11005,11105,11205,11305,11405,11505,11605,11705,11805,11900,11905,12005,12105,12205,12305,12405,12500,12505,12605,12705,12805,12905,13005,13105,13205,13305,13405,13505,13605,13705,13805,13900,13905,14005,14105,14205,14305,14405,14500,14505,14605,14705,14805,14905,15005,15105,15205,15305,15405,15505,15605,15705,15805,15900,15905,16005,16105,16205,16305,16405,16500,16505,16605,16705,16805,16905,17005,17105,17205,17305,17405,17505,17605,17705,17805,17900,17905,18005,18105,18205,18305,18405,18500,18505,18605,18705,18805,18905,19005,19105,19205,19305,19400,19405,19505,19605,19705,19805,19900,19905,20000,20005,20105,20205,20305,20405,20500,20505,20605,20705,20805,20905,21005,21100,21105,21205,21305,21405,21505,21605,21705,21805,21900,21905,22000,22500,23900,24500,25900,26500,27900,28500,29900,30500,31900,32500,33900,34500,35900,36500,37900,38500,39900,40500,41900,42500,43900,44500,45900,46500,47900,48500,49900,50500,51900,52500,53900,54500,55900,56500,57900,58500};
	_paFrame_NextEvent = new frame[289];
	...
	requestActor(10000224, EnemyDrastea, "EnemyDrastea-10000224");
    // gen01 end
...
void StageDebugPartController::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000224);
			...
			case 1900: {
				requestActor(10000225, EnemyDrastea, "EnemyDrastea-10000225");
				break;
			}
			case 1905: {
			...
			case 2500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000225);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 2505: {
			...
			case 3900: {
				requestActor(10000226, EnemyDrastea, "EnemyDrastea-10000226");
				break;
			}
			case 3905: {
			...
			case 4500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000226);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 4505: {
			...
			case 5900: {
				requestActor(10000227, EnemyDrastea, "EnemyDrastea-10000227");
				break;
			}
			case 5905: {
			...
			case 6500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000227);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 6505: {
			...
			case 7900: {
				requestActor(10000228, EnemyDrastea, "EnemyDrastea-10000228");
				break;
			}
			case 7905: {
			...
			case 8500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000228);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 8505: {
			...
			case 9900: {
				requestActor(10000229, EnemyDrastea, "EnemyDrastea-10000229");
				break;
			}
			case 9905: {
			...
			case 10500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000229);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 10505: {
			...
			case 11900: {
				requestActor(10000230, EnemyDrastea, "EnemyDrastea-10000230");
				break;
			}
			case 11905: {
			...
			case 12500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000230);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 12505: {
			...
			case 13900: {
				requestActor(10000231, EnemyDrastea, "EnemyDrastea-10000231");
				break;
			}
			case 13905: {
			...
			case 14500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000231);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 14505: {
			...
			case 15900: {
				requestActor(10000232, EnemyDrastea, "EnemyDrastea-10000232");
				break;
			}
			case 15905: {
			...
			case 16500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000232);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 16505: {
			...
			case 17900: {
				requestActor(10000233, EnemyDrastea, "EnemyDrastea-10000233");
				break;
			}
			case 17905: {
			...
			case 18500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000233);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 18505: {
			...
			case 19400: {
				requestActor(10000254, VarietyRatislavia001, "VarietyRatislavia001-10000254");
				break;
			}
			case 19405: {
			...
			case 19900: {
				requestActor(10000234, EnemyDrastea, "EnemyDrastea-10000234");
				break;
			}
			case 19905: {
			...
			case 20000: {
				VarietyRatislavia001* pRatislavia = (VarietyRatislavia001*)receiveActor(10000254);
			...
			case 20500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000234);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 20505: {
			...
			case 21900: {
				requestActor(10000235, EnemyDrastea, "EnemyDrastea-10000235");
				break;
			}
			case 21905: {
			...
			case 22500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000235);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 23900: {
				requestActor(10000236, EnemyDrastea, "EnemyDrastea-10000236");
				break;
			}
			case 24500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000236);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 25900: {
				requestActor(10000237, EnemyDrastea, "EnemyDrastea-10000237");
				break;
			}
			case 26500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000237);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 27900: {
				requestActor(10000238, EnemyDrastea, "EnemyDrastea-10000238");
				break;
			}
			case 28500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000238);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 29900: {
				requestActor(10000239, EnemyDrastea, "EnemyDrastea-10000239");
				break;
			}
			case 30500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000239);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 31900: {
				requestActor(10000240, EnemyDrastea, "EnemyDrastea-10000240");
				break;
			}
			case 32500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000240);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 33900: {
				requestActor(10000241, EnemyDrastea, "EnemyDrastea-10000241");
				break;
			}
			case 34500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000241);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 35900: {
				requestActor(10000242, EnemyDrastea, "EnemyDrastea-10000242");
				break;
			}
			case 36500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000242);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 37900: {
				requestActor(10000243, EnemyDrastea, "EnemyDrastea-10000243");
				break;
			}
			case 38500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000243);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 39900: {
				requestActor(10000244, EnemyDrastea, "EnemyDrastea-10000244");
				break;
			}
			case 40500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000244);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 41900: {
				requestActor(10000245, EnemyDrastea, "EnemyDrastea-10000245");
				break;
			}
			case 42500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000245);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 43900: {
				requestActor(10000246, EnemyDrastea, "EnemyDrastea-10000246");
				break;
			}
			case 44500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000246);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 45900: {
				requestActor(10000247, EnemyDrastea, "EnemyDrastea-10000247");
				break;
			}
			case 46500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000247);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 47900: {
				requestActor(10000248, EnemyDrastea, "EnemyDrastea-10000248");
				break;
			}
			case 48500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000248);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 49900: {
				requestActor(10000249, EnemyDrastea, "EnemyDrastea-10000249");
				break;
			}
			case 50500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000249);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 51900: {
				requestActor(10000250, EnemyDrastea, "EnemyDrastea-10000250");
				break;
			}
			case 52500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000250);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 53900: {
				requestActor(10000251, EnemyDrastea, "EnemyDrastea-10000251");
				break;
			}
			case 54500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000251);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 55900: {
				requestActor(10000252, EnemyDrastea, "EnemyDrastea-10000252");
				break;
			}
			case 56500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000252);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			case 57900: {
				requestActor(10000253, EnemyDrastea, "EnemyDrastea-10000253");
				break;
			}
			case 58500: {
				EnemyDrastea* p = (EnemyDrastea*)receiveActor(10000253);
				bringSceneMediator()->appendGroupChild(p);
				break;
			}
			default :
		...
		_cnt_event = (_cnt_event < 289-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
