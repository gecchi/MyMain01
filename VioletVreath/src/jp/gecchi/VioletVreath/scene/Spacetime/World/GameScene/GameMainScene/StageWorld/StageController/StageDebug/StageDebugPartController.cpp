...
StageDebugPartController::StageDebugPartController(const char* prm_name) : StagePartController(prm_name) {
	...
	requestActor(10000021, EnemyErelmanController002, "EnemyErelmanController002-10000021");
	requestActor(10000022, EnemyErelmanController001, "EnemyErelmanController001-10000022");
	...
	requestActor(10001156, VarietyRatislavia002, "VarietyRatislavia002-10001156");
    // gen01 end
}
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 100: {
				...
				VarietyRatislavia002* pRatislavia = (VarietyRatislavia002*)receiveActor(10001156);
			...
			case 400: {
				...
				EnemyErelmanController002* pE1 = (EnemyErelmanController002*)receiveActor(10000021);
			...
			case 500: {
				...
				EnemyErelmanController001* pE2 = (EnemyErelmanController001*)receiveActor(10000022);
			...
			case 1400: {
				...
				bringSceneMediator()->appendGroupChild(p2);
				p2->setPosition(RND_ABOUT(PX_C(800), PX_C(2000)), RND_ABOUT(0, PX_C(2000)), RND(0, PX_C(5000)) );
				requestActor(10000013, EnemyOebiusController002, "EnemyOebiusController002-10000013");
				break;
			}
			case 1405: {
			...
			case 2000: {
				EnemyOebiusController002* p2 = (EnemyOebiusController002*)receiveActor(10000013);
				bringSceneMediator()->appendGroupChild(p2);
				p2->setPosition(RND_ABOUT(PX_C(800), PX_C(2000)), RND_ABOUT(0, PX_C(2000)), RND(0, PX_C(5000)) );
				break;
			}
			...
			case 9100: {
				requestScene(10000003, StageDebugPartWall, "StageDebugPartWall-10000003");
				break;
			}
			case 9105: {
			...
			case 19400: {
				requestActor(10001157, VarietyRatislavia001, "VarietyRatislavia001-10001157");
				break;
			}
			case 19405: {
			...
			case 20000: {
				VarietyRatislavia001* pRatislavia = (VarietyRatislavia001*)receiveActor(10001157);
				bringSceneMediator()->appendGroupChild(pRatislavia);
				break;
			}
			case 20005: {
			...
			case 21100: {
				requestScene(10000004, StageDebugPartClimax, "StageDebugPartClimax-10000004");
				break;
			}
			case 21105: {
			...
			case 39700: {
				requestActor(10000025, EnemyErmione, "EnemyErmione-10000025");
				break;
			}
			case 39900: {
			...
			case 40300: {
				EnemyErmione* pE = (EnemyErmione*)receiveActor(10000025);
				bringSceneMediator()->appendGroupChild(pE);
				pE->_x = RND(1000000,4000000);
				pE->_y = RND(-6000000,6000000);
				pE->_z = RND(-6000000,6000000);
		...
		_cnt_event = (_cnt_event < 1194-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
