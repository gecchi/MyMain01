...
StageDebugPartController::StageDebugPartController(const char* prm_name) : StagePartController(prm_name) {
    ...
    _paFrame_NextEvent = new frame[1192];
    memcpy(_paFrame_NextEvent, f, sizeof(f));
    _event_num = 1192;
    requestActor(10000004, EnemyOebiusController002, "EnemyOebiusController002-10000004");
    requestActor(10000019, EnemyErelmanController002, "EnemyErelmanController002-10000019");
    requestActor(10000020, EnemyErelmanController001, "EnemyErelmanController001-10000020");
    requestActor(10000021, EnemyErmione, "EnemyErmione-10000021");
    ...
    requestActor(10001124, EnemyDrastea, "EnemyDrastea-10001124");
    requestActor(10001154, VarietyRatislavia002, "VarietyRatislavia002-10001154");
    // gen01 end
}
    ...
    if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
        switch (getBehaveingFrame()) {
            ...
            case 100: {
                ...
                VarietyRatislavia002* pRatislavia = (VarietyRatislavia002*)receiveActor(10001154);
            ...
            case 300: {
                ...
                EnemyErmione* pE = (EnemyErmione*)receiveActor(10000021);
            ...
            case 400: {
                ...
                EnemyErelmanController002* pE1 = (EnemyErelmanController002*)receiveActor(10000019);
            ...
            case 500: {
                ...
                EnemyErelmanController001* pE2 = (EnemyErelmanController001*)receiveActor(10000020);
                bringSceneMediator()->appendGroupChild(pE2);
                pE2->setPosition(PX_C(3400), PX_C(0), PX_C(0) );
                EnemyDrastea* p = (EnemyDrastea*)receiveActor(10001124);
            ...
            case 19400: {
                requestActor(10001155, VarietyRatislavia001, "VarietyRatislavia001-10001155");
                break;
            }
            case 19405: {
            ...
            case 20000: {
                VarietyRatislavia001* pRatislavia = (VarietyRatislavia001*)receiveActor(10001155);
                bringSceneMediator()->appendGroupChild(pRatislavia);
                break;
            }
            case 20005: {
        ...
        _cnt_event = (_cnt_event < 1192-1 ? _cnt_event+1 : _cnt_event);
    }
    // gen02 end
