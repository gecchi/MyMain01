...
Stage01Part02::Stage01Part02(const char* prm_name) :
        Stage01Part<GgafLib::DefaultScene>(prm_name, EVENT_STAGE01_PART_02_WAS_FINISHED) {
    _class_name = "Stage01Part02";
...
void Stage01Part02::initialize() {

}

void Stage01Part02::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 100: {
				...
				getSceneChief()->appendChild(pEtis);
			...
			case 2300: {
				...
				getSceneChief()->appendChild(pStraea2);
				pStraea2->_z = 1800000;
				pStraea2->_y = -100000;
				break;
			}
			...
			case 2500: {
				...
				getSceneChief()->appendChild(pFormationEmilia);
				break;
			}
			case 2530: {
			...
			case 5000: {
				...
				getSceneChief()->appendChild(pRatislaviaA);
				FormationHalia* pF = (FormationHalia*)receiveActor(30001019);
				getSceneChief()->appendChild(pF);
				getSceneChief()->appendChild(receiveActor(30001030));
				break;
			}
			case 5020: {
			...
			case 6000: {
				...
				getSceneChief()->appendChild(pRatislaviaB);
				getSceneChief()->appendChild(receiveActor(30001031));
				break;
			}
			case 6010: {
			...
			case 7000: {
				...
				getSceneChief()->appendChild(pRatislavia);
				getSceneChief()->appendChild(receiveActor(30001032));
				break;
			}
			case 7030: {
			...
			case 8000: {
				getSceneChief()->appendChild(receiveActor(30001033));
				break;
			}
			case 8020: {
			...
			case 9000: {
				...
				getSceneChief()->appendChild(pF);
				getSceneChief()->appendChild(receiveActor(30001034));
				break;
			}
			case 9010: {
			...
			case 10000: {
				...
				getSceneChief()->appendChild(receiveActor(30001035));
				break;
			}
			case 10030: {
