...
GameMainScene::GameMainScene(const char* prm_name) : DefaultScene(prm_name) {
    ...
    _pFont16_SCORE->locate(PX2CO(GGAF_PROPERTY(GAME_BUFFER_WIDTH)), PX2CO(1));
    ...
    _pFont16_RANK->locate(PX2CO(GGAF_PROPERTY(GAME_BUFFER_WIDTH)), PX2CO(20));
    ...
    _pFont16_STAMINA->locate(PX2CO(GGAF_PROPERTY(GAME_BUFFER_WIDTH)), PX2CO(40));
    ...
    _pFont8_JIKI_X->locate(PX2CO(1), PX2CO(GGAF_PROPERTY(GAME_BUFFER_HEIGHT) - 8*3-1));
    _pFont8_JIKI_Y->locate(PX2CO(1), PX2CO(GGAF_PROPERTY(GAME_BUFFER_HEIGHT) - 8*2-1));
    _pFont8_JIKI_Z->locate(PX2CO(1), PX2CO(GGAF_PROPERTY(GAME_BUFFER_HEIGHT) - 8*1-1));
    ...
    _pRankFont->locate(PX2CO(GGAF_PROPERTY(GAME_BUFFER_WIDTH)), PX2CO(GGAF_PROPERTY(GAME_BUFFER_HEIGHT)));
