    ...
    switch (_pProg->get()) {
        ...
        case GameBeginningScene::PROG_SELECT_MODE: {
            if (_pProg->isJustChanged()) {
                pLabel01_->update(PXCO(200), PXCO(200), "GAME_BEGINNING_SCENE BEGIN");
                pLabel02_->update(PXCO(200), PXCO(250), "SELECT MODE!");
            }
        ...
        case GameBeginningScene::PROG_DECIDE: {
            if (_pProg->isJustChanged()) {
                pLabel02_->update(PXCO(300), PXCO(300), "OK OK OK");
