...
void Stage01_02::processBehavior() {
	...
	if (getActivePartFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getActivePartFrame()) {
			...
			case 1400: {
				orderActorToFactory(40000083, EnemyAstraea, "Astraea_39");
				break;
			}
			case 1420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000022);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000037, EnemyMetis, "Metis_40");
				break;
			}
			case 1480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000023);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000038, EnemyMetis, "Metis_41");
				break;
			}
			case 1540: {
			...
			case 1600: {
				...
				orderActorToFactory(40000084, FormationMassalia, "FormationMassalia_44");
				break;
			}
			case 1660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000026);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000041, EnemyMetis, "Metis_45");
				break;
			}
			case 1720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000027);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000042, EnemyMetis, "Metis_46");
				break;
			}
			case 1780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000028);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000043, EnemyMetis, "Metis_47");
				break;
			}
			case 1800: {
				orderActorToFactory(40000086, FormationPallas001a, "F001a_Pallas_48");
				orderActorToFactory(40000087, FormationPallas001b, "F001b_Pallas_49");
				orderActorToFactory(40000088, FormationPallas001c, "F001c_Pallas_50");
				orderActorToFactory(40000089, FormationPallas001d, "F001d_Pallas_51");
				orderActorToFactory(40000090, FormationPallas001a, "F001a_Pallas_52");
				orderActorToFactory(40000091, FormationPallas001d, "F001d_Pallas_53");
				orderActorToFactory(40000092, FormationPallas001b, "F001b_Pallas_54");
				orderActorToFactory(40000093, FormationPallas001c, "F001c_Pallas_55");
				orderActorToFactory(40000094, FormationPallas001a, "F001a_Pallas_56");
				orderActorToFactory(40000095, FormationPallas001d, "F001d_Pallas_57");
				orderActorToFactory(40000096, FormationPallas001b, "F001b_Pallas_58");
				orderActorToFactory(40000097, FormationPallas001c, "F001c_Pallas_59");
				break;
			}
			case 1840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000029);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000044, EnemyMetis, "Metis_60");
				break;
			}
			case 1900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000030);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000045, EnemyMetis, "Metis_61");
				break;
			}
			case 1960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000031);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000046, EnemyMetis, "Metis_62");
				break;
			}
			case 2020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000032);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000047, EnemyMetis, "Metis_63");
				break;
			}
			case 2080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000033);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000048, EnemyMetis, "Metis_64");
				break;
			}
			case 2100: {
				orderActorToFactory(40000098, FormationJuno001, "F002_Juno_65");
				break;
			}
			case 2140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000034);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000049, EnemyMetis, "Metis_66");
				break;
			}
			case 2200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000035);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000050, EnemyMetis, "Metis_67");
				break;
			}
			case 2260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000036);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000051, EnemyMetis, "Metis_68");
				break;
			}
			case 2300: {
			...
			case 2320: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000052, EnemyMetis, "Metis_69");
				break;
			}
			case 2380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000038);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000053, EnemyMetis, "Metis_70");
				break;
			}
			case 2440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000039);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000054, EnemyMetis, "Metis_71");
				break;
			}
			case 2500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000040);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000055, EnemyMetis, "Metis_72");
			...
			case 2560: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000056, EnemyMetis, "Metis_73");
				break;
			}
			case 2620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000042);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000057, EnemyMetis, "Metis_74");
				break;
			}
			case 2680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000043);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000058, EnemyMetis, "Metis_75");
				break;
			}
			case 2700: {
				{
			...
			case 2740: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000059, EnemyMetis, "Metis_76");
				break;
			}
			case 2800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000045);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000060, EnemyMetis, "Metis_77");
				break;
			}
			case 2860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000046);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000061, EnemyMetis, "Metis_78");
				break;
			}
			case 2920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000047);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000062, EnemyMetis, "Metis_79");
				break;
			}
			case 2980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(40000048);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000063, EnemyMetis, "Metis_80");
				break;
			}
			case 3000: {
			...
			case 4060: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(40000081, EnemyMetis, "Metis_99");
				break;
			}
			case 4100: {
				orderActorToFactory(40000100, VarietySylvia002, "VarietySylvia002_100");
				break;
			}
			case 4120: {
			...
			case 5100: {
				orderActorToFactory(40000101, VarietySylvia003, "VarietySylvia003_101");
				break;
			}
			case 6000: {
			...
			case 6100: {
				orderActorToFactory(40000102, VarietySylvia004, "VarietySylvia004_102");
				break;
			}
			case 7000: {
			...
			case 7100: {
				orderActorToFactory(40000103, VarietySylvia004, "VarietySylvia004_103");
				break;
			}
			case 8000: {
			...
			case 8100: {
				orderActorToFactory(40000104, FormationThalia, "FormationThalia_104");
				break;
			}
			case 8300: {
				orderActorToFactory(40000106, FormationIris002, "F002_Iris_105");
				orderActorToFactory(40000107, FormationIris001, "F001_Iris_106");
				orderActorToFactory(40000108, FormationIris001, "F001_Iris_107");
				orderActorToFactory(40000109, FormationIris002, "F002_Iris_108");
				orderActorToFactory(40000110, FormationIris001, "F001_Iris_109");
				orderActorToFactory(40000111, FormationIris002, "F002_Iris_110");
				break;
			}
			case 9000: {
			...
			case 9200: {
				{
				FormationTableScene* ta = NEW FormationTableScene("FormationTable_40000105");
				ta->setMaxPerformFrame(2000);
				addSubLast(ta);
				ta->addToTable(((FormationIris002*)obtainActorFromFactory(40000106)), 400);
				ta->addToTable(((FormationIris001*)obtainActorFromFactory(40000107)), 400);
				ta->addToTable(((FormationIris001*)obtainActorFromFactory(40000108)), 400);
				ta->addToTable(((FormationIris002*)obtainActorFromFactory(40000109)), 400);
				ta->addToTable(((FormationIris001*)obtainActorFromFactory(40000110)), 400);
				ta->addToTable(((FormationIris002*)obtainActorFromFactory(40000111)), 400);
				}
				break;
			}
			case 10000: {
		...
		_cnt_event = (_cnt_event < 103-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
}
