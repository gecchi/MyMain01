...
Stage01_02::Stage01_02(const char* prm_name) : DefaultScene(prm_name) {
    ...
    // gen01 start
	frame f[] = {1,100,300,400,500,700,900,1000,1100,1300,1500,1700,1900,2100,2300,2400,2500,2700,2900,3000,3100,3300,3400,3500,3700,3900,4000,4100,4300,4400,4500,4700,4900,5000,5400,6000,6400,7000,7400,8000,8400,8600,8900,9000,9200,9400,9500,10000};
	_paFrame_NextEvent = new frame[48];
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 1000: {
				...
				FormationEbe001* pF12 = (FormationEbe001*)obtainActorFromFactory(30000054);
				getSceneDirector()->addSubGroup(pF12);
				break;
			}
			case 1100: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(30000005);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(30000008, EnemyEtis, "EnemyEtis-13");
				break;
			}
			case 1300: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(30000006);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(30000009, EnemyEtis, "EnemyEtis-14");
				break;
			}
			case 1500: {
			...
			case 2700: {
				...
				{
				FormationTableScene* ta = NEW FormationTableScene("FormationTableScene-37");
			...
			case 2900: {
				...
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(30000017, EnemyEtis, "EnemyEtis-38");
				break;
			}
			case 3000: {
				FormationGeria001* pF39 = (FormationGeria001*)obtainActorFromFactory(30000041);
				getSceneDirector()->addSubGroup(pF39);
				break;
			}
			case 3100: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(30000015);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(30000018, EnemyEtis, "EnemyEtis-40");
				break;
			}
			case 3300: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(30000016);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(30000019, EnemyEtis, "EnemyEtis-41");
				break;
			}
			case 3400: {
			...
			case 9200: {
				{
				FormationTableScene* ta = NEW FormationTableScene("FormationTableScene-67");
			...
			case 9400: {
				orderActorToFactory(30000060, EnemyEsperia, "EnemyEsperia-68");
				break;
			}
			case 9500: {
		...
		_cnt_event = (_cnt_event < 48-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
