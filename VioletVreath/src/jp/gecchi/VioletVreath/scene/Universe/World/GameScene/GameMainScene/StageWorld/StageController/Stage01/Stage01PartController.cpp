...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10000019, EnemyMetis, "EnemyMetis-3");
	orderActorToFactory(10000020, EnemyMetis, "EnemyMetis-4");
	orderActorToFactory(10000021, EnemyMetis, "EnemyMetis-5");
	orderActorToFactory(10000022, EnemyMetis, "EnemyMetis-6");
	orderActorToFactory(10000023, EnemyMetis, "EnemyMetis-7");
	orderActorToFactory(10000024, EnemyMetis, "EnemyMetis-8");
	orderActorToFactory(10000025, EnemyMetis, "EnemyMetis-9");
	orderActorToFactory(10000026, EnemyMetis, "EnemyMetis-10");
	orderActorToFactory(10000027, EnemyMetis, "EnemyMetis-11");
	orderActorToFactory(10000028, EnemyMetis, "EnemyMetis-12");
	orderActorToFactory(10000029, EnemyMetis, "EnemyMetis-13");
	orderActorToFactory(10000030, EnemyMetis, "EnemyMetis-14");
	orderActorToFactory(10000031, EnemyMetis, "EnemyMetis-15");
	orderActorToFactory(10000032, EnemyMetis, "EnemyMetis-16");
	orderActorToFactory(10000033, EnemyMetis, "EnemyMetis-17");
	orderActorToFactory(10000034, EnemyMetis, "EnemyMetis-18");
	orderActorToFactory(10000035, EnemyMetis, "EnemyMetis-19");
	orderActorToFactory(10000036, EnemyMetis, "EnemyMetis-20");
	orderActorToFactory(10000037, EnemyMetis, "EnemyMetis-21");
	orderActorToFactory(10000038, EnemyMetis, "EnemyMetis-22");
	orderActorToFactory(10000039, EnemyMetis, "EnemyMetis-23");
	orderActorToFactory(10000040, EnemyMetis, "EnemyMetis-24");
	orderActorToFactory(10000041, EnemyMetis, "EnemyMetis-25");
	orderActorToFactory(10000042, EnemyMetis, "EnemyMetis-26");
	orderActorToFactory(10000043, EnemyMetis, "EnemyMetis-27");
	orderActorToFactory(10000044, EnemyMetis, "EnemyMetis-28");
	orderActorToFactory(10000045, EnemyMetis, "EnemyMetis-29");
	orderActorToFactory(10000046, EnemyMetis, "EnemyMetis-30");
	orderActorToFactory(10000047, EnemyMetis, "EnemyMetis-31");
	orderActorToFactory(10000048, EnemyMetis, "EnemyMetis-32");
	orderActorToFactory(10000049, EnemyMetis, "EnemyMetis-33");
	orderActorToFactory(10000050, EnemyMetis, "EnemyMetis-34");
	orderActorToFactory(10000051, EnemyMetis, "EnemyMetis-35");
	orderActorToFactory(10000052, EnemyMetis, "EnemyMetis-36");
	orderActorToFactory(10000053, EnemyMetis, "EnemyMetis-37");
	orderActorToFactory(10000054, EnemyMetis, "EnemyMetis-38");
	orderActorToFactory(10000055, EnemyMetis, "EnemyMetis-39");
	orderActorToFactory(10000056, EnemyMetis, "EnemyMetis-40");
	orderActorToFactory(10000057, EnemyMetis, "EnemyMetis-41");
	orderActorToFactory(10000058, EnemyMetis, "EnemyMetis-42");
	orderActorToFactory(10000059, EnemyMetis, "EnemyMetis-43");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getActivePartFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getActivePartFrame()) {
			...
			case 20: {
				orderActorToFactory(10000060, EnemyMetis, "EnemyMetis-44");
				break;
			}
			case 40: {
				orderActorToFactory(10000061, EnemyMetis, "EnemyMetis-45");
				break;
			}
			case 60: {
				orderActorToFactory(10000062, EnemyMetis, "EnemyMetis-46");
				break;
			}
			case 80: {
				orderActorToFactory(10000063, EnemyMetis, "EnemyMetis-47");
				break;
			}
			case 100: {
				...
				orderActorToFactory(10000064, EnemyMetis, "EnemyMetis-48");
				break;
			}
			case 120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000020);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000065, EnemyMetis, "EnemyMetis-49");
				break;
			}
			case 140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000021);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000066, EnemyMetis, "EnemyMetis-50");
				break;
			}
			case 160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000022);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000067, EnemyMetis, "EnemyMetis-51");
				break;
			}
			case 180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000023);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000068, EnemyMetis, "EnemyMetis-52");
				break;
			}
			case 200: {
			...
			case 10000: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000559, EnemyMetis, "EnemyMetis-549");
				break;
			}
			case 10020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000515);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000560, EnemyMetis, "EnemyMetis-550");
				break;
			}
			case 10040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000516);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000561, EnemyMetis, "EnemyMetis-551");
				break;
			}
			case 10060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000517);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000562, EnemyMetis, "EnemyMetis-552");
				break;
			}
			case 10080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000518);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000563, EnemyMetis, "EnemyMetis-553");
				break;
			}
			case 10100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000519);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000564, EnemyMetis, "EnemyMetis-554");
				break;
			}
			case 10120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000520);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000565, EnemyMetis, "EnemyMetis-555");
				break;
			}
			case 10140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000521);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000566, EnemyMetis, "EnemyMetis-556");
				break;
			}
			case 10160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000522);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000567, EnemyMetis, "EnemyMetis-557");
				break;
			}
			case 10180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000523);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000568, EnemyMetis, "EnemyMetis-558");
				break;
			}
			case 10200: {
			...
			case 20000: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001059, EnemyMetis, "EnemyMetis-1055");
				break;
			}
			case 20020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001015);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001060, EnemyMetis, "EnemyMetis-1056");
				break;
			}
			case 20040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001016);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001061, EnemyMetis, "EnemyMetis-1057");
				break;
			}
			case 20060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001017);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001062, EnemyMetis, "EnemyMetis-1058");
				break;
			}
			case 20080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001018);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001063, EnemyMetis, "EnemyMetis-1059");
				break;
			}
			case 20100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001019);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001064, EnemyMetis, "EnemyMetis-1060");
				break;
			}
			case 20120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001020);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001065, EnemyMetis, "EnemyMetis-1061");
				break;
			}
			case 20140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001021);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001066, EnemyMetis, "EnemyMetis-1062");
				break;
			}
			case 20160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001022);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001067, EnemyMetis, "EnemyMetis-1063");
				break;
			}
			case 20180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001023);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001068, EnemyMetis, "EnemyMetis-1064");
				break;
			}
			case 20200: {
