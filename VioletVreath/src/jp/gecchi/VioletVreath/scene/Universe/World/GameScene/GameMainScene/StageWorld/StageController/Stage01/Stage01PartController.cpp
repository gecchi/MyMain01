...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10000021, EnemyThisbe, "EnemyThisbe-3");
	orderActorToFactory(10000022, FormationHebe001, "FormationHebe001-4");
	orderActorToFactory(10000023, FormationEunomia001a, "FormationEunomia001a-5");
	orderActorToFactory(10000024, FormationEunomia001b, "FormationEunomia001b-6");
	orderActorToFactory(10000025, EnemyAstraea, "EnemyAstraea-7");
	orderActorToFactory(10000026, EnemyThisbe002, "EnemyThisbe002-8");
	...
	orderActorToFactory(10000068, EnemyMetis, "EnemyMetis-50");
	orderActorToFactory(10001524, EnemyHesperia, "EnemyHesperia-51");
	orderActorToFactory(10001525, EnemyHesperia, "EnemyHesperia-52");
	orderActorToFactory(10001526, EnemyHesperia, "EnemyHesperia-53");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getActivePartFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getActivePartFrame()) {
			...
			case 20: {
				orderActorToFactory(10000069, EnemyMetis, "EnemyMetis-54");
				break;
			}
			case 40: {
				orderActorToFactory(10000070, EnemyMetis, "EnemyMetis-55");
				break;
			}
			case 60: {
				orderActorToFactory(10000071, EnemyMetis, "EnemyMetis-56");
				break;
			}
			case 80: {
				orderActorToFactory(10000072, EnemyMetis, "EnemyMetis-57");
				break;
			}
			case 100: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000073, EnemyMetis, "EnemyMetis-58");
				EnemyHesperia* p59 = (EnemyHesperia*)obtainActorFromFactory(10001524);
				getDirector()->addSubGroup(p59);
				orderActorToFactory(10001527, EnemyHesperia, "EnemyHesperia-60");
				break;
			}
			case 120: {
			...
			case 160: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000076, EnemyMetis, "EnemyMetis-63");
				break;
			}
			case 180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000032);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000077, EnemyMetis, "EnemyMetis-64");
				break;
			}
			case 200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000033);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000078, EnemyMetis, "EnemyMetis-65");
				break;
			}
			case 220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000034);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000079, EnemyMetis, "EnemyMetis-66");
				break;
			}
			case 240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000035);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000080, EnemyMetis, "EnemyMetis-67");
				break;
			}
			case 260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000036);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000081, EnemyMetis, "EnemyMetis-68");
				break;
			}
			case 280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000037);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000082, EnemyMetis, "EnemyMetis-69");
				break;
			}
			case 300: {
				orderActorToFactory(10000006, EnemyHermione, "EnemyHermione-70");
				EnemyThisbe* p = (EnemyThisbe*)obtainActorFromFactory(10000021);
				getDirector()->addSubGroup(p);
				p->_X = 0;
				p->_Y = 0;
				p->_Z = 2000000;
				FormationHebe001* pF71 = (FormationHebe001*)obtainActorFromFactory(10000022);
				getDirector()->addSubGroup(pF71);
				FormationEunomia001a* pFormationEunomia = (FormationEunomia001a*)obtainActorFromFactory(10000023);
				getDirector()->addSubGroup(pFormationEunomia);
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000038);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000083, EnemyMetis, "EnemyMetis-72");
				break;
			}
			case 320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000039);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000084, EnemyMetis, "EnemyMetis-73");
				break;
			}
			case 340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000040);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000085, EnemyMetis, "EnemyMetis-74");
				break;
			}
			case 360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000041);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000086, EnemyMetis, "EnemyMetis-75");
				break;
			}
			case 380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000042);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000087, EnemyMetis, "EnemyMetis-76");
				break;
			}
			case 400: {
				EnemyThisbe002* p = (EnemyThisbe002*)obtainActorFromFactory(10000026);
				getDirector()->addSubGroup(p);
				p->_X = 0;
				p->_Y = 0;
				p->_Z = 2000000;
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000088, EnemyMetis, "EnemyMetis-77");
				EnemyHesperia* p78 = (EnemyHesperia*)obtainActorFromFactory(10001525);
				getDirector()->addSubGroup(p78);
				orderActorToFactory(10001528, EnemyHesperia, "EnemyHesperia-79");
				break;
			}
			case 420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000044);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000089, EnemyMetis, "EnemyMetis-80");
				break;
			}
			case 440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000045);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000090, EnemyMetis, "EnemyMetis-81");
				break;
			}
			case 460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000046);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000091, EnemyMetis, "EnemyMetis-82");
				break;
			}
			case 480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000047);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000092, EnemyMetis, "EnemyMetis-83");
				break;
			}
			case 500: {
				Stage01WalledScene* pWScene = (Stage01WalledScene*)obtainSceneFromFactory(10000002);
				addSubLast(pWScene);
				FormationEunomia001b* pFormationEunomia = (FormationEunomia001b*)obtainActorFromFactory(10000024);
				getDirector()->addSubGroup(pFormationEunomia);
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000048);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000093, EnemyMetis, "EnemyMetis-84");
				break;
			}
			case 520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000049);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000094, EnemyMetis, "EnemyMetis-85");
				break;
			}
			case 540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000050);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000095, EnemyMetis, "EnemyMetis-86");
				break;
			}
			case 560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000051);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000096, EnemyMetis, "EnemyMetis-87");
				break;
			}
			case 580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000052);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000097, EnemyMetis, "EnemyMetis-88");
				break;
			}
			case 600: {
				EnemyAstraea* pAstraea2 = (EnemyAstraea*)obtainActorFromFactory(10000025);
				getDirector()->addSubGroup(pAstraea2);
				pAstraea2->_Z = 1000000;
				pAstraea2->_Y = 10000;
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000053);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000098, EnemyMetis, "EnemyMetis-89");
				break;
			}
			case 620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000054);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000099, EnemyMetis, "EnemyMetis-90");
				break;
			}
			case 640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000055);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000100, EnemyMetis, "EnemyMetis-91");
				break;
			}
			case 660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000056);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000101, EnemyMetis, "EnemyMetis-92");
				break;
			}
			case 680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000057);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000102, EnemyMetis, "EnemyMetis-93");
				break;
			}
			case 700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000058);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000103, EnemyMetis, "EnemyMetis-94");
				EnemyHesperia* p95 = (EnemyHesperia*)obtainActorFromFactory(10001526);
				getDirector()->addSubGroup(p95);
				orderActorToFactory(10001529, EnemyHesperia, "EnemyHesperia-96");
				break;
			}
			case 720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000059);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000104, EnemyMetis, "EnemyMetis-97");
				break;
			}
			case 740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000060);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000105, EnemyMetis, "EnemyMetis-98");
				break;
			}
			case 760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000061);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000106, EnemyMetis, "EnemyMetis-99");
				break;
			}
			case 780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000062);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000107, EnemyMetis, "EnemyMetis-100");
				break;
			}
			case 800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000063);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000108, EnemyMetis, "EnemyMetis-101");
				break;
			}
			case 820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000064);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000109, EnemyMetis, "EnemyMetis-102");
				break;
			}
			case 840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000065);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000110, EnemyMetis, "EnemyMetis-103");
				break;
			}
			case 860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000066);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000111, EnemyMetis, "EnemyMetis-104");
				break;
			}
			case 880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000067);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000112, EnemyMetis, "EnemyMetis-105");
				break;
			}
			case 900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000068);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000113, EnemyMetis, "EnemyMetis-106");
				break;
			}
			case 920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000069);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000114, EnemyMetis, "EnemyMetis-107");
				break;
			}
			case 940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000070);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000115, EnemyMetis, "EnemyMetis-108");
				break;
			}
			case 960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000071);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000116, EnemyMetis, "EnemyMetis-109");
				break;
			}
			case 980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000072);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000117, EnemyMetis, "EnemyMetis-110");
				break;
			}
			case 1000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000073);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000118, EnemyMetis, "EnemyMetis-111");
				EnemyHesperia* p112 = (EnemyHesperia*)obtainActorFromFactory(10001527);
				getDirector()->addSubGroup(p112);
				orderActorToFactory(10001530, EnemyHesperia, "EnemyHesperia-113");
				break;
			}
			case 1020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000074);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000119, EnemyMetis, "EnemyMetis-114");
				break;
			}
			case 1040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000075);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000120, EnemyMetis, "EnemyMetis-115");
				break;
			}
			case 1060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000076);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000121, EnemyMetis, "EnemyMetis-116");
				break;
			}
			case 1080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000077);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000122, EnemyMetis, "EnemyMetis-117");
				break;
			}
			case 1100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000078);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000123, EnemyMetis, "EnemyMetis-118");
				break;
			}
			case 1120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000079);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000124, EnemyMetis, "EnemyMetis-119");
				break;
			}
			case 1140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000080);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000125, EnemyMetis, "EnemyMetis-120");
				break;
			}
			case 1160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000081);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000126, EnemyMetis, "EnemyMetis-121");
				break;
			}
			case 1180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000082);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000127, EnemyMetis, "EnemyMetis-122");
				break;
			}
			case 1200: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000128, EnemyMetis, "EnemyMetis-123");
				break;
			}
			case 1220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000084);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000129, EnemyMetis, "EnemyMetis-124");
				break;
			}
			case 1240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000085);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000130, EnemyMetis, "EnemyMetis-125");
				break;
			}
			case 1260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000086);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000131, EnemyMetis, "EnemyMetis-126");
				break;
			}
			case 1280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000087);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000132, EnemyMetis, "EnemyMetis-127");
				break;
			}
			case 1300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000088);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000133, EnemyMetis, "EnemyMetis-128");
				EnemyHesperia* p129 = (EnemyHesperia*)obtainActorFromFactory(10001528);
				getDirector()->addSubGroup(p129);
				orderActorToFactory(10001531, EnemyHesperia, "EnemyHesperia-130");
				break;
			}
			case 1320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000089);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000134, EnemyMetis, "EnemyMetis-131");
				break;
			}
			case 1340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000090);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000135, EnemyMetis, "EnemyMetis-132");
				break;
			}
			case 1360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000091);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000136, EnemyMetis, "EnemyMetis-133");
				break;
			}
			case 1380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000092);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000137, EnemyMetis, "EnemyMetis-134");
				break;
			}
			case 1400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000093);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000138, EnemyMetis, "EnemyMetis-135");
				break;
			}
			case 1420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000094);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000139, EnemyMetis, "EnemyMetis-136");
				break;
			}
			case 1440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000095);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000140, EnemyMetis, "EnemyMetis-137");
				break;
			}
			case 1460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000096);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000141, EnemyMetis, "EnemyMetis-138");
				break;
			}
			case 1480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000097);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000142, EnemyMetis, "EnemyMetis-139");
				break;
			}
			case 1500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000098);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000143, EnemyMetis, "EnemyMetis-140");
				break;
			}
			case 1520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000099);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000144, EnemyMetis, "EnemyMetis-141");
				break;
			}
			case 1540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000100);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000145, EnemyMetis, "EnemyMetis-142");
				break;
			}
			case 1560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000101);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000146, EnemyMetis, "EnemyMetis-143");
				break;
			}
			case 1580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000102);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000147, EnemyMetis, "EnemyMetis-144");
				break;
			}
			case 1600: {
				orderActorToFactory(10000005, FormationEunomia001a, "FormationEunomia001a-145");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000103);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000148, EnemyMetis, "EnemyMetis-146");
				EnemyHesperia* p147 = (EnemyHesperia*)obtainActorFromFactory(10001529);
				getDirector()->addSubGroup(p147);
				orderActorToFactory(10001532, EnemyHesperia, "EnemyHesperia-148");
				break;
			}
			case 1620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000104);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000149, EnemyMetis, "EnemyMetis-149");
				break;
			}
			case 1640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000105);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000150, EnemyMetis, "EnemyMetis-150");
				break;
			}
			case 1660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000106);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000151, EnemyMetis, "EnemyMetis-151");
				break;
			}
			case 1680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000107);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000152, EnemyMetis, "EnemyMetis-152");
				break;
			}
			case 1700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000108);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000153, EnemyMetis, "EnemyMetis-153");
				break;
			}
			case 1720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000109);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000154, EnemyMetis, "EnemyMetis-154");
				break;
			}
			case 1740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000110);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000155, EnemyMetis, "EnemyMetis-155");
				break;
			}
			case 1760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000111);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000156, EnemyMetis, "EnemyMetis-156");
				break;
			}
			case 1780: {
			...
			case 1900: {
				...
				EnemyHesperia* p164 = (EnemyHesperia*)obtainActorFromFactory(10001530);
				getDirector()->addSubGroup(p164);
				orderActorToFactory(10001533, EnemyHesperia, "EnemyHesperia-165");
				break;
			}
			case 1920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000119);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000164, EnemyMetis, "EnemyMetis-166");
				break;
			}
			case 1940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000120);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000165, EnemyMetis, "EnemyMetis-167");
				break;
			}
			case 1960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000121);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000166, EnemyMetis, "EnemyMetis-168");
				break;
			}
			case 1980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000122);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000167, EnemyMetis, "EnemyMetis-169");
				break;
			}
			case 2000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000123);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000168, EnemyMetis, "EnemyMetis-170");
				break;
			}
			case 2020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000124);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000169, EnemyMetis, "EnemyMetis-171");
				break;
			}
			case 2040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000125);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000170, EnemyMetis, "EnemyMetis-172");
				break;
			}
			case 2060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000126);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000171, EnemyMetis, "EnemyMetis-173");
				break;
			}
			case 2080: {
			...
			case 2160: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000176, EnemyMetis, "EnemyMetis-178");
				break;
			}
			case 2180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000132);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000177, EnemyMetis, "EnemyMetis-179");
				break;
			}
			case 2200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000133);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000178, EnemyMetis, "EnemyMetis-180");
				EnemyHesperia* p181 = (EnemyHesperia*)obtainActorFromFactory(10001531);
				getDirector()->addSubGroup(p181);
				orderActorToFactory(10001534, EnemyHesperia, "EnemyHesperia-182");
				break;
			}
			case 2220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000134);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000179, EnemyMetis, "EnemyMetis-183");
				break;
			}
			case 2240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000135);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000180, EnemyMetis, "EnemyMetis-184");
				break;
			}
			case 2260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000136);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000181, EnemyMetis, "EnemyMetis-185");
				break;
			}
			case 2280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000137);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000182, EnemyMetis, "EnemyMetis-186");
				break;
			}
			case 2300: {
				orderActorToFactory(10000007, EnemyHermione, "EnemyHermione-187");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000138);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000183, EnemyMetis, "EnemyMetis-188");
				break;
			}
			case 2320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000139);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000184, EnemyMetis, "EnemyMetis-189");
				break;
			}
			case 2340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000140);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000185, EnemyMetis, "EnemyMetis-190");
				break;
			}
			case 2360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000141);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000186, EnemyMetis, "EnemyMetis-191");
				break;
			}
			case 2380: {
			...
			case 2500: {
				...
				EnemyHesperia* p199 = (EnemyHesperia*)obtainActorFromFactory(10001532);
				getDirector()->addSubGroup(p199);
				orderActorToFactory(10001535, EnemyHesperia, "EnemyHesperia-200");
				break;
			}
			case 2520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000149);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000194, EnemyMetis, "EnemyMetis-201");
				break;
			}
			case 2540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000150);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000195, EnemyMetis, "EnemyMetis-202");
				break;
			}
			case 2560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000151);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000196, EnemyMetis, "EnemyMetis-203");
				break;
			}
			case 2580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000152);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000197, EnemyMetis, "EnemyMetis-204");
				break;
			}
			case 2600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000153);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000198, EnemyMetis, "EnemyMetis-205");
				break;
			}
			case 2620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000154);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000199, EnemyMetis, "EnemyMetis-206");
				break;
			}
			case 2640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000155);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000200, EnemyMetis, "EnemyMetis-207");
				break;
			}
			case 2660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000156);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000201, EnemyMetis, "EnemyMetis-208");
				break;
			}
			case 2680: {
			...
			case 2800: {
				...
				EnemyHesperia* p216 = (EnemyHesperia*)obtainActorFromFactory(10001533);
				getDirector()->addSubGroup(p216);
				orderActorToFactory(10001536, EnemyHesperia, "EnemyHesperia-217");
				break;
			}
			case 2820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000164);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000209, EnemyMetis, "EnemyMetis-218");
				break;
			}
			case 2840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000165);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000210, EnemyMetis, "EnemyMetis-219");
				break;
			}
			case 2860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000166);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000211, EnemyMetis, "EnemyMetis-220");
				break;
			}
			case 2880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000167);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000212, EnemyMetis, "EnemyMetis-221");
				break;
			}
			case 2900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000168);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000213, EnemyMetis, "EnemyMetis-222");
				break;
			}
			case 2920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000169);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000214, EnemyMetis, "EnemyMetis-223");
				break;
			}
			case 2940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000170);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000215, EnemyMetis, "EnemyMetis-224");
				break;
			}
			case 2960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000171);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000216, EnemyMetis, "EnemyMetis-225");
				break;
			}
			case 2980: {
			...
			case 3100: {
				...
				EnemyHesperia* p233 = (EnemyHesperia*)obtainActorFromFactory(10001534);
				getDirector()->addSubGroup(p233);
				orderActorToFactory(10001537, EnemyHesperia, "EnemyHesperia-234");
				break;
			}
			case 3120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000179);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000224, EnemyMetis, "EnemyMetis-235");
				break;
			}
			case 3140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000180);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000225, EnemyMetis, "EnemyMetis-236");
				break;
			}
			case 3160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000181);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000226, EnemyMetis, "EnemyMetis-237");
				break;
			}
			case 3180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000182);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000227, EnemyMetis, "EnemyMetis-238");
				break;
			}
			case 3200: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000228, EnemyMetis, "EnemyMetis-239");
				break;
			}
			case 3220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000184);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000229, EnemyMetis, "EnemyMetis-240");
				break;
			}
			case 3240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000185);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000230, EnemyMetis, "EnemyMetis-241");
				break;
			}
			case 3260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000186);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000231, EnemyMetis, "EnemyMetis-242");
				break;
			}
			case 3280: {
			...
			case 3400: {
				...
				EnemyHesperia* p250 = (EnemyHesperia*)obtainActorFromFactory(10001535);
				getDirector()->addSubGroup(p250);
				orderActorToFactory(10001538, EnemyHesperia, "EnemyHesperia-251");
				break;
			}
			case 3420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000194);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000239, EnemyMetis, "EnemyMetis-252");
				break;
			}
			case 3440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000195);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000240, EnemyMetis, "EnemyMetis-253");
				break;
			}
			case 3460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000196);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000241, EnemyMetis, "EnemyMetis-254");
				break;
			}
			case 3480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000197);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000242, EnemyMetis, "EnemyMetis-255");
				break;
			}
			case 3500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000198);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000243, EnemyMetis, "EnemyMetis-256");
				break;
			}
			case 3520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000199);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000244, EnemyMetis, "EnemyMetis-257");
				break;
			}
			case 3540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000200);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000245, EnemyMetis, "EnemyMetis-258");
				break;
			}
			case 3560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000201);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000246, EnemyMetis, "EnemyMetis-259");
				break;
			}
			case 3580: {
			...
			case 3700: {
				...
				EnemyHesperia* p267 = (EnemyHesperia*)obtainActorFromFactory(10001536);
				getDirector()->addSubGroup(p267);
				orderActorToFactory(10001539, EnemyHesperia, "EnemyHesperia-268");
				break;
			}
			case 3720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000209);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000254, EnemyMetis, "EnemyMetis-269");
				break;
			}
			case 3740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000210);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000255, EnemyMetis, "EnemyMetis-270");
				break;
			}
			case 3760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000211);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000256, EnemyMetis, "EnemyMetis-271");
				break;
			}
			case 3780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000212);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000257, EnemyMetis, "EnemyMetis-272");
				break;
			}
			case 3800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000213);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000258, EnemyMetis, "EnemyMetis-273");
				break;
			}
			case 3820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000214);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000259, EnemyMetis, "EnemyMetis-274");
				break;
			}
			case 3840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000215);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000260, EnemyMetis, "EnemyMetis-275");
				break;
			}
			case 3860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000216);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000261, EnemyMetis, "EnemyMetis-276");
				break;
			}
			case 3880: {
			...
			case 3960: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000266, EnemyMetis, "EnemyMetis-281");
				break;
			}
			case 3980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000222);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000267, EnemyMetis, "EnemyMetis-282");
				break;
			}
			case 4000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000223);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000268, EnemyMetis, "EnemyMetis-283");
				EnemyHesperia* p284 = (EnemyHesperia*)obtainActorFromFactory(10001537);
				getDirector()->addSubGroup(p284);
				orderActorToFactory(10001540, EnemyHesperia, "EnemyHesperia-285");
				break;
			}
			case 4020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000224);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000269, EnemyMetis, "EnemyMetis-286");
				break;
			}
			case 4040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000225);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000270, EnemyMetis, "EnemyMetis-287");
				break;
			}
			case 4060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000226);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000271, EnemyMetis, "EnemyMetis-288");
				break;
			}
			case 4080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000227);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000272, EnemyMetis, "EnemyMetis-289");
				break;
			}
			case 4100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000228);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000273, EnemyMetis, "EnemyMetis-290");
				break;
			}
			case 4120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000229);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000274, EnemyMetis, "EnemyMetis-291");
				break;
			}
			case 4140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000230);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000275, EnemyMetis, "EnemyMetis-292");
				break;
			}
			case 4160: {
			...
			case 4180: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000277, EnemyMetis, "EnemyMetis-294");
				break;
			}
			case 4200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000233);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000278, EnemyMetis, "EnemyMetis-295");
				break;
			}
			case 4220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000234);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000279, EnemyMetis, "EnemyMetis-296");
				break;
			}
			case 4240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000235);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000280, EnemyMetis, "EnemyMetis-297");
				break;
			}
			case 4260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000236);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000281, EnemyMetis, "EnemyMetis-298");
				break;
			}
			case 4280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000237);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000282, EnemyMetis, "EnemyMetis-299");
				break;
			}
			case 4300: {
				orderActorToFactory(10000008, EnemyHermione, "EnemyHermione-300");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000238);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000283, EnemyMetis, "EnemyMetis-301");
				EnemyHesperia* p302 = (EnemyHesperia*)obtainActorFromFactory(10001538);
				getDirector()->addSubGroup(p302);
				orderActorToFactory(10001541, EnemyHesperia, "EnemyHesperia-303");
				break;
			}
			case 4320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000239);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000284, EnemyMetis, "EnemyMetis-304");
				break;
			}
			case 4340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000240);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000285, EnemyMetis, "EnemyMetis-305");
				break;
			}
			case 4360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000241);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000286, EnemyMetis, "EnemyMetis-306");
				break;
			}
			case 4380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000242);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000287, EnemyMetis, "EnemyMetis-307");
				break;
			}
			case 4400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000243);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000288, EnemyMetis, "EnemyMetis-308");
				break;
			}
			case 4420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000244);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000289, EnemyMetis, "EnemyMetis-309");
				break;
			}
			case 4440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000245);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000290, EnemyMetis, "EnemyMetis-310");
				break;
			}
			case 4460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000246);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000291, EnemyMetis, "EnemyMetis-311");
				break;
			}
			case 4480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000247);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000292, EnemyMetis, "EnemyMetis-312");
				break;
			}
			case 4500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000248);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000293, EnemyMetis, "EnemyMetis-313");
				break;
			}
			case 4520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000249);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000294, EnemyMetis, "EnemyMetis-314");
				break;
			}
			case 4540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000250);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000295, EnemyMetis, "EnemyMetis-315");
				break;
			}
			case 4560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000251);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000296, EnemyMetis, "EnemyMetis-316");
				break;
			}
			case 4580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000252);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000297, EnemyMetis, "EnemyMetis-317");
				break;
			}
			case 4600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000253);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000298, EnemyMetis, "EnemyMetis-318");
				EnemyHesperia* p319 = (EnemyHesperia*)obtainActorFromFactory(10001539);
				getDirector()->addSubGroup(p319);
				orderActorToFactory(10001542, EnemyHesperia, "EnemyHesperia-320");
				break;
			}
			case 4620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000254);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000299, EnemyMetis, "EnemyMetis-321");
				break;
			}
			case 4640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000255);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000300, EnemyMetis, "EnemyMetis-322");
				break;
			}
			case 4660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000256);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000301, EnemyMetis, "EnemyMetis-323");
				break;
			}
			case 4680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000257);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000302, EnemyMetis, "EnemyMetis-324");
				break;
			}
			case 4700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000258);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000303, EnemyMetis, "EnemyMetis-325");
				break;
			}
			case 4720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000259);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000304, EnemyMetis, "EnemyMetis-326");
				break;
			}
			case 4740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000260);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000305, EnemyMetis, "EnemyMetis-327");
				break;
			}
			case 4760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000261);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000306, EnemyMetis, "EnemyMetis-328");
				break;
			}
			case 4780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000262);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000307, EnemyMetis, "EnemyMetis-329");
				break;
			}
			case 4800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000263);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000308, EnemyMetis, "EnemyMetis-330");
				break;
			}
			case 4820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000264);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000309, EnemyMetis, "EnemyMetis-331");
				break;
			}
			case 4840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000265);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000310, EnemyMetis, "EnemyMetis-332");
				break;
			}
			case 4860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000266);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000311, EnemyMetis, "EnemyMetis-333");
				break;
			}
			case 4880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000267);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000312, EnemyMetis, "EnemyMetis-334");
				break;
			}
			case 4900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000268);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000313, EnemyMetis, "EnemyMetis-335");
				EnemyHesperia* p336 = (EnemyHesperia*)obtainActorFromFactory(10001540);
				getDirector()->addSubGroup(p336);
				orderActorToFactory(10001543, EnemyHesperia, "EnemyHesperia-337");
				break;
			}
			case 4920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000269);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000314, EnemyMetis, "EnemyMetis-338");
				break;
			}
			case 4940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000270);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000315, EnemyMetis, "EnemyMetis-339");
				break;
			}
			case 4960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000271);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000316, EnemyMetis, "EnemyMetis-340");
				break;
			}
			case 4980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000272);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000317, EnemyMetis, "EnemyMetis-341");
				break;
			}
			case 5000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000273);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000318, EnemyMetis, "EnemyMetis-342");
				break;
			}
			case 5020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000274);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000319, EnemyMetis, "EnemyMetis-343");
				break;
			}
			case 5040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000275);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000320, EnemyMetis, "EnemyMetis-344");
				break;
			}
			case 5060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000276);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000321, EnemyMetis, "EnemyMetis-345");
				break;
			}
			case 5080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000277);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000322, EnemyMetis, "EnemyMetis-346");
				break;
			}
			case 5100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000278);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000323, EnemyMetis, "EnemyMetis-347");
				break;
			}
			case 5120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000279);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000324, EnemyMetis, "EnemyMetis-348");
				break;
			}
			case 5140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000280);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000325, EnemyMetis, "EnemyMetis-349");
				break;
			}
			case 5160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000281);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000326, EnemyMetis, "EnemyMetis-350");
				break;
			}
			case 5180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000282);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000327, EnemyMetis, "EnemyMetis-351");
				break;
			}
			case 5200: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000328, EnemyMetis, "EnemyMetis-352");
				EnemyHesperia* p353 = (EnemyHesperia*)obtainActorFromFactory(10001541);
				getDirector()->addSubGroup(p353);
				orderActorToFactory(10001544, EnemyHesperia, "EnemyHesperia-354");
				break;
			}
			case 5220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000284);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000329, EnemyMetis, "EnemyMetis-355");
				break;
			}
			case 5240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000285);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000330, EnemyMetis, "EnemyMetis-356");
				break;
			}
			case 5260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000286);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000331, EnemyMetis, "EnemyMetis-357");
				break;
			}
			case 5280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000287);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000332, EnemyMetis, "EnemyMetis-358");
				break;
			}
			case 5300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000288);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000333, EnemyMetis, "EnemyMetis-359");
				break;
			}
			case 5320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000289);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000334, EnemyMetis, "EnemyMetis-360");
				break;
			}
			case 5340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000290);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000335, EnemyMetis, "EnemyMetis-361");
				break;
			}
			case 5360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000291);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000336, EnemyMetis, "EnemyMetis-362");
				break;
			}
			case 5380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000292);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000337, EnemyMetis, "EnemyMetis-363");
				break;
			}
			case 5400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000293);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000338, EnemyMetis, "EnemyMetis-364");
				break;
			}
			case 5420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000294);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000339, EnemyMetis, "EnemyMetis-365");
				break;
			}
			case 5440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000295);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000340, EnemyMetis, "EnemyMetis-366");
				break;
			}
			case 5460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000296);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000341, EnemyMetis, "EnemyMetis-367");
				break;
			}
			case 5480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000297);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000342, EnemyMetis, "EnemyMetis-368");
				break;
			}
			case 5500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000298);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000343, EnemyMetis, "EnemyMetis-369");
				EnemyHesperia* p370 = (EnemyHesperia*)obtainActorFromFactory(10001542);
				getDirector()->addSubGroup(p370);
				orderActorToFactory(10001545, EnemyHesperia, "EnemyHesperia-371");
				break;
			}
			case 5520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000299);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000344, EnemyMetis, "EnemyMetis-372");
				break;
			}
			case 5540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000300);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000345, EnemyMetis, "EnemyMetis-373");
				break;
			}
			case 5560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000301);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000346, EnemyMetis, "EnemyMetis-374");
				break;
			}
			case 5580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000302);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000347, EnemyMetis, "EnemyMetis-375");
				break;
			}
			case 5600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000303);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000348, EnemyMetis, "EnemyMetis-376");
				break;
			}
			case 5620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000304);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000349, EnemyMetis, "EnemyMetis-377");
				break;
			}
			case 5640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000305);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000350, EnemyMetis, "EnemyMetis-378");
				break;
			}
			case 5660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000306);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000351, EnemyMetis, "EnemyMetis-379");
				break;
			}
			case 5680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000307);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000352, EnemyMetis, "EnemyMetis-380");
				break;
			}
			case 5700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000308);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000353, EnemyMetis, "EnemyMetis-381");
				break;
			}
			case 5720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000309);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000354, EnemyMetis, "EnemyMetis-382");
				break;
			}
			case 5740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000310);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000355, EnemyMetis, "EnemyMetis-383");
				break;
			}
			case 5760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000311);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000356, EnemyMetis, "EnemyMetis-384");
				break;
			}
			case 5780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000312);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000357, EnemyMetis, "EnemyMetis-385");
				break;
			}
			case 5800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000313);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000358, EnemyMetis, "EnemyMetis-386");
				EnemyHesperia* p387 = (EnemyHesperia*)obtainActorFromFactory(10001543);
				getDirector()->addSubGroup(p387);
				orderActorToFactory(10001546, EnemyHesperia, "EnemyHesperia-388");
				break;
			}
			case 5820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000314);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000359, EnemyMetis, "EnemyMetis-389");
				break;
			}
			case 5840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000315);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000360, EnemyMetis, "EnemyMetis-390");
				break;
			}
			case 5860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000316);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000361, EnemyMetis, "EnemyMetis-391");
				break;
			}
			case 5880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000317);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000362, EnemyMetis, "EnemyMetis-392");
				break;
			}
			case 5900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000318);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000363, EnemyMetis, "EnemyMetis-393");
				break;
			}
			case 5920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000319);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000364, EnemyMetis, "EnemyMetis-394");
				break;
			}
			case 5940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000320);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000365, EnemyMetis, "EnemyMetis-395");
				break;
			}
			case 5960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000321);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000366, EnemyMetis, "EnemyMetis-396");
				break;
			}
			case 5980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000322);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000367, EnemyMetis, "EnemyMetis-397");
				break;
			}
			case 6000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000323);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000368, EnemyMetis, "EnemyMetis-398");
				break;
			}
			case 6020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000324);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000369, EnemyMetis, "EnemyMetis-399");
				break;
			}
			case 6040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000325);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000370, EnemyMetis, "EnemyMetis-400");
				break;
			}
			case 6060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000326);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000371, EnemyMetis, "EnemyMetis-401");
				break;
			}
			case 6080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000327);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000372, EnemyMetis, "EnemyMetis-402");
				break;
			}
			case 6100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000328);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000373, EnemyMetis, "EnemyMetis-403");
				EnemyHesperia* p404 = (EnemyHesperia*)obtainActorFromFactory(10001544);
				getDirector()->addSubGroup(p404);
				orderActorToFactory(10001547, EnemyHesperia, "EnemyHesperia-405");
				break;
			}
			case 6120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000329);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000374, EnemyMetis, "EnemyMetis-406");
				break;
			}
			case 6140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000330);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000375, EnemyMetis, "EnemyMetis-407");
				break;
			}
			case 6160: {
			...
			case 6280: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000382, EnemyMetis, "EnemyMetis-414");
				break;
			}
			case 6300: {
				orderActorToFactory(10000009, EnemyHermione, "EnemyHermione-415");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000338);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000383, EnemyMetis, "EnemyMetis-416");
				break;
			}
			case 6320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000339);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000384, EnemyMetis, "EnemyMetis-417");
				break;
			}
			case 6340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000340);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000385, EnemyMetis, "EnemyMetis-418");
				break;
			}
			case 6360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000341);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000386, EnemyMetis, "EnemyMetis-419");
				break;
			}
			case 6380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000342);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000387, EnemyMetis, "EnemyMetis-420");
				break;
			}
			case 6400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000343);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000388, EnemyMetis, "EnemyMetis-421");
				EnemyHesperia* p422 = (EnemyHesperia*)obtainActorFromFactory(10001545);
				getDirector()->addSubGroup(p422);
				orderActorToFactory(10001548, EnemyHesperia, "EnemyHesperia-423");
				break;
			}
			case 6420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000344);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000389, EnemyMetis, "EnemyMetis-424");
				break;
			}
			case 6440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000345);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000390, EnemyMetis, "EnemyMetis-425");
				break;
			}
			case 6460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000346);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000391, EnemyMetis, "EnemyMetis-426");
				break;
			}
			case 6480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000347);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000392, EnemyMetis, "EnemyMetis-427");
				break;
			}
			case 6500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000348);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000393, EnemyMetis, "EnemyMetis-428");
				break;
			}
			case 6520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000349);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000394, EnemyMetis, "EnemyMetis-429");
				break;
			}
			case 6540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000350);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000395, EnemyMetis, "EnemyMetis-430");
				break;
			}
			case 6560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000351);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000396, EnemyMetis, "EnemyMetis-431");
				break;
			}
			case 6580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000352);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000397, EnemyMetis, "EnemyMetis-432");
				break;
			}
			case 6600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000353);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000398, EnemyMetis, "EnemyMetis-433");
				break;
			}
			case 6620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000354);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000399, EnemyMetis, "EnemyMetis-434");
				break;
			}
			case 6640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000355);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000400, EnemyMetis, "EnemyMetis-435");
				break;
			}
			case 6660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000356);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000401, EnemyMetis, "EnemyMetis-436");
				break;
			}
			case 6680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000357);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000402, EnemyMetis, "EnemyMetis-437");
				break;
			}
			case 6700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000358);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000403, EnemyMetis, "EnemyMetis-438");
				EnemyHesperia* p439 = (EnemyHesperia*)obtainActorFromFactory(10001546);
				getDirector()->addSubGroup(p439);
				orderActorToFactory(10001549, EnemyHesperia, "EnemyHesperia-440");
				break;
			}
			case 6720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000359);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000404, EnemyMetis, "EnemyMetis-441");
				break;
			}
			case 6740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000360);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000405, EnemyMetis, "EnemyMetis-442");
				break;
			}
			case 6760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000361);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000406, EnemyMetis, "EnemyMetis-443");
				break;
			}
			case 6780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000362);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000407, EnemyMetis, "EnemyMetis-444");
				break;
			}
			case 6800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000363);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000408, EnemyMetis, "EnemyMetis-445");
				break;
			}
			case 6820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000364);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000409, EnemyMetis, "EnemyMetis-446");
				break;
			}
			case 6840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000365);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000410, EnemyMetis, "EnemyMetis-447");
				break;
			}
			case 6860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000366);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000411, EnemyMetis, "EnemyMetis-448");
				break;
			}
			case 6880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000367);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000412, EnemyMetis, "EnemyMetis-449");
				break;
			}
			case 6900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000368);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000413, EnemyMetis, "EnemyMetis-450");
				break;
			}
			case 6920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000369);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000414, EnemyMetis, "EnemyMetis-451");
				break;
			}
			case 6940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000370);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000415, EnemyMetis, "EnemyMetis-452");
				break;
			}
			case 6960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000371);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000416, EnemyMetis, "EnemyMetis-453");
				break;
			}
			case 6980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000372);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000417, EnemyMetis, "EnemyMetis-454");
				break;
			}
			case 7000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000373);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000418, EnemyMetis, "EnemyMetis-455");
				EnemyHesperia* p456 = (EnemyHesperia*)obtainActorFromFactory(10001547);
				getDirector()->addSubGroup(p456);
				orderActorToFactory(10001550, EnemyHesperia, "EnemyHesperia-457");
				break;
			}
			case 7020: {
			...
			case 7300: {
				...
				EnemyHesperia* p473 = (EnemyHesperia*)obtainActorFromFactory(10001548);
				getDirector()->addSubGroup(p473);
				orderActorToFactory(10001551, EnemyHesperia, "EnemyHesperia-474");
				break;
			}
			case 7320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000389);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000434, EnemyMetis, "EnemyMetis-475");
				break;
			}
			case 7340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000390);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000435, EnemyMetis, "EnemyMetis-476");
				break;
			}
			case 7360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000391);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000436, EnemyMetis, "EnemyMetis-477");
				break;
			}
			case 7380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000392);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000437, EnemyMetis, "EnemyMetis-478");
				break;
			}
			case 7400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000393);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000438, EnemyMetis, "EnemyMetis-479");
				break;
			}
			case 7420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000394);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000439, EnemyMetis, "EnemyMetis-480");
				break;
			}
			case 7440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000395);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000440, EnemyMetis, "EnemyMetis-481");
				break;
			}
			case 7460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000396);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000441, EnemyMetis, "EnemyMetis-482");
				break;
			}
			case 7480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000397);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000442, EnemyMetis, "EnemyMetis-483");
				break;
			}
			case 7500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000398);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000443, EnemyMetis, "EnemyMetis-484");
				break;
			}
			case 7520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000399);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000444, EnemyMetis, "EnemyMetis-485");
				break;
			}
			case 7540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000400);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000445, EnemyMetis, "EnemyMetis-486");
				break;
			}
			case 7560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000401);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000446, EnemyMetis, "EnemyMetis-487");
				break;
			}
			case 7580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000402);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000447, EnemyMetis, "EnemyMetis-488");
				break;
			}
			case 7600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000403);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000448, EnemyMetis, "EnemyMetis-489");
				EnemyHesperia* p490 = (EnemyHesperia*)obtainActorFromFactory(10001549);
				getDirector()->addSubGroup(p490);
				orderActorToFactory(10001552, EnemyHesperia, "EnemyHesperia-491");
				break;
			}
			case 7620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000404);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000449, EnemyMetis, "EnemyMetis-492");
				break;
			}
			case 7640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000405);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000450, EnemyMetis, "EnemyMetis-493");
				break;
			}
			case 7660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000406);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000451, EnemyMetis, "EnemyMetis-494");
				break;
			}
			case 7680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000407);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000452, EnemyMetis, "EnemyMetis-495");
				break;
			}
			case 7700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000408);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000453, EnemyMetis, "EnemyMetis-496");
				break;
			}
			case 7720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000409);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000454, EnemyMetis, "EnemyMetis-497");
				break;
			}
			case 7740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000410);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000455, EnemyMetis, "EnemyMetis-498");
				break;
			}
			case 7760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000411);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000456, EnemyMetis, "EnemyMetis-499");
				break;
			}
			case 7780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000412);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000457, EnemyMetis, "EnemyMetis-500");
				break;
			}
			case 7800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000413);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000458, EnemyMetis, "EnemyMetis-501");
				break;
			}
			case 7820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000414);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000459, EnemyMetis, "EnemyMetis-502");
				break;
			}
			case 7840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000415);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000460, EnemyMetis, "EnemyMetis-503");
				break;
			}
			case 7860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000416);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000461, EnemyMetis, "EnemyMetis-504");
				break;
			}
			case 7880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000417);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000462, EnemyMetis, "EnemyMetis-505");
				break;
			}
			case 7900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000418);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000463, EnemyMetis, "EnemyMetis-506");
				EnemyHesperia* p507 = (EnemyHesperia*)obtainActorFromFactory(10001550);
				getDirector()->addSubGroup(p507);
				orderActorToFactory(10001553, EnemyHesperia, "EnemyHesperia-508");
				break;
			}
			case 7920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000419);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000464, EnemyMetis, "EnemyMetis-509");
				break;
			}
			case 7940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000420);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000465, EnemyMetis, "EnemyMetis-510");
				break;
			}
			case 7960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000421);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000466, EnemyMetis, "EnemyMetis-511");
				break;
			}
			case 7980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000422);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000467, EnemyMetis, "EnemyMetis-512");
				break;
			}
			case 8000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000423);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000468, EnemyMetis, "EnemyMetis-513");
				break;
			}
			case 8020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000424);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000469, EnemyMetis, "EnemyMetis-514");
				break;
			}
			case 8040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000425);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000470, EnemyMetis, "EnemyMetis-515");
				break;
			}
			case 8060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000426);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000471, EnemyMetis, "EnemyMetis-516");
				break;
			}
			case 8080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000427);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000472, EnemyMetis, "EnemyMetis-517");
				break;
			}
			case 8100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000428);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000473, EnemyMetis, "EnemyMetis-518");
				break;
			}
			case 8120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000429);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000474, EnemyMetis, "EnemyMetis-519");
				break;
			}
			case 8140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000430);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000475, EnemyMetis, "EnemyMetis-520");
				break;
			}
			case 8160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000431);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000476, EnemyMetis, "EnemyMetis-521");
				break;
			}
			case 8180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000432);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000477, EnemyMetis, "EnemyMetis-522");
				break;
			}
			case 8200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000433);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000478, EnemyMetis, "EnemyMetis-523");
				EnemyHesperia* p524 = (EnemyHesperia*)obtainActorFromFactory(10001551);
				getDirector()->addSubGroup(p524);
				orderActorToFactory(10001554, EnemyHesperia, "EnemyHesperia-525");
				break;
			}
			case 8220: {
			...
			case 8300: {
				orderActorToFactory(10000010, EnemyHermione, "EnemyHermione-530");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000438);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000483, EnemyMetis, "EnemyMetis-531");
				break;
			}
			case 8320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000439);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000484, EnemyMetis, "EnemyMetis-532");
				break;
			}
			case 8340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000440);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000485, EnemyMetis, "EnemyMetis-533");
				break;
			}
			case 8360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000441);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000486, EnemyMetis, "EnemyMetis-534");
				break;
			}
			case 8380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000442);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000487, EnemyMetis, "EnemyMetis-535");
				break;
			}
			case 8400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000443);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000488, EnemyMetis, "EnemyMetis-536");
				break;
			}
			case 8420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000444);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000489, EnemyMetis, "EnemyMetis-537");
				break;
			}
			case 8440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000445);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000490, EnemyMetis, "EnemyMetis-538");
				break;
			}
			case 8460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000446);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000491, EnemyMetis, "EnemyMetis-539");
				break;
			}
			case 8480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000447);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000492, EnemyMetis, "EnemyMetis-540");
				break;
			}
			case 8500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000448);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000493, EnemyMetis, "EnemyMetis-541");
				EnemyHesperia* p542 = (EnemyHesperia*)obtainActorFromFactory(10001552);
				getDirector()->addSubGroup(p542);
				orderActorToFactory(10001555, EnemyHesperia, "EnemyHesperia-543");
				break;
			}
			case 8520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000449);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000494, EnemyMetis, "EnemyMetis-544");
				break;
			}
			case 8540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000450);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000495, EnemyMetis, "EnemyMetis-545");
				break;
			}
			case 8560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000451);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000496, EnemyMetis, "EnemyMetis-546");
				break;
			}
			case 8580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000452);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000497, EnemyMetis, "EnemyMetis-547");
				break;
			}
			case 8600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000453);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000498, EnemyMetis, "EnemyMetis-548");
				break;
			}
			case 8620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000454);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000499, EnemyMetis, "EnemyMetis-549");
				break;
			}
			case 8640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000455);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000500, EnemyMetis, "EnemyMetis-550");
				break;
			}
			case 8660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000456);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000501, EnemyMetis, "EnemyMetis-551");
				break;
			}
			case 8680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000457);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000502, EnemyMetis, "EnemyMetis-552");
				break;
			}
			case 8700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000458);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000503, EnemyMetis, "EnemyMetis-553");
				break;
			}
			case 8720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000459);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000504, EnemyMetis, "EnemyMetis-554");
				break;
			}
			case 8740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000460);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000505, EnemyMetis, "EnemyMetis-555");
				break;
			}
			case 8760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000461);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000506, EnemyMetis, "EnemyMetis-556");
				break;
			}
			case 8780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000462);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000507, EnemyMetis, "EnemyMetis-557");
				break;
			}
			case 8800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000463);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000508, EnemyMetis, "EnemyMetis-558");
				EnemyHesperia* p559 = (EnemyHesperia*)obtainActorFromFactory(10001553);
				getDirector()->addSubGroup(p559);
				orderActorToFactory(10001556, EnemyHesperia, "EnemyHesperia-560");
				break;
			}
			case 8820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000464);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000509, EnemyMetis, "EnemyMetis-561");
				break;
			}
			case 8840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000465);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000510, EnemyMetis, "EnemyMetis-562");
				break;
			}
			case 8860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000466);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000511, EnemyMetis, "EnemyMetis-563");
				break;
			}
			case 8880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000467);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000512, EnemyMetis, "EnemyMetis-564");
				break;
			}
			case 8900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000468);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000513, EnemyMetis, "EnemyMetis-565");
				break;
			}
			case 8920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000469);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000514, EnemyMetis, "EnemyMetis-566");
				break;
			}
			case 8940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000470);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000515, EnemyMetis, "EnemyMetis-567");
				break;
			}
			case 8960: {
			...
			case 8980: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000517, EnemyMetis, "EnemyMetis-569");
				break;
			}
			case 9000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000473);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000518, EnemyMetis, "EnemyMetis-570");
				break;
			}
			case 9020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000474);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000519, EnemyMetis, "EnemyMetis-571");
				break;
			}
			case 9040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000475);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000520, EnemyMetis, "EnemyMetis-572");
				break;
			}
			case 9060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000476);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000521, EnemyMetis, "EnemyMetis-573");
				break;
			}
			case 9080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000477);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000522, EnemyMetis, "EnemyMetis-574");
				break;
			}
			case 9100: {
				orderSceneToFactory(10000001, Stage01_02, "Stage01_02-575");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000478);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000523, EnemyMetis, "EnemyMetis-576");
				EnemyHesperia* p577 = (EnemyHesperia*)obtainActorFromFactory(10001554);
				getDirector()->addSubGroup(p577);
				orderActorToFactory(10001557, EnemyHesperia, "EnemyHesperia-578");
				break;
			}
			case 9120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000479);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000524, EnemyMetis, "EnemyMetis-579");
				break;
			}
			case 9140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000480);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000525, EnemyMetis, "EnemyMetis-580");
				break;
			}
			case 9160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000481);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000526, EnemyMetis, "EnemyMetis-581");
				break;
			}
			case 9180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000482);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000527, EnemyMetis, "EnemyMetis-582");
				break;
			}
			case 9200: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000528, EnemyMetis, "EnemyMetis-583");
				break;
			}
			case 9220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000484);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000529, EnemyMetis, "EnemyMetis-584");
				break;
			}
			case 9240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000485);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000530, EnemyMetis, "EnemyMetis-585");
				break;
			}
			case 9260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000486);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000531, EnemyMetis, "EnemyMetis-586");
				break;
			}
			case 9280: {
			...
			case 9400: {
				...
				EnemyHesperia* p594 = (EnemyHesperia*)obtainActorFromFactory(10001555);
				getDirector()->addSubGroup(p594);
				break;
			}
			case 9420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000494);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000539, EnemyMetis, "EnemyMetis-595");
				break;
			}
			case 9440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000495);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000540, EnemyMetis, "EnemyMetis-596");
				break;
			}
			case 9460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000496);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000541, EnemyMetis, "EnemyMetis-597");
				break;
			}
			case 9480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000497);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000542, EnemyMetis, "EnemyMetis-598");
				break;
			}
			case 9500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000498);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000543, EnemyMetis, "EnemyMetis-599");
				break;
			}
			case 9520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000499);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000544, EnemyMetis, "EnemyMetis-600");
				break;
			}
			case 9540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000500);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000545, EnemyMetis, "EnemyMetis-601");
				break;
			}
			case 9560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000501);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000546, EnemyMetis, "EnemyMetis-602");
				break;
			}
			case 9580: {
			...
			case 9700: {
				...
				EnemyHesperia* p610 = (EnemyHesperia*)obtainActorFromFactory(10001556);
				getDirector()->addSubGroup(p610);
				break;
			}
			case 9720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000509);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000554, EnemyMetis, "EnemyMetis-611");
				break;
			}
			case 9740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000510);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000555, EnemyMetis, "EnemyMetis-612");
				break;
			}
			case 9760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000511);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000556, EnemyMetis, "EnemyMetis-613");
				break;
			}
			case 9780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000512);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000557, EnemyMetis, "EnemyMetis-614");
				break;
			}
			case 9800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000513);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000558, EnemyMetis, "EnemyMetis-615");
				break;
			}
			case 9820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000514);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000559, EnemyMetis, "EnemyMetis-616");
				break;
			}
			case 9840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000515);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000560, EnemyMetis, "EnemyMetis-617");
				break;
			}
			case 9860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000516);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000561, EnemyMetis, "EnemyMetis-618");
				break;
			}
			case 9880: {
			...
			case 10000: {
				...
				EnemyHesperia* p626 = (EnemyHesperia*)obtainActorFromFactory(10001557);
				getDirector()->addSubGroup(p626);
				break;
			}
			case 10020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000524);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000569, EnemyMetis, "EnemyMetis-627");
				break;
			}
			case 10040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000525);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000570, EnemyMetis, "EnemyMetis-628");
				break;
			}
			case 10060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000526);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000571, EnemyMetis, "EnemyMetis-629");
				break;
			}
			case 10080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000527);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000572, EnemyMetis, "EnemyMetis-630");
				break;
			}
			case 10100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000528);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000573, EnemyMetis, "EnemyMetis-631");
				break;
			}
			case 10120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000529);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000574, EnemyMetis, "EnemyMetis-632");
				break;
			}
			case 10140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000530);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000575, EnemyMetis, "EnemyMetis-633");
				break;
			}
			case 10160: {
			...
			case 19100: {
				orderSceneToFactory(10000003, Stage01_03, "Stage01_03-1086");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000978);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001023, EnemyMetis, "EnemyMetis-1087");
				break;
			}
			case 19120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000979);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001024, EnemyMetis, "EnemyMetis-1088");
				break;
			}
			case 19140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000980);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001025, EnemyMetis, "EnemyMetis-1089");
				break;
			}
			case 19160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000981);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001026, EnemyMetis, "EnemyMetis-1090");
				break;
			}
			case 19180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000982);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001027, EnemyMetis, "EnemyMetis-1091");
				break;
			}
			case 19200: {
			...
			case 20000: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001068, EnemyMetis, "EnemyMetis-1132");
				break;
			}
			case 20020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001024);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001069, EnemyMetis, "EnemyMetis-1133");
				break;
			}
			case 20040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001025);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001070, EnemyMetis, "EnemyMetis-1134");
				break;
			}
			case 20060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001026);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001071, EnemyMetis, "EnemyMetis-1135");
				break;
			}
			case 20080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001027);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001072, EnemyMetis, "EnemyMetis-1136");
				break;
			}
			case 20100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001028);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001073, EnemyMetis, "EnemyMetis-1137");
				break;
			}
			case 20120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001029);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001074, EnemyMetis, "EnemyMetis-1138");
				break;
			}
			case 20140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001030);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001075, EnemyMetis, "EnemyMetis-1139");
				break;
			}
			case 20160: {
			...
			case 28300: {
				orderActorToFactory(10000020, EnemyHermione, "EnemyHermione-1551");
			...
			case 28980: {
				...
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001517, EnemyMetis, "EnemyMetis-1586");
				break;
			}
			case 29000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001473);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001518, EnemyMetis, "EnemyMetis-1587");
				break;
			}
			case 29020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001474);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001519, EnemyMetis, "EnemyMetis-1588");
				break;
			}
			case 29040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001475);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001520, EnemyMetis, "EnemyMetis-1589");
				break;
			}
			case 29060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001476);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001521, EnemyMetis, "EnemyMetis-1590");
				break;
			}
			case 29080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001477);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001522, EnemyMetis, "EnemyMetis-1591");
				break;
			}
			case 29100: {
				orderSceneToFactory(10000004, Stage01_Climax, "Stage01_Climax-1592");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001478);
				getDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001523, EnemyMetis, "EnemyMetis-1593");
				break;
			}
			case 29120: {
			...
			case 30000: {
				...
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10001523);
				getDirector()->addSubGroup(pMetis);
				break;
			}
			default :
