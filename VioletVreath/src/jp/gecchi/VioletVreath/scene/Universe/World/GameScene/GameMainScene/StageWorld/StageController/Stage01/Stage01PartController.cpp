...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10001496, FormationOrtuna001b, "FormationOrtuna001b-42");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 20: {
				orderActorToFactory(10000041, EnemyEtis, "EnemyEtis-43");
				break;
			}
			case 40: {
				orderActorToFactory(10000042, EnemyEtis, "EnemyEtis-44");
				break;
			}
			case 60: {
				orderActorToFactory(10000043, EnemyEtis, "EnemyEtis-45");
				break;
			}
			case 80: {
				orderActorToFactory(10000044, EnemyEtis, "EnemyEtis-46");
				break;
			}
			case 100: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000000);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000045, EnemyEtis, "EnemyEtis-47");
				break;
			}
			case 120: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000001);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000046, EnemyEtis, "EnemyEtis-48");
				break;
			}
			case 140: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000002);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000047, EnemyEtis, "EnemyEtis-49");
				break;
			}
			case 160: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000003);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000048, EnemyEtis, "EnemyEtis-50");
				break;
			}
			case 180: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000004);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000049, EnemyEtis, "EnemyEtis-51");
				break;
			}
			case 200: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000005);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000050, EnemyEtis, "EnemyEtis-52");
				break;
			}
			case 220: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000006);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000051, EnemyEtis, "EnemyEtis-53");
				break;
			}
			case 240: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000007);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000052, EnemyEtis, "EnemyEtis-54");
				break;
			}
			case 260: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000008);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000053, EnemyEtis, "EnemyEtis-55");
				break;
			}
			case 280: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000009);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000054, EnemyEtis, "EnemyEtis-56");
				break;
			}
			case 300: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000010);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000055, EnemyEtis, "EnemyEtis-57");
				break;
			}
			case 320: {
			...
			case 380: {
				...
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000059, EnemyEtis, "EnemyEtis-61");
				break;
			}
			case 400: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000015);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000060, EnemyEtis, "EnemyEtis-62");
				break;
			}
			case 420: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000016);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000061, EnemyEtis, "EnemyEtis-63");
				break;
			}
			case 440: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000017);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000062, EnemyEtis, "EnemyEtis-64");
				break;
			}
			case 460: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000018);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000063, EnemyEtis, "EnemyEtis-65");
				break;
			}
			case 480: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000019);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000064, EnemyEtis, "EnemyEtis-66");
				break;
			}
			case 500: {
				EnemyEtis* pEtis = (EnemyEtis*)obtainActorFromFactory(10000020);
				getSceneDirector()->addSubGroup(pEtis);
				orderActorToFactory(10000065, EnemyEtis, "EnemyEtis-67");
				FormationOrtuna001b* pF1 = (FormationOrtuna001b*)obtainActorFromFactory(10001496);
