...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10000004, EnemyMetis, "EnemyMetis-2");
	orderActorToFactory(10000005, EnemyMetis, "EnemyMetis-3");
	orderActorToFactory(10000006, EnemyMetis, "EnemyMetis-4");
	orderActorToFactory(10000007, EnemyMetis, "EnemyMetis-5");
	orderActorToFactory(10000008, EnemyMetis, "EnemyMetis-6");
	orderActorToFactory(10000009, EnemyMetis, "EnemyMetis-7");
	orderActorToFactory(10000010, EnemyMetis, "EnemyMetis-8");
	orderActorToFactory(10000011, EnemyMetis, "EnemyMetis-9");
	orderActorToFactory(10000012, EnemyMetis, "EnemyMetis-10");
	orderActorToFactory(10000013, EnemyMetis, "EnemyMetis-11");
	orderActorToFactory(10000014, EnemyMetis, "EnemyMetis-12");
	orderActorToFactory(10000015, EnemyMetis, "EnemyMetis-13");
	orderActorToFactory(10000016, EnemyMetis, "EnemyMetis-14");
	orderActorToFactory(10000017, EnemyMetis, "EnemyMetis-15");
	orderActorToFactory(10000018, EnemyMetis, "EnemyMetis-16");
	orderActorToFactory(10000019, EnemyMetis, "EnemyMetis-17");
	orderActorToFactory(10000020, EnemyMetis, "EnemyMetis-18");
	orderActorToFactory(10000021, EnemyMetis, "EnemyMetis-19");
	orderActorToFactory(10000022, EnemyMetis, "EnemyMetis-20");
	orderActorToFactory(10000023, EnemyMetis, "EnemyMetis-21");
	orderActorToFactory(10000024, EnemyMetis, "EnemyMetis-22");
	orderActorToFactory(10000025, EnemyMetis, "EnemyMetis-23");
	orderActorToFactory(10000026, EnemyMetis, "EnemyMetis-24");
	orderActorToFactory(10000027, EnemyMetis, "EnemyMetis-25");
	orderActorToFactory(10000028, EnemyMetis, "EnemyMetis-26");
	orderActorToFactory(10000029, EnemyMetis, "EnemyMetis-27");
	orderActorToFactory(10000030, EnemyMetis, "EnemyMetis-28");
	orderActorToFactory(10000031, EnemyMetis, "EnemyMetis-29");
	orderActorToFactory(10000032, EnemyMetis, "EnemyMetis-30");
	orderActorToFactory(10000033, EnemyMetis, "EnemyMetis-31");
	orderActorToFactory(10000034, EnemyMetis, "EnemyMetis-32");
	orderActorToFactory(10000035, EnemyMetis, "EnemyMetis-33");
	orderActorToFactory(10000036, EnemyMetis, "EnemyMetis-34");
	orderActorToFactory(10000037, EnemyMetis, "EnemyMetis-35");
	orderActorToFactory(10000038, EnemyMetis, "EnemyMetis-36");
	orderActorToFactory(10000039, EnemyMetis, "EnemyMetis-37");
	orderActorToFactory(10000040, EnemyMetis, "EnemyMetis-38");
	orderActorToFactory(10000041, EnemyMetis, "EnemyMetis-39");
	orderActorToFactory(10000042, EnemyMetis, "EnemyMetis-40");
	orderActorToFactory(10000043, EnemyMetis, "EnemyMetis-41");
	orderActorToFactory(10000044, EnemyMetis, "EnemyMetis-42");
	orderActorToFactory(10001500, EnemyHesperia, "EnemyHesperia-43");
	orderActorToFactory(10001501, EnemyHesperia, "EnemyHesperia-44");
	orderActorToFactory(10001502, EnemyHesperia, "EnemyHesperia-45");
	orderActorToFactory(10001534, TestGu, "TestGu-46");
	orderActorToFactory(10001535, TestGu, "TestGu-47");
	orderActorToFactory(10001536, TestGu, "TestGu-48");
	orderActorToFactory(10001537, TestGu, "TestGu-49");
	orderActorToFactory(10001538, TestGu, "TestGu-50");
	orderActorToFactory(10001539, TestGu, "TestGu-51");
	orderActorToFactory(10001540, TestGu, "TestGu-52");
	orderActorToFactory(10001541, TestChoki, "TestChoki-53");
	orderActorToFactory(10001542, TestChoki, "TestChoki-54");
	orderActorToFactory(10001543, TestChoki, "TestChoki-55");
	orderActorToFactory(10001544, TestChoki, "TestChoki-56");
	orderActorToFactory(10001545, TestChoki, "TestChoki-57");
	orderActorToFactory(10001546, TestChoki, "TestChoki-58");
	orderActorToFactory(10001547, TestChoki, "TestChoki-59");
	orderActorToFactory(10001548, TestPa, "TestPa-60");
	orderActorToFactory(10001549, TestPa, "TestPa-61");
	orderActorToFactory(10001550, TestPa, "TestPa-62");
	orderActorToFactory(10001551, TestPa, "TestPa-63");
	orderActorToFactory(10001552, TestPa, "TestPa-64");
	orderActorToFactory(10001553, TestPa, "TestPa-65");
	orderActorToFactory(10001554, TestPa, "TestPa-66");
	orderActorToFactory(10001555, TestNomal, "TestNomal-67");
	orderActorToFactory(10001556, TestNomal, "TestNomal-68");
	orderActorToFactory(10001557, TestNomal, "TestNomal-69");
	orderActorToFactory(10001558, TestNomal, "TestNomal-70");
	orderActorToFactory(10001559, TestNomal, "TestNomal-71");
	orderActorToFactory(10001560, TestNomal, "TestNomal-72");
	orderActorToFactory(10001561, TestNomal, "TestNomal-73");
	orderActorToFactory(10001562, EnemyHermione, "EnemyHermione-74");
	orderActorToFactory(10001563, FormationSappho001a, "FormationSappho001a-75");
	orderActorToFactory(10001564, FormationSappho001b, "FormationSappho001b-76");
	orderActorToFactory(10001565, FormationSappho001a, "FormationSappho001a-77");
	orderActorToFactory(10001567, FormationAdelheid001, "FormationAdelheid001-78");
	orderActorToFactory(10001568, FormationAdelheid001, "FormationAdelheid001-79");
	orderActorToFactory(10001569, FormationAdelheid001, "FormationAdelheid001-80");
	orderActorToFactory(10001570, FormationAdelheid001, "FormationAdelheid001-81");
	orderActorToFactory(10001571, FormationAdelheid001, "FormationAdelheid001-82");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getActiveFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getActiveFrame()) {
			...
			case 20: {
				orderActorToFactory(10000045, EnemyMetis, "EnemyMetis-83");
				break;
			}
			case 40: {
				orderActorToFactory(10000046, EnemyMetis, "EnemyMetis-84");
				break;
			}
			case 60: {
				orderActorToFactory(10000047, EnemyMetis, "EnemyMetis-85");
				break;
			}
			case 80: {
				orderActorToFactory(10000048, EnemyMetis, "EnemyMetis-86");
				break;
			}
			case 100: {
				...
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000004);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000049, EnemyMetis, "EnemyMetis-87");
				EnemyHesperia* p88 = (EnemyHesperia*)obtainActorFromFactory(10001500);
				getSceneDirector()->addSubGroup(p88);
				orderActorToFactory(10001503, EnemyHesperia, "EnemyHesperia-89");
				TestGu* p = (TestGu*)obtainActorFromFactory(10001534);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = 300000;
				p->_Z = 100000;
				orderActorToFactory(10001572, FormationAdelheid001, "FormationAdelheid001-90");
				break;
			}
			case 101: {
			...
			case 107: {
				TestChoki* p = (TestChoki*)obtainActorFromFactory(10001541);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = 300000;
				p->_Z = 0;
			...
			case 114: {
				TestPa* p = (TestPa*)obtainActorFromFactory(10001548);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = 300000;
				p->_Z = -100000;
			...
			case 120: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000050, EnemyMetis, "EnemyMetis-91");
				TestPa* p = (TestPa*)obtainActorFromFactory(10001554);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = -300000;
				p->_Z = -100000;
				orderActorToFactory(10001566, FormationSappho001b, "FormationSappho001b-92");
				break;
			}
			case 121: {
				TestNomal* p = (TestNomal*)obtainActorFromFactory(10001555);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = 300000;
				p->_Z = -200000;
			...
			case 140: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000051, EnemyMetis, "EnemyMetis-93");
				break;
			}
			case 160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000007);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000052, EnemyMetis, "EnemyMetis-94");
				break;
			}
			case 180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000008);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000053, EnemyMetis, "EnemyMetis-95");
				break;
			}
			case 200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000009);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000054, EnemyMetis, "EnemyMetis-96");
				orderActorToFactory(10001573, FormationAdelheid001, "FormationAdelheid001-97");
				break;
			}
			case 220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000010);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000055, EnemyMetis, "EnemyMetis-98");
				break;
			}
			case 240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000011);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000056, EnemyMetis, "EnemyMetis-99");
				break;
			}
			case 260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000012);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000057, EnemyMetis, "EnemyMetis-100");
				break;
			}
			case 280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000013);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000058, EnemyMetis, "EnemyMetis-101");
				break;
			}
			case 300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000014);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000059, EnemyMetis, "EnemyMetis-102");
				FormationSappho001a* pFSap = (FormationSappho001a*)obtainActorFromFactory(10001563);
				getSceneDirector()->addSubGroup(pFSap);
				orderActorToFactory(10001574, FormationAdelheid001, "FormationAdelheid001-103");
				break;
			}
			case 320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000015);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000060, EnemyMetis, "EnemyMetis-104");
				break;
			}
			case 340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000016);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000061, EnemyMetis, "EnemyMetis-105");
				break;
			}
			case 360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000017);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000062, EnemyMetis, "EnemyMetis-106");
				break;
			}
			case 380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000018);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000063, EnemyMetis, "EnemyMetis-107");
				break;
			}
			case 400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000019);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000064, EnemyMetis, "EnemyMetis-108");
				EnemyHesperia* p109 = (EnemyHesperia*)obtainActorFromFactory(10001501);
				getSceneDirector()->addSubGroup(p109);
				orderActorToFactory(10001504, EnemyHesperia, "EnemyHesperia-110");
				orderActorToFactory(10001575, FormationAdelheid001, "FormationAdelheid001-111");
				break;
			}
			case 420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000020);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000065, EnemyMetis, "EnemyMetis-112");
				break;
			}
			case 440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000021);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000066, EnemyMetis, "EnemyMetis-113");
				break;
			}
			case 460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000022);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000067, EnemyMetis, "EnemyMetis-114");
				break;
			}
			case 480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000023);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000068, EnemyMetis, "EnemyMetis-115");
				break;
			}
			case 500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000024);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000069, EnemyMetis, "EnemyMetis-116");
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001567);
			...
			case 520: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000070, EnemyMetis, "EnemyMetis-117");
				break;
			}
			case 540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000026);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000071, EnemyMetis, "EnemyMetis-118");
				FormationSappho001b* pFSap = (FormationSappho001b*)obtainActorFromFactory(10001564);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 560: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000072, EnemyMetis, "EnemyMetis-119");
				break;
			}
			case 580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000028);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000073, EnemyMetis, "EnemyMetis-120");
				break;
			}
			case 600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000029);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000074, EnemyMetis, "EnemyMetis-121");
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001568);
				getSceneDirector()->addSubGroup(pF);
			...
			case 620: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000075, EnemyMetis, "EnemyMetis-122");
				break;
			}
			case 640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000031);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000076, EnemyMetis, "EnemyMetis-123");
				break;
			}
			case 660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000032);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000077, EnemyMetis, "EnemyMetis-124");
				break;
			}
			case 680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000033);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000078, EnemyMetis, "EnemyMetis-125");
				break;
			}
			case 700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000034);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000079, EnemyMetis, "EnemyMetis-126");
				EnemyHesperia* p127 = (EnemyHesperia*)obtainActorFromFactory(10001502);
				getSceneDirector()->addSubGroup(p127);
				orderActorToFactory(10001505, EnemyHesperia, "EnemyHesperia-128");
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001569);
				getSceneDirector()->addSubGroup(pF);
			...
			case 720: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000080, EnemyMetis, "EnemyMetis-129");
				break;
			}
			case 740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000036);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000081, EnemyMetis, "EnemyMetis-130");
				break;
			}
			case 760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000037);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000082, EnemyMetis, "EnemyMetis-131");
				break;
			}
			case 780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000038);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000083, EnemyMetis, "EnemyMetis-132");
				FormationSappho001a* pFSap = (FormationSappho001a*)obtainActorFromFactory(10001565);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 800: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000084, EnemyMetis, "EnemyMetis-133");
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001570);
				getSceneDirector()->addSubGroup(pF);
			...
			case 820: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000085, EnemyMetis, "EnemyMetis-134");
				break;
			}
			case 840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000041);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000086, EnemyMetis, "EnemyMetis-135");
				break;
			}
			case 860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000042);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000087, EnemyMetis, "EnemyMetis-136");
				break;
			}
			case 880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000043);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000088, EnemyMetis, "EnemyMetis-137");
				break;
			}
			case 900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000044);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000089, EnemyMetis, "EnemyMetis-138");
				EnemyHermione* p = (EnemyHermione*)obtainActorFromFactory(10001562);
				getSceneDirector()->addSubGroup(p);
				p->_X = 8000000;
				p->_Y = RND(-200000,200000);
				p->_Z = RND(-200000,200000);
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001571);
				getSceneDirector()->addSubGroup(pF);
			...
			case 920: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000090, EnemyMetis, "EnemyMetis-139");
				break;
			}
			case 940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000046);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000091, EnemyMetis, "EnemyMetis-140");
				break;
			}
			case 960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000047);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000092, EnemyMetis, "EnemyMetis-141");
				break;
			}
			case 980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000048);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000093, EnemyMetis, "EnemyMetis-142");
				break;
			}
			case 1000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000049);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000094, EnemyMetis, "EnemyMetis-143");
				EnemyHesperia* p144 = (EnemyHesperia*)obtainActorFromFactory(10001503);
				getSceneDirector()->addSubGroup(p144);
				orderActorToFactory(10001506, EnemyHesperia, "EnemyHesperia-145");
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001572);
				getSceneDirector()->addSubGroup(pF);
				pF->locate(PX_C(-200), PX_C( 100), PX_C(500), D_ANG(10), D_ANG(0));
				break;
			}
			case 1020: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000095, EnemyMetis, "EnemyMetis-146");
				FormationSappho001b* pFSap = (FormationSappho001b*)obtainActorFromFactory(10001566);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 1040: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000096, EnemyMetis, "EnemyMetis-147");
				break;
			}
			case 1060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000052);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000097, EnemyMetis, "EnemyMetis-148");
				break;
			}
			case 1080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000053);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000098, EnemyMetis, "EnemyMetis-149");
				break;
			}
			case 1100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000054);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000099, EnemyMetis, "EnemyMetis-150");
			...
			case 1120: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000100, EnemyMetis, "EnemyMetis-151");
				break;
			}
			case 1140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000056);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000101, EnemyMetis, "EnemyMetis-152");
				break;
			}
			case 1160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000057);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000102, EnemyMetis, "EnemyMetis-153");
				break;
			}
			case 1180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000058);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000103, EnemyMetis, "EnemyMetis-154");
				break;
			}
			case 1200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000059);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000104, EnemyMetis, "EnemyMetis-155");
			...
			case 1220: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000105, EnemyMetis, "EnemyMetis-156");
				break;
			}
			case 1240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000061);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000106, EnemyMetis, "EnemyMetis-157");
				break;
			}
			case 1260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000062);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000107, EnemyMetis, "EnemyMetis-158");
				break;
			}
			case 1280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000063);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000108, EnemyMetis, "EnemyMetis-159");
				break;
			}
			case 1300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000064);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000109, EnemyMetis, "EnemyMetis-160");
				EnemyHesperia* p161 = (EnemyHesperia*)obtainActorFromFactory(10001504);
				getSceneDirector()->addSubGroup(p161);
				orderActorToFactory(10001507, EnemyHesperia, "EnemyHesperia-162");
			...
			case 1320: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000110, EnemyMetis, "EnemyMetis-163");
				break;
			}
			case 1340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000066);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000111, EnemyMetis, "EnemyMetis-164");
				break;
			}
			case 1360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000067);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000112, EnemyMetis, "EnemyMetis-165");
				break;
			}
			case 1380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000068);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000113, EnemyMetis, "EnemyMetis-166");
				break;
			}
			case 1400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000069);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000114, EnemyMetis, "EnemyMetis-167");
				break;
			}
			case 1420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000070);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000115, EnemyMetis, "EnemyMetis-168");
				break;
			}
			case 1440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000071);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000116, EnemyMetis, "EnemyMetis-169");
				break;
			}
			case 1460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000072);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000117, EnemyMetis, "EnemyMetis-170");
				break;
			}
			case 1480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000073);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000118, EnemyMetis, "EnemyMetis-171");
				break;
			}
			case 1500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000074);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000119, EnemyMetis, "EnemyMetis-172");
				break;
			}
			case 1520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000075);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000120, EnemyMetis, "EnemyMetis-173");
				break;
			}
			case 1540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000076);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000121, EnemyMetis, "EnemyMetis-174");
				break;
			}
			case 1560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000077);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000122, EnemyMetis, "EnemyMetis-175");
				break;
			}
			case 1580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000078);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000123, EnemyMetis, "EnemyMetis-176");
				break;
			}
			case 1600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000079);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000124, EnemyMetis, "EnemyMetis-177");
				EnemyHesperia* p178 = (EnemyHesperia*)obtainActorFromFactory(10001505);
				getSceneDirector()->addSubGroup(p178);
				orderActorToFactory(10001508, EnemyHesperia, "EnemyHesperia-179");
				break;
			}
			case 1620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000080);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000125, EnemyMetis, "EnemyMetis-180");
				break;
			}
			case 1640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000081);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000126, EnemyMetis, "EnemyMetis-181");
				break;
			}
			case 1660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000082);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000127, EnemyMetis, "EnemyMetis-182");
				break;
			}
			case 1680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000083);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000128, EnemyMetis, "EnemyMetis-183");
				break;
			}
			case 1700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000084);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000129, EnemyMetis, "EnemyMetis-184");
				break;
			}
			case 1720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000085);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000130, EnemyMetis, "EnemyMetis-185");
				break;
			}
			case 1740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000086);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000131, EnemyMetis, "EnemyMetis-186");
				break;
			}
			case 1760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000087);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000132, EnemyMetis, "EnemyMetis-187");
				break;
			}
			case 1780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000088);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000133, EnemyMetis, "EnemyMetis-188");
				break;
			}
			case 1800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000089);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000134, EnemyMetis, "EnemyMetis-189");
				break;
			}
			case 1820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000090);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000135, EnemyMetis, "EnemyMetis-190");
				break;
			}
			case 1840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000091);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000136, EnemyMetis, "EnemyMetis-191");
				break;
			}
			case 1860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000092);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000137, EnemyMetis, "EnemyMetis-192");
				break;
			}
			case 1880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000093);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000138, EnemyMetis, "EnemyMetis-193");
				break;
			}
			case 1900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000094);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000139, EnemyMetis, "EnemyMetis-194");
				EnemyHesperia* p195 = (EnemyHesperia*)obtainActorFromFactory(10001506);
				getSceneDirector()->addSubGroup(p195);
				orderActorToFactory(10001509, EnemyHesperia, "EnemyHesperia-196");
				break;
			}
			case 1920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000095);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000140, EnemyMetis, "EnemyMetis-197");
				break;
			}
			case 1940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000096);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000141, EnemyMetis, "EnemyMetis-198");
				break;
			}
			case 1960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000097);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000142, EnemyMetis, "EnemyMetis-199");
				break;
			}
			case 1980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000098);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000143, EnemyMetis, "EnemyMetis-200");
				break;
			}
			case 2000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000099);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000144, EnemyMetis, "EnemyMetis-201");
				break;
			}
			case 2020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000100);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000145, EnemyMetis, "EnemyMetis-202");
				break;
			}
			case 2040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000101);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000146, EnemyMetis, "EnemyMetis-203");
				break;
			}
			case 2060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000102);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000147, EnemyMetis, "EnemyMetis-204");
				break;
			}
			case 2080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000103);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000148, EnemyMetis, "EnemyMetis-205");
				break;
			}
			case 2100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000104);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000149, EnemyMetis, "EnemyMetis-206");
				break;
			}
			case 2120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000105);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000150, EnemyMetis, "EnemyMetis-207");
				break;
			}
			case 2140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000106);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000151, EnemyMetis, "EnemyMetis-208");
				break;
			}
			case 2160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000107);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000152, EnemyMetis, "EnemyMetis-209");
				break;
			}
			case 2180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000108);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000153, EnemyMetis, "EnemyMetis-210");
				break;
			}
			case 2200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000109);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000154, EnemyMetis, "EnemyMetis-211");
				EnemyHesperia* p212 = (EnemyHesperia*)obtainActorFromFactory(10001507);
				getSceneDirector()->addSubGroup(p212);
				orderActorToFactory(10001510, EnemyHesperia, "EnemyHesperia-213");
				break;
			}
			case 2220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000110);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000155, EnemyMetis, "EnemyMetis-214");
				break;
			}
			case 2240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000111);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000156, EnemyMetis, "EnemyMetis-215");
				break;
			}
			case 2260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000112);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000157, EnemyMetis, "EnemyMetis-216");
				break;
			}
			case 2280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000113);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000158, EnemyMetis, "EnemyMetis-217");
				break;
			}
			case 2300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000114);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000159, EnemyMetis, "EnemyMetis-218");
				break;
			}
			case 2320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000115);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000160, EnemyMetis, "EnemyMetis-219");
				break;
			}
			case 2340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000116);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000161, EnemyMetis, "EnemyMetis-220");
				break;
			}
			case 2360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000117);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000162, EnemyMetis, "EnemyMetis-221");
				break;
			}
			case 2380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000118);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000163, EnemyMetis, "EnemyMetis-222");
				break;
			}
			case 2400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000119);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000164, EnemyMetis, "EnemyMetis-223");
				break;
			}
			case 2420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000120);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000165, EnemyMetis, "EnemyMetis-224");
				break;
			}
			case 2440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000121);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000166, EnemyMetis, "EnemyMetis-225");
				break;
			}
			case 2460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000122);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000167, EnemyMetis, "EnemyMetis-226");
				break;
			}
			case 2480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000123);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000168, EnemyMetis, "EnemyMetis-227");
				break;
			}
			case 2500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000124);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000169, EnemyMetis, "EnemyMetis-228");
				EnemyHesperia* p229 = (EnemyHesperia*)obtainActorFromFactory(10001508);
				getSceneDirector()->addSubGroup(p229);
				orderActorToFactory(10001511, EnemyHesperia, "EnemyHesperia-230");
				break;
			}
			case 2520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000125);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000170, EnemyMetis, "EnemyMetis-231");
				break;
			}
			case 2540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000126);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000171, EnemyMetis, "EnemyMetis-232");
				break;
			}
			case 2560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000127);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000172, EnemyMetis, "EnemyMetis-233");
				break;
			}
			case 2580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000128);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000173, EnemyMetis, "EnemyMetis-234");
				break;
			}
			case 2600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000129);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000174, EnemyMetis, "EnemyMetis-235");
				break;
			}
			case 2620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000130);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000175, EnemyMetis, "EnemyMetis-236");
				break;
			}
			case 2640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000131);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000176, EnemyMetis, "EnemyMetis-237");
				break;
			}
			case 2660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000132);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000177, EnemyMetis, "EnemyMetis-238");
				break;
			}
			case 2680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000133);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000178, EnemyMetis, "EnemyMetis-239");
				break;
			}
			case 2700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000134);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000179, EnemyMetis, "EnemyMetis-240");
				break;
			}
			case 2720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000135);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000180, EnemyMetis, "EnemyMetis-241");
				break;
			}
			case 2740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000136);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000181, EnemyMetis, "EnemyMetis-242");
				break;
			}
			case 2760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000137);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000182, EnemyMetis, "EnemyMetis-243");
				break;
			}
			case 2780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000138);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000183, EnemyMetis, "EnemyMetis-244");
				break;
			}
			case 2800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000139);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000184, EnemyMetis, "EnemyMetis-245");
				EnemyHesperia* p246 = (EnemyHesperia*)obtainActorFromFactory(10001509);
				getSceneDirector()->addSubGroup(p246);
				orderActorToFactory(10001512, EnemyHesperia, "EnemyHesperia-247");
				break;
			}
			case 2820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000140);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000185, EnemyMetis, "EnemyMetis-248");
				break;
			}
			case 2840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000141);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000186, EnemyMetis, "EnemyMetis-249");
				break;
			}
			case 2860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000142);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000187, EnemyMetis, "EnemyMetis-250");
				break;
			}
			case 2880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000143);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000188, EnemyMetis, "EnemyMetis-251");
				break;
			}
			case 2900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000144);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000189, EnemyMetis, "EnemyMetis-252");
				break;
			}
			case 2920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000145);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000190, EnemyMetis, "EnemyMetis-253");
				break;
			}
			case 2940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000146);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000191, EnemyMetis, "EnemyMetis-254");
				break;
			}
			case 2960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000147);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000192, EnemyMetis, "EnemyMetis-255");
				break;
			}
			case 2980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000148);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000193, EnemyMetis, "EnemyMetis-256");
				break;
			}
			case 3000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000149);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000194, EnemyMetis, "EnemyMetis-257");
				break;
			}
			case 3020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000150);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000195, EnemyMetis, "EnemyMetis-258");
				break;
			}
			case 3040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000151);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000196, EnemyMetis, "EnemyMetis-259");
				break;
			}
			case 3060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000152);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000197, EnemyMetis, "EnemyMetis-260");
				break;
			}
			case 3080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000153);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000198, EnemyMetis, "EnemyMetis-261");
				break;
			}
			case 3100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000154);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000199, EnemyMetis, "EnemyMetis-262");
				EnemyHesperia* p263 = (EnemyHesperia*)obtainActorFromFactory(10001510);
				getSceneDirector()->addSubGroup(p263);
				orderActorToFactory(10001513, EnemyHesperia, "EnemyHesperia-264");
				break;
			}
			case 3120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000155);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000200, EnemyMetis, "EnemyMetis-265");
				break;
			}
			case 3140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000156);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000201, EnemyMetis, "EnemyMetis-266");
				break;
			}
			case 3160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000157);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000202, EnemyMetis, "EnemyMetis-267");
				break;
			}
			case 3180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000158);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000203, EnemyMetis, "EnemyMetis-268");
				break;
			}
			case 3200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000159);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000204, EnemyMetis, "EnemyMetis-269");
				break;
			}
			case 3220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000160);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000205, EnemyMetis, "EnemyMetis-270");
				break;
			}
			case 3240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000161);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000206, EnemyMetis, "EnemyMetis-271");
				break;
			}
			case 3260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000162);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000207, EnemyMetis, "EnemyMetis-272");
				break;
			}
			case 3280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000163);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000208, EnemyMetis, "EnemyMetis-273");
				break;
			}
			case 3300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000164);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000209, EnemyMetis, "EnemyMetis-274");
				break;
			}
			case 3320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000165);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000210, EnemyMetis, "EnemyMetis-275");
				break;
			}
			case 3340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000166);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000211, EnemyMetis, "EnemyMetis-276");
				break;
			}
			case 3360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000167);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000212, EnemyMetis, "EnemyMetis-277");
				break;
			}
			case 3380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000168);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000213, EnemyMetis, "EnemyMetis-278");
				break;
			}
			case 3400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000169);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000214, EnemyMetis, "EnemyMetis-279");
				EnemyHesperia* p280 = (EnemyHesperia*)obtainActorFromFactory(10001511);
				getSceneDirector()->addSubGroup(p280);
				orderActorToFactory(10001514, EnemyHesperia, "EnemyHesperia-281");
				break;
			}
			case 3420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000170);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000215, EnemyMetis, "EnemyMetis-282");
				break;
			}
			case 3440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000171);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000216, EnemyMetis, "EnemyMetis-283");
				break;
			}
			case 3460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000172);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000217, EnemyMetis, "EnemyMetis-284");
				break;
			}
			case 3480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000173);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000218, EnemyMetis, "EnemyMetis-285");
				break;
			}
			case 3500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000174);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000219, EnemyMetis, "EnemyMetis-286");
				break;
			}
			case 3520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000175);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000220, EnemyMetis, "EnemyMetis-287");
				break;
			}
			case 3540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000176);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000221, EnemyMetis, "EnemyMetis-288");
				break;
			}
			case 3560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000177);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000222, EnemyMetis, "EnemyMetis-289");
				break;
			}
			case 3580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000178);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000223, EnemyMetis, "EnemyMetis-290");
				break;
			}
			case 3600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000179);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000224, EnemyMetis, "EnemyMetis-291");
				break;
			}
			case 3620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000180);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000225, EnemyMetis, "EnemyMetis-292");
				break;
			}
			case 3640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000181);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000226, EnemyMetis, "EnemyMetis-293");
				break;
			}
			case 3660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000182);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000227, EnemyMetis, "EnemyMetis-294");
				break;
			}
			case 3680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000183);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000228, EnemyMetis, "EnemyMetis-295");
				break;
			}
			case 3700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000184);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000229, EnemyMetis, "EnemyMetis-296");
				EnemyHesperia* p297 = (EnemyHesperia*)obtainActorFromFactory(10001512);
				getSceneDirector()->addSubGroup(p297);
				orderActorToFactory(10001515, EnemyHesperia, "EnemyHesperia-298");
				break;
			}
			case 3720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000185);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000230, EnemyMetis, "EnemyMetis-299");
				break;
			}
			case 3740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000186);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000231, EnemyMetis, "EnemyMetis-300");
				break;
			}
			case 3760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000187);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000232, EnemyMetis, "EnemyMetis-301");
				break;
			}
			case 3780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000188);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000233, EnemyMetis, "EnemyMetis-302");
				break;
			}
			case 3800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000189);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000234, EnemyMetis, "EnemyMetis-303");
				break;
			}
			case 3820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000190);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000235, EnemyMetis, "EnemyMetis-304");
				break;
			}
			case 3840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000191);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000236, EnemyMetis, "EnemyMetis-305");
				break;
			}
			case 3860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000192);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000237, EnemyMetis, "EnemyMetis-306");
				break;
			}
			case 3880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000193);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000238, EnemyMetis, "EnemyMetis-307");
				break;
			}
			case 3900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000194);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000239, EnemyMetis, "EnemyMetis-308");
				break;
			}
			case 3920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000195);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000240, EnemyMetis, "EnemyMetis-309");
				break;
			}
			case 3940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000196);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000241, EnemyMetis, "EnemyMetis-310");
				break;
			}
			case 3960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000197);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000242, EnemyMetis, "EnemyMetis-311");
				break;
			}
			case 3980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000198);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000243, EnemyMetis, "EnemyMetis-312");
				break;
			}
			case 4000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000199);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000244, EnemyMetis, "EnemyMetis-313");
				EnemyHesperia* p314 = (EnemyHesperia*)obtainActorFromFactory(10001513);
				getSceneDirector()->addSubGroup(p314);
				orderActorToFactory(10001516, EnemyHesperia, "EnemyHesperia-315");
				break;
			}
			case 4020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000200);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000245, EnemyMetis, "EnemyMetis-316");
				break;
			}
			case 4040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000201);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000246, EnemyMetis, "EnemyMetis-317");
				break;
			}
			case 4060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000202);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000247, EnemyMetis, "EnemyMetis-318");
				break;
			}
			case 4080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000203);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000248, EnemyMetis, "EnemyMetis-319");
				break;
			}
			case 4100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000204);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000249, EnemyMetis, "EnemyMetis-320");
				break;
			}
			case 4120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000205);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000250, EnemyMetis, "EnemyMetis-321");
				break;
			}
			case 4140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000206);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000251, EnemyMetis, "EnemyMetis-322");
				break;
			}
			case 4160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000207);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000252, EnemyMetis, "EnemyMetis-323");
				break;
			}
			case 4180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000208);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000253, EnemyMetis, "EnemyMetis-324");
				break;
			}
			case 4200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000209);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000254, EnemyMetis, "EnemyMetis-325");
				break;
			}
			case 4220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000210);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000255, EnemyMetis, "EnemyMetis-326");
				break;
			}
			case 4240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000211);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000256, EnemyMetis, "EnemyMetis-327");
				break;
			}
			case 4260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000212);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000257, EnemyMetis, "EnemyMetis-328");
				break;
			}
			case 4280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000213);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000258, EnemyMetis, "EnemyMetis-329");
				break;
			}
			case 4300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000214);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000259, EnemyMetis, "EnemyMetis-330");
				EnemyHesperia* p331 = (EnemyHesperia*)obtainActorFromFactory(10001514);
				getSceneDirector()->addSubGroup(p331);
				orderActorToFactory(10001517, EnemyHesperia, "EnemyHesperia-332");
				break;
			}
			case 4320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000215);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000260, EnemyMetis, "EnemyMetis-333");
				break;
			}
			case 4340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000216);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000261, EnemyMetis, "EnemyMetis-334");
				break;
			}
			case 4360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000217);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000262, EnemyMetis, "EnemyMetis-335");
				break;
			}
			case 4380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000218);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000263, EnemyMetis, "EnemyMetis-336");
				break;
			}
			case 4400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000219);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000264, EnemyMetis, "EnemyMetis-337");
				break;
			}
			case 4420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000220);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000265, EnemyMetis, "EnemyMetis-338");
				break;
			}
			case 4440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000221);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000266, EnemyMetis, "EnemyMetis-339");
				break;
			}
			case 4460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000222);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000267, EnemyMetis, "EnemyMetis-340");
				break;
			}
			case 4480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000223);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000268, EnemyMetis, "EnemyMetis-341");
				break;
			}
			case 4500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000224);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000269, EnemyMetis, "EnemyMetis-342");
				break;
			}
			case 4520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000225);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000270, EnemyMetis, "EnemyMetis-343");
				break;
			}
			case 4540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000226);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000271, EnemyMetis, "EnemyMetis-344");
				break;
			}
			case 4560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000227);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000272, EnemyMetis, "EnemyMetis-345");
				break;
			}
			case 4580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000228);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000273, EnemyMetis, "EnemyMetis-346");
				break;
			}
			case 4600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000229);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000274, EnemyMetis, "EnemyMetis-347");
				EnemyHesperia* p348 = (EnemyHesperia*)obtainActorFromFactory(10001515);
				getSceneDirector()->addSubGroup(p348);
				orderActorToFactory(10001518, EnemyHesperia, "EnemyHesperia-349");
				break;
			}
			case 4620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000230);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000275, EnemyMetis, "EnemyMetis-350");
				break;
			}
			case 4640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000231);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000276, EnemyMetis, "EnemyMetis-351");
				break;
			}
			case 4660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000232);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000277, EnemyMetis, "EnemyMetis-352");
				break;
			}
			case 4680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000233);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000278, EnemyMetis, "EnemyMetis-353");
				break;
			}
			case 4700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000234);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000279, EnemyMetis, "EnemyMetis-354");
				break;
			}
			case 4720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000235);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000280, EnemyMetis, "EnemyMetis-355");
				break;
			}
			case 4740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000236);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000281, EnemyMetis, "EnemyMetis-356");
				break;
			}
			case 4760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000237);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000282, EnemyMetis, "EnemyMetis-357");
				break;
			}
			case 4780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000238);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000283, EnemyMetis, "EnemyMetis-358");
				break;
			}
			case 4800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000239);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000284, EnemyMetis, "EnemyMetis-359");
				break;
			}
			case 4820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000240);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000285, EnemyMetis, "EnemyMetis-360");
				break;
			}
			case 4840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000241);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000286, EnemyMetis, "EnemyMetis-361");
				break;
			}
			case 4860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000242);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000287, EnemyMetis, "EnemyMetis-362");
				break;
			}
			case 4880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000243);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000288, EnemyMetis, "EnemyMetis-363");
				break;
			}
			case 4900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000244);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000289, EnemyMetis, "EnemyMetis-364");
				EnemyHesperia* p365 = (EnemyHesperia*)obtainActorFromFactory(10001516);
				getSceneDirector()->addSubGroup(p365);
				orderActorToFactory(10001519, EnemyHesperia, "EnemyHesperia-366");
				break;
			}
			case 4920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000245);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000290, EnemyMetis, "EnemyMetis-367");
				break;
			}
			case 4940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000246);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000291, EnemyMetis, "EnemyMetis-368");
				break;
			}
			case 4960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000247);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000292, EnemyMetis, "EnemyMetis-369");
				break;
			}
			case 4980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000248);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000293, EnemyMetis, "EnemyMetis-370");
				break;
			}
			case 5000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000249);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000294, EnemyMetis, "EnemyMetis-371");
				break;
			}
			case 5020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000250);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000295, EnemyMetis, "EnemyMetis-372");
				break;
			}
			case 5040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000251);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000296, EnemyMetis, "EnemyMetis-373");
				break;
			}
			case 5060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000252);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000297, EnemyMetis, "EnemyMetis-374");
				break;
			}
			case 5080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000253);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000298, EnemyMetis, "EnemyMetis-375");
				break;
			}
			case 5100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000254);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000299, EnemyMetis, "EnemyMetis-376");
				break;
			}
			case 5120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000255);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000300, EnemyMetis, "EnemyMetis-377");
				break;
			}
			case 5140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000256);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000301, EnemyMetis, "EnemyMetis-378");
				break;
			}
			case 5160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000257);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000302, EnemyMetis, "EnemyMetis-379");
				break;
			}
			case 5180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000258);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000303, EnemyMetis, "EnemyMetis-380");
				break;
			}
			case 5200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000259);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000304, EnemyMetis, "EnemyMetis-381");
				EnemyHesperia* p382 = (EnemyHesperia*)obtainActorFromFactory(10001517);
				getSceneDirector()->addSubGroup(p382);
				orderActorToFactory(10001520, EnemyHesperia, "EnemyHesperia-383");
				break;
			}
			case 5220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000260);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000305, EnemyMetis, "EnemyMetis-384");
				break;
			}
			case 5240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000261);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000306, EnemyMetis, "EnemyMetis-385");
				break;
			}
			case 5260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000262);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000307, EnemyMetis, "EnemyMetis-386");
				break;
			}
			case 5280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000263);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000308, EnemyMetis, "EnemyMetis-387");
				break;
			}
			case 5300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000264);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000309, EnemyMetis, "EnemyMetis-388");
				break;
			}
			case 5320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000265);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000310, EnemyMetis, "EnemyMetis-389");
				break;
			}
			case 5340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000266);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000311, EnemyMetis, "EnemyMetis-390");
				break;
			}
			case 5360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000267);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000312, EnemyMetis, "EnemyMetis-391");
				break;
			}
			case 5380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000268);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000313, EnemyMetis, "EnemyMetis-392");
				break;
			}
			case 5400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000269);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000314, EnemyMetis, "EnemyMetis-393");
				break;
			}
			case 5420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000270);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000315, EnemyMetis, "EnemyMetis-394");
				break;
			}
			case 5440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000271);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000316, EnemyMetis, "EnemyMetis-395");
				break;
			}
			case 5460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000272);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000317, EnemyMetis, "EnemyMetis-396");
				break;
			}
			case 5480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000273);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000318, EnemyMetis, "EnemyMetis-397");
				break;
			}
			case 5500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000274);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000319, EnemyMetis, "EnemyMetis-398");
				EnemyHesperia* p399 = (EnemyHesperia*)obtainActorFromFactory(10001518);
				getSceneDirector()->addSubGroup(p399);
				orderActorToFactory(10001521, EnemyHesperia, "EnemyHesperia-400");
				break;
			}
			case 5520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000275);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000320, EnemyMetis, "EnemyMetis-401");
				break;
			}
			case 5540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000276);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000321, EnemyMetis, "EnemyMetis-402");
				break;
			}
			case 5560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000277);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000322, EnemyMetis, "EnemyMetis-403");
				break;
			}
			case 5580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000278);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000323, EnemyMetis, "EnemyMetis-404");
				break;
			}
			case 5600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000279);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000324, EnemyMetis, "EnemyMetis-405");
				break;
			}
			case 5620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000280);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000325, EnemyMetis, "EnemyMetis-406");
				break;
			}
			case 5640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000281);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000326, EnemyMetis, "EnemyMetis-407");
				break;
			}
			case 5660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000282);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000327, EnemyMetis, "EnemyMetis-408");
				break;
			}
			case 5680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000283);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000328, EnemyMetis, "EnemyMetis-409");
				break;
			}
			case 5700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000284);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000329, EnemyMetis, "EnemyMetis-410");
				break;
			}
			case 5720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000285);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000330, EnemyMetis, "EnemyMetis-411");
				break;
			}
			case 5740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000286);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000331, EnemyMetis, "EnemyMetis-412");
				break;
			}
			case 5760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000287);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000332, EnemyMetis, "EnemyMetis-413");
				break;
			}
			case 5780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000288);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000333, EnemyMetis, "EnemyMetis-414");
				break;
			}
			case 5800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000289);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000334, EnemyMetis, "EnemyMetis-415");
				EnemyHesperia* p416 = (EnemyHesperia*)obtainActorFromFactory(10001519);
				getSceneDirector()->addSubGroup(p416);
				orderActorToFactory(10001522, EnemyHesperia, "EnemyHesperia-417");
				break;
			}
			case 5820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000290);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000335, EnemyMetis, "EnemyMetis-418");
				break;
			}
			case 5840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000291);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000336, EnemyMetis, "EnemyMetis-419");
				break;
			}
			case 5860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000292);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000337, EnemyMetis, "EnemyMetis-420");
				break;
			}
			case 5880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000293);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000338, EnemyMetis, "EnemyMetis-421");
				break;
			}
			case 5900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000294);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000339, EnemyMetis, "EnemyMetis-422");
				break;
			}
			case 5920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000295);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000340, EnemyMetis, "EnemyMetis-423");
				break;
			}
			case 5940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000296);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000341, EnemyMetis, "EnemyMetis-424");
				break;
			}
			case 5960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000297);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000342, EnemyMetis, "EnemyMetis-425");
				break;
			}
			case 5980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000298);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000343, EnemyMetis, "EnemyMetis-426");
				break;
			}
			case 6000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000299);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000344, EnemyMetis, "EnemyMetis-427");
				break;
			}
			case 6020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000300);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000345, EnemyMetis, "EnemyMetis-428");
				break;
			}
			case 6040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000301);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000346, EnemyMetis, "EnemyMetis-429");
				break;
			}
			case 6060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000302);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000347, EnemyMetis, "EnemyMetis-430");
				break;
			}
			case 6080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000303);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000348, EnemyMetis, "EnemyMetis-431");
				break;
			}
			case 6100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000304);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000349, EnemyMetis, "EnemyMetis-432");
				EnemyHesperia* p433 = (EnemyHesperia*)obtainActorFromFactory(10001520);
				getSceneDirector()->addSubGroup(p433);
				orderActorToFactory(10001523, EnemyHesperia, "EnemyHesperia-434");
				break;
			}
			case 6120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000305);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000350, EnemyMetis, "EnemyMetis-435");
				break;
			}
			case 6140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000306);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000351, EnemyMetis, "EnemyMetis-436");
				break;
			}
			case 6160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000307);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000352, EnemyMetis, "EnemyMetis-437");
				break;
			}
			case 6180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000308);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000353, EnemyMetis, "EnemyMetis-438");
				break;
			}
			case 6200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000309);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000354, EnemyMetis, "EnemyMetis-439");
				break;
			}
			case 6220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000310);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000355, EnemyMetis, "EnemyMetis-440");
				break;
			}
			case 6240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000311);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000356, EnemyMetis, "EnemyMetis-441");
				break;
			}
			case 6260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000312);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000357, EnemyMetis, "EnemyMetis-442");
				break;
			}
			case 6280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000313);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000358, EnemyMetis, "EnemyMetis-443");
				break;
			}
			case 6300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000314);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000359, EnemyMetis, "EnemyMetis-444");
				break;
			}
			case 6320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000315);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000360, EnemyMetis, "EnemyMetis-445");
				break;
			}
			case 6340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000316);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000361, EnemyMetis, "EnemyMetis-446");
				break;
			}
			case 6360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000317);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000362, EnemyMetis, "EnemyMetis-447");
				break;
			}
			case 6380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000318);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000363, EnemyMetis, "EnemyMetis-448");
				break;
			}
			case 6400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000319);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000364, EnemyMetis, "EnemyMetis-449");
				EnemyHesperia* p450 = (EnemyHesperia*)obtainActorFromFactory(10001521);
				getSceneDirector()->addSubGroup(p450);
				orderActorToFactory(10001524, EnemyHesperia, "EnemyHesperia-451");
				break;
			}
			case 6420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000320);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000365, EnemyMetis, "EnemyMetis-452");
				break;
			}
			case 6440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000321);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000366, EnemyMetis, "EnemyMetis-453");
				break;
			}
			case 6460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000322);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000367, EnemyMetis, "EnemyMetis-454");
				break;
			}
			case 6480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000323);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000368, EnemyMetis, "EnemyMetis-455");
				break;
			}
			case 6500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000324);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000369, EnemyMetis, "EnemyMetis-456");
				break;
			}
			case 6520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000325);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000370, EnemyMetis, "EnemyMetis-457");
				break;
			}
			case 6540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000326);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000371, EnemyMetis, "EnemyMetis-458");
				break;
			}
			case 6560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000327);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000372, EnemyMetis, "EnemyMetis-459");
				break;
			}
			case 6580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000328);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000373, EnemyMetis, "EnemyMetis-460");
				break;
			}
			case 6600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000329);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000374, EnemyMetis, "EnemyMetis-461");
				break;
			}
			case 6620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000330);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000375, EnemyMetis, "EnemyMetis-462");
				break;
			}
			case 6640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000331);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000376, EnemyMetis, "EnemyMetis-463");
				break;
			}
			case 6660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000332);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000377, EnemyMetis, "EnemyMetis-464");
				break;
			}
			case 6680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000333);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000378, EnemyMetis, "EnemyMetis-465");
				break;
			}
			case 6700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000334);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000379, EnemyMetis, "EnemyMetis-466");
				EnemyHesperia* p467 = (EnemyHesperia*)obtainActorFromFactory(10001522);
				getSceneDirector()->addSubGroup(p467);
				orderActorToFactory(10001525, EnemyHesperia, "EnemyHesperia-468");
				break;
			}
			case 6720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000335);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000380, EnemyMetis, "EnemyMetis-469");
				break;
			}
			case 6740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000336);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000381, EnemyMetis, "EnemyMetis-470");
				break;
			}
			case 6760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000337);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000382, EnemyMetis, "EnemyMetis-471");
				break;
			}
			case 6780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000338);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000383, EnemyMetis, "EnemyMetis-472");
				break;
			}
			case 6800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000339);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000384, EnemyMetis, "EnemyMetis-473");
				break;
			}
			case 6820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000340);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000385, EnemyMetis, "EnemyMetis-474");
				break;
			}
			case 6840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000341);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000386, EnemyMetis, "EnemyMetis-475");
				break;
			}
			case 6860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000342);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000387, EnemyMetis, "EnemyMetis-476");
				break;
			}
			case 6880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000343);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000388, EnemyMetis, "EnemyMetis-477");
				break;
			}
			case 6900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000344);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000389, EnemyMetis, "EnemyMetis-478");
				break;
			}
			case 6920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000345);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000390, EnemyMetis, "EnemyMetis-479");
				break;
			}
			case 6940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000346);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000391, EnemyMetis, "EnemyMetis-480");
				break;
			}
			case 6960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000347);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000392, EnemyMetis, "EnemyMetis-481");
				break;
			}
			case 6980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000348);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000393, EnemyMetis, "EnemyMetis-482");
				break;
			}
			case 7000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000349);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000394, EnemyMetis, "EnemyMetis-483");
				EnemyHesperia* p484 = (EnemyHesperia*)obtainActorFromFactory(10001523);
				getSceneDirector()->addSubGroup(p484);
				orderActorToFactory(10001526, EnemyHesperia, "EnemyHesperia-485");
				break;
			}
			case 7020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000350);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000395, EnemyMetis, "EnemyMetis-486");
				break;
			}
			case 7040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000351);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000396, EnemyMetis, "EnemyMetis-487");
				break;
			}
			case 7060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000352);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000397, EnemyMetis, "EnemyMetis-488");
				break;
			}
			case 7080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000353);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000398, EnemyMetis, "EnemyMetis-489");
				break;
			}
			case 7100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000354);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000399, EnemyMetis, "EnemyMetis-490");
				break;
			}
			case 7120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000355);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000400, EnemyMetis, "EnemyMetis-491");
				break;
			}
			case 7140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000356);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000401, EnemyMetis, "EnemyMetis-492");
				break;
			}
			case 7160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000357);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000402, EnemyMetis, "EnemyMetis-493");
				break;
			}
			case 7180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000358);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000403, EnemyMetis, "EnemyMetis-494");
				break;
			}
			case 7200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000359);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000404, EnemyMetis, "EnemyMetis-495");
				break;
			}
			case 7220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000360);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000405, EnemyMetis, "EnemyMetis-496");
				break;
			}
			case 7240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000361);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000406, EnemyMetis, "EnemyMetis-497");
				break;
			}
			case 7260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000362);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000407, EnemyMetis, "EnemyMetis-498");
				break;
			}
			case 7280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000363);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000408, EnemyMetis, "EnemyMetis-499");
				break;
			}
			case 7300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000364);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000409, EnemyMetis, "EnemyMetis-500");
				EnemyHesperia* p501 = (EnemyHesperia*)obtainActorFromFactory(10001524);
				getSceneDirector()->addSubGroup(p501);
				orderActorToFactory(10001527, EnemyHesperia, "EnemyHesperia-502");
				break;
			}
			case 7320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000365);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000410, EnemyMetis, "EnemyMetis-503");
				break;
			}
			case 7340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000366);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000411, EnemyMetis, "EnemyMetis-504");
				break;
			}
			case 7360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000367);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000412, EnemyMetis, "EnemyMetis-505");
				break;
			}
			case 7380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000368);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000413, EnemyMetis, "EnemyMetis-506");
				break;
			}
			case 7400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000369);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000414, EnemyMetis, "EnemyMetis-507");
				break;
			}
			case 7420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000370);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000415, EnemyMetis, "EnemyMetis-508");
				break;
			}
			case 7440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000371);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000416, EnemyMetis, "EnemyMetis-509");
				break;
			}
			case 7460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000372);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000417, EnemyMetis, "EnemyMetis-510");
				break;
			}
			case 7480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000373);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000418, EnemyMetis, "EnemyMetis-511");
				break;
			}
			case 7500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000374);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000419, EnemyMetis, "EnemyMetis-512");
				break;
			}
			case 7520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000375);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000420, EnemyMetis, "EnemyMetis-513");
				break;
			}
			case 7540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000376);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000421, EnemyMetis, "EnemyMetis-514");
				break;
			}
			case 7560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000377);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000422, EnemyMetis, "EnemyMetis-515");
				break;
			}
			case 7580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000378);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000423, EnemyMetis, "EnemyMetis-516");
				break;
			}
			case 7600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000379);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000424, EnemyMetis, "EnemyMetis-517");
				EnemyHesperia* p518 = (EnemyHesperia*)obtainActorFromFactory(10001525);
				getSceneDirector()->addSubGroup(p518);
				orderActorToFactory(10001528, EnemyHesperia, "EnemyHesperia-519");
				break;
			}
			case 7620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000380);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000425, EnemyMetis, "EnemyMetis-520");
				break;
			}
			case 7640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000381);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000426, EnemyMetis, "EnemyMetis-521");
				break;
			}
			case 7660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000382);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000427, EnemyMetis, "EnemyMetis-522");
				break;
			}
			case 7680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000383);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000428, EnemyMetis, "EnemyMetis-523");
				break;
			}
			case 7700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000384);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000429, EnemyMetis, "EnemyMetis-524");
				break;
			}
			case 7720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000385);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000430, EnemyMetis, "EnemyMetis-525");
				break;
			}
			case 7740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000386);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000431, EnemyMetis, "EnemyMetis-526");
				break;
			}
			case 7760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000387);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000432, EnemyMetis, "EnemyMetis-527");
				break;
			}
			case 7780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000388);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000433, EnemyMetis, "EnemyMetis-528");
				break;
			}
			case 7800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000389);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000434, EnemyMetis, "EnemyMetis-529");
				break;
			}
			case 7820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000390);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000435, EnemyMetis, "EnemyMetis-530");
				break;
			}
			case 7840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000391);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000436, EnemyMetis, "EnemyMetis-531");
				break;
			}
			case 7860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000392);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000437, EnemyMetis, "EnemyMetis-532");
				break;
			}
			case 7880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000393);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000438, EnemyMetis, "EnemyMetis-533");
				break;
			}
			case 7900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000394);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000439, EnemyMetis, "EnemyMetis-534");
				EnemyHesperia* p535 = (EnemyHesperia*)obtainActorFromFactory(10001526);
				getSceneDirector()->addSubGroup(p535);
				orderActorToFactory(10001529, EnemyHesperia, "EnemyHesperia-536");
				break;
			}
			case 7920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000395);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000440, EnemyMetis, "EnemyMetis-537");
				break;
			}
			case 7940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000396);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000441, EnemyMetis, "EnemyMetis-538");
				break;
			}
			case 7960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000397);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000442, EnemyMetis, "EnemyMetis-539");
				break;
			}
			case 7980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000398);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000443, EnemyMetis, "EnemyMetis-540");
				break;
			}
			case 8000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000399);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000444, EnemyMetis, "EnemyMetis-541");
				break;
			}
			case 8020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000400);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000445, EnemyMetis, "EnemyMetis-542");
				break;
			}
			case 8040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000401);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000446, EnemyMetis, "EnemyMetis-543");
				break;
			}
			case 8060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000402);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000447, EnemyMetis, "EnemyMetis-544");
				break;
			}
			case 8080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000403);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000448, EnemyMetis, "EnemyMetis-545");
				break;
			}
			case 8100: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000404);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000449, EnemyMetis, "EnemyMetis-546");
				break;
			}
			case 8120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000405);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000450, EnemyMetis, "EnemyMetis-547");
				break;
			}
			case 8140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000406);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000451, EnemyMetis, "EnemyMetis-548");
				break;
			}
			case 8160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000407);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000452, EnemyMetis, "EnemyMetis-549");
				break;
			}
			case 8180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000408);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000453, EnemyMetis, "EnemyMetis-550");
				break;
			}
			case 8200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000409);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000454, EnemyMetis, "EnemyMetis-551");
				EnemyHesperia* p552 = (EnemyHesperia*)obtainActorFromFactory(10001527);
				getSceneDirector()->addSubGroup(p552);
				orderActorToFactory(10001530, EnemyHesperia, "EnemyHesperia-553");
				break;
			}
			case 8220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000410);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000455, EnemyMetis, "EnemyMetis-554");
				break;
			}
			case 8240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000411);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000456, EnemyMetis, "EnemyMetis-555");
				break;
			}
			case 8260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000412);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000457, EnemyMetis, "EnemyMetis-556");
				break;
			}
			case 8280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000413);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000458, EnemyMetis, "EnemyMetis-557");
				break;
			}
			case 8300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000414);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000459, EnemyMetis, "EnemyMetis-558");
				break;
			}
			case 8320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000415);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000460, EnemyMetis, "EnemyMetis-559");
				break;
			}
			case 8340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000416);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000461, EnemyMetis, "EnemyMetis-560");
				break;
			}
			case 8360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000417);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000462, EnemyMetis, "EnemyMetis-561");
				break;
			}
			case 8380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000418);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000463, EnemyMetis, "EnemyMetis-562");
				break;
			}
			case 8400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000419);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000464, EnemyMetis, "EnemyMetis-563");
				break;
			}
			case 8420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000420);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000465, EnemyMetis, "EnemyMetis-564");
				break;
			}
			case 8440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000421);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000466, EnemyMetis, "EnemyMetis-565");
				break;
			}
			case 8460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000422);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000467, EnemyMetis, "EnemyMetis-566");
				break;
			}
			case 8480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000423);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000468, EnemyMetis, "EnemyMetis-567");
				break;
			}
			case 8500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000424);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000469, EnemyMetis, "EnemyMetis-568");
				EnemyHesperia* p569 = (EnemyHesperia*)obtainActorFromFactory(10001528);
				getSceneDirector()->addSubGroup(p569);
				orderActorToFactory(10001531, EnemyHesperia, "EnemyHesperia-570");
				break;
			}
			case 8520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000425);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000470, EnemyMetis, "EnemyMetis-571");
				break;
			}
			case 8540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000426);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000471, EnemyMetis, "EnemyMetis-572");
				break;
			}
			case 8560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000427);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000472, EnemyMetis, "EnemyMetis-573");
				break;
			}
			case 8580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000428);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000473, EnemyMetis, "EnemyMetis-574");
				break;
			}
			case 8600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000429);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000474, EnemyMetis, "EnemyMetis-575");
				break;
			}
			case 8620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000430);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000475, EnemyMetis, "EnemyMetis-576");
				break;
			}
			case 8640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000431);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000476, EnemyMetis, "EnemyMetis-577");
				break;
			}
			case 8660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000432);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000477, EnemyMetis, "EnemyMetis-578");
				break;
			}
			case 8680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000433);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000478, EnemyMetis, "EnemyMetis-579");
				break;
			}
			case 8700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000434);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000479, EnemyMetis, "EnemyMetis-580");
				break;
			}
			case 8720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000435);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000480, EnemyMetis, "EnemyMetis-581");
				break;
			}
			case 8740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000436);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000481, EnemyMetis, "EnemyMetis-582");
				break;
			}
			case 8760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000437);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000482, EnemyMetis, "EnemyMetis-583");
				break;
			}
			case 8780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000438);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000483, EnemyMetis, "EnemyMetis-584");
				break;
			}
			case 8800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000439);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000484, EnemyMetis, "EnemyMetis-585");
				EnemyHesperia* p586 = (EnemyHesperia*)obtainActorFromFactory(10001529);
				getSceneDirector()->addSubGroup(p586);
				orderActorToFactory(10001532, EnemyHesperia, "EnemyHesperia-587");
				break;
			}
			case 8820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000440);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000485, EnemyMetis, "EnemyMetis-588");
				break;
			}
			case 8840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000441);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000486, EnemyMetis, "EnemyMetis-589");
				break;
			}
			case 8860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000442);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000487, EnemyMetis, "EnemyMetis-590");
				break;
			}
			case 8880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000443);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000488, EnemyMetis, "EnemyMetis-591");
				break;
			}
			case 8900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000444);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000489, EnemyMetis, "EnemyMetis-592");
				break;
			}
			case 8920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000445);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000490, EnemyMetis, "EnemyMetis-593");
				break;
			}
			case 8940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000446);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000491, EnemyMetis, "EnemyMetis-594");
				break;
			}
			case 8960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000447);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000492, EnemyMetis, "EnemyMetis-595");
				break;
			}
			case 8980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000448);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000493, EnemyMetis, "EnemyMetis-596");
				break;
			}
			case 9000: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000449);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000494, EnemyMetis, "EnemyMetis-597");
				break;
			}
			case 9020: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000450);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000495, EnemyMetis, "EnemyMetis-598");
				break;
			}
			case 9040: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000451);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000496, EnemyMetis, "EnemyMetis-599");
				break;
			}
			case 9060: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000452);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000497, EnemyMetis, "EnemyMetis-600");
				break;
			}
			case 9080: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000453);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000498, EnemyMetis, "EnemyMetis-601");
				break;
			}
			case 9100: {
				orderSceneToFactory(10000001, Stage01_02, "Stage01_02-602");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000454);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000499, EnemyMetis, "EnemyMetis-603");
				EnemyHesperia* p604 = (EnemyHesperia*)obtainActorFromFactory(10001530);
				getSceneDirector()->addSubGroup(p604);
				orderActorToFactory(10001533, EnemyHesperia, "EnemyHesperia-605");
				break;
			}
			case 9120: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000455);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000500, EnemyMetis, "EnemyMetis-606");
				break;
			}
			case 9140: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000456);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000501, EnemyMetis, "EnemyMetis-607");
				break;
			}
			case 9160: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000457);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000502, EnemyMetis, "EnemyMetis-608");
				break;
			}
			case 9180: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000458);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000503, EnemyMetis, "EnemyMetis-609");
				break;
			}
			case 9200: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000459);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000504, EnemyMetis, "EnemyMetis-610");
				break;
			}
			case 9220: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000460);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000505, EnemyMetis, "EnemyMetis-611");
				break;
			}
			case 9240: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000461);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000506, EnemyMetis, "EnemyMetis-612");
				break;
			}
			case 9260: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000462);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000507, EnemyMetis, "EnemyMetis-613");
				break;
			}
			case 9280: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000463);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000508, EnemyMetis, "EnemyMetis-614");
				break;
			}
			case 9300: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000464);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000509, EnemyMetis, "EnemyMetis-615");
				break;
			}
			case 9320: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000465);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000510, EnemyMetis, "EnemyMetis-616");
				break;
			}
			case 9340: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000466);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000511, EnemyMetis, "EnemyMetis-617");
				break;
			}
			case 9360: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000467);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000512, EnemyMetis, "EnemyMetis-618");
				break;
			}
			case 9380: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000468);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000513, EnemyMetis, "EnemyMetis-619");
				break;
			}
			case 9400: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000469);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000514, EnemyMetis, "EnemyMetis-620");
				EnemyHesperia* p621 = (EnemyHesperia*)obtainActorFromFactory(10001531);
				getSceneDirector()->addSubGroup(p621);
				break;
			}
			case 9420: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000470);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000515, EnemyMetis, "EnemyMetis-622");
				break;
			}
			case 9440: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000471);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000516, EnemyMetis, "EnemyMetis-623");
				break;
			}
			case 9460: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000472);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000517, EnemyMetis, "EnemyMetis-624");
				break;
			}
			case 9480: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000473);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000518, EnemyMetis, "EnemyMetis-625");
				break;
			}
			case 9500: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000474);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000519, EnemyMetis, "EnemyMetis-626");
				break;
			}
			case 9520: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000475);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000520, EnemyMetis, "EnemyMetis-627");
				break;
			}
			case 9540: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000476);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000521, EnemyMetis, "EnemyMetis-628");
				break;
			}
			case 9560: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000477);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000522, EnemyMetis, "EnemyMetis-629");
				break;
			}
			case 9580: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000478);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000523, EnemyMetis, "EnemyMetis-630");
				break;
			}
			case 9600: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000479);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000524, EnemyMetis, "EnemyMetis-631");
				break;
			}
			case 9620: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000480);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000525, EnemyMetis, "EnemyMetis-632");
				break;
			}
			case 9640: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000481);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000526, EnemyMetis, "EnemyMetis-633");
				break;
			}
			case 9660: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000482);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000527, EnemyMetis, "EnemyMetis-634");
				break;
			}
			case 9680: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000483);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000528, EnemyMetis, "EnemyMetis-635");
				break;
			}
			case 9700: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000484);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000529, EnemyMetis, "EnemyMetis-636");
				EnemyHesperia* p637 = (EnemyHesperia*)obtainActorFromFactory(10001532);
				getSceneDirector()->addSubGroup(p637);
				break;
			}
			case 9720: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000485);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000530, EnemyMetis, "EnemyMetis-638");
				break;
			}
			case 9740: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000486);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000531, EnemyMetis, "EnemyMetis-639");
				break;
			}
			case 9760: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000487);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000532, EnemyMetis, "EnemyMetis-640");
				break;
			}
			case 9780: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000488);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000533, EnemyMetis, "EnemyMetis-641");
				break;
			}
			case 9800: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000489);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000534, EnemyMetis, "EnemyMetis-642");
				break;
			}
			case 9820: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000490);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000535, EnemyMetis, "EnemyMetis-643");
				break;
			}
			case 9840: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000491);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000536, EnemyMetis, "EnemyMetis-644");
				break;
			}
			case 9860: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000492);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000537, EnemyMetis, "EnemyMetis-645");
				break;
			}
			case 9880: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000493);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000538, EnemyMetis, "EnemyMetis-646");
				break;
			}
			case 9900: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000494);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000539, EnemyMetis, "EnemyMetis-647");
				break;
			}
			case 9920: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000495);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000540, EnemyMetis, "EnemyMetis-648");
				break;
			}
			case 9940: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000496);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000541, EnemyMetis, "EnemyMetis-649");
				break;
			}
			case 9960: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000497);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000542, EnemyMetis, "EnemyMetis-650");
				break;
			}
			case 9980: {
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000498);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000543, EnemyMetis, "EnemyMetis-651");
				break;
			}
			case 10000: {
