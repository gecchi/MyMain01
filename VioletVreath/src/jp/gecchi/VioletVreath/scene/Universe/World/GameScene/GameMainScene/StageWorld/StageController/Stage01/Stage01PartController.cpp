...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
    ...
    // gen01 start
	frame f[] = {1,40,100,160,220,280,340,400,460,520,580,640,700,760,820,880,940,1000,1060,1120,1180,1240,1300,1360,1420,1480,1540,1600,1660,1720,1780,1840,1900,1960,2020,2080,2140,2200,2260,2320,2380,2440,2500,2560,2620,2680,2740,2800,2860,2920,2980,4100,5000,14100,15000};
	_paFrame_NextEvent = new frame[55];
	memcpy(_paFrame_NextEvent, f, sizeof(f));
	_event_num = 55;
	orderSceneToFactory(10000000, Stage01_01, "Stage01_01-1");
	orderActorToFactory(10000004, EnemyGlaja, "EnemyGlaja-2");
	orderActorToFactory(10000005, EnemyDuna, "EnemyDuna-3");
	orderActorToFactory(10000006, EnemyDuna, "EnemyDuna-4");
	orderActorToFactory(10000007, EnemyDuna, "EnemyDuna-5");
	orderActorToFactory(10000008, EnemyDuna, "EnemyDuna-6");
	orderActorToFactory(10000009, EnemyDuna, "EnemyDuna-7");
	orderActorToFactory(10000010, EnemyDuna, "EnemyDuna-8");
	orderActorToFactory(10000011, EnemyDuna, "EnemyDuna-9");
	orderActorToFactory(10000012, EnemyDuna, "EnemyDuna-10");
	orderActorToFactory(10000013, EnemyDuna, "EnemyDuna-11");
    // gen01 end
...
void Stage01PartController::processBehavior() {
	...
	if (getBehaveingFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getBehaveingFrame()) {
			...
			case 40: {
				orderActorToFactory(10000014, EnemyDuna, "EnemyDuna-12");
				break;
			}
			case 100: {
				Stage01_01* pScene = (Stage01_01*)obtainSceneFromFactory(10000000);
				addSubLast(pScene);
				orderSceneToFactory(10000002, Stage01_03, "Stage01_03-13");
				orderActorToFactory(10000015, EnemyDuna, "EnemyDuna-14");
				break;
			}
			case 160: {
				orderActorToFactory(10000016, EnemyDuna, "EnemyDuna-15");
				break;
			}
			case 220: {
				orderActorToFactory(10000017, EnemyDuna, "EnemyDuna-16");
				break;
			}
			case 280: {
				orderActorToFactory(10000018, EnemyDuna, "EnemyDuna-17");
				break;
			}
			case 340: {
				orderActorToFactory(10000019, EnemyDuna, "EnemyDuna-18");
				break;
			}
			case 400: {
				EnemyGlaja* p = (EnemyGlaja*)obtainActorFromFactory(10000004);
				...
				orderActorToFactory(10000020, EnemyDuna, "EnemyDuna-19");
				break;
			}
			case 460: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000021, EnemyDuna, "EnemyDuna-20");
				break;
			}
			case 520: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000022, EnemyDuna, "EnemyDuna-21");
				break;
			}
			case 580: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000023, EnemyDuna, "EnemyDuna-22");
				break;
			}
			case 640: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000024, EnemyDuna, "EnemyDuna-23");
				break;
			}
			case 700: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000025, EnemyDuna, "EnemyDuna-24");
				break;
			}
			case 760: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000026, EnemyDuna, "EnemyDuna-25");
				break;
			}
			case 820: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000027, EnemyDuna, "EnemyDuna-26");
				break;
			}
			case 880: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000028, EnemyDuna, "EnemyDuna-27");
				break;
			}
			case 940: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000029, EnemyDuna, "EnemyDuna-28");
				break;
			}
			case 1000: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000030, EnemyDuna, "EnemyDuna-29");
				break;
			}
			case 1060: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000031, EnemyDuna, "EnemyDuna-30");
				break;
			}
			case 1120: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000032, EnemyDuna, "EnemyDuna-31");
				break;
			}
			case 1180: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000033, EnemyDuna, "EnemyDuna-32");
				break;
			}
			case 1240: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000034, EnemyDuna, "EnemyDuna-33");
				break;
			}
			case 1300: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000035, EnemyDuna, "EnemyDuna-34");
				break;
			}
			case 1360: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000036, EnemyDuna, "EnemyDuna-35");
				break;
			}
			case 1420: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000037, EnemyDuna, "EnemyDuna-36");
				break;
			}
			case 1480: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000038, EnemyDuna, "EnemyDuna-37");
				break;
			}
			case 1540: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000039, EnemyDuna, "EnemyDuna-38");
				break;
			}
			case 1600: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000040, EnemyDuna, "EnemyDuna-39");
				break;
			}
			case 1660: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000041, EnemyDuna, "EnemyDuna-40");
				break;
			}
			case 1720: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000042, EnemyDuna, "EnemyDuna-41");
				break;
			}
			case 1780: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000043, EnemyDuna, "EnemyDuna-42");
				break;
			}
			case 1840: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000044, EnemyDuna, "EnemyDuna-43");
				break;
			}
			case 1900: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000045, EnemyDuna, "EnemyDuna-44");
				break;
			}
			case 1960: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000046, EnemyDuna, "EnemyDuna-45");
				break;
			}
			case 2020: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000047, EnemyDuna, "EnemyDuna-46");
				break;
			}
			case 2080: {
				...
				getSceneDirector()->addSubGroup(pDuna);
				pDuna->position(2000000,RND(-800000,800000),RND(-800000,800000));
				orderActorToFactory(10000048, EnemyDuna, "EnemyDuna-47");
				break;
			}
			case 2140: {
			...
			case 4100: {
				orderSceneToFactory(10000001, Stage01_02, "Stage01_02-48");
				break;
			}
			case 5000: {
			...
			case 14100: {
				orderSceneToFactory(10000003, Stage01_Climax, "Stage01_Climax-49");
				break;
			}
			case 15000: {
		...
		_cnt_event = (_cnt_event < 55-1 ? _cnt_event+1 : _cnt_event);
	}
    // gen02 end
