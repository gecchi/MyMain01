...
Stage01PartController::Stage01PartController(const char* prm_name) : StagePartController(prm_name) {
	...
	orderActorToFactory(10000027, EnemyHermione, "EnemyHermione-9");
	...
	orderActorToFactory(10001530, TestGu, "TestGu-57");
	...
	orderActorToFactory(10001537, TestChoki, "TestChoki-64");
	...
	orderActorToFactory(10001544, TestPa, "TestPa-71");
	...
	orderActorToFactory(10001551, TestNomal, "TestNomal-78");
	orderActorToFactory(10001553, FormationSappho001a, "FormationSappho001a-79");
	orderActorToFactory(10001554, EnemyHermione, "EnemyHermione-80");
	orderActorToFactory(10001555, FormationSappho001a, "FormationSappho001a-81");
	orderActorToFactory(10001556, FormationSappho001b, "FormationSappho001b-82");
	orderActorToFactory(10001557, FormationSappho001a, "FormationSappho001a-83");
	orderActorToFactory(10001572, FormationAntiope001, "FormationAntiope001-84");
	orderActorToFactory(10001583, FormationAdelheid001, "FormationAdelheid001-85");
    // gen01 end
	...
	if (getActiveFrame() == _paFrame_NextEvent[_cnt_event]) {
		switch (getActiveFrame()) {
			...
			case 100: {
				...
				orderActorToFactory(10000073, EnemyMetis, "EnemyMetis-90");
				TestGu* p = (TestGu*)obtainActorFromFactory(10001524);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = 300000;
				p->_Z = 100000;
				orderActorToFactory(10001552, FormationSappho001b, "FormationSappho001b-91");
				orderActorToFactory(10001560, FormationPallas001a, "FormationPallas001a-92");
				orderActorToFactory(10001561, FormationPallas001b, "FormationPallas001b-93");
				orderActorToFactory(10001562, FormationPallas001c, "FormationPallas001c-94");
				orderActorToFactory(10001563, FormationPallas001d, "FormationPallas001d-95");
				orderActorToFactory(10001564, FormationPallas001a, "FormationPallas001a-96");
				orderActorToFactory(10001565, FormationPallas001d, "FormationPallas001d-97");
				orderActorToFactory(10001566, FormationPallas001b, "FormationPallas001b-98");
				orderActorToFactory(10001567, FormationPallas001c, "FormationPallas001c-99");
				orderActorToFactory(10001568, FormationPallas001a, "FormationPallas001a-100");
				orderActorToFactory(10001569, FormationPallas001d, "FormationPallas001d-101");
				orderActorToFactory(10001570, FormationPallas001b, "FormationPallas001b-102");
				orderActorToFactory(10001571, FormationPallas001c, "FormationPallas001c-103");
				orderActorToFactory(10001573, FormationAntiope001, "FormationAntiope001-104");
				break;
			}
			case 101: {
			...
			case 106: {
				TestGu* p = (TestGu*)obtainActorFromFactory(10001530);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = -300000;
				p->_Z = 100000;
			...
			case 113: {
				TestChoki* p = (TestChoki*)obtainActorFromFactory(10001537);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = -300000;
				p->_Z = 0;
			...
			case 120: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000074, EnemyMetis, "EnemyMetis-105");
				TestPa* p = (TestPa*)obtainActorFromFactory(10001544);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = -300000;
				p->_Z = -100000;
				orderActorToFactory(10001558, FormationSappho001b, "FormationSappho001b-106");
				break;
			}
			case 121: {
			...
			case 127: {
				TestNomal* p = (TestNomal*)obtainActorFromFactory(10001551);
				getSceneDirector()->addSubGroup(p);
				p->_X = 500000;
				p->_Y = -300000;
				p->_Z = -200000;
			...
			case 280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000082, EnemyMetis, "EnemyMetis-114");
				break;
			}
			case 300: {
				orderActorToFactory(10000006, EnemyHermione, "EnemyHermione-115");
				EnemyThisbe* p = (EnemyThisbe*)obtainActorFromFactory(10000021);
				getSceneDirector()->addSubGroup(p);
				p->_X = 0;
				p->_Y = 0;
				p->_Z = 2000000;
				FormationHebe001* pF116 = (FormationHebe001*)obtainActorFromFactory(10000022);
				getSceneDirector()->addSubGroup(pF116);
				...
				FormationSappho001a* pFSap = (FormationSappho001a*)obtainActorFromFactory(10001555);
			...
			case 400: {
				...
				FormationSappho001a* pF = (FormationSappho001a*)obtainActorFromFactory(10001553);
			...
			case 500: {
				...
				getSceneDirector()->addSubGroup(pFormationEunomia);
				EnemyHermione* p = (EnemyHermione*)obtainActorFromFactory(10000027);
				getSceneDirector()->addSubGroup(p);
				p->_X = 300000;
				p->_Y = 0;
				p->_Z = 0;
				...
				FormationAdelheid001* pF = (FormationAdelheid001*)obtainActorFromFactory(10001583);
				getSceneDirector()->addSubGroup(pF);
			...
			case 540: {
				...
				FormationSappho001b* pFSap = (FormationSappho001b*)obtainActorFromFactory(10001556);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 560: {
			...
			case 780: {
				...
				FormationSappho001a* pFSap = (FormationSappho001a*)obtainActorFromFactory(10001557);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 800: {
			...
			case 900: {
				...
				EnemyHermione* p = (EnemyHermione*)obtainActorFromFactory(10001554);
				getSceneDirector()->addSubGroup(p);
				p->_X = 8000000;
			...
			case 1000: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000118, EnemyMetis, "EnemyMetis-152");
				FormationSappho001b* pF = (FormationSappho001b*)obtainActorFromFactory(10001552);
				getSceneDirector()->addSubGroup(pF);
				{
				FormationTableScene* ta = NEW FormationTableScene("FormationTableScene-153");
				ta->setMaxPerformFrame(3000);
				addSubLast(ta);
				ta->addToTable(((FormationPallas001a*)obtainActorFromFactory(10001560)), 400);
				ta->addToTable(((FormationPallas001b*)obtainActorFromFactory(10001561)), 400);
				ta->addToTable(((FormationPallas001c*)obtainActorFromFactory(10001562)), 400);
				ta->addToTable(((FormationPallas001d*)obtainActorFromFactory(10001563)), 400);
				ta->addToTable(((FormationPallas001a*)obtainActorFromFactory(10001564)), 1);
				ta->addToTable(((FormationPallas001d*)obtainActorFromFactory(10001565)), 400);
				ta->addToTable(((FormationPallas001b*)obtainActorFromFactory(10001566)), 1);
				ta->addToTable(((FormationPallas001c*)obtainActorFromFactory(10001567)), 400);
				ta->addToTable(((FormationPallas001a*)obtainActorFromFactory(10001568)), 1);
				ta->addToTable(((FormationPallas001d*)obtainActorFromFactory(10001569)), 1);
				ta->addToTable(((FormationPallas001b*)obtainActorFromFactory(10001570)), 1);
				ta->addToTable(((FormationPallas001c*)obtainActorFromFactory(10001571)), 400);
				}
				FormationAntiope001* pFAnti = (FormationAntiope001*)obtainActorFromFactory(10001573);
				getSceneDirector()->addSubGroup(pFAnti);
				break;
			}
			case 1020: {
				...
				FormationSappho001b* pFSap = (FormationSappho001b*)obtainActorFromFactory(10001558);
				getSceneDirector()->addSubGroup(pFSap);
				break;
			}
			case 1040: {
			...
			case 1580: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000147, EnemyMetis, "EnemyMetis-182");
				break;
			}
			case 1600: {
				orderActorToFactory(10000005, FormationEunomia001a, "FormationEunomia001a-183");
			...
			case 2300: {
				orderActorToFactory(10000007, EnemyHermione, "EnemyHermione-219");
			...
			case 4280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000282, EnemyMetis, "EnemyMetis-319");
				break;
			}
			case 4300: {
				orderActorToFactory(10000008, EnemyHermione, "EnemyHermione-320");
			...
			case 6280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000382, EnemyMetis, "EnemyMetis-420");
				break;
			}
			case 6300: {
				orderActorToFactory(10000009, EnemyHermione, "EnemyHermione-421");
			...
			case 8280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000482, EnemyMetis, "EnemyMetis-521");
				break;
			}
			case 8300: {
				orderActorToFactory(10000010, EnemyHermione, "EnemyHermione-522");
			...
			case 9080: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000522, EnemyMetis, "EnemyMetis-562");
				break;
			}
			case 9100: {
				orderSceneToFactory(10000001, Stage01_02, "Stage01_02-563");
			...
			case 10280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000582, EnemyMetis, "EnemyMetis-623");
				break;
			}
			case 10300: {
				orderActorToFactory(10000011, EnemyHermione, "EnemyHermione-624");
			...
			case 12280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000682, EnemyMetis, "EnemyMetis-724");
				break;
			}
			case 12300: {
				orderActorToFactory(10000012, EnemyHermione, "EnemyHermione-725");
			...
			case 14280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000782, EnemyMetis, "EnemyMetis-825");
				break;
			}
			case 14300: {
				orderActorToFactory(10000013, EnemyHermione, "EnemyHermione-826");
			...
			case 16280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000882, EnemyMetis, "EnemyMetis-926");
				break;
			}
			case 16300: {
				orderActorToFactory(10000014, EnemyHermione, "EnemyHermione-927");
			...
			case 18280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10000982, EnemyMetis, "EnemyMetis-1027");
				break;
			}
			case 18300: {
				orderActorToFactory(10000015, EnemyHermione, "EnemyHermione-1028");
			...
			case 19080: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001022, EnemyMetis, "EnemyMetis-1068");
				break;
			}
			case 19100: {
				orderSceneToFactory(10000003, Stage01_03, "Stage01_03-1069");
				EnemyMetis* pMetis = (EnemyMetis*)obtainActorFromFactory(10000978);
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001023, EnemyMetis, "EnemyMetis-1070");
				orderActorToFactory(10001574, FormationAdelheid001, "FormationAdelheid001-1071");
				break;
			}
			case 19120: {
			...
			case 19200: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001028, EnemyMetis, "EnemyMetis-1076");
				orderActorToFactory(10001575, FormationAdelheid001, "FormationAdelheid001-1077");
				break;
			}
			case 19220: {
			...
			case 19300: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001033, EnemyMetis, "EnemyMetis-1082");
				orderActorToFactory(10001576, FormationAdelheid001, "FormationAdelheid001-1083");
				break;
			}
			case 19320: {
			...
			case 19400: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001038, EnemyMetis, "EnemyMetis-1088");
				orderActorToFactory(10001577, FormationAdelheid001, "FormationAdelheid001-1089");
				break;
			}
			case 19420: {
			...
			case 19500: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001043, EnemyMetis, "EnemyMetis-1094");
				orderActorToFactory(10001578, FormationAdelheid001, "FormationAdelheid001-1095");
				break;
			}
			case 19520: {
			...
			case 19600: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001048, EnemyMetis, "EnemyMetis-1100");
				orderActorToFactory(10001579, FormationAdelheid001, "FormationAdelheid001-1101");
				break;
			}
			case 19620: {
			...
			case 19700: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001053, EnemyMetis, "EnemyMetis-1106");
				orderActorToFactory(10001580, FormationAdelheid001, "FormationAdelheid001-1107");
				break;
			}
			case 19720: {
			...
			case 19800: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001058, EnemyMetis, "EnemyMetis-1112");
				orderActorToFactory(10001581, FormationAdelheid001, "FormationAdelheid001-1113");
				break;
			}
			case 19820: {
			...
			case 19900: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001063, EnemyMetis, "EnemyMetis-1118");
				orderActorToFactory(10001582, FormationAdelheid001, "FormationAdelheid001-1119");
				break;
			}
			case 19920: {
			...
			case 20280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001082, EnemyMetis, "EnemyMetis-1138");
				break;
			}
			case 20300: {
				orderActorToFactory(10000016, EnemyHermione, "EnemyHermione-1139");
			...
			case 22280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001182, EnemyMetis, "EnemyMetis-1239");
				break;
			}
			case 22300: {
				orderActorToFactory(10000017, EnemyHermione, "EnemyHermione-1240");
			...
			case 24280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001282, EnemyMetis, "EnemyMetis-1340");
				break;
			}
			case 24300: {
				orderActorToFactory(10000018, EnemyHermione, "EnemyHermione-1341");
			...
			case 26280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001382, EnemyMetis, "EnemyMetis-1441");
				break;
			}
			case 26300: {
				orderActorToFactory(10000019, EnemyHermione, "EnemyHermione-1442");
			...
			case 28280: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001482, EnemyMetis, "EnemyMetis-1542");
				break;
			}
			case 28300: {
				orderActorToFactory(10000020, EnemyHermione, "EnemyHermione-1543");
			...
			case 29080: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001522, EnemyMetis, "EnemyMetis-1583");
				break;
			}
			case 29100: {
				...
				getSceneDirector()->addSubGroup(pMetis);
				orderActorToFactory(10001523, EnemyMetis, "EnemyMetis-1585");
				break;
			}
			case 29120: {
