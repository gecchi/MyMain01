...
public:
    enum {
        ITEM_FULL_SCREEN,
        ITEM_DUAL_VIEW,
//        ITEM_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        ITEM_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        ITEM_SECONDARY_VIEW_FULL_SCREEN_RESOLUTION,
        ITEM_SWAP_VIEW,
        ITEM_FIXED_VIEW_ASPECT,
//        ITEM_PRIMARY_VIEW_PRESENT_POSITION,
        ITEM_PRIMARY_VIEW_PRESENT_POSITION,
        ITEM_SECONDARY_VIEW_PRESENT_POSITION,
...
//        VALUE_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        VALUE_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        VALUE_SECONDARY_VIEW_FULL_SCREEN_RESOLUTION,
        VALUE_SWAP_VIEW_FALSE, VALUE_SWAP_VIEW_TRUE,
        VALUE_FIXED_VIEW_TRUE, VALUE_FIXED_VIEW_FALSE,
//        VALUE_POS_1, VALUE_POS_2, VALUE_POS_3, VALUE_POS_4, VALUE_POS_5, VALUE_POS_6, VALUE_POS_7, VALUE_POS_8, VALUE_POS_9,
    ...
    enum {
        ...
        SUBCUR_DUAL_VIEW,
//        SUBCUR_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        SUBCUR_PRIMARY_VIEW_FULL_SCREEN_RESOLUTION,
        SUBCUR_SECONDARY_VIEW_FULL_SCREEN_RESOLUTION,
        SUBCUR_SWAP_VIEW,
        SUBCUR_FIXED_VIEW_ASPECT,
//        SUBCUR_PRIMARY_VIEW_PRESENT_POSITION,
        SUBCUR_PRIMARY_VIEW_PRESENT_POSITION,
        SUBCUR_SECONDARY_VIEW_PRESENT_POSITION,
        SUBCUR_BANPEI,
    };
    ...
    bool in_DUAL_VIEW_;
    bool in_SWAP_VIEW_;
    bool in_FIXED_VIEW_ASPECT_;
    int in_PRIMARY_VIEW_PRESENT_POSITION_;
    int in_SECONDARY_VIEW_PRESENT_POSITION_;
//    int in_PRIMARY_VIEW_PRESENT_POSITION_;
