...
//    WNDCLASSEX wcex2 = wcex1;
    ...
    try {
        ...
        if (VV_VB_PLAY) {
            VV_VB_PLAY->_pRpy->outputFile("VV_VB_PLAY_LAST_ggaf_Exception.rep");
        }
        if (VV_VB_UI) {
            VV_VB_UI->_pRpy->outputFile("VV_VB_UI_LAST_ggaf_Exception.rep");
        }
        ...
        VV_VB_PLAY->_pRpy->outputFile("VV_VB_PLAY_LAST_exception.rep");
        VV_VB_UI->_pRpy->outputFile("VV_VB_UI_LAST_exception.rep");
        return EXIT_FAILURE;
    }
#endif
//#ifndef MY_DEBUG
...
//        VV_VB_PLAY->_pRpy->outputFile("VV_VB_PLAY_LAST_UNKNOWN_ERROR.rep");
//        VV_VB_UI->_pRpy->outputFile("VV_VB_UI_LAST_UNKNOWN_ERROR.rep");
//        return EXIT_FAILURE;
//    }
//#endif
...
void myUnexpectedHandler() {
    ...
    VV_VB_PLAY->_pRpy->outputFile("VV_VB_PLAY_LAST_Unexpected.rep");
    VV_VB_UI->_pRpy->outputFile("VV_VB_UI_LAST_Unexpected.rep");
    std::unexpected();
}
...
void myTerminateHandler() {
    ...
    VV_VB_PLAY->_pRpy->outputFile("VV_VB_PLAY_LAST_Terminate.rep");
    VV_VB_UI->_pRpy->outputFile("VV_VB_UI_LAST_Terminate.rep");
    std::terminate();
}
